...
module TreeArbiter(
  ...
  assign io_out_bits_id = _GEN ? io_in_0_bits_id : 4'h0;
  assign io_out_bits_isBtoT = _GEN & io_in_0_bits_isBtoT;
  assign io_out_bits_occupy_way = _GEN ? io_in_0_bits_occupy_way : 4'h0;
