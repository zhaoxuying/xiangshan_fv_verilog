...
module PipelineRegModule_2(
  ...
  input  [4:0]   io_in_bits_schedIndex,
  input          io_out_ready,
  output         io_out_valid,
  ...
  output [4:0]   io_out_bits_schedIndex
);
  ...
  reg  [2:0]   io_out_bits_r_uop_ftqPtr_value;
  ...
  reg  [4:0]   io_out_bits_r_schedIndex;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_bits_r_uop_ftqPtr_value = _RANDOM[6'h4][6:4];
        io_out_bits_r_uop_ftqOffset = _RANDOM[6'h4][10:7];
        io_out_bits_r_uop_fuOpType = _RANDOM[6'h6][16:8];
        io_out_bits_r_uop_rfWen = _RANDOM[6'h6][17];
        io_out_bits_r_uop_fpWen = _RANDOM[6'h6][18];
        io_out_bits_r_uop_vpu_vstart = {_RANDOM[6'h8][31:26], _RANDOM[6'h9][1:0]};
        io_out_bits_r_uop_vpu_veew = _RANDOM[6'hE][2:1];
        io_out_bits_r_uop_uopIdx = _RANDOM[6'hE][22:16];
        io_out_bits_r_uop_pdest = _RANDOM[6'h11][29:22];
        io_out_bits_r_uop_robIdx_flag = _RANDOM[6'h12][10];
        io_out_bits_r_uop_robIdx_value = _RANDOM[6'h12][16:11];
        io_out_bits_r_uop_storeSetHit = _RANDOM[6'h27][2];
        io_out_bits_r_uop_waitForRobIdx_flag = _RANDOM[6'h27][3];
        io_out_bits_r_uop_waitForRobIdx_value = _RANDOM[6'h27][9:4];
        io_out_bits_r_uop_loadWaitBit = _RANDOM[6'h27][10];
        io_out_bits_r_uop_loadWaitStrict = _RANDOM[6'h27][11];
        io_out_bits_r_uop_lqIdx_flag = _RANDOM[6'h27][17];
        io_out_bits_r_uop_lqIdx_value = _RANDOM[6'h27][22:18];
        io_out_bits_r_uop_sqIdx_flag = _RANDOM[6'h27][23];
        io_out_bits_r_uop_sqIdx_value = _RANDOM[6'h27][28:24];
        io_out_bits_r_vaddr = {_RANDOM[6'h28][31:4], _RANDOM[6'h29][21:0]};
        io_out_bits_r_paddr =
          {_RANDOM[6'h2B][31:23], _RANDOM[6'h2C], _RANDOM[6'h2D][6:0]};
        io_out_bits_r_data =
          {_RANDOM[6'h2F][31:23],
           _RANDOM[6'h30],
           _RANDOM[6'h31],
           _RANDOM[6'h32],
           _RANDOM[6'h33][23:0]};
        io_out_bits_r_isvec = _RANDOM[6'h38][24];
        io_out_bits_r_is128bit = _RANDOM[6'h38][26];
        io_out_bits_r_vecActive = _RANDOM[6'h3D][13];
        io_out_bits_r_schedIndex = _RANDOM[6'h3E][6:2];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        pipeline_reg_valid = 1'h0;
    end // initial
