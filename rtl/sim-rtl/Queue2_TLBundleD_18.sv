...
module Queue2_TLBundleD_18(
  ...
  ram_2x10 ram_ext (
    ...
    .W0_en   (do_enq),
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_denied})
  );
  assign io_enq_ready = ~full;
  assign io_deq_valid = ~empty;
  assign io_deq_bits_denied = _ram_ext_R0_data[0];
  assign io_deq_bits_data = _ram_ext_R0_data[8:1];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[9];
endmodule
