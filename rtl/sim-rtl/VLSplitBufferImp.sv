...
module VLSplitBufferImp(
  ...
  reg  [5:0]   uopq_uop_waitForRobIdx_value;
    ...
    {15'h0,
     {8'h0,
      {4'h0,
       ...
       | {16{uopq_alignedType == 3'h4}} | {16{&uopq_alignedType}}} << _vaddr_T[3:0];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_baseAddr = {_RANDOM[7'h5][31:8], _RANDOM[7'h6], _RANDOM[7'h7][7:0]};
        ...
        uopq_uop_preDecodeInfo_isRVC = _RANDOM[7'h12][31];
        uopq_uop_ftqPtr_flag = _RANDOM[7'h13][6];
        uopq_uop_ftqPtr_value = _RANDOM[7'h13][9:7];
        uopq_uop_ftqOffset = _RANDOM[7'h13][13:10];
        uopq_uop_fuOpType = _RANDOM[7'h15][19:11];
        uopq_uop_rfWen = _RANDOM[7'h15][20];
        uopq_uop_fpWen = _RANDOM[7'h15][21];
        uopq_uop_vpu_vstart = {_RANDOM[7'h17][31:29], _RANDOM[7'h18][4:0]};
        uopq_uop_vpu_vuopIdx = _RANDOM[7'h18][23:17];
        uopq_uop_vpu_veew = _RANDOM[7'h1D][5:4];
        uopq_uop_uopIdx = _RANDOM[7'h1D][25:19];
        uopq_uop_pdest = {_RANDOM[7'h20][31:25], _RANDOM[7'h21][0]};
        uopq_uop_robIdx_flag = _RANDOM[7'h21][13];
        uopq_uop_robIdx_value = _RANDOM[7'h21][19:14];
        uopq_uop_storeSetHit = _RANDOM[7'h36][5];
        uopq_uop_waitForRobIdx_flag = _RANDOM[7'h36][6];
        uopq_uop_waitForRobIdx_value = _RANDOM[7'h36][12:7];
        uopq_uop_loadWaitBit = _RANDOM[7'h36][13];
        uopq_uop_loadWaitStrict = _RANDOM[7'h36][14];
        uopq_uop_lqIdx_flag = _RANDOM[7'h36][20];
        uopq_uop_lqIdx_value = _RANDOM[7'h36][25:21];
        uopq_uop_sqIdx_flag = _RANDOM[7'h36][26];
        uopq_uop_sqIdx_value = _RANDOM[7'h36][31:27];
        uopq_preIsSplit = _RANDOM[7'h3B][11];
        uopq_mBIndex = _RANDOM[7'h3B][15:12];
        uopq_alignedType = _RANDOM[7'h3B][18:16];
        uopq_indexVlMaxInVd = _RANDOM[7'h3B][26:19];
        regOffset = _RANDOM[7'h3B][30:27];
        uopq_usAligned128 = _RANDOM[7'h3B][31];
        uopq_usMask = _RANDOM[7'h3C];
        allocated = _RANDOM[7'h3D][0];
        splitIdx = _RANDOM[7'h3D][5:1];
        strideOffsetReg =
          {_RANDOM[7'h3D][31:6],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
