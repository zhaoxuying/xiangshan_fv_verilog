...
module MultiWakeupQueue_2(
  ...
  input  [5:0]  io_enq_bits_uop_pdest,
  ...
  output        io_deq_valid,
  output [5:0]  io_deq_bits_pdestCopy_0,
  output [5:0]  io_deq_bits_pdestCopy_1,
  output [5:0]  io_deq_bits_pdestCopy_2,
  output [5:0]  io_deq_bits_pdestCopy_3,
  output [5:0]  io_deq_bits_pdestCopy_4,
  output [5:0]  io_deq_bits_pdestCopy_5,
  ...
  wire [5:0] _pipes_0_io_deq_bits_pdest;
  ...
  reg  [5:0] lastConnect_bits_pdestCopy_0;
  reg  [5:0] lastConnect_bits_pdestCopy_1;
  reg  [5:0] lastConnect_bits_pdestCopy_2;
  reg  [5:0] lastConnect_bits_pdestCopy_3;
  reg  [5:0] lastConnect_bits_pdestCopy_4;
  reg  [5:0] lastConnect_bits_pdestCopy_5;
  ...
  reg  [5:0] lastConnect_bits_pdest;
  ...
  always @(posedge clock) begin
    ...
    lastConnect_bits_pdestCopy_0 <= _pipes_0_io_deq_bits_pdest;
    lastConnect_bits_pdestCopy_1 <= _pipes_0_io_deq_bits_pdest;
    lastConnect_bits_pdestCopy_2 <= _pipes_0_io_deq_bits_pdest;
    lastConnect_bits_pdestCopy_3 <= _pipes_0_io_deq_bits_pdest;
    lastConnect_bits_pdestCopy_4 <= _pipes_0_io_deq_bits_pdest;
    lastConnect_bits_pdestCopy_5 <= _pipes_0_io_deq_bits_pdest;
    ...
    lastConnect_bits_loadDependencyCopy_0_0 <= _pipes_0_io_deq_bits_loadDependency_0;
    lastConnect_bits_loadDependencyCopy_0_1 <= _pipes_0_io_deq_bits_loadDependency_1;
    lastConnect_bits_loadDependencyCopy_0_2 <= _pipes_0_io_deq_bits_loadDependency_2;
    lastConnect_bits_loadDependencyCopy_1_0 <= _pipes_0_io_deq_bits_loadDependency_0;
    lastConnect_bits_loadDependencyCopy_1_1 <= _pipes_0_io_deq_bits_loadDependency_1;
    lastConnect_bits_loadDependencyCopy_1_2 <= _pipes_0_io_deq_bits_loadDependency_2;
    lastConnect_bits_loadDependencyCopy_2_0 <= _pipes_0_io_deq_bits_loadDependency_0;
    lastConnect_bits_loadDependencyCopy_2_1 <= _pipes_0_io_deq_bits_loadDependency_1;
    lastConnect_bits_loadDependencyCopy_2_2 <= _pipes_0_io_deq_bits_loadDependency_2;
    lastConnect_bits_loadDependencyCopy_3_0 <= _pipes_0_io_deq_bits_loadDependency_0;
    lastConnect_bits_loadDependencyCopy_3_1 <= _pipes_0_io_deq_bits_loadDependency_1;
    lastConnect_bits_loadDependencyCopy_3_2 <= _pipes_0_io_deq_bits_loadDependency_2;
    lastConnect_bits_loadDependencyCopy_4_0 <= _pipes_0_io_deq_bits_loadDependency_0;
    lastConnect_bits_loadDependencyCopy_4_1 <= _pipes_0_io_deq_bits_loadDependency_1;
    lastConnect_bits_loadDependencyCopy_4_2 <= _pipes_0_io_deq_bits_loadDependency_2;
    lastConnect_bits_loadDependencyCopy_5_0 <= _pipes_0_io_deq_bits_loadDependency_0;
    lastConnect_bits_loadDependencyCopy_5_1 <= _pipes_0_io_deq_bits_loadDependency_1;
    lastConnect_bits_loadDependencyCopy_5_2 <= _pipes_0_io_deq_bits_loadDependency_2;
    lastConnect_bits_pdest <= _pipes_0_io_deq_bits_pdest;
    lastConnect_bits_rfWen <= pipesOut_bits_rfWen;
    lastConnect_bits_loadDependency_0 <= _pipes_0_io_deq_bits_loadDependency_0;
    lastConnect_bits_loadDependency_1 <= _pipes_0_io_deq_bits_loadDependency_1;
    lastConnect_bits_loadDependency_2 <= _pipes_0_io_deq_bits_loadDependency_2;
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdestCopy_0 = _RANDOM[4'h7][30:25];
        lastConnect_bits_pdestCopy_1 = {_RANDOM[4'h7][31], _RANDOM[4'h8][4:0]};
        lastConnect_bits_pdestCopy_2 = _RANDOM[4'h8][10:5];
        lastConnect_bits_pdestCopy_3 = _RANDOM[4'h8][16:11];
        lastConnect_bits_pdestCopy_4 = _RANDOM[4'h8][22:17];
        lastConnect_bits_pdestCopy_5 = _RANDOM[4'h8][28:23];
        lastConnect_bits_rfWenCopy_0 = _RANDOM[4'h8][29];
        lastConnect_bits_rfWenCopy_1 = _RANDOM[4'h8][30];
        lastConnect_bits_rfWenCopy_2 = _RANDOM[4'h8][31];
        lastConnect_bits_rfWenCopy_3 = _RANDOM[4'h9][0];
        lastConnect_bits_rfWenCopy_4 = _RANDOM[4'h9][1];
        lastConnect_bits_rfWenCopy_5 = _RANDOM[4'h9][2];
        lastConnect_bits_loadDependencyCopy_0_0 = _RANDOM[4'h9][4:3];
        lastConnect_bits_loadDependencyCopy_0_1 = _RANDOM[4'h9][6:5];
        lastConnect_bits_loadDependencyCopy_0_2 = _RANDOM[4'h9][8:7];
        lastConnect_bits_loadDependencyCopy_1_0 = _RANDOM[4'h9][10:9];
        lastConnect_bits_loadDependencyCopy_1_1 = _RANDOM[4'h9][12:11];
        lastConnect_bits_loadDependencyCopy_1_2 = _RANDOM[4'h9][14:13];
        lastConnect_bits_loadDependencyCopy_2_0 = _RANDOM[4'h9][16:15];
        lastConnect_bits_loadDependencyCopy_2_1 = _RANDOM[4'h9][18:17];
        lastConnect_bits_loadDependencyCopy_2_2 = _RANDOM[4'h9][20:19];
        lastConnect_bits_loadDependencyCopy_3_0 = _RANDOM[4'h9][22:21];
        lastConnect_bits_loadDependencyCopy_3_1 = _RANDOM[4'h9][24:23];
        lastConnect_bits_loadDependencyCopy_3_2 = _RANDOM[4'h9][26:25];
        lastConnect_bits_loadDependencyCopy_4_0 = _RANDOM[4'h9][28:27];
        lastConnect_bits_loadDependencyCopy_4_1 = _RANDOM[4'h9][30:29];
        lastConnect_bits_loadDependencyCopy_4_2 = {_RANDOM[4'h9][31], _RANDOM[4'hA][0]};
        lastConnect_bits_loadDependencyCopy_5_0 = _RANDOM[4'hA][2:1];
        lastConnect_bits_loadDependencyCopy_5_1 = _RANDOM[4'hA][4:3];
        lastConnect_bits_loadDependencyCopy_5_2 = _RANDOM[4'hA][6:5];
        lastConnect_bits_pdest = _RANDOM[4'hA][12:7];
        lastConnect_bits_rfWen = _RANDOM[4'hA][13];
        lastConnect_bits_loadDependency_0 = _RANDOM[4'hB][3:2];
        lastConnect_bits_loadDependency_1 = _RANDOM[4'hB][5:4];
        lastConnect_bits_loadDependency_2 = _RANDOM[4'hB][7:6];
      `endif // RANDOMIZE_REG_INIT
    end // initial
