...
module ExeUnit_14(
  ...
  wire [5:0]   _VSetRvfWvf_io_out_bits_ctrl_robIdx_value;
  ...
  wire [5:0]   _Vipu_io_out_bits_ctrl_robIdx_value;
  ...
  wire [5:0]   _Vfcvt_io_out_bits_ctrl_robIdx_value;
  ...
  wire [5:0]   _Vfalu_io_out_bits_ctrl_robIdx_value;
  ...
  wire         Vfalu_clock_te_cgen = cg_bore_cgen;
  wire         Vfcvt_clock_te_cgen = cg_bore_1_cgen;
  wire         Vipu_clock_te_cgen = cg_bore_2_cgen;
  reg          fuVld_en_reg;
  reg          fuVldVec_1;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_1_robIdx_value = {_RANDOM[7'h17][31:29], _RANDOM[7'h18][2:0]};
        inPipe_1_1_pdest = _RANDOM[7'h18][15:8];
        inPipe_1_1_rfWen = _RANDOM[7'h18][16];
        inPipe_1_1_fpWen = _RANDOM[7'h18][17];
        inPipe_1_1_vecWen = _RANDOM[7'h18][18];
        inPipe_1_1_v0Wen = _RANDOM[7'h18][19];
        inPipe_1_1_fpu_wflags = _RANDOM[7'h18][23];
        inPipe_1_1_vpu_vma = _RANDOM[7'h19][0];
        inPipe_1_1_vpu_vta = _RANDOM[7'h19][1];
        inPipe_1_1_vpu_vsew = _RANDOM[7'h19][3:2];
        inPipe_1_1_vpu_vlmul = _RANDOM[7'h19][6:4];
        inPipe_1_1_vpu_vm = _RANDOM[7'h19][15];
        inPipe_1_1_vpu_vstart = _RANDOM[7'h19][23:16];
        inPipe_1_1_vpu_fpu_isFoldTo1_2 = _RANDOM[7'h19][31];
        inPipe_1_1_vpu_fpu_isFoldTo1_4 = _RANDOM[7'h1A][0];
        inPipe_1_1_vpu_fpu_isFoldTo1_8 = _RANDOM[7'h1A][1];
        inPipe_1_1_vpu_vuopIdx = _RANDOM[7'h1A][10:4];
        inPipe_1_1_vpu_lastUop = _RANDOM[7'h1A][11];
        inPipe_1_1_vpu_isNarrow = _RANDOM[7'h1E][27];
        inPipe_1_1_vpu_isDstMask = _RANDOM[7'h1E][28];
        inPipe_1_2_src_2 =
          {_RANDOM[7'h3D][31:3],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
        ...
        inPipe_1_2_src_4 =
          {_RANDOM[7'h45][31:3],
           ...
           _RANDOM[7'h48],
           _RANDOM[7'h49][2:0]};
        inPipe_1_2_robIdx_flag = _RANDOM[7'h4B][3];
        inPipe_1_2_robIdx_value = _RANDOM[7'h4B][9:4];
        inPipe_1_2_pdest = _RANDOM[7'h4B][22:15];
        inPipe_1_2_rfWen = _RANDOM[7'h4B][23];
        inPipe_1_2_vecWen = _RANDOM[7'h4B][25];
        inPipe_1_2_v0Wen = _RANDOM[7'h4B][26];
        inPipe_1_2_fpu_wflags = _RANDOM[7'h4B][30];
        inPipe_1_2_vpu_vma = _RANDOM[7'h4C][7];
        inPipe_1_2_vpu_vta = _RANDOM[7'h4C][8];
        inPipe_1_2_vpu_vm = _RANDOM[7'h4C][22];
        inPipe_1_2_vpu_vstart = _RANDOM[7'h4C][30:23];
        inPipe_1_2_vpu_vuopIdx = _RANDOM[7'h4D][17:11];
        inPipe_1_2_vpu_isDstMask = _RANDOM[7'h52][3];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
  ...
  assign io_out_bits_robIdx_value =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_VSetRvfWvf_io_out_valid ? _VSetRvfWvf_io_out_bits_ctrl_robIdx_value : 6'h0);
