  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_fuType_0 = _RANDOM[5'h0][8];
        entryReg_status_fuType_1 = _RANDOM[5'h0][9];
        entryReg_status_fuType_2 = _RANDOM[5'h0][10];
        entryReg_status_fuType_3 = _RANDOM[5'h0][11];
        entryReg_status_fuType_6 = _RANDOM[5'h0][14];
        entryReg_status_fuType_28 = _RANDOM[5'h1][4];
        entryReg_status_fuType_29 = _RANDOM[5'h1][5];
        entryReg_status_srcStatus_0_psrc = _RANDOM[5'h1][16:11];
        entryReg_status_srcStatus_0_srcType = _RANDOM[5'h1][20:17];
        entryReg_status_srcStatus_0_srcState = _RANDOM[5'h1][21];
        entryReg_status_srcStatus_0_dataSources_value = _RANDOM[5'h1][25:22];
        entryReg_status_srcStatus_0_srcLoadDependency_0 = _RANDOM[5'h1][27:26];
        entryReg_status_srcStatus_0_srcLoadDependency_1 = _RANDOM[5'h1][29:28];
        entryReg_status_srcStatus_0_srcLoadDependency_2 = _RANDOM[5'h1][31:30];
        entryReg_status_srcStatus_0_exuSources_value = _RANDOM[5'h2][2:0];
        entryReg_status_srcStatus_0_useRegCache = _RANDOM[5'h2][3];
        entryReg_status_srcStatus_0_regCacheIdx = _RANDOM[5'h2][8:4];
        entryReg_status_srcStatus_1_psrc = _RANDOM[5'h2][14:9];
        entryReg_status_srcStatus_1_srcType = _RANDOM[5'h2][18:15];
        entryReg_status_srcStatus_1_srcState = _RANDOM[5'h2][19];
        entryReg_status_srcStatus_1_dataSources_value = _RANDOM[5'h2][23:20];
        entryReg_status_srcStatus_1_srcLoadDependency_0 = _RANDOM[5'h2][25:24];
        entryReg_status_srcStatus_1_srcLoadDependency_1 = _RANDOM[5'h2][27:26];
        entryReg_status_srcStatus_1_srcLoadDependency_2 = _RANDOM[5'h2][29:28];
        entryReg_status_srcStatus_1_exuSources_value =
          {_RANDOM[5'h2][31:30], _RANDOM[5'h3][0]};
        entryReg_status_srcStatus_1_useRegCache = _RANDOM[5'h3][1];
        entryReg_status_srcStatus_1_regCacheIdx = _RANDOM[5'h3][6:2];
        entryReg_status_issued = _RANDOM[5'h3][8];
        entryReg_status_issueTimer = _RANDOM[5'h3][11:10];
        entryReg_status_deqPortIdx = _RANDOM[5'h3][12];
        entryReg_imm = {_RANDOM[5'h3][31:13], _RANDOM[5'h4][12:0]};
        entryReg_payload_preDecodeInfo_isRVC = _RANDOM[5'h8][8];
        entryReg_payload_pred_taken = _RANDOM[5'h8][13];
        entryReg_payload_ftqPtr_flag = _RANDOM[5'h8][15];
        entryReg_payload_ftqPtr_value = _RANDOM[5'h8][18:16];
        entryReg_payload_ftqOffset = _RANDOM[5'h8][22:19];
        entryReg_payload_fuOpType = _RANDOM[5'hA][28:20];
        entryReg_payload_rfWen = _RANDOM[5'hA][29];
        entryReg_payload_fpWen = _RANDOM[5'hA][30];
        entryReg_payload_vecWen = _RANDOM[5'hA][31];
        entryReg_payload_v0Wen = _RANDOM[5'hB][0];
        entryReg_payload_vlWen = _RANDOM[5'hB][1];
        entryReg_payload_selImm = _RANDOM[5'hB][10:7];
        entryReg_payload_fpu_typeTagOut = _RANDOM[5'hC][12:11];
        entryReg_payload_fpu_wflags = _RANDOM[5'hC][13];
        entryReg_payload_fpu_typ = _RANDOM[5'hC][15:14];
        entryReg_payload_fpu_rm = _RANDOM[5'hC][20:18];
        entryReg_payload_pdest = _RANDOM[5'h16][9:2];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validReg_last_REG = 1'h0;
    end // initial
