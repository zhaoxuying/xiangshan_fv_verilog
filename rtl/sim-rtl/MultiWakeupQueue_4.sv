...
module MultiWakeupQueue_4(
  ...
  wire [5:0]  _pipes_3_io_deq_bits_robIdx_value;
  ...
  wire [5:0]  _pipes_0_io_deq_bits_robIdx_value;
  ...
  wire [6:0]  _pipesValidVec_redirectFlush_flushItself_T_10 =
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lastConnect_bits_pdest = {_RANDOM[4'h9][31:25], _RANDOM[4'hA][0]};
        lastConnect_bits_fpWen = _RANDOM[4'hA][2];
        lastConnect_bits_vecWen = _RANDOM[4'hA][3];
        lastConnect_bits_v0Wen = _RANDOM[4'hA][4];
      `endif // RANDOMIZE_REG_INIT
    end // initial
