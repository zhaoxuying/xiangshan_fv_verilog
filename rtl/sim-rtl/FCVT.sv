  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fireReg_last_r = _RANDOM[6'h32][12];
        outIs16bits_REG = _RANDOM[6'h32][13];
        outIs16bits = _RANDOM[6'h32][14];
        outIs32bits_REG = _RANDOM[6'h32][15];
        outIs32bits = _RANDOM[6'h32][16];
        result_r = {_RANDOM[6'h32][31:27], _RANDOM[6'h33], _RANDOM[6'h34][26:0]};
        result_r_1 = {_RANDOM[6'h34][31:27], _RANDOM[6'h35], _RANDOM[6'h36][26:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validVecThisFu_1 = 1'h0;
        validVecThisFu_2 = 1'h0;
