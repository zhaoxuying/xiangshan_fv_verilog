...
module PTW(
  ...
  wire [52:0]      _GEN_1 =
    (&af_level)
      ...
      : af_level == 2'h2
          ? (_GEN_0
               ? {l3Hit ? ppn : io_mem_resp_bits[53:10], vpn[26:18]}
               : {satp_ppn, vpn[26:18]})
          : {l2Hit ? ppn : io_mem_resp_bits[53:10], vpn[17:9]};
  ...
  wire [55:0]      gpaddr =
    stage1Hit | onlyS2xlate
      ? {full_gvpn, 12'h0}
      : s_last_hptw_req ? {_GEN_1, 3'h0} : {_GEN_2[level], 12'h0};
  ...
  wire [3:0][37:0] _GEN_3 =
    {{{hptw_resp_entry_ppn[37:27], gpaddr[38:12]}},
     ...
     {hptw_resp_entry_n
        ...
        : hptw_resp_entry_ppn}};
  wire             resp_pf = pte_valid & pageFault;
  wire             resp_af = (accessFault | ppn_af) & ~(resp_pf | guestFault);
  wire [1:0]       resp_level =
    accessFault & resp_af ? af_level : guestFault ? gpf_level : level;
  wire             resp_pte_n = pte_valid & io_mem_resp_bits[63];
  wire [1:0]       resp_pte_pbmt = pte_valid ? io_mem_resp_bits[62:61] : 2'h0;
  wire [35:0]      resp_pte_ppn = pte_valid ? io_mem_resp_bits[45:10] : ppn[35:0];
  wire             resp_pte_perm_d = pte_valid & io_mem_resp_bits[7];
  wire             resp_pte_perm_a = pte_valid & io_mem_resp_bits[6];
  wire             resp_pte_perm_g = pte_valid & io_mem_resp_bits[5];
  wire             resp_pte_perm_u = pte_valid & io_mem_resp_bits[4];
  wire             resp_pte_perm_x = pte_valid & io_mem_resp_bits[3];
  wire             resp_pte_perm_w = pte_valid & io_mem_resp_bits[2];
  wire             resp_pte_perm_r = pte_valid & io_mem_resp_bits[1];
  wire             ptw_resp_1_v = pte_valid & io_mem_resp_bits[0];
  wire [40:0]      ptw_resp_1_ppn =
    {pte_valid ? io_mem_resp_bits[53:46] : ppn[43:36], resp_pte_ppn[35:3]};
  ...
  wire             _GEN_10 = io_hptw_resp_valid & ~w_last_hptw_resp;
  wire             _GEN_11 = _GEN_10 & stage1Hit;
  wire             _GEN_12 = _GEN_10 & ~stage1Hit;
  ...
  wire             _GEN_15 = mem_addr_update & _GEN_14;
  wire             vs_finish = _GEN_15 & s2xlate;
  wire             _GEN_16 = s2xlate & need_last_s2xlate;
  wire             finish =
    mem_addr_update & ~_GEN_14 & (io_llptw_valid_0 | ~_GEN_16 & io_resp_valid_0);
  reg              perfEvents_5_2;
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_5) begin
      ppn <= _GEN_7 ? io_req_bits_ppn : satp_ppn;
    ...
    hptw_resp_stage2 <= _GEN_11 | ~_GEN_4 & hptw_resp_stage2;
    if (_GEN_12 | _GEN_11 | _GEN_9) begin
    ...
    if (update_full_gvpn_mem_resp)
      ...
      full_gvpn_reg <=
        _GEN_18[full_gvpn_reg_idx] == 2'h0
          ? (_GEN_21[full_gvpn_reg_idx]
               ? {_GEN_19[full_gvpn_reg_idx][40:1],
                  _GEN_17[full_gvpn_reg_idx][0],
  ...
  wire             sent_to_pmp =
    ~idle & (~s_pmp_check | mem_addr_update) & ~finish & ~vs_finish
    & ~first_gvpn_check_fail & ~(find_pte & pte_valid);
  wire             _GEN_22 =
    sent_to_pmp ? io_pmp_resp_ld | io_pmp_resp_mmio : accessFault;
  wire             _GEN_23 = ~_GEN_4 & need_last_s2xlate;
  wire             _GEN_24 = io_resp_ready & io_resp_valid_0;
  wire [1:0]       _GEN_25 =
    io_req_bits_l2Hit ? 2'h1 : _GEN_0 ? {1'h1, ~io_req_bits_l3Hit} : 2'h2;
  wire [14:0]      gvpn_wire = _GEN_7 ? io_req_bits_ppn[43:29] : satp_ppn[43:29];
  wire             _GEN_26 = ~_GEN_5 & (_GEN_24 & stage1Hit | ~_GEN_4 & idle);
  ...
  wire             _GEN_27 = (&io_req_bits_req_info_s2xlate) & check_gpa_high_fail_1;
  wire             _GEN_28 = io_hptw_req_ready & io_hptw_req_valid_0;
  wire             _GEN_29 = _GEN_28 & ~s_hptw_req;
  wire             _GEN_30 =
  ...
  wire             _GEN_31 =
    ...
    & (_GEN_5
         ? ~_check_gpa_high_fail_T & (&io_req_bits_req_info_s2xlate)
           & (~check_gpa_high_fail_1 | _GEN_23)
         : _GEN_23);
  wire             _GEN_32 = _GEN_28 & ~s_last_hptw_req;
  wire             _GEN_33 = sent_to_pmp & ~mem_addr_update;
  wire             _GEN_34 = accessFault & ~idle;
  wire             _GEN_35 = guestFault & ~idle;
  wire             _GEN_36 = _GEN_35 | _GEN_34;
  wire             _GEN_37 = io_mem_resp_valid & ~w_mem_resp;
  wire             _GEN_38 = ~_GEN_37 & (_GEN_36 | s_llptw_req);
  wire             _GEN_39 =
    _GEN_37 | _GEN_35 | _GEN_34 | _GEN_12 | _GEN_9 & _GEN_30
    | (_GEN_5
         ? (_check_gpa_high_fail_T
              ? check_gpa_high_fail | mem_addr_update
              : _GEN_27 | mem_addr_update)
         : mem_addr_update);
  wire             _GEN_40 = io_llptw_ready & io_llptw_valid_0;
  wire             _GEN_41 = ~mem_addr_update | _GEN_14;
  wire             _GEN_42 = guestFault | accessFault | pageFault | ppn_af;
  wire             _GEN_43 = io_resp_valid_0 & _GEN_24;
  wire             _GEN_44 = ~_GEN_16 & _GEN_43;
  wire             _GEN_45 = _GEN_14 | io_llptw_valid_0 | _GEN_16;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_37) begin
        ...
        if (satp_mode == 4'h8 & ~pte_valid & ~l2Hit)
        ...
        gpf_level <=
          _GEN_0
            ? (io_req_bits_l2Hit ? 2'h2 : {2{io_req_bits_l3Hit}})
            : {io_req_bits_l2Hit, 1'h0};
      end
      s_pmp_check <=
        flush | _GEN_35 | _GEN_34 | _GEN_33 | ~(_GEN_9 & ~_GEN_30)
        & (~_GEN_5 | _check_gpa_high_fail_T | (&io_req_bits_req_info_s2xlate))
        & s_pmp_check;
      s_mem_req <=
        flush | (~_GEN_15 | s2xlate) & (perfEvents_4_2 | _GEN_36 | ~_GEN_33 & s_mem_req);
      s_llptw_req <=
        flush
        | (mem_addr_update
             ? _GEN_14 | (io_llptw_valid_0 ? _GEN_40 | _GEN_38 : _GEN_44 | _GEN_38)
             : _GEN_38);
      w_mem_resp <= flush | _GEN_37 | ~perfEvents_4_2 & (_GEN_36 | w_mem_resp);
      s_hptw_req <=
        flush | ~(mem_addr_update & _GEN_14 & s2xlate)
        & (_GEN_35 | _GEN_34 | _GEN_29
           | (~_GEN_5 | _check_gpa_high_fail_T | ~(&io_req_bits_req_info_s2xlate)
              | check_gpa_high_fail_1) & s_hptw_req);
      w_hptw_resp <= flush | _GEN_35 | _GEN_34 | _GEN_9 | ~_GEN_29 & w_hptw_resp;
      s_last_hptw_req <=
        flush | (~mem_addr_update | _GEN_14 | io_llptw_valid_0 | ~(_GEN_16 & ~_GEN_42))
        & (_GEN_35 | _GEN_34 | _GEN_32
           | (~(_GEN_5 & _check_gpa_high_fail_T) | check_gpa_high_fail) & ~_GEN_4
           & s_last_hptw_req);
      w_last_hptw_resp <=
        flush | _GEN_35 | _GEN_34 | _GEN_13 | ~_GEN_32 & w_last_hptw_resp;
      mem_addr_update <=
        ~flush
        & (mem_addr_update
             ? ~_GEN_14
               & (io_llptw_valid_0
                    ? ~_GEN_40 & _GEN_39
                    : _GEN_16 ? _GEN_42 & _GEN_39 : ~_GEN_43 & _GEN_39)
             : _GEN_39);
      idle <=
        flush
        | (_GEN_41 ? _GEN_26 : io_llptw_valid_0 ? _GEN_40 | _GEN_26 : _GEN_44 | _GEN_26);
      if (_GEN_12)
        hptw_pageFault <= io_hptw_resp_bits_h_resp_gpf;
      else if (_GEN_9)
        hptw_pageFault <= _hptw_resp_gpf_T;
      else
        hptw_pageFault <= ~_GEN_8 & hptw_pageFault;
      if (_GEN_12 | _GEN_9)
        hptw_accessFault <= io_hptw_resp_bits_h_resp_gaf;
      else
        hptw_accessFault <= ~_GEN_8 & hptw_accessFault;
      if (_GEN_41)
        need_last_s2xlate <= ~_GEN_36 & _GEN_31;
      else if (io_llptw_valid_0)
        need_last_s2xlate <= ~(_GEN_40 | _GEN_36) & _GEN_31;
      else
        need_last_s2xlate <= ~(_GEN_16 | _GEN_36) & _GEN_31;
      first_gvpn_check_fail <=
        ~flush & (~mem_addr_update | _GEN_45 | ~_GEN_43)
        & (_GEN_5
             ? (_check_gpa_high_fail_T
                  ? check_gpa_high_fail | first_gvpn_check_fail
                  : _GEN_27 | first_gvpn_check_fail)
             : first_gvpn_check_fail);
      pte_valid <= _GEN_37 | ~_GEN_5 & pte_valid;
      accessFault <=
        ~flush
        & (~mem_addr_update | _GEN_45 | ~io_resp_valid_0
             ? ~_GEN_5 & _GEN_22
             : ~(_GEN_24 | _GEN_5) & _GEN_22);
      update_full_gvpn_mem_resp <=
        ~update_full_gvpn_mem_resp & (_GEN_37 | update_full_gvpn_mem_resp);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        idle = _RANDOM[6'h3][9];
        hptw_pageFault = _RANDOM[6'h3][10];
        hptw_accessFault = _RANDOM[6'h3][11];
        need_last_s2xlate = _RANDOM[6'h3][12];
        stage1Hit = _RANDOM[6'h3][13];
        stage1_entry_0_tag = {_RANDOM[6'h3][31:14], _RANDOM[6'h4][16:0]};
        stage1_entry_0_asid = {_RANDOM[6'h4][31:17], _RANDOM[6'h5][0]};
        stage1_entry_0_vmid = _RANDOM[6'h5][14:1];
        stage1_entry_0_n = _RANDOM[6'h5][15];
        stage1_entry_0_pbmt = _RANDOM[6'h5][17:16];
        stage1_entry_0_perm_d = _RANDOM[6'h5][18];
        stage1_entry_0_perm_a = _RANDOM[6'h5][19];
        stage1_entry_0_perm_g = _RANDOM[6'h5][20];
        stage1_entry_0_perm_u = _RANDOM[6'h5][21];
        stage1_entry_0_perm_x = _RANDOM[6'h5][22];
        stage1_entry_0_perm_w = _RANDOM[6'h5][23];
        stage1_entry_0_perm_r = _RANDOM[6'h5][24];
        stage1_entry_0_level = _RANDOM[6'h5][26:25];
        stage1_entry_0_v = _RANDOM[6'h5][28];
        stage1_entry_0_ppn = {_RANDOM[6'h5][31:29], _RANDOM[6'h6], _RANDOM[6'h7][5:0]};
        stage1_entry_0_ppn_low = _RANDOM[6'h7][8:6];
        stage1_entry_0_pf = _RANDOM[6'h7][10];
        stage1_entry_1_tag = {_RANDOM[6'h7][31:12], _RANDOM[6'h8][14:0]};
        stage1_entry_1_asid = _RANDOM[6'h8][30:15];
        stage1_entry_1_vmid = {_RANDOM[6'h8][31], _RANDOM[6'h9][12:0]};
        stage1_entry_1_n = _RANDOM[6'h9][13];
        stage1_entry_1_pbmt = _RANDOM[6'h9][15:14];
        stage1_entry_1_perm_d = _RANDOM[6'h9][16];
        stage1_entry_1_perm_a = _RANDOM[6'h9][17];
        stage1_entry_1_perm_g = _RANDOM[6'h9][18];
        stage1_entry_1_perm_u = _RANDOM[6'h9][19];
        stage1_entry_1_perm_x = _RANDOM[6'h9][20];
        stage1_entry_1_perm_w = _RANDOM[6'h9][21];
        stage1_entry_1_perm_r = _RANDOM[6'h9][22];
        stage1_entry_1_level = _RANDOM[6'h9][24:23];
        stage1_entry_1_v = _RANDOM[6'h9][26];
        stage1_entry_1_ppn = {_RANDOM[6'h9][31:27], _RANDOM[6'hA], _RANDOM[6'hB][3:0]};
        stage1_entry_1_ppn_low = _RANDOM[6'hB][6:4];
        stage1_entry_1_pf = _RANDOM[6'hB][8];
        stage1_entry_2_tag = {_RANDOM[6'hB][31:10], _RANDOM[6'hC][12:0]};
        stage1_entry_2_asid = _RANDOM[6'hC][28:13];
        stage1_entry_2_vmid = {_RANDOM[6'hC][31:29], _RANDOM[6'hD][10:0]};
        stage1_entry_2_n = _RANDOM[6'hD][11];
        stage1_entry_2_pbmt = _RANDOM[6'hD][13:12];
        stage1_entry_2_perm_d = _RANDOM[6'hD][14];
        stage1_entry_2_perm_a = _RANDOM[6'hD][15];
        stage1_entry_2_perm_g = _RANDOM[6'hD][16];
        stage1_entry_2_perm_u = _RANDOM[6'hD][17];
        stage1_entry_2_perm_x = _RANDOM[6'hD][18];
        stage1_entry_2_perm_w = _RANDOM[6'hD][19];
        stage1_entry_2_perm_r = _RANDOM[6'hD][20];
        stage1_entry_2_level = _RANDOM[6'hD][22:21];
        stage1_entry_2_v = _RANDOM[6'hD][24];
        stage1_entry_2_ppn = {_RANDOM[6'hD][31:25], _RANDOM[6'hE], _RANDOM[6'hF][1:0]};
        stage1_entry_2_ppn_low = _RANDOM[6'hF][4:2];
        stage1_entry_2_pf = _RANDOM[6'hF][6];
        stage1_entry_3_tag = {_RANDOM[6'hF][31:8], _RANDOM[6'h10][10:0]};
        stage1_entry_3_asid = _RANDOM[6'h10][26:11];
        stage1_entry_3_vmid = {_RANDOM[6'h10][31:27], _RANDOM[6'h11][8:0]};
        stage1_entry_3_n = _RANDOM[6'h11][9];
        stage1_entry_3_pbmt = _RANDOM[6'h11][11:10];
        stage1_entry_3_perm_d = _RANDOM[6'h11][12];
        stage1_entry_3_perm_a = _RANDOM[6'h11][13];
        stage1_entry_3_perm_g = _RANDOM[6'h11][14];
        stage1_entry_3_perm_u = _RANDOM[6'h11][15];
        stage1_entry_3_perm_x = _RANDOM[6'h11][16];
        stage1_entry_3_perm_w = _RANDOM[6'h11][17];
        stage1_entry_3_perm_r = _RANDOM[6'h11][18];
        stage1_entry_3_level = _RANDOM[6'h11][20:19];
        stage1_entry_3_v = _RANDOM[6'h11][22];
        stage1_entry_3_ppn = {_RANDOM[6'h11][31:23], _RANDOM[6'h12]};
        stage1_entry_3_ppn_low = _RANDOM[6'h13][2:0];
        stage1_entry_3_pf = _RANDOM[6'h13][4];
        stage1_entry_4_tag = {_RANDOM[6'h13][31:6], _RANDOM[6'h14][8:0]};
        stage1_entry_4_asid = _RANDOM[6'h14][24:9];
        stage1_entry_4_vmid = {_RANDOM[6'h14][31:25], _RANDOM[6'h15][6:0]};
        stage1_entry_4_n = _RANDOM[6'h15][7];
        stage1_entry_4_pbmt = _RANDOM[6'h15][9:8];
        stage1_entry_4_perm_d = _RANDOM[6'h15][10];
        stage1_entry_4_perm_a = _RANDOM[6'h15][11];
        stage1_entry_4_perm_g = _RANDOM[6'h15][12];
        stage1_entry_4_perm_u = _RANDOM[6'h15][13];
        stage1_entry_4_perm_x = _RANDOM[6'h15][14];
        stage1_entry_4_perm_w = _RANDOM[6'h15][15];
        stage1_entry_4_perm_r = _RANDOM[6'h15][16];
        stage1_entry_4_level = _RANDOM[6'h15][18:17];
        stage1_entry_4_v = _RANDOM[6'h15][20];
        stage1_entry_4_ppn = {_RANDOM[6'h15][31:21], _RANDOM[6'h16][29:0]};
        stage1_entry_4_ppn_low = {_RANDOM[6'h16][31:30], _RANDOM[6'h17][0]};
        stage1_entry_4_pf = _RANDOM[6'h17][2];
        stage1_entry_5_tag = {_RANDOM[6'h17][31:4], _RANDOM[6'h18][6:0]};
        stage1_entry_5_asid = _RANDOM[6'h18][22:7];
        stage1_entry_5_vmid = {_RANDOM[6'h18][31:23], _RANDOM[6'h19][4:0]};
        stage1_entry_5_n = _RANDOM[6'h19][5];
        stage1_entry_5_pbmt = _RANDOM[6'h19][7:6];
        stage1_entry_5_perm_d = _RANDOM[6'h19][8];
        stage1_entry_5_perm_a = _RANDOM[6'h19][9];
        stage1_entry_5_perm_g = _RANDOM[6'h19][10];
        stage1_entry_5_perm_u = _RANDOM[6'h19][11];
        stage1_entry_5_perm_x = _RANDOM[6'h19][12];
        stage1_entry_5_perm_w = _RANDOM[6'h19][13];
        stage1_entry_5_perm_r = _RANDOM[6'h19][14];
        stage1_entry_5_level = _RANDOM[6'h19][16:15];
        stage1_entry_5_v = _RANDOM[6'h19][18];
        stage1_entry_5_ppn = {_RANDOM[6'h19][31:19], _RANDOM[6'h1A][27:0]};
        stage1_entry_5_ppn_low = _RANDOM[6'h1A][30:28];
        stage1_entry_5_pf = _RANDOM[6'h1B][0];
        stage1_entry_6_tag = {_RANDOM[6'h1B][31:2], _RANDOM[6'h1C][4:0]};
        stage1_entry_6_asid = _RANDOM[6'h1C][20:5];
        stage1_entry_6_vmid = {_RANDOM[6'h1C][31:21], _RANDOM[6'h1D][2:0]};
        stage1_entry_6_n = _RANDOM[6'h1D][3];
        stage1_entry_6_pbmt = _RANDOM[6'h1D][5:4];
        stage1_entry_6_perm_d = _RANDOM[6'h1D][6];
        stage1_entry_6_perm_a = _RANDOM[6'h1D][7];
        stage1_entry_6_perm_g = _RANDOM[6'h1D][8];
        stage1_entry_6_perm_u = _RANDOM[6'h1D][9];
        stage1_entry_6_perm_x = _RANDOM[6'h1D][10];
        stage1_entry_6_perm_w = _RANDOM[6'h1D][11];
        stage1_entry_6_perm_r = _RANDOM[6'h1D][12];
        stage1_entry_6_level = _RANDOM[6'h1D][14:13];
        stage1_entry_6_v = _RANDOM[6'h1D][16];
        stage1_entry_6_ppn = {_RANDOM[6'h1D][31:17], _RANDOM[6'h1E][25:0]};
        stage1_entry_6_ppn_low = _RANDOM[6'h1E][28:26];
        stage1_entry_6_pf = _RANDOM[6'h1E][30];
        stage1_entry_7_tag = {_RANDOM[6'h1F], _RANDOM[6'h20][2:0]};
        stage1_entry_7_asid = _RANDOM[6'h20][18:3];
        stage1_entry_7_vmid = {_RANDOM[6'h20][31:19], _RANDOM[6'h21][0]};
        stage1_entry_7_n = _RANDOM[6'h21][1];
        stage1_entry_7_pbmt = _RANDOM[6'h21][3:2];
        stage1_entry_7_perm_d = _RANDOM[6'h21][4];
        stage1_entry_7_perm_a = _RANDOM[6'h21][5];
        stage1_entry_7_perm_g = _RANDOM[6'h21][6];
        stage1_entry_7_perm_u = _RANDOM[6'h21][7];
        stage1_entry_7_perm_x = _RANDOM[6'h21][8];
        stage1_entry_7_perm_w = _RANDOM[6'h21][9];
        stage1_entry_7_perm_r = _RANDOM[6'h21][10];
        stage1_entry_7_level = _RANDOM[6'h21][12:11];
        stage1_entry_7_v = _RANDOM[6'h21][14];
        stage1_entry_7_ppn = {_RANDOM[6'h21][31:15], _RANDOM[6'h22][23:0]};
        stage1_entry_7_ppn_low = _RANDOM[6'h22][26:24];
        stage1_entry_7_pf = _RANDOM[6'h22][28];
        stage1_pteidx_0 = _RANDOM[6'h22][30];
        stage1_pteidx_1 = _RANDOM[6'h22][31];
        stage1_pteidx_2 = _RANDOM[6'h23][0];
        stage1_pteidx_3 = _RANDOM[6'h23][1];
        stage1_pteidx_4 = _RANDOM[6'h23][2];
        stage1_pteidx_5 = _RANDOM[6'h23][3];
        stage1_pteidx_6 = _RANDOM[6'h23][4];
        stage1_pteidx_7 = _RANDOM[6'h23][5];
        stage1_not_super = _RANDOM[6'h23][6];
        hptw_resp_stage2 = _RANDOM[6'h23][8];
        first_gvpn_check_fail = _RANDOM[6'h23][9];
        pte_valid = _RANDOM[6'h23][10];
        source = _RANDOM[6'h23][12:11];
        accessFault = _RANDOM[6'h23][13];
        hptw_resp_entry_tag = {_RANDOM[6'h23][31:14], _RANDOM[6'h24][19:0]};
        hptw_resp_entry_vmid = _RANDOM[6'h25][17:4];
        hptw_resp_entry_n = _RANDOM[6'h25][18];
        hptw_resp_entry_pbmt = _RANDOM[6'h25][20:19];
        hptw_resp_entry_ppn = {_RANDOM[6'h25][31:21], _RANDOM[6'h26][26:0]};
        hptw_resp_entry_perm_d = _RANDOM[6'h26][27];
        hptw_resp_entry_perm_a = _RANDOM[6'h26][28];
        hptw_resp_entry_perm_g = _RANDOM[6'h26][29];
        hptw_resp_entry_perm_u = _RANDOM[6'h26][30];
        hptw_resp_entry_perm_x = _RANDOM[6'h26][31];
        hptw_resp_entry_perm_w = _RANDOM[6'h27][0];
        hptw_resp_entry_perm_r = _RANDOM[6'h27][1];
        hptw_resp_entry_level = _RANDOM[6'h27][3:2];
        hptw_resp_gpf = _RANDOM[6'h27][6];
        hptw_resp_gaf = _RANDOM[6'h27][7];
        update_full_gvpn_mem_resp = _RANDOM[6'h27][8];
        full_gvpn_reg = {_RANDOM[6'h27][31:9], _RANDOM[6'h28][20:0]};
        perfEvents_5_2 = _RANDOM[6'h28][22];
        io_perf_0_value_REG = _RANDOM[6'h28][23];
        io_perf_0_value_REG_1 = _RANDOM[6'h28][24];
        io_perf_1_value_REG = _RANDOM[6'h28][25];
        io_perf_1_value_REG_1 = _RANDOM[6'h28][26];
        io_perf_2_value_REG = _RANDOM[6'h28][27];
        io_perf_2_value_REG_1 = _RANDOM[6'h28][28];
        io_perf_3_value_REG = _RANDOM[6'h28][29];
        io_perf_3_value_REG_1 = _RANDOM[6'h28][30];
        io_perf_4_value_REG = _RANDOM[6'h28][31];
        io_perf_4_value_REG_1 = _RANDOM[6'h29][0];
        io_perf_5_value_REG = _RANDOM[6'h29][1];
        io_perf_5_value_REG_1 = _RANDOM[6'h29][2];
        io_perf_6_value_REG = _RANDOM[6'h29][3];
        io_perf_6_value_REG_1 = _RANDOM[6'h29][4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        level = 2'h3;
        af_level = 2'h3;
  ...
  assign io_resp_bits_resp_entry_0_n =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_n : resp_pte_n;
  assign io_resp_bits_resp_entry_0_pbmt =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_pbmt : resp_pte_pbmt;
  assign io_resp_bits_resp_entry_0_perm_d =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_perm_d : resp_pte_perm_d;
  assign io_resp_bits_resp_entry_0_perm_a =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_perm_a : resp_pte_perm_a;
  assign io_resp_bits_resp_entry_0_perm_g =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_perm_g : resp_pte_perm_g;
  assign io_resp_bits_resp_entry_0_perm_u =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_perm_u : resp_pte_perm_u;
  assign io_resp_bits_resp_entry_0_perm_x =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_perm_x : resp_pte_perm_x;
  assign io_resp_bits_resp_entry_0_perm_w =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_perm_w : resp_pte_perm_w;
  assign io_resp_bits_resp_entry_0_perm_r =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_perm_r : resp_pte_perm_r;
  assign io_resp_bits_resp_entry_0_level =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_level : resp_level;
  ...
  assign io_resp_bits_resp_entry_0_ppn_low =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_ppn_low : resp_pte_ppn[2:0];
  assign io_resp_bits_resp_entry_0_af = ~_io_resp_bits_resp_T_4 & resp_af;
  assign io_resp_bits_resp_entry_0_pf =
    _io_resp_bits_resp_T_4 ? stage1_entry_0_pf : resp_pf;
  ...
  assign io_resp_bits_resp_entry_1_n =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_n : resp_pte_n;
  assign io_resp_bits_resp_entry_1_pbmt =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_pbmt : resp_pte_pbmt;
  assign io_resp_bits_resp_entry_1_perm_d =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_perm_d : resp_pte_perm_d;
  assign io_resp_bits_resp_entry_1_perm_a =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_perm_a : resp_pte_perm_a;
  assign io_resp_bits_resp_entry_1_perm_g =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_perm_g : resp_pte_perm_g;
  assign io_resp_bits_resp_entry_1_perm_u =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_perm_u : resp_pte_perm_u;
  assign io_resp_bits_resp_entry_1_perm_x =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_perm_x : resp_pte_perm_x;
  assign io_resp_bits_resp_entry_1_perm_w =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_perm_w : resp_pte_perm_w;
  assign io_resp_bits_resp_entry_1_perm_r =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_perm_r : resp_pte_perm_r;
  assign io_resp_bits_resp_entry_1_level =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_level : resp_level;
  ...
  assign io_resp_bits_resp_entry_1_ppn_low =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_ppn_low : resp_pte_ppn[2:0];
  assign io_resp_bits_resp_entry_1_af = ~_io_resp_bits_resp_T_4 & resp_af;
  assign io_resp_bits_resp_entry_1_pf =
    _io_resp_bits_resp_T_4 ? stage1_entry_1_pf : resp_pf;
  ...
  assign io_resp_bits_resp_entry_2_n =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_n : resp_pte_n;
  assign io_resp_bits_resp_entry_2_pbmt =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_pbmt : resp_pte_pbmt;
  assign io_resp_bits_resp_entry_2_perm_d =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_perm_d : resp_pte_perm_d;
  assign io_resp_bits_resp_entry_2_perm_a =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_perm_a : resp_pte_perm_a;
  assign io_resp_bits_resp_entry_2_perm_g =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_perm_g : resp_pte_perm_g;
  assign io_resp_bits_resp_entry_2_perm_u =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_perm_u : resp_pte_perm_u;
  assign io_resp_bits_resp_entry_2_perm_x =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_perm_x : resp_pte_perm_x;
  assign io_resp_bits_resp_entry_2_perm_w =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_perm_w : resp_pte_perm_w;
  assign io_resp_bits_resp_entry_2_perm_r =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_perm_r : resp_pte_perm_r;
  assign io_resp_bits_resp_entry_2_level =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_level : resp_level;
  ...
  assign io_resp_bits_resp_entry_2_ppn_low =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_ppn_low : resp_pte_ppn[2:0];
  assign io_resp_bits_resp_entry_2_af = ~_io_resp_bits_resp_T_4 & resp_af;
  assign io_resp_bits_resp_entry_2_pf =
    _io_resp_bits_resp_T_4 ? stage1_entry_2_pf : resp_pf;
  ...
  assign io_resp_bits_resp_entry_3_n =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_n : resp_pte_n;
  assign io_resp_bits_resp_entry_3_pbmt =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_pbmt : resp_pte_pbmt;
  assign io_resp_bits_resp_entry_3_perm_d =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_perm_d : resp_pte_perm_d;
  assign io_resp_bits_resp_entry_3_perm_a =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_perm_a : resp_pte_perm_a;
  assign io_resp_bits_resp_entry_3_perm_g =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_perm_g : resp_pte_perm_g;
  assign io_resp_bits_resp_entry_3_perm_u =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_perm_u : resp_pte_perm_u;
  assign io_resp_bits_resp_entry_3_perm_x =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_perm_x : resp_pte_perm_x;
  assign io_resp_bits_resp_entry_3_perm_w =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_perm_w : resp_pte_perm_w;
  assign io_resp_bits_resp_entry_3_perm_r =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_perm_r : resp_pte_perm_r;
  assign io_resp_bits_resp_entry_3_level =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_level : resp_level;
  ...
  assign io_resp_bits_resp_entry_3_ppn_low =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_ppn_low : resp_pte_ppn[2:0];
  assign io_resp_bits_resp_entry_3_af = ~_io_resp_bits_resp_T_4 & resp_af;
  assign io_resp_bits_resp_entry_3_pf =
    _io_resp_bits_resp_T_4 ? stage1_entry_3_pf : resp_pf;
  ...
  assign io_resp_bits_resp_entry_4_n =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_n : resp_pte_n;
  assign io_resp_bits_resp_entry_4_pbmt =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_pbmt : resp_pte_pbmt;
  assign io_resp_bits_resp_entry_4_perm_d =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_perm_d : resp_pte_perm_d;
  assign io_resp_bits_resp_entry_4_perm_a =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_perm_a : resp_pte_perm_a;
  assign io_resp_bits_resp_entry_4_perm_g =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_perm_g : resp_pte_perm_g;
  assign io_resp_bits_resp_entry_4_perm_u =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_perm_u : resp_pte_perm_u;
  assign io_resp_bits_resp_entry_4_perm_x =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_perm_x : resp_pte_perm_x;
  assign io_resp_bits_resp_entry_4_perm_w =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_perm_w : resp_pte_perm_w;
  assign io_resp_bits_resp_entry_4_perm_r =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_perm_r : resp_pte_perm_r;
  assign io_resp_bits_resp_entry_4_level =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_level : resp_level;
  ...
  assign io_resp_bits_resp_entry_4_ppn_low =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_ppn_low : resp_pte_ppn[2:0];
  assign io_resp_bits_resp_entry_4_af = ~_io_resp_bits_resp_T_4 & resp_af;
  assign io_resp_bits_resp_entry_4_pf =
    _io_resp_bits_resp_T_4 ? stage1_entry_4_pf : resp_pf;
  ...
  assign io_resp_bits_resp_entry_5_n =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_n : resp_pte_n;
  assign io_resp_bits_resp_entry_5_pbmt =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_pbmt : resp_pte_pbmt;
  assign io_resp_bits_resp_entry_5_perm_d =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_perm_d : resp_pte_perm_d;
  assign io_resp_bits_resp_entry_5_perm_a =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_perm_a : resp_pte_perm_a;
  assign io_resp_bits_resp_entry_5_perm_g =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_perm_g : resp_pte_perm_g;
  assign io_resp_bits_resp_entry_5_perm_u =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_perm_u : resp_pte_perm_u;
  assign io_resp_bits_resp_entry_5_perm_x =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_perm_x : resp_pte_perm_x;
  assign io_resp_bits_resp_entry_5_perm_w =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_perm_w : resp_pte_perm_w;
  assign io_resp_bits_resp_entry_5_perm_r =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_perm_r : resp_pte_perm_r;
  assign io_resp_bits_resp_entry_5_level =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_level : resp_level;
  ...
  assign io_resp_bits_resp_entry_5_ppn_low =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_ppn_low : resp_pte_ppn[2:0];
  assign io_resp_bits_resp_entry_5_af = ~_io_resp_bits_resp_T_4 & resp_af;
  assign io_resp_bits_resp_entry_5_pf =
    _io_resp_bits_resp_T_4 ? stage1_entry_5_pf : resp_pf;
  ...
  assign io_resp_bits_resp_entry_6_n =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_n : resp_pte_n;
  assign io_resp_bits_resp_entry_6_pbmt =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_pbmt : resp_pte_pbmt;
  assign io_resp_bits_resp_entry_6_perm_d =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_perm_d : resp_pte_perm_d;
  assign io_resp_bits_resp_entry_6_perm_a =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_perm_a : resp_pte_perm_a;
  assign io_resp_bits_resp_entry_6_perm_g =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_perm_g : resp_pte_perm_g;
  assign io_resp_bits_resp_entry_6_perm_u =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_perm_u : resp_pte_perm_u;
  assign io_resp_bits_resp_entry_6_perm_x =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_perm_x : resp_pte_perm_x;
  assign io_resp_bits_resp_entry_6_perm_w =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_perm_w : resp_pte_perm_w;
  assign io_resp_bits_resp_entry_6_perm_r =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_perm_r : resp_pte_perm_r;
  assign io_resp_bits_resp_entry_6_level =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_level : resp_level;
  ...
  assign io_resp_bits_resp_entry_6_ppn_low =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_ppn_low : resp_pte_ppn[2:0];
  assign io_resp_bits_resp_entry_6_af = ~_io_resp_bits_resp_T_4 & resp_af;
  assign io_resp_bits_resp_entry_6_pf =
    _io_resp_bits_resp_T_4 ? stage1_entry_6_pf : resp_pf;
  ...
  assign io_resp_bits_resp_entry_7_n =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_n : resp_pte_n;
  assign io_resp_bits_resp_entry_7_pbmt =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_pbmt : resp_pte_pbmt;
  assign io_resp_bits_resp_entry_7_perm_d =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_perm_d : resp_pte_perm_d;
  assign io_resp_bits_resp_entry_7_perm_a =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_perm_a : resp_pte_perm_a;
  assign io_resp_bits_resp_entry_7_perm_g =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_perm_g : resp_pte_perm_g;
  assign io_resp_bits_resp_entry_7_perm_u =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_perm_u : resp_pte_perm_u;
  assign io_resp_bits_resp_entry_7_perm_x =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_perm_x : resp_pte_perm_x;
  assign io_resp_bits_resp_entry_7_perm_w =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_perm_w : resp_pte_perm_w;
  assign io_resp_bits_resp_entry_7_perm_r =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_perm_r : resp_pte_perm_r;
  assign io_resp_bits_resp_entry_7_level =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_level : resp_level;
  ...
  assign io_resp_bits_resp_entry_7_ppn_low =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_ppn_low : resp_pte_ppn[2:0];
  assign io_resp_bits_resp_entry_7_af = ~_io_resp_bits_resp_T_4 & resp_af;
  assign io_resp_bits_resp_entry_7_pf =
    _io_resp_bits_resp_T_4 ? stage1_entry_7_pf : resp_pf;
