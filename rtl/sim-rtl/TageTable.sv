...
module TageTable(
  ...
  input  [3:0]  io_req_bits_folded_hist_hist_3_folded_hist,
  ...
  wire [3:0]  _GEN = io_req_bits_pc[4:1] ^ io_req_bits_folded_hist_hist_3_folded_hist;
  ...
  wire [5:0]  _table_banks_3_io_r_req_bits_setIdx_T = {io_req_bits_pc[8:5], _GEN[3:2]};
  ...
  wire [3:0]  _GEN_0 = io_update_pc[4:1] ^ io_update_ghist[3:0];
  wire [5:0]  update_tag =
    {io_update_pc[6], {io_update_pc[5], _GEN_0} ^ {io_update_ghist[3:0], 1'h0}};
  ...
  wire [5:0]  update_idx_in_bank = {io_update_pc[8:5], _GEN_0[3:2]};
  ...
  always @(posedge clock) begin
    if (_s1_bank_req_1h_T) begin
      ...
      s1_tag <=
        {io_req_bits_pc[6],
         {io_req_bits_pc[5], _GEN} ^ {io_req_bits_folded_hist_hist_3_folded_hist, 1'h0}};
  ...
  FoldedSRAMTemplate us (
    ...
    .io_r_req_bits_setIdx  ({io_req_bits_pc[8:5], _GEN}),
    ...
    .io_w_req_bits_setIdx  ({io_update_pc[8:5], _GEN_0}),
