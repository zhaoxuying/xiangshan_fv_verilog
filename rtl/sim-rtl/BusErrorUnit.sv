...
module BusErrorUnit(
  ...
  wire             _GEN = io_errors_dcache_ecc_error_valid & enable_1;
  wire             _GEN_0 =
    cause_reg == 2'h0 & (_GEN | io_errors_icache_ecc_error_valid & enable_0);
  ...
  always @(posedge clock) begin
    if (valids_1_0 | valids_1_1 | valids_1_2 | valids_1_3 | valids_1_4 | valids_1_5)
      ...
      pad_1 <= _GEN ? io_errors_dcache_ecc_error_bits : io_errors_icache_ecc_error_bits;
  end // always @(posedge)
  ...
  assign auto_in_d_bits_data =
    {16'h0,
     _GEN_1[auto_in_a_bits_address[5:3]] ? _GEN_2[auto_in_a_bits_address[5:3]] : 48'h0};
  assign auto_int_out_0 =
    |({accrued_2, accrued_1, accrued_0}
      & {global_interrupt_2, global_interrupt_1, global_interrupt_0});
  assign io_interrupt =
    |({accrued_2, accrued_1, accrued_0}
      & {local_interrupt_2, local_interrupt_1, local_interrupt_0});
endmodule
