  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_vpu_vma = _RANDOM[5'h0][27];
        outCtrl_r_vpu_vta = _RANDOM[5'h0][28];
        outCtrl_r_vpu_vsew = _RANDOM[5'h0][30:29];
        outCtrl_r_vpu_vm = _RANDOM[5'h1][10];
        outCtrl_r_vpu_vstart = _RANDOM[5'h1][18:11];
        outCtrl_r_vpu_vuopIdx = {_RANDOM[5'h1][31], _RANDOM[5'h2][5:0]};
        outCtrl_r_vpu_isNarrow = _RANDOM[5'h6][22];
        outCtrl_r_vpu_isDstMask = _RANDOM[5'h6][23];
        outData_r_src_4 = {_RANDOM[5'h6][31:29], _RANDOM[5'h7][4:0]};
        outData_r_src_3 =
          {_RANDOM[5'h7][31:5],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:5],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][4:0]};
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1B][5];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h1B][11:6];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h1B][19:12];
        io_out_bits_ctrl_vecWen_r = _RANDOM[5'h1B][20];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[5'h1B][21];
      `endif // RANDOMIZE_REG_INIT
    end // initial
