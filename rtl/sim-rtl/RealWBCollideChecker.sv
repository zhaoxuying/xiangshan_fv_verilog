...
module RealWBCollideChecker(
  ...
  output [5:0]  io_out_7_bits_pdest,
  output [63:0] io_out_7_bits_data,
  output        io_out_6_valid,
  output        io_out_6_bits_rfWen,
  output [5:0]  io_out_6_bits_pdest,
