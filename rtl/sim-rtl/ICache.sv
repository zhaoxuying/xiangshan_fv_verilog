...
module ICache(
  ...
  wire [39:0]  _wayLookup_io_read_bits_entry_ptag_0;
  wire [39:0]  _wayLookup_io_read_bits_entry_ptag_1;
  ...
  wire [1:0]   _prefetcher_io_metaRead_toIMeta_bits_vSetIdx_0;
  wire [1:0]   _prefetcher_io_metaRead_toIMeta_bits_vSetIdx_1;
  ...
  wire [1:0]   _prefetcher_io_MSHRReq_bits_vSetIdx;
  wire         _prefetcher_io_wayLookupWrite_valid;
  wire [1:0]   _prefetcher_io_wayLookupWrite_bits_entry_vSetIdx_0;
  wire [1:0]   _prefetcher_io_wayLookupWrite_bits_entry_vSetIdx_1;
  wire [3:0]   _prefetcher_io_wayLookupWrite_bits_entry_waymask_0;
  wire [3:0]   _prefetcher_io_wayLookupWrite_bits_entry_waymask_1;
  wire [39:0]  _prefetcher_io_wayLookupWrite_bits_entry_ptag_0;
  wire [39:0]  _prefetcher_io_wayLookupWrite_bits_entry_ptag_1;
  ...
  wire [1:0]   _missUnit_io_fetch_resp_bits_vSetIdx;
  ...
  wire [1:0]   _missUnit_io_meta_write_bits_virIdx;
  wire [39:0]  _missUnit_io_meta_write_bits_phyTag;
  wire [3:0]   _missUnit_io_meta_write_bits_waymask;
  wire         _missUnit_io_meta_write_bits_bankIdx;
  wire         _missUnit_io_data_write_valid;
  wire [1:0]   _missUnit_io_data_write_bits_virIdx;
  ...
  wire [1:0]   _missUnit_io_victim_vSetIdx_bits;
  wire         _mainPipe_io_dataArray_toIData_0_valid;
  wire [1:0]   _mainPipe_io_dataArray_toIData_0_bits_vSetIdx_0;
  wire [1:0]   _mainPipe_io_dataArray_toIData_0_bits_vSetIdx_1;
  ...
  wire [1:0]   _mainPipe_io_dataArray_toIData_1_bits_vSetIdx_0;
  wire [1:0]   _mainPipe_io_dataArray_toIData_1_bits_vSetIdx_1;
  wire         _mainPipe_io_dataArray_toIData_2_valid;
  wire [1:0]   _mainPipe_io_dataArray_toIData_2_bits_vSetIdx_0;
  wire [1:0]   _mainPipe_io_dataArray_toIData_2_bits_vSetIdx_1;
  wire         _mainPipe_io_dataArray_toIData_3_valid;
  wire [1:0]   _mainPipe_io_dataArray_toIData_3_bits_vSetIdx_0;
  wire [1:0]   _mainPipe_io_dataArray_toIData_3_bits_vSetIdx_1;
  wire         _mainPipe_io_metaArrayFlush_0_valid;
  wire [1:0]   _mainPipe_io_metaArrayFlush_0_bits_virIdx;
  wire [3:0]   _mainPipe_io_metaArrayFlush_0_bits_waymask;
  wire         _mainPipe_io_metaArrayFlush_1_valid;
  wire [1:0]   _mainPipe_io_metaArrayFlush_1_bits_virIdx;
  wire [3:0]   _mainPipe_io_metaArrayFlush_1_bits_waymask;
  wire         _mainPipe_io_touch_0_valid;
  wire [1:0]   _mainPipe_io_touch_0_bits_vSetIdx;
  wire [1:0]   _mainPipe_io_touch_0_bits_way;
  wire         _mainPipe_io_touch_1_valid;
  wire [1:0]   _mainPipe_io_touch_1_bits_vSetIdx;
  ...
  wire [1:0]   _mainPipe_io_mshr_req_bits_vSetIdx;
  ...
  wire [39:0]  _metaArray_io_readResp_metas_0_0_tag;
  wire [39:0]  _metaArray_io_readResp_metas_0_1_tag;
  wire [39:0]  _metaArray_io_readResp_metas_0_2_tag;
  wire [39:0]  _metaArray_io_readResp_metas_0_3_tag;
  wire [39:0]  _metaArray_io_readResp_metas_1_0_tag;
  wire [39:0]  _metaArray_io_readResp_metas_1_1_tag;
  wire [39:0]  _metaArray_io_readResp_metas_1_2_tag;
  wire [39:0]  _metaArray_io_readResp_metas_1_3_tag;
  ...
  wire [1:0]   _ctrlUnitOpt_io_metaRead_bits_vSetIdx_0;
  wire [1:0]   _ctrlUnitOpt_io_metaRead_bits_vSetIdx_1;
  wire         _ctrlUnitOpt_io_metaWrite_valid;
  wire [1:0]   _ctrlUnitOpt_io_metaWrite_bits_virIdx;
  wire [39:0]  _ctrlUnitOpt_io_metaWrite_bits_phyTag;
  ...
  wire [1:0]   _ctrlUnitOpt_io_dataWrite_bits_virIdx;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        softPrefetch_isSoftPrefetch = _RANDOM[3'h3][9];
        io_error_bits_r_paddr = {_RANDOM[3'h3][31:21], _RANDOM[3'h4], _RANDOM[3'h5][4:0]};
        io_error_bits_r_report_to_beu = _RANDOM[3'h5][5];
        io_error_valid_REG = _RANDOM[3'h5][6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        softPrefetchValid = 1'h0;
        softPrefetch_startAddr = 50'h0;
  ...
  IPrefetchPipe prefetcher (
    ...
    .io_req_bits_ftqIdx_value
      (softPrefetchValid ? 3'h0 : io_ftqPrefetch_req_bits_ftqIdx_value),
