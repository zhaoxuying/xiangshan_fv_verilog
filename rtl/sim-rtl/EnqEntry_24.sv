...
module EnqEntry_24(
  ...
  output        io_commonOut_entry_bits_payload_storeSetHit,
  output        io_commonOut_entry_bits_payload_waitForRobIdx_flag,
  output [5:0]  io_commonOut_entry_bits_payload_waitForRobIdx_value,
  output        io_commonOut_entry_bits_payload_loadWaitBit,
  output        io_commonOut_entry_bits_payload_loadWaitStrict,
  ...
  output [5:0]  io_commonOut_transEntry_bits_payload_waitForRobIdx_value,
  ...
  reg  [5:0]  entryReg_payload_waitForRobIdx_value;
  ...
  assign wakeupVec_0_0 =
    io_commonIn_wakeUpFromIQ_0_bits_pdest == _GEN & entryReg_status_srcStatus_0_srcType[0]
    & io_commonIn_wakeUpFromIQ_0_bits_rfWen;
  assign wakeupVec_0_1 =
    io_commonIn_wakeUpFromIQ_1_bits_pdest == _GEN & entryReg_status_srcStatus_0_srcType[0]
  ...
  assign wakeupVec_0_3 =
    io_commonIn_wakeUpFromIQ_3_bits_pdest == _GEN & entryReg_status_srcStatus_0_srcType[0]
    & io_commonIn_wakeUpFromIQ_3_bits_rfWen;
  wire        wakeupVec_0_4 =
    io_commonIn_wakeUpFromIQ_4_bits_pdest == _GEN & entryReg_status_srcStatus_0_srcType[0]
    & io_commonIn_wakeUpFromIQ_4_bits_rfWen;
  wire        wakeupVec_0_5 =
    io_commonIn_wakeUpFromIQ_5_bits_pdest == _GEN & entryReg_status_srcStatus_0_srcType[0]
    & io_commonIn_wakeUpFromIQ_5_bits_rfWen;
  wire        wakeupVec_0_6 =
    io_commonIn_wakeUpFromIQ_6_bits_pdest == _GEN & entryReg_status_srcStatus_0_srcType[0]
  ...
  wire        enqDelayOut1_srcWakeUpByIQVec_0_1 =
    io_enqDelayIn1_wakeUpFromIQ_1_bits_pdest == _GEN
  ...
  wire        enqDelayOut1_srcWakeUpByIQVec_0_3 =
    io_enqDelayIn1_wakeUpFromIQ_3_bits_pdest == _GEN
    ...
    if (reset) begin
      ...
      validReg_last_REG <=
        ...
        | ~(common_flushed | io_commonIn_issueResp_valid
            & (&io_commonIn_issueResp_bits_resp) & ~srcCancelByLoad
  ...
  always @(posedge clock) begin
    if (enqDelayValidRegNext) begin
      ...
      entryReg_payload_waitForRobIdx_value <= 6'h0;
    ...
    entryReg_payload_storeSetHit <= ~enqDelayValidRegNext & entryReg_payload_storeSetHit;
    entryReg_payload_waitForRobIdx_flag <=
      ~enqDelayValidRegNext & entryReg_payload_waitForRobIdx_flag;
    entryReg_payload_loadWaitBit <= ~enqDelayValidRegNext & entryReg_payload_loadWaitBit;
    entryReg_payload_loadWaitStrict <=
      ~enqDelayValidRegNext & entryReg_payload_loadWaitStrict;
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_fuType_15 = _RANDOM[6'h0][23];
        entryReg_status_srcStatus_0_psrc = _RANDOM[6'h1][16:11];
        entryReg_status_srcStatus_0_srcType = _RANDOM[6'h1][20:17];
        entryReg_status_srcStatus_0_srcState = _RANDOM[6'h1][21];
        entryReg_status_srcStatus_0_dataSources_value = _RANDOM[6'h1][25:22];
        entryReg_status_srcStatus_0_srcLoadDependency_0 = _RANDOM[6'h1][27:26];
        entryReg_status_srcStatus_0_srcLoadDependency_1 = _RANDOM[6'h1][29:28];
        entryReg_status_srcStatus_0_srcLoadDependency_2 = _RANDOM[6'h1][31:30];
        entryReg_status_srcStatus_0_exuSources_value = _RANDOM[6'h2][2:0];
        entryReg_status_srcStatus_0_useRegCache = _RANDOM[6'h2][3];
        entryReg_status_srcStatus_0_regCacheIdx = _RANDOM[6'h2][8:4];
        entryReg_status_issued = _RANDOM[6'h2][10];
        entryReg_status_issueTimer = _RANDOM[6'h2][13:12];
        entryReg_imm = {_RANDOM[6'h2][31:15], _RANDOM[6'h3][14:0]};
        entryReg_payload_preDecodeInfo_isRVC = _RANDOM[6'h7][10];
        entryReg_payload_ftqPtr_flag = _RANDOM[6'h7][17];
        entryReg_payload_ftqPtr_value = _RANDOM[6'h7][20:18];
        entryReg_payload_ftqOffset = _RANDOM[6'h7][24:21];
        entryReg_payload_fuOpType = _RANDOM[6'h9][30:22];
        entryReg_payload_rfWen = _RANDOM[6'h9][31];
        entryReg_payload_fpWen = _RANDOM[6'hA][0];
        entryReg_payload_pdest = _RANDOM[6'h15][11:4];
        entryReg_payload_storeSetHit = _RANDOM[6'h2A][16];
        entryReg_payload_waitForRobIdx_flag = _RANDOM[6'h2A][17];
        entryReg_payload_waitForRobIdx_value = _RANDOM[6'h2A][23:18];
        entryReg_payload_loadWaitBit = _RANDOM[6'h2A][24];
        entryReg_payload_loadWaitStrict = _RANDOM[6'h2A][25];
        entryReg_payload_lqIdx_flag = _RANDOM[6'h2A][31];
        entryReg_payload_lqIdx_value = _RANDOM[6'h2B][4:0];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h2B][5];
        entryReg_payload_sqIdx_value = _RANDOM[6'h2B][10:6];
        enqDelayValidReg_last_REG = _RANDOM[6'h2B][18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
  ...
  assign io_commonOut_fuType = {19'h0, entryReg_status_fuType_15, 15'h0};
  ...
  assign io_commonOut_entry_bits_payload_storeSetHit = entryReg_payload_storeSetHit;
  assign io_commonOut_entry_bits_payload_waitForRobIdx_flag =
    entryReg_payload_waitForRobIdx_flag;
  assign io_commonOut_entry_bits_payload_waitForRobIdx_value =
    entryReg_payload_waitForRobIdx_value;
  assign io_commonOut_entry_bits_payload_loadWaitBit = entryReg_payload_loadWaitBit;
  assign io_commonOut_entry_bits_payload_loadWaitStrict = entryReg_payload_loadWaitStrict;
  ...
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_0 =
    wakeupByIQ ? _GEN_3 : common_srcLoadDependencyNext_0_0;
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_1 =
    wakeupByIQ ? _GEN_4 : common_srcLoadDependencyNext_0_1;
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_2 =
    wakeupByIQ ? _GEN_5 : common_srcLoadDependencyNext_0_2;
