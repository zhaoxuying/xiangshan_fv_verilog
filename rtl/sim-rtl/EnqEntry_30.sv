...
module EnqEntry_30(
  ...
  assign currentStatus_srcStatus_0_srcState =
    enqDelayValidReg_last_REG
      ? ~enqDelayOut1_srcCancelByLoad_0 & entryReg_status_srcStatus_0_srcState
        ...
        | io_enqDelayIn1_wakeUpFromWB_7_bits_pdest == entryReg_status_srcStatus_0_psrc
        & entryReg_status_srcStatus_0_srcType[1]
        & io_enqDelayIn1_wakeUpFromWB_7_bits_fpWen & io_enqDelayIn1_wakeUpFromWB_7_valid
        | io_enqDelayIn1_wakeUpFromWB_8_bits_pdest == entryReg_status_srcStatus_0_psrc
        & entryReg_status_srcStatus_0_srcType[1]
        & io_enqDelayIn1_wakeUpFromWB_8_bits_fpWen & io_enqDelayIn1_wakeUpFromWB_8_valid
        | io_enqDelayIn1_wakeUpFromWB_9_bits_pdest == entryReg_status_srcStatus_0_psrc
        & entryReg_status_srcStatus_0_srcType[1]
        & io_enqDelayIn1_wakeUpFromWB_9_bits_fpWen & io_enqDelayIn1_wakeUpFromWB_9_valid
  ...
  always @(posedge clock) begin
    if (enqDelayValidRegNext) begin
      ...
      if (wakeupByIQ) begin
        ...
        entryReg_status_srcStatus_0_srcLoadDependency_0 <= _GEN_2;
        entryReg_status_srcStatus_0_srcLoadDependency_1 <= _GEN_3;
        entryReg_status_srcStatus_0_srcLoadDependency_2 <= _GEN_4;
      end
      else begin
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_srcStatus_0_srcLoadDependency_0 = _RANDOM[6'h1][29:28];
        entryReg_status_srcStatus_0_srcLoadDependency_1 = _RANDOM[6'h1][31:30];
        entryReg_status_srcStatus_0_srcLoadDependency_2 = _RANDOM[6'h2][1:0];
        entryReg_status_srcStatus_0_exuSources_value = _RANDOM[6'h2][4:2];
        entryReg_status_srcStatus_0_useRegCache = _RANDOM[6'h2][5];
        entryReg_status_srcStatus_0_regCacheIdx = _RANDOM[6'h2][10:6];
        entryReg_status_issued = _RANDOM[6'h2][12];
        entryReg_status_issueTimer = _RANDOM[6'h2][15:14];
        entryReg_payload_fuOpType = {_RANDOM[6'h8][31:24], _RANDOM[6'h9][0]};
        entryReg_payload_sqIdx_flag = _RANDOM[6'h2A][7];
        entryReg_payload_sqIdx_value = _RANDOM[6'h2A][12:8];
        enqDelayValidReg_last_REG = _RANDOM[6'h2A][20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
  ...
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_0 =
    wakeupByIQ ? _GEN_2 : common_srcLoadDependencyNext_0_0;
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_1 =
    wakeupByIQ ? _GEN_3 : common_srcLoadDependencyNext_0_1;
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_2 =
    wakeupByIQ ? _GEN_4 : common_srcLoadDependencyNext_0_2;
