...
module TlbStorageWrapper_1(
  ...
  wire       _page_ldtlb_storage_fa_io_access_0_touch_ways_valid;
  wire [1:0] _page_ldtlb_storage_fa_io_access_0_touch_ways_bits;
  wire       _page_ldtlb_storage_fa_io_access_1_touch_ways_valid;
  wire [1:0] _page_ldtlb_storage_fa_io_access_1_touch_ways_bits;
  wire       _page_ldtlb_storage_fa_io_access_2_touch_ways_valid;
  wire [1:0] _page_ldtlb_storage_fa_io_access_2_touch_ways_bits;
  wire       _page_ldtlb_storage_fa_io_access_3_touch_ways_valid;
  wire [1:0] _page_ldtlb_storage_fa_io_access_3_touch_ways_bits;
  ...
  wire [1:0] _refill_idx_state_reg_T_19 =
    _page_ldtlb_storage_fa_io_access_1_touch_ways_valid
      ...
      : _refill_idx_state_reg_T_9;
  wire       _refill_idx_state_reg_T_23 =
  ...
  wire       _refill_idx_state_reg_T_27 =
    _page_ldtlb_storage_fa_io_access_2_touch_ways_bits[1]
      ? _refill_idx_state_reg_T_19[0]
      : ~(_page_ldtlb_storage_fa_io_access_2_touch_ways_bits[0]);
  wire [1:0] _refill_idx_state_reg_T_29 =
    _page_ldtlb_storage_fa_io_access_2_touch_ways_valid
      ? {_refill_idx_state_reg_T_23, _refill_idx_state_reg_T_27}
      : _refill_idx_state_reg_T_19;
  always @(posedge clock or posedge reset) begin
    if (reset)
      refill_idx_state_reg <= 3'h0;
    else if (_page_ldtlb_storage_fa_io_access_0_touch_ways_valid
             | _page_ldtlb_storage_fa_io_access_1_touch_ways_valid
             | _page_ldtlb_storage_fa_io_access_2_touch_ways_valid
             | _page_ldtlb_storage_fa_io_access_3_touch_ways_valid) begin
      if (_page_ldtlb_storage_fa_io_access_3_touch_ways_valid)
        refill_idx_state_reg <=
          {~(_page_ldtlb_storage_fa_io_access_3_touch_ways_bits[1]),
           _page_ldtlb_storage_fa_io_access_3_touch_ways_bits[1]
             ? ~(_page_ldtlb_storage_fa_io_access_3_touch_ways_bits[0])
             : _refill_idx_state_reg_T_29[1],
           _page_ldtlb_storage_fa_io_access_3_touch_ways_bits[1]
             ? _refill_idx_state_reg_T_29[0]
             : ~(_page_ldtlb_storage_fa_io_access_3_touch_ways_bits[0])};
      else if (_page_ldtlb_storage_fa_io_access_2_touch_ways_valid)
        refill_idx_state_reg <=
          {~(_page_ldtlb_storage_fa_io_access_2_touch_ways_bits[1]),
           _refill_idx_state_reg_T_23,
           _refill_idx_state_reg_T_27};
      else if (_page_ldtlb_storage_fa_io_access_1_touch_ways_valid)
        refill_idx_state_reg <=
          {~(_page_ldtlb_storage_fa_io_access_1_touch_ways_bits[1]),
           _refill_idx_state_reg_T_13,
           _refill_idx_state_reg_T_17};
      else if (_page_ldtlb_storage_fa_io_access_0_touch_ways_valid)
        refill_idx_state_reg <=
          {~(_page_ldtlb_storage_fa_io_access_0_touch_ways_bits[1]),
  ...
  TLBFA_1 page_ldtlb_storage_fa (
    ...
    .io_access_3_touch_ways_valid   (_page_ldtlb_storage_fa_io_access_3_touch_ways_valid),
    .io_access_3_touch_ways_bits    (_page_ldtlb_storage_fa_io_access_3_touch_ways_bits)
  );
endmodule
