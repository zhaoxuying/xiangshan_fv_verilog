...
module TLXbar_2(
  ...
  wire        requestDOI_0_0 = auto_out_d_bits_source[8:3] == 6'h20;
  reg         beatsLeft;
  ...
  assign auto_in_1_c_ready = auto_out_c_ready;
  assign auto_in_1_d_valid = auto_out_d_valid & ~(auto_out_d_bits_source[8]);
  ...
  assign auto_in_1_e_ready = auto_out_e_ready;
  ...
  assign auto_in_0_d_bits_source = auto_out_d_bits_source[2:0];
  ...
  assign auto_out_a_bits_source =
    (muxState_0 ? {6'h20, auto_in_0_a_bits_source} : 9'h0)
  ...
  assign auto_out_a_bits_user_amba_prot_bufferable =
    muxState_0 & auto_in_0_a_bits_user_amba_prot_bufferable;
  assign auto_out_a_bits_user_amba_prot_modifiable =
    muxState_0 & auto_in_0_a_bits_user_amba_prot_modifiable;
  assign auto_out_a_bits_user_amba_prot_readalloc =
    muxState_0 & auto_in_0_a_bits_user_amba_prot_readalloc;
  assign auto_out_a_bits_user_amba_prot_writealloc =
    muxState_0 & auto_in_0_a_bits_user_amba_prot_writealloc;
  assign auto_out_a_bits_user_amba_prot_privileged =
    muxState_0 & auto_in_0_a_bits_user_amba_prot_privileged;
  assign auto_out_a_bits_user_amba_prot_secure =
    muxState_0 & auto_in_0_a_bits_user_amba_prot_secure;
  assign auto_out_a_bits_user_amba_prot_fetch =
    muxState_0 & auto_in_0_a_bits_user_amba_prot_fetch;
  assign auto_out_a_bits_echo_blockisdirty =
    muxState_1 & auto_in_1_a_bits_echo_blockisdirty;
  ...
  assign auto_out_c_valid = auto_in_1_c_valid;
  assign auto_out_c_bits_opcode = auto_in_1_c_bits_opcode;
  assign auto_out_c_bits_param = auto_in_1_c_bits_param;
  assign auto_out_c_bits_size = auto_in_1_c_bits_size;
  assign auto_out_c_bits_source = {1'h0, auto_in_1_c_bits_source};
  assign auto_out_c_bits_address = auto_in_1_c_bits_address;
  assign auto_out_c_bits_echo_blockisdirty = auto_in_1_c_bits_echo_blockisdirty;
  assign auto_out_c_bits_data = auto_in_1_c_bits_data;
  assign auto_out_c_bits_corrupt = auto_in_1_c_bits_corrupt;
  assign auto_out_d_ready =
    requestDOI_0_0 & auto_in_0_d_ready | ~(auto_out_d_bits_source[8]) & auto_in_1_d_ready;
  assign auto_out_e_valid = auto_in_1_e_valid;
  assign auto_out_e_bits_sink = auto_in_1_e_bits_sink;
endmodule
