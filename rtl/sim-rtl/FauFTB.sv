  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        u_bits_ftb_entry_isCall = _RANDOM[6'h1C][3];
        u_bits_ftb_entry_isRet = _RANDOM[6'h1C][4];
        u_bits_ftb_entry_isJalr = _RANDOM[6'h1C][5];
        u_bits_ftb_entry_valid = _RANDOM[6'h1C][6];
        u_bits_ftb_entry_brSlots_0_offset = _RANDOM[6'h1C][10:7];
        u_bits_ftb_entry_brSlots_0_sharing = _RANDOM[6'h1C][11];
        u_bits_ftb_entry_brSlots_0_valid = _RANDOM[6'h1C][12];
        u_bits_ftb_entry_brSlots_0_lower = _RANDOM[6'h1C][24:13];
        u_bits_ftb_entry_brSlots_0_tarStat = _RANDOM[6'h1C][26:25];
        u_bits_ftb_entry_tailSlot_offset = _RANDOM[6'h1C][30:27];
        u_bits_ftb_entry_tailSlot_sharing = _RANDOM[6'h1C][31];
        u_bits_ftb_entry_tailSlot_valid = _RANDOM[6'h1D][0];
        u_bits_ftb_entry_tailSlot_lower = _RANDOM[6'h1D][20:1];
        u_bits_ftb_entry_tailSlot_tarStat = _RANDOM[6'h1D][22:21];
        u_bits_ftb_entry_pftAddr = _RANDOM[6'h1D][26:23];
        u_bits_ftb_entry_carry = _RANDOM[6'h1D][27];
        u_bits_ftb_entry_last_may_be_rvi_call = _RANDOM[6'h1D][28];
        u_bits_ftb_entry_strong_bias_0 = _RANDOM[6'h1D][29];
        u_bits_ftb_entry_strong_bias_1 = _RANDOM[6'h1D][30];
        u_bits_br_taken_mask_0 = _RANDOM[6'h1E][4];
        u_bits_br_taken_mask_1 = _RANDOM[6'h1E][5];
        u_bits_meta =
          {_RANDOM[6'h1E][31:17],
           _RANDOM[6'h1F],
           _RANDOM[6'h20],
           ...
           _RANDOM[6'h25],
           _RANDOM[6'h26][20:0]};
        u_s1_valid = _RANDOM[6'h29][21];
        u_s1_tag = {_RANDOM[6'h29][31:22], _RANDOM[6'h2A][5:0]};
        u_s1_hit_oh = {_RANDOM[6'h2A][31:6], _RANDOM[6'h2B][5:0]};
        u_s1_hit = _RANDOM[6'h2B][6];
        u_s1_ftb_entry_isCall = _RANDOM[6'h2B][7];
        u_s1_ftb_entry_isRet = _RANDOM[6'h2B][8];
        u_s1_ftb_entry_isJalr = _RANDOM[6'h2B][9];
        u_s1_ftb_entry_valid = _RANDOM[6'h2B][10];
        u_s1_ftb_entry_brSlots_0_offset = _RANDOM[6'h2B][14:11];
        u_s1_ftb_entry_brSlots_0_sharing = _RANDOM[6'h2B][15];
        u_s1_ftb_entry_brSlots_0_valid = _RANDOM[6'h2B][16];
        u_s1_ftb_entry_brSlots_0_lower = _RANDOM[6'h2B][28:17];
        u_s1_ftb_entry_brSlots_0_tarStat = _RANDOM[6'h2B][30:29];
        u_s1_ftb_entry_tailSlot_offset = {_RANDOM[6'h2B][31], _RANDOM[6'h2C][2:0]};
        u_s1_ftb_entry_tailSlot_sharing = _RANDOM[6'h2C][3];
        u_s1_ftb_entry_tailSlot_valid = _RANDOM[6'h2C][4];
        u_s1_ftb_entry_tailSlot_lower = _RANDOM[6'h2C][24:5];
        u_s1_ftb_entry_tailSlot_tarStat = _RANDOM[6'h2C][26:25];
        u_s1_ftb_entry_pftAddr = _RANDOM[6'h2C][30:27];
        u_s1_ftb_entry_carry = _RANDOM[6'h2C][31];
        u_s1_ftb_entry_last_may_be_rvi_call = _RANDOM[6'h2D][0];
        u_s1_ftb_entry_strong_bias_0 = _RANDOM[6'h2D][1];
        u_s1_ftb_entry_strong_bias_1 = _RANDOM[6'h2D][2];
        u_s1_br_update_valids_0 = _RANDOM[6'h2E][21];
        u_s1_br_update_valids_1 = _RANDOM[6'h2E][22];
        u_s1_br_takens_0 = _RANDOM[6'h2E][23];
        u_s1_br_takens_1 = _RANDOM[6'h2E][24];
        io_perf_0_value_REG = _RANDOM[6'h2E][26];
        io_perf_0_value_REG_1 = _RANDOM[6'h2E][27];
        io_perf_1_value_REG = _RANDOM[6'h2E][28];
        io_perf_1_value_REG_1 = _RANDOM[6'h2E][29];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s2_pc_dup_s2_pc_seg_0_value = 26'h0;
        s2_pc_dup_s2_pc_seg_1_value = 12'h0;
