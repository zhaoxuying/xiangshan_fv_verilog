...
module Queue1_AXI4BundleARW(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][27:0]};
        full = _RANDOM[2'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_cache = full ? ram[71:68] : io_enq_bits_cache;
  assign io_deq_bits_prot = full ? ram[74:72] : io_enq_bits_prot;
  assign io_deq_bits_qos = full ? ram[78:75] : 4'h0;
  assign io_deq_bits_echo_blockisdirty = full ? ram[79] : io_enq_bits_echo_blockisdirty;
  assign io_deq_bits_echo_tl_state_size =
    full ? ram[83:80] : io_enq_bits_echo_tl_state_size;
  assign io_deq_bits_echo_tl_state_source =
    full ? ram[89:84] : io_enq_bits_echo_tl_state_source;
  assign io_deq_bits_wen = full ? ram[90] : io_enq_bits_wen;
endmodule
