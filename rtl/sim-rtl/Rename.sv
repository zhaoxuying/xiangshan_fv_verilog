...
module Rename(
  ...
  input  [5:0]   io_snptLastEnq_bits_value,
  input          io_snptIsFull,
  ...
  wire [1:0] _GEN = {1'h0, io_in_1_valid & io_in_1_bits_lastUop};
  wire [1:0] _GEN_0 = {1'h0, io_in_2_valid & io_in_2_bits_lastUop};
  wire [1:0] _GEN_1 = {1'h0, _uops_5_robIdx_T};
  wire [1:0] _GEN_2 = {1'h0, io_in_4_valid & io_in_4_bits_lastUop};
  wire [1:0] _GEN_3 = {1'h0, io_in_3_valid & io_in_3_bits_lastUop};
  reg        robIdxHead_flag;
  reg  [5:0] robIdxHead_value;
  reg        lastCycleMisprediction_last_REG;
  wire [6:0] _GEN_4 = {1'h0, robIdxHead_value};
  wire       isVlsType_0 =
  ...
  wire       _GEN_5 = emul_0 == 3'h0 | emul_0 == 3'h1 | emul_0 == 3'h2 | emul_0 == 3'h3;
  wire [4:0] _GEN_6 = {3'h0, io_in_0_bits_vpu_veew};
  ...
  wire [4:0] _GEN_8 = {3'h0, io_in_0_bits_vpu_vsew};
  wire [4:0] numLsElem_segmentIndexFlowNum =
    $signed(emul_0) > $signed(io_in_0_bits_vpu_vlmul)
      ? {_GEN_5, &emul_0, _numLsElem_T_158, _numLsElem_T_157, 1'h0} >> _GEN_6
      : {_GEN_7, &io_in_0_bits_vpu_vlmul, _numLsElem_T_114, _numLsElem_T_113, 1'h0}
        >> _GEN_8;
  wire       _numLsElem_T_358 = emul_1 == 3'h5;
  wire       _numLsElem_T_359 = emul_1 == 3'h6;
  wire       _GEN_9 = emul_1 == 3'h0 | emul_1 == 3'h1 | emul_1 == 3'h2 | emul_1 == 3'h3;
  wire [4:0] _GEN_10 = {3'h0, io_in_1_bits_vpu_veew};
  ...
  wire [4:0] _GEN_12 = {3'h0, io_in_1_bits_vpu_vsew};
  wire [4:0] numLsElem_segmentIndexFlowNum_1 =
    $signed(emul_1) > $signed(io_in_1_bits_vpu_vlmul)
      ? {_GEN_9, &emul_1, _numLsElem_T_359, _numLsElem_T_358, 1'h0} >> _GEN_10
      : {_GEN_11, &io_in_1_bits_vpu_vlmul, _numLsElem_T_315, _numLsElem_T_314, 1'h0}
        >> _GEN_12;
  wire       _numLsElem_T_559 = emul_2 == 3'h5;
  wire       _numLsElem_T_560 = emul_2 == 3'h6;
  wire       _GEN_13 = emul_2 == 3'h0 | emul_2 == 3'h1 | emul_2 == 3'h2 | emul_2 == 3'h3;
  wire [4:0] _GEN_14 = {3'h0, io_in_2_bits_vpu_veew};
  ...
  wire [4:0] _GEN_16 = {3'h0, io_in_2_bits_vpu_vsew};
  wire [4:0] numLsElem_segmentIndexFlowNum_2 =
    $signed(emul_2) > $signed(io_in_2_bits_vpu_vlmul)
      ? {_GEN_13, &emul_2, _numLsElem_T_560, _numLsElem_T_559, 1'h0} >> _GEN_14
      : {_GEN_15, &io_in_2_bits_vpu_vlmul, _numLsElem_T_516, _numLsElem_T_515, 1'h0}
        >> _GEN_16;
  wire       _numLsElem_T_760 = emul_3 == 3'h5;
  wire       _numLsElem_T_761 = emul_3 == 3'h6;
  wire       _GEN_17 = emul_3 == 3'h0 | emul_3 == 3'h1 | emul_3 == 3'h2 | emul_3 == 3'h3;
  wire [4:0] _GEN_18 = {3'h0, io_in_3_bits_vpu_veew};
  ...
  wire [4:0] _GEN_20 = {3'h0, io_in_3_bits_vpu_vsew};
  wire [4:0] numLsElem_segmentIndexFlowNum_3 =
    $signed(emul_3) > $signed(io_in_3_bits_vpu_vlmul)
      ? {_GEN_17, &emul_3, _numLsElem_T_761, _numLsElem_T_760, 1'h0} >> _GEN_18
      : {_GEN_19, &io_in_3_bits_vpu_vlmul, _numLsElem_T_717, _numLsElem_T_716, 1'h0}
        >> _GEN_20;
  wire       _numLsElem_T_961 = emul_4 == 3'h5;
  wire       _numLsElem_T_962 = emul_4 == 3'h6;
  wire       _GEN_21 = emul_4 == 3'h0 | emul_4 == 3'h1 | emul_4 == 3'h2 | emul_4 == 3'h3;
  wire [4:0] _GEN_22 = {3'h0, io_in_4_bits_vpu_veew};
  ...
  wire [4:0] _GEN_24 = {3'h0, io_in_4_bits_vpu_vsew};
  wire [4:0] numLsElem_segmentIndexFlowNum_4 =
    $signed(emul_4) > $signed(io_in_4_bits_vpu_vlmul)
      ? {_GEN_21, &emul_4, _numLsElem_T_962, _numLsElem_T_961, 1'h0} >> _GEN_22
      : {_GEN_23, &io_in_4_bits_vpu_vlmul, _numLsElem_T_918, _numLsElem_T_917, 1'h0}
        >> _GEN_24;
  wire       _numLsElem_T_1162 = emul_5 == 3'h5;
  wire       _numLsElem_T_1163 = emul_5 == 3'h6;
  wire       _GEN_25 = emul_5 == 3'h0 | emul_5 == 3'h1 | emul_5 == 3'h2 | emul_5 == 3'h3;
  wire [4:0] _GEN_26 = {3'h0, io_in_5_bits_vpu_veew};
  ...
  wire [4:0] _GEN_28 = {3'h0, io_in_5_bits_vpu_vsew};
  wire [4:0] numLsElem_segmentIndexFlowNum_5 =
    $signed(emul_5) > $signed(io_in_5_bits_vpu_vlmul)
      ? {_GEN_25, &emul_5, _numLsElem_T_1163, _numLsElem_T_1162, 1'h0} >> _GEN_26
      : {_GEN_27, &io_in_5_bits_vpu_vlmul, _numLsElem_T_1119, _numLsElem_T_1118, 1'h0}
        >> _GEN_28;
  wire       isMove_0 =
  ...
  wire [7:0] _uops_0_robIdx_diff_T_4 = 8'({2'h0, robIdxHead_value} - 8'h30);
  wire       uops_0_robIdx_reverse_flag = $signed(_uops_0_robIdx_diff_T_4) > -8'sh1;
  wire [8:0] _GEN_29 =
  ...
  wire [6:0] uops_1_robIdx_new_value = 7'(_GEN_4 + {6'h0, _uops_5_robIdx_T});
  wire [7:0] _uops_1_robIdx_diff_T_4 = 8'({1'h0, uops_1_robIdx_new_value} - 8'h30);
  wire       uops_1_robIdx_reverse_flag = $signed(_uops_1_robIdx_diff_T_4) > -8'sh1;
  wire [8:0] _GEN_30 =
  ...
  wire [6:0] uops_2_robIdx_new_value = 7'(_GEN_4 + {5'h0, 2'(_GEN_1 + _GEN)});
  wire [7:0] _uops_2_robIdx_diff_T_4 = 8'({1'h0, uops_2_robIdx_new_value} - 8'h30);
  wire       uops_2_robIdx_reverse_flag = $signed(_uops_2_robIdx_diff_T_4) > -8'sh1;
  wire [8:0] _GEN_31 =
  ...
  wire [6:0] uops_3_robIdx_new_value =
    7'(_GEN_4 + {5'h0, 2'(_GEN_1 + 2'(_GEN + _GEN_0))});
  wire [7:0] _uops_3_robIdx_diff_T_4 = 8'({1'h0, uops_3_robIdx_new_value} - 8'h30);
  wire       uops_3_robIdx_reverse_flag = $signed(_uops_3_robIdx_diff_T_4) > -8'sh1;
  wire [8:0] _GEN_32 =
  ...
  wire [6:0] uops_4_robIdx_new_value =
    7'(_GEN_4 + {4'h0, 3'({1'h0, 2'(_GEN_1 + _GEN)} + {1'h0, 2'(_GEN_0 + _GEN_3)})});
  wire [7:0] _uops_4_robIdx_diff_T_4 = 8'({1'h0, uops_4_robIdx_new_value} - 8'h30);
  wire       uops_4_robIdx_reverse_flag = $signed(_uops_4_robIdx_diff_T_4) > -8'sh1;
  wire [8:0] _GEN_33 =
  ...
  wire [6:0] uops_5_robIdx_new_value =
    7'(_GEN_4
       + {4'h0,
          3'({1'h0, 2'(_GEN_1 + _GEN)} + {1'h0, 2'(_GEN_0 + 2'(_GEN_3 + _GEN_2))})});
  wire [7:0] _uops_5_robIdx_diff_T_4 = 8'({1'h0, uops_5_robIdx_new_value} - 8'h30);
  wire       uops_5_robIdx_reverse_flag = $signed(_uops_5_robIdx_diff_T_4) > -8'sh1;
  wire [8:0] _GEN_34 =
  ...
  wire [6:0] robIdxHeadNext_new_value = 7'(_GEN_4 + 7'h1);
  wire [7:0] _robIdxHeadNext_diff_T_4 = 8'({1'h0, robIdxHeadNext_new_value} - 8'h30);
  wire       robIdxHeadNext_reverse_flag = $signed(_robIdxHeadNext_diff_T_4) > -8'sh1;
  wire       robIdxHeadNext_new_ptr_flag = robIdxHeadNext_reverse_flag ^ robIdxHead_flag;
  wire [5:0] _robIdxHeadNext_new_ptr_value_T_1 =
    robIdxHeadNext_reverse_flag
      ? _robIdxHeadNext_diff_T_4[5:0]
      : robIdxHeadNext_new_value[5:0];
  wire [6:0] robIdxHeadNext_new_value_1 =
    7'(_GEN_4
       + {4'h0,
          3'({1'h0, 2'(_GEN_1 + 2'(_GEN + _GEN_0))}
             + {1'h0,
                2'(_GEN_3
                   + 2'(_GEN_2 + {1'h0, io_in_5_valid & io_in_5_bits_lastUop}))})});
  wire [7:0] _robIdxHeadNext_diff_T_10 = 8'({1'h0, robIdxHeadNext_new_value_1} - 8'h30);
  wire       robIdxHeadNext_reverse_flag_1 = $signed(_robIdxHeadNext_diff_T_10) > -8'sh1;
  wire [5:0] _robIdxHeadNext_new_ptr_value_T_3 =
    robIdxHeadNext_reverse_flag_1
      ? _robIdxHeadNext_diff_T_10[5:0]
      : robIdxHeadNext_new_value_1[5:0];
  wire       _robIdxHeadNext_T_flag =
    canOut & robIdxHeadNext_reverse_flag_1 ^ robIdxHead_flag;
  wire [5:0] robIdxHeadNext_value =
    io_redirect_valid
  ...
  wire [5:0] _notInSameSnpt_T_5 =
    6'(6'(robIdxHeadNext_value - 6'h10) - io_snptLastEnq_bits_value);
  wire [5:0] _notInSameSnpt_T_1 = 6'(robIdxHeadNext_value - io_snptLastEnq_bits_value);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      robIdxHead_flag <= 1'h0;
      robIdxHead_value <= 6'h0;
      ...
      notInSameSnpt_last_REG <=
        ((io_redirect_valid
           ...
           ? _notInSameSnpt_T_1[5]
           : _notInSameSnpt_T_5[5]) | ~io_snptLastEnq_valid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        robIdxHead_value = _RANDOM[6'h0][6:1];
        lastCycleMisprediction_last_REG = _RANDOM[6'h0][7];
        lastCycleCreateSnpt = _RANDOM[6'hC][8];
        notInSameSnpt_last_REG = _RANDOM[6'hC][9];
        intFreeList_io_freePhyReg_0_REG = _RANDOM[6'hC][17:10];
        fpFreeList_io_freeReq_0_last_REG = _RANDOM[6'hC][18];
        vecFreeList_io_freeReq_0_last_REG = _RANDOM[6'hC][19];
        v0FreeList_io_freeReq_0_last_REG = _RANDOM[6'hC][20];
        vlFreeList_io_freeReq_0_last_REG = _RANDOM[6'hC][21];
        intFreeList_io_freePhyReg_1_REG = _RANDOM[6'hC][29:22];
        fpFreeList_io_freeReq_1_last_REG = _RANDOM[6'hC][30];
        vecFreeList_io_freeReq_1_last_REG = _RANDOM[6'hC][31];
        v0FreeList_io_freeReq_1_last_REG = _RANDOM[6'hD][0];
        vlFreeList_io_freeReq_1_last_REG = _RANDOM[6'hD][1];
        intFreeList_io_freePhyReg_2_REG = _RANDOM[6'hD][9:2];
        fpFreeList_io_freeReq_2_last_REG = _RANDOM[6'hD][10];
        vecFreeList_io_freeReq_2_last_REG = _RANDOM[6'hD][11];
        v0FreeList_io_freeReq_2_last_REG = _RANDOM[6'hD][12];
        vlFreeList_io_freeReq_2_last_REG = _RANDOM[6'hD][13];
        intFreeList_io_freePhyReg_3_REG = _RANDOM[6'hD][21:14];
        fpFreeList_io_freeReq_3_last_REG = _RANDOM[6'hD][22];
        vecFreeList_io_freeReq_3_last_REG = _RANDOM[6'hD][23];
        v0FreeList_io_freeReq_3_last_REG = _RANDOM[6'hD][24];
        vlFreeList_io_freeReq_3_last_REG = _RANDOM[6'hD][25];
        intFreeList_io_freePhyReg_4_REG = {_RANDOM[6'hD][31:26], _RANDOM[6'hE][1:0]};
        fpFreeList_io_freeReq_4_last_REG = _RANDOM[6'hE][2];
        vecFreeList_io_freeReq_4_last_REG = _RANDOM[6'hE][3];
        v0FreeList_io_freeReq_4_last_REG = _RANDOM[6'hE][4];
        vlFreeList_io_freeReq_4_last_REG = _RANDOM[6'hE][5];
        intFreeList_io_freePhyReg_5_REG = _RANDOM[6'hE][13:6];
        fpFreeList_io_freeReq_5_last_REG = _RANDOM[6'hE][14];
        vecFreeList_io_freeReq_5_last_REG = _RANDOM[6'hE][15];
        v0FreeList_io_freeReq_5_last_REG = _RANDOM[6'hE][16];
        vlFreeList_io_freeReq_5_last_REG = _RANDOM[6'hE][17];
        io_perf_0_value_REG = _RANDOM[6'h1D][16:14];
        io_perf_0_value_REG_1 = _RANDOM[6'h1D][19:17];
        io_perf_1_value_REG = _RANDOM[6'h1D][22:20];
        io_perf_1_value_REG_1 = _RANDOM[6'h1D][25:23];
        io_perf_2_value_REG = _RANDOM[6'h1D][26];
        io_perf_2_value_REG_1 = _RANDOM[6'h1D][27];
        io_perf_3_value_REG = _RANDOM[6'h1D][28];
        io_perf_3_value_REG_1 = _RANDOM[6'h1D][29];
        io_perf_4_value_REG = _RANDOM[6'h1D][30];
        io_perf_4_value_REG_1 = _RANDOM[6'h1D][31];
        io_perf_5_value_REG = _RANDOM[6'h1E][0];
        io_perf_5_value_REG_1 = _RANDOM[6'h1E][1];
        io_perf_6_value_REG = _RANDOM[6'h1E][2];
        io_perf_6_value_REG_1 = _RANDOM[6'h1E][3];
        io_perf_7_value_REG = _RANDOM[6'h1E][4];
        io_perf_7_value_REG_1 = _RANDOM[6'h1E][5];
        io_perf_8_value_REG = _RANDOM[6'h1E][6];
        io_perf_8_value_REG_1 = _RANDOM[6'h1E][7];
        io_perf_9_value_REG = _RANDOM[6'h1E][8];
        io_perf_9_value_REG_1 = _RANDOM[6'h1E][9];
        io_perf_10_value_REG = _RANDOM[6'h1E][15:10];
        io_perf_10_value_REG_1 = _RANDOM[6'h1E][21:16];
        io_perf_11_value_REG = _RANDOM[6'h1E][27:22];
        io_perf_11_value_REG_1 = {_RANDOM[6'h1E][31:28], _RANDOM[6'h1F][1:0]};
        io_perf_12_value_REG = _RANDOM[6'h1F][7:2];
        io_perf_12_value_REG_1 = _RANDOM[6'h1F][13:8];
        io_perf_13_value_REG = _RANDOM[6'h1F][19:14];
        io_perf_13_value_REG_1 = _RANDOM[6'h1F][25:20];
        io_perf_14_value_REG = _RANDOM[6'h1F][31:26];
        io_perf_14_value_REG_1 = _RANDOM[6'h20][5:0];
        io_perf_15_value_REG = _RANDOM[6'h20][11:6];
        io_perf_15_value_REG_1 = _RANDOM[6'h20][17:12];
        io_perf_16_value_REG = _RANDOM[6'h20][23:18];
        io_perf_16_value_REG_1 = _RANDOM[6'h20][29:24];
        io_perf_17_value_REG = {_RANDOM[6'h20][31:30], _RANDOM[6'h21][3:0]};
        io_perf_17_value_REG_1 = _RANDOM[6'h21][9:4];
        io_perf_18_value_REG = _RANDOM[6'h21][15:10];
        io_perf_18_value_REG_1 = _RANDOM[6'h21][21:16];
        io_perf_19_value_REG = _RANDOM[6'h21][27:22];
        io_perf_19_value_REG_1 = {_RANDOM[6'h21][31:28], _RANDOM[6'h22][1:0]};
        io_perf_20_value_REG = _RANDOM[6'h22][7:2];
        io_perf_20_value_REG_1 = _RANDOM[6'h22][13:8];
        io_perf_21_value_REG = _RANDOM[6'h22][19:14];
        io_perf_21_value_REG_1 = _RANDOM[6'h22][25:20];
        io_perf_22_value_REG = _RANDOM[6'h22][31:26];
        io_perf_22_value_REG_1 = _RANDOM[6'h23][5:0];
        io_perf_23_value_REG = _RANDOM[6'h23][11:6];
        io_perf_23_value_REG_1 = _RANDOM[6'h23][17:12];
        io_perf_24_value_REG = _RANDOM[6'h23][23:18];
        io_perf_24_value_REG_1 = _RANDOM[6'h23][29:24];
        io_perf_25_value_REG = {_RANDOM[6'h23][31:30], _RANDOM[6'h24][3:0]};
        io_perf_25_value_REG_1 = _RANDOM[6'h24][9:4];
        io_perf_26_value_REG = _RANDOM[6'h24][15:10];
        io_perf_26_value_REG_1 = _RANDOM[6'h24][21:16];
        io_perf_27_value_REG = _RANDOM[6'h24][27:22];
        io_perf_27_value_REG_1 = {_RANDOM[6'h24][31:28], _RANDOM[6'h25][1:0]};
        io_perf_28_value_REG = _RANDOM[6'h25][7:2];
        io_perf_28_value_REG_1 = _RANDOM[6'h25][13:8];
        io_perf_29_value_REG = _RANDOM[6'h25][19:14];
        io_perf_29_value_REG_1 = _RANDOM[6'h25][25:20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        robIdxHead_flag = 1'h0;
        robIdxHead_value = 6'h0;
  ...
  assign io_out_0_bits_instr = io_in_0_bits_instr;
  ...
  assign io_out_0_bits_exceptionVec_4 = io_in_0_bits_exceptionVec_4;
  assign io_out_0_bits_exceptionVec_5 = io_in_0_bits_exceptionVec_5;
  assign io_out_0_bits_exceptionVec_6 = io_in_0_bits_exceptionVec_6;
  assign io_out_0_bits_exceptionVec_7 = io_in_0_bits_exceptionVec_7;
  assign io_out_0_bits_exceptionVec_8 = io_in_0_bits_exceptionVec_8;
  assign io_out_0_bits_exceptionVec_9 = io_in_0_bits_exceptionVec_9;
  assign io_out_0_bits_exceptionVec_10 = io_in_0_bits_exceptionVec_10;
  assign io_out_0_bits_exceptionVec_11 = io_in_0_bits_exceptionVec_11;
  assign io_out_0_bits_exceptionVec_12 = io_in_0_bits_exceptionVec_12;
  assign io_out_0_bits_exceptionVec_13 = io_in_0_bits_exceptionVec_13;
  assign io_out_0_bits_exceptionVec_14 = io_in_0_bits_exceptionVec_14;
  assign io_out_0_bits_exceptionVec_15 = io_in_0_bits_exceptionVec_15;
  assign io_out_0_bits_exceptionVec_16 = io_in_0_bits_exceptionVec_16;
  assign io_out_0_bits_exceptionVec_17 = io_in_0_bits_exceptionVec_17;
  assign io_out_0_bits_exceptionVec_18 = io_in_0_bits_exceptionVec_18;
  assign io_out_0_bits_exceptionVec_19 = io_in_0_bits_exceptionVec_19;
  assign io_out_0_bits_exceptionVec_20 = io_in_0_bits_exceptionVec_20;
  assign io_out_0_bits_exceptionVec_21 = io_in_0_bits_exceptionVec_21;
  assign io_out_0_bits_exceptionVec_22 = io_in_0_bits_exceptionVec_22;
  assign io_out_0_bits_exceptionVec_23 = io_in_0_bits_exceptionVec_23;
  assign io_out_0_bits_isFetchMalAddr = io_in_0_bits_isFetchMalAddr;
  assign io_out_0_bits_hasException = (|_GEN_29) | io_in_0_bits_trigger == 4'h1;
  ...
  assign io_out_0_bits_isXSTrap = io_in_0_bits_isXSTrap;
  assign io_out_0_bits_waitForward =
    io_in_0_bits_waitForward
    & ~(isCsrr_0
        & ~(io_in_0_bits_instr[31:20] == 12'h25C | io_in_0_bits_instr[31:20] == 12'h15C
            | io_in_0_bits_instr[31:20] == 12'h35C | io_in_0_bits_instr[31:20] == 12'hEB0
            | io_in_0_bits_instr[31:20] == 12'hDB0 | io_in_0_bits_instr[31:20] == 12'hFB0
            | io_in_0_bits_instr[31:20] == 12'h251 | io_in_0_bits_instr[31:20] == 12'h151
            | io_in_0_bits_instr[31:20] == 12'h351 | io_in_0_bits_instr[31:20] == 12'hC21
            | io_in_0_bits_instr[31:20] == 12'h7B0 | io_in_0_bits_instr[31:20] == 12'h744
            | io_in_0_bits_instr[31:20] == 12'h600 | io_in_0_bits_instr[31:20] == 12'h300
            | io_in_0_bits_instr[31:20] == 12'h200 | io_in_0_bits_instr[31:20] == 12'h100
            | io_in_0_bits_instr[31:20] == 12'h8 | io_in_0_bits_instr[31:20] == 12'hF
            | io_in_0_bits_instr[31:20] == 12'h9 | io_in_0_bits_instr[31:20] == 12'h3)
        & io_in_0_bits_instr[31:20] != 12'h1);
  assign io_out_0_bits_blockBackward =
    io_in_0_bits_blockBackward
    & ~(isCsrr_0
        & ~(io_in_0_bits_instr[31:20] == 12'h25C | io_in_0_bits_instr[31:20] == 12'h15C
            | io_in_0_bits_instr[31:20] == 12'h35C | io_in_0_bits_instr[31:20] == 12'hEB0
            | io_in_0_bits_instr[31:20] == 12'hDB0 | io_in_0_bits_instr[31:20] == 12'hFB0
            | io_in_0_bits_instr[31:20] == 12'h251 | io_in_0_bits_instr[31:20] == 12'h151)
        & io_in_0_bits_instr[31:20] != 12'h351);
  ...
  assign io_out_0_bits_wfflags = io_in_0_bits_wfflags;
  ...
  assign io_out_0_bits_lastUop = io_in_0_bits_lastUop;
  assign io_out_0_bits_numWB =
    isMove_0 | (|_GEN_29) | io_in_0_bits_trigger == 4'h1 ? 7'h0 : io_in_0_bits_numWB;
  ...
  assign io_out_0_bits_robIdx_value =
    uops_0_robIdx_reverse_flag ? _uops_0_robIdx_diff_T_4[5:0] : robIdxHead_value;
  assign io_out_0_bits_dirtyFs = io_in_0_bits_fpWen;
  assign io_out_0_bits_dirtyVs =
    (|io_in_0_bits_uopSplitType)
    & ~(io_in_0_bits_uopSplitType == 6'h35 | io_in_0_bits_uopSplitType == 6'h36
        | io_in_0_bits_uopSplitType == 6'h37)
    & ~(io_in_0_bits_fuType[24] & io_in_0_bits_fuOpType == 9'h11 | io_in_0_bits_fuType[18]
        & io_in_0_bits_fuOpType == 9'h4B | io_in_0_bits_fuType[18]
        & io_in_0_bits_fuOpType == 9'h4C | io_in_0_bits_fuType[18]
        & io_in_0_bits_fuOpType == 9'h53);
  ...
  assign io_out_0_bits_traceBlockInPipe_iretire =
    {1'h0,
     3'({1'h0, io_in_0_bits_commitType[2] ? halfWordNumVec_1 : 2'h0}
        + {1'h0, io_in_0_bits_preDecodeInfo_isRVC ? 2'h1 : 2'h2})};
  ...
  assign io_out_0_bits_numLsElem =
    io_in_0_valid & isVlsType_0 & ~(io_in_0_bits_vpu_isVleff & io_in_0_bits_lastUop)
      ? (isVlsType_0 & ~(|(io_in_0_bits_fuOpType[6:5]))
         & (io_in_0_bits_fuOpType[8] ^ io_in_0_bits_fuOpType[7])
           ...
           : (instType_0 == 3'h0
             ...
             | (instType_0 == 3'h1
                  ? ($signed(emul_0) > $signed(io_in_0_bits_vpu_vlmul)
                       ? {_GEN_5, &emul_0, _numLsElem_T_158, _numLsElem_T_157, 1'h0}
                         >> _GEN_6
                       : {_GEN_7,
                          &io_in_0_bits_vpu_vlmul,
                          _numLsElem_T_114,
  ...
  assign io_out_1_bits_instr = io_in_1_bits_instr;
  ...
  assign io_out_1_bits_exceptionVec_4 = io_in_1_bits_exceptionVec_4;
  assign io_out_1_bits_exceptionVec_5 = io_in_1_bits_exceptionVec_5;
  assign io_out_1_bits_exceptionVec_6 = io_in_1_bits_exceptionVec_6;
  assign io_out_1_bits_exceptionVec_7 = io_in_1_bits_exceptionVec_7;
  assign io_out_1_bits_exceptionVec_8 = io_in_1_bits_exceptionVec_8;
  assign io_out_1_bits_exceptionVec_9 = io_in_1_bits_exceptionVec_9;
  assign io_out_1_bits_exceptionVec_10 = io_in_1_bits_exceptionVec_10;
  assign io_out_1_bits_exceptionVec_11 = io_in_1_bits_exceptionVec_11;
  assign io_out_1_bits_exceptionVec_12 = io_in_1_bits_exceptionVec_12;
  assign io_out_1_bits_exceptionVec_13 = io_in_1_bits_exceptionVec_13;
  assign io_out_1_bits_exceptionVec_14 = io_in_1_bits_exceptionVec_14;
  assign io_out_1_bits_exceptionVec_15 = io_in_1_bits_exceptionVec_15;
  assign io_out_1_bits_exceptionVec_16 = io_in_1_bits_exceptionVec_16;
  assign io_out_1_bits_exceptionVec_17 = io_in_1_bits_exceptionVec_17;
  assign io_out_1_bits_exceptionVec_18 = io_in_1_bits_exceptionVec_18;
  assign io_out_1_bits_exceptionVec_19 = io_in_1_bits_exceptionVec_19;
  assign io_out_1_bits_exceptionVec_20 = io_in_1_bits_exceptionVec_20;
  assign io_out_1_bits_exceptionVec_21 = io_in_1_bits_exceptionVec_21;
  assign io_out_1_bits_exceptionVec_22 = io_in_1_bits_exceptionVec_22;
  assign io_out_1_bits_exceptionVec_23 = io_in_1_bits_exceptionVec_23;
  assign io_out_1_bits_isFetchMalAddr = io_in_1_bits_isFetchMalAddr;
  assign io_out_1_bits_hasException = (|_GEN_30) | io_in_1_bits_trigger == 4'h1;
  ...
  assign io_out_1_bits_ftqPtr_flag = io_in_1_bits_ftqPtr_flag;
  assign io_out_1_bits_ftqPtr_value = io_in_1_bits_ftqPtr_value;
  assign io_out_1_bits_ftqOffset = io_in_1_bits_ftqOffset;
  ...
  assign io_out_1_bits_isXSTrap = io_in_1_bits_isXSTrap;
  assign io_out_1_bits_waitForward =
    io_in_1_bits_waitForward
    & ~(isCsrr_1
        & ~(io_in_1_bits_instr[31:20] == 12'h25C | io_in_1_bits_instr[31:20] == 12'h15C
            | io_in_1_bits_instr[31:20] == 12'h35C | io_in_1_bits_instr[31:20] == 12'hEB0
            | io_in_1_bits_instr[31:20] == 12'hDB0 | io_in_1_bits_instr[31:20] == 12'hFB0
            | io_in_1_bits_instr[31:20] == 12'h251 | io_in_1_bits_instr[31:20] == 12'h151
            | io_in_1_bits_instr[31:20] == 12'h351 | io_in_1_bits_instr[31:20] == 12'hC21
            | io_in_1_bits_instr[31:20] == 12'h7B0 | io_in_1_bits_instr[31:20] == 12'h744
            | io_in_1_bits_instr[31:20] == 12'h600 | io_in_1_bits_instr[31:20] == 12'h300
            | io_in_1_bits_instr[31:20] == 12'h200 | io_in_1_bits_instr[31:20] == 12'h100
            | io_in_1_bits_instr[31:20] == 12'h8 | io_in_1_bits_instr[31:20] == 12'hF
            | io_in_1_bits_instr[31:20] == 12'h9 | io_in_1_bits_instr[31:20] == 12'h3)
        & io_in_1_bits_instr[31:20] != 12'h1);
  assign io_out_1_bits_blockBackward =
    io_in_1_bits_blockBackward
    & ~(isCsrr_1
        & ~(io_in_1_bits_instr[31:20] == 12'h25C | io_in_1_bits_instr[31:20] == 12'h15C
            | io_in_1_bits_instr[31:20] == 12'h35C | io_in_1_bits_instr[31:20] == 12'hEB0
            | io_in_1_bits_instr[31:20] == 12'hDB0 | io_in_1_bits_instr[31:20] == 12'hFB0
            | io_in_1_bits_instr[31:20] == 12'h251 | io_in_1_bits_instr[31:20] == 12'h151)
        & io_in_1_bits_instr[31:20] != 12'h351);
  ...
  assign io_out_1_bits_wfflags = io_in_1_bits_wfflags;
  ...
  assign io_out_1_bits_firstUop = io_in_1_bits_firstUop;
  assign io_out_1_bits_lastUop = io_in_1_bits_lastUop;
  assign io_out_1_bits_numWB =
    isMove_1 | (|_GEN_30) | io_in_1_bits_trigger == 4'h1 ? 7'h0 : io_in_1_bits_numWB;
  ...
  assign io_out_1_bits_robIdx_value =
    uops_1_robIdx_reverse_flag
      ? _uops_1_robIdx_diff_T_4[5:0]
      : uops_1_robIdx_new_value[5:0];
  assign io_out_1_bits_dirtyFs = io_in_1_bits_fpWen;
  assign io_out_1_bits_dirtyVs =
    (|io_in_1_bits_uopSplitType)
    & ~(io_in_1_bits_uopSplitType == 6'h35 | io_in_1_bits_uopSplitType == 6'h36
        | io_in_1_bits_uopSplitType == 6'h37)
    & ~(io_in_1_bits_fuType[24] & io_in_1_bits_fuOpType == 9'h11 | io_in_1_bits_fuType[18]
        & io_in_1_bits_fuOpType == 9'h4B | io_in_1_bits_fuType[18]
        & io_in_1_bits_fuOpType == 9'h4C | io_in_1_bits_fuType[18]
        & io_in_1_bits_fuOpType == 9'h53);
  ...
  assign io_out_1_bits_numLsElem =
    io_in_1_valid & isVlsType_1 & ~(io_in_1_bits_vpu_isVleff & io_in_1_bits_lastUop)
      ? (isVlsType_1 & ~(|(io_in_1_bits_fuOpType[6:5]))
         & (io_in_1_bits_fuOpType[8] ^ io_in_1_bits_fuOpType[7])
           ...
           : (instType_1 == 3'h0
             ...
             | (instType_1 == 3'h1
                  ? ($signed(emul_1) > $signed(io_in_1_bits_vpu_vlmul)
                       ? {_GEN_9, &emul_1, _numLsElem_T_359, _numLsElem_T_358, 1'h0}
                         >> _GEN_10
                       : {_GEN_11,
                          &io_in_1_bits_vpu_vlmul,
                          _numLsElem_T_315,
  ...
  assign io_out_2_bits_instr = io_in_2_bits_instr;
  ...
  assign io_out_2_bits_exceptionVec_4 = io_in_2_bits_exceptionVec_4;
  assign io_out_2_bits_exceptionVec_5 = io_in_2_bits_exceptionVec_5;
  assign io_out_2_bits_exceptionVec_6 = io_in_2_bits_exceptionVec_6;
  assign io_out_2_bits_exceptionVec_7 = io_in_2_bits_exceptionVec_7;
  assign io_out_2_bits_exceptionVec_8 = io_in_2_bits_exceptionVec_8;
  assign io_out_2_bits_exceptionVec_9 = io_in_2_bits_exceptionVec_9;
  assign io_out_2_bits_exceptionVec_10 = io_in_2_bits_exceptionVec_10;
  assign io_out_2_bits_exceptionVec_11 = io_in_2_bits_exceptionVec_11;
  assign io_out_2_bits_exceptionVec_12 = io_in_2_bits_exceptionVec_12;
  assign io_out_2_bits_exceptionVec_13 = io_in_2_bits_exceptionVec_13;
  assign io_out_2_bits_exceptionVec_14 = io_in_2_bits_exceptionVec_14;
  assign io_out_2_bits_exceptionVec_15 = io_in_2_bits_exceptionVec_15;
  assign io_out_2_bits_exceptionVec_16 = io_in_2_bits_exceptionVec_16;
  assign io_out_2_bits_exceptionVec_17 = io_in_2_bits_exceptionVec_17;
  assign io_out_2_bits_exceptionVec_18 = io_in_2_bits_exceptionVec_18;
  assign io_out_2_bits_exceptionVec_19 = io_in_2_bits_exceptionVec_19;
  assign io_out_2_bits_exceptionVec_20 = io_in_2_bits_exceptionVec_20;
  assign io_out_2_bits_exceptionVec_21 = io_in_2_bits_exceptionVec_21;
  assign io_out_2_bits_exceptionVec_22 = io_in_2_bits_exceptionVec_22;
  assign io_out_2_bits_exceptionVec_23 = io_in_2_bits_exceptionVec_23;
  assign io_out_2_bits_isFetchMalAddr = io_in_2_bits_isFetchMalAddr;
  assign io_out_2_bits_hasException = (|_GEN_31) | io_in_2_bits_trigger == 4'h1;
  ...
  assign io_out_2_bits_ftqPtr_flag = io_in_2_bits_ftqPtr_flag;
  assign io_out_2_bits_ftqPtr_value = io_in_2_bits_ftqPtr_value;
  assign io_out_2_bits_ftqOffset = io_in_2_bits_ftqOffset;
  ...
  assign io_out_2_bits_isXSTrap = io_in_2_bits_isXSTrap;
  assign io_out_2_bits_waitForward =
    io_in_2_bits_waitForward
    & ~(isCsrr_2
        & ~(io_in_2_bits_instr[31:20] == 12'h25C | io_in_2_bits_instr[31:20] == 12'h15C
            | io_in_2_bits_instr[31:20] == 12'h35C | io_in_2_bits_instr[31:20] == 12'hEB0
            | io_in_2_bits_instr[31:20] == 12'hDB0 | io_in_2_bits_instr[31:20] == 12'hFB0
            | io_in_2_bits_instr[31:20] == 12'h251 | io_in_2_bits_instr[31:20] == 12'h151
            | io_in_2_bits_instr[31:20] == 12'h351 | io_in_2_bits_instr[31:20] == 12'hC21
            | io_in_2_bits_instr[31:20] == 12'h7B0 | io_in_2_bits_instr[31:20] == 12'h744
            | io_in_2_bits_instr[31:20] == 12'h600 | io_in_2_bits_instr[31:20] == 12'h300
            | io_in_2_bits_instr[31:20] == 12'h200 | io_in_2_bits_instr[31:20] == 12'h100
            | io_in_2_bits_instr[31:20] == 12'h8 | io_in_2_bits_instr[31:20] == 12'hF
            | io_in_2_bits_instr[31:20] == 12'h9 | io_in_2_bits_instr[31:20] == 12'h3)
        & io_in_2_bits_instr[31:20] != 12'h1);
  assign io_out_2_bits_blockBackward =
    io_in_2_bits_blockBackward
    & ~(isCsrr_2
        & ~(io_in_2_bits_instr[31:20] == 12'h25C | io_in_2_bits_instr[31:20] == 12'h15C
            | io_in_2_bits_instr[31:20] == 12'h35C | io_in_2_bits_instr[31:20] == 12'hEB0
            | io_in_2_bits_instr[31:20] == 12'hDB0 | io_in_2_bits_instr[31:20] == 12'hFB0
            | io_in_2_bits_instr[31:20] == 12'h251 | io_in_2_bits_instr[31:20] == 12'h151)
        & io_in_2_bits_instr[31:20] != 12'h351);
  ...
  assign io_out_2_bits_wfflags = io_in_2_bits_wfflags;
  ...
  assign io_out_2_bits_firstUop = io_in_2_bits_firstUop;
  assign io_out_2_bits_lastUop = io_in_2_bits_lastUop;
  assign io_out_2_bits_numWB =
    isMove_2 | (|_GEN_31) | io_in_2_bits_trigger == 4'h1 ? 7'h0 : io_in_2_bits_numWB;
  ...
  assign io_out_2_bits_robIdx_value =
    uops_2_robIdx_reverse_flag
      ? _uops_2_robIdx_diff_T_4[5:0]
      : uops_2_robIdx_new_value[5:0];
  assign io_out_2_bits_dirtyFs = io_in_2_bits_fpWen;
  assign io_out_2_bits_dirtyVs =
    (|io_in_2_bits_uopSplitType)
    & ~(io_in_2_bits_uopSplitType == 6'h35 | io_in_2_bits_uopSplitType == 6'h36
        | io_in_2_bits_uopSplitType == 6'h37)
    & ~(io_in_2_bits_fuType[24] & io_in_2_bits_fuOpType == 9'h11 | io_in_2_bits_fuType[18]
        & io_in_2_bits_fuOpType == 9'h4B | io_in_2_bits_fuType[18]
        & io_in_2_bits_fuOpType == 9'h4C | io_in_2_bits_fuType[18]
        & io_in_2_bits_fuOpType == 9'h53);
  ...
  assign io_out_2_bits_numLsElem =
    io_in_2_valid & isVlsType_2 & ~(io_in_2_bits_vpu_isVleff & io_in_2_bits_lastUop)
      ? (isVlsType_2 & ~(|(io_in_2_bits_fuOpType[6:5]))
         & (io_in_2_bits_fuOpType[8] ^ io_in_2_bits_fuOpType[7])
           ...
           : (instType_2 == 3'h0
                ...
                : 5'h0)
             | (instType_2 == 3'h2
                  ? {_GEN_13, &emul_2, _numLsElem_T_560, _numLsElem_T_559, 1'h0}
                    >> _GEN_14
                  : 5'h0)
             | (instType_2 == 3'h1
                  ? ($signed(emul_2) > $signed(io_in_2_bits_vpu_vlmul)
  ...
  assign io_out_3_bits_instr = io_in_3_bits_instr;
  ...
  assign io_out_3_bits_exceptionVec_4 = io_in_3_bits_exceptionVec_4;
  assign io_out_3_bits_exceptionVec_5 = io_in_3_bits_exceptionVec_5;
  assign io_out_3_bits_exceptionVec_6 = io_in_3_bits_exceptionVec_6;
  assign io_out_3_bits_exceptionVec_7 = io_in_3_bits_exceptionVec_7;
  assign io_out_3_bits_exceptionVec_8 = io_in_3_bits_exceptionVec_8;
  assign io_out_3_bits_exceptionVec_9 = io_in_3_bits_exceptionVec_9;
  assign io_out_3_bits_exceptionVec_10 = io_in_3_bits_exceptionVec_10;
  assign io_out_3_bits_exceptionVec_11 = io_in_3_bits_exceptionVec_11;
  assign io_out_3_bits_exceptionVec_12 = io_in_3_bits_exceptionVec_12;
  assign io_out_3_bits_exceptionVec_13 = io_in_3_bits_exceptionVec_13;
  assign io_out_3_bits_exceptionVec_14 = io_in_3_bits_exceptionVec_14;
  assign io_out_3_bits_exceptionVec_15 = io_in_3_bits_exceptionVec_15;
  assign io_out_3_bits_exceptionVec_16 = io_in_3_bits_exceptionVec_16;
  assign io_out_3_bits_exceptionVec_17 = io_in_3_bits_exceptionVec_17;
  assign io_out_3_bits_exceptionVec_18 = io_in_3_bits_exceptionVec_18;
  assign io_out_3_bits_exceptionVec_19 = io_in_3_bits_exceptionVec_19;
  assign io_out_3_bits_exceptionVec_20 = io_in_3_bits_exceptionVec_20;
  assign io_out_3_bits_exceptionVec_21 = io_in_3_bits_exceptionVec_21;
  assign io_out_3_bits_exceptionVec_22 = io_in_3_bits_exceptionVec_22;
  assign io_out_3_bits_exceptionVec_23 = io_in_3_bits_exceptionVec_23;
  assign io_out_3_bits_isFetchMalAddr = io_in_3_bits_isFetchMalAddr;
  assign io_out_3_bits_hasException = (|_GEN_32) | io_in_3_bits_trigger == 4'h1;
  ...
  assign io_out_3_bits_ftqPtr_flag = io_in_3_bits_ftqPtr_flag;
  assign io_out_3_bits_ftqPtr_value = io_in_3_bits_ftqPtr_value;
  assign io_out_3_bits_ftqOffset = io_in_3_bits_ftqOffset;
  ...
  assign io_out_3_bits_isXSTrap = io_in_3_bits_isXSTrap;
  assign io_out_3_bits_waitForward =
    io_in_3_bits_waitForward
    & ~(isCsrr_3
        & ~(io_in_3_bits_instr[31:20] == 12'h25C | io_in_3_bits_instr[31:20] == 12'h15C
            | io_in_3_bits_instr[31:20] == 12'h35C | io_in_3_bits_instr[31:20] == 12'hEB0
            | io_in_3_bits_instr[31:20] == 12'hDB0 | io_in_3_bits_instr[31:20] == 12'hFB0
            | io_in_3_bits_instr[31:20] == 12'h251 | io_in_3_bits_instr[31:20] == 12'h151
            | io_in_3_bits_instr[31:20] == 12'h351 | io_in_3_bits_instr[31:20] == 12'hC21
            | io_in_3_bits_instr[31:20] == 12'h7B0 | io_in_3_bits_instr[31:20] == 12'h744
            | io_in_3_bits_instr[31:20] == 12'h600 | io_in_3_bits_instr[31:20] == 12'h300
            | io_in_3_bits_instr[31:20] == 12'h200 | io_in_3_bits_instr[31:20] == 12'h100
            | io_in_3_bits_instr[31:20] == 12'h8 | io_in_3_bits_instr[31:20] == 12'hF
            | io_in_3_bits_instr[31:20] == 12'h9 | io_in_3_bits_instr[31:20] == 12'h3)
        & io_in_3_bits_instr[31:20] != 12'h1);
  assign io_out_3_bits_blockBackward =
    io_in_3_bits_blockBackward
    & ~(isCsrr_3
        & ~(io_in_3_bits_instr[31:20] == 12'h25C | io_in_3_bits_instr[31:20] == 12'h15C
            | io_in_3_bits_instr[31:20] == 12'h35C | io_in_3_bits_instr[31:20] == 12'hEB0
            | io_in_3_bits_instr[31:20] == 12'hDB0 | io_in_3_bits_instr[31:20] == 12'hFB0
            | io_in_3_bits_instr[31:20] == 12'h251 | io_in_3_bits_instr[31:20] == 12'h151)
        & io_in_3_bits_instr[31:20] != 12'h351);
  ...
  assign io_out_3_bits_wfflags = io_in_3_bits_wfflags;
  ...
  assign io_out_3_bits_firstUop = io_in_3_bits_firstUop;
  assign io_out_3_bits_lastUop = io_in_3_bits_lastUop;
  assign io_out_3_bits_numWB =
    isMove_3 | (|_GEN_32) | io_in_3_bits_trigger == 4'h1 ? 7'h0 : io_in_3_bits_numWB;
  ...
  assign io_out_3_bits_robIdx_value =
    uops_3_robIdx_reverse_flag
      ? _uops_3_robIdx_diff_T_4[5:0]
      : uops_3_robIdx_new_value[5:0];
  assign io_out_3_bits_dirtyFs = io_in_3_bits_fpWen;
  assign io_out_3_bits_dirtyVs =
    (|io_in_3_bits_uopSplitType)
    & ~(io_in_3_bits_uopSplitType == 6'h35 | io_in_3_bits_uopSplitType == 6'h36
        | io_in_3_bits_uopSplitType == 6'h37)
    & ~(io_in_3_bits_fuType[24] & io_in_3_bits_fuOpType == 9'h11 | io_in_3_bits_fuType[18]
        & io_in_3_bits_fuOpType == 9'h4B | io_in_3_bits_fuType[18]
        & io_in_3_bits_fuOpType == 9'h4C | io_in_3_bits_fuType[18]
        & io_in_3_bits_fuOpType == 9'h53);
  ...
  assign io_out_3_bits_numLsElem =
    io_in_3_valid & isVlsType_3 & ~(io_in_3_bits_vpu_isVleff & io_in_3_bits_lastUop)
      ? (isVlsType_3 & ~(|(io_in_3_bits_fuOpType[6:5]))
         & (io_in_3_bits_fuOpType[8] ^ io_in_3_bits_fuOpType[7])
           ...
           : (instType_3 == 3'h0
                ...
                : 5'h0)
             | (instType_3 == 3'h2
                  ? {_GEN_17, &emul_3, _numLsElem_T_761, _numLsElem_T_760, 1'h0}
                    >> _GEN_18
                  : 5'h0)
             | (instType_3 == 3'h1
                  ? ($signed(emul_3) > $signed(io_in_3_bits_vpu_vlmul)
  ...
  assign io_out_4_bits_instr = io_in_4_bits_instr;
  ...
  assign io_out_4_bits_exceptionVec_4 = io_in_4_bits_exceptionVec_4;
  assign io_out_4_bits_exceptionVec_5 = io_in_4_bits_exceptionVec_5;
  assign io_out_4_bits_exceptionVec_6 = io_in_4_bits_exceptionVec_6;
  assign io_out_4_bits_exceptionVec_7 = io_in_4_bits_exceptionVec_7;
  assign io_out_4_bits_exceptionVec_8 = io_in_4_bits_exceptionVec_8;
  assign io_out_4_bits_exceptionVec_9 = io_in_4_bits_exceptionVec_9;
  assign io_out_4_bits_exceptionVec_10 = io_in_4_bits_exceptionVec_10;
  assign io_out_4_bits_exceptionVec_11 = io_in_4_bits_exceptionVec_11;
  assign io_out_4_bits_exceptionVec_12 = io_in_4_bits_exceptionVec_12;
  assign io_out_4_bits_exceptionVec_13 = io_in_4_bits_exceptionVec_13;
  assign io_out_4_bits_exceptionVec_14 = io_in_4_bits_exceptionVec_14;
  assign io_out_4_bits_exceptionVec_15 = io_in_4_bits_exceptionVec_15;
  assign io_out_4_bits_exceptionVec_16 = io_in_4_bits_exceptionVec_16;
  assign io_out_4_bits_exceptionVec_17 = io_in_4_bits_exceptionVec_17;
  assign io_out_4_bits_exceptionVec_18 = io_in_4_bits_exceptionVec_18;
  assign io_out_4_bits_exceptionVec_19 = io_in_4_bits_exceptionVec_19;
  assign io_out_4_bits_exceptionVec_20 = io_in_4_bits_exceptionVec_20;
  assign io_out_4_bits_exceptionVec_21 = io_in_4_bits_exceptionVec_21;
  assign io_out_4_bits_exceptionVec_22 = io_in_4_bits_exceptionVec_22;
  assign io_out_4_bits_exceptionVec_23 = io_in_4_bits_exceptionVec_23;
  assign io_out_4_bits_isFetchMalAddr = io_in_4_bits_isFetchMalAddr;
  assign io_out_4_bits_hasException = (|_GEN_33) | io_in_4_bits_trigger == 4'h1;
  ...
  assign io_out_4_bits_ftqPtr_flag = io_in_4_bits_ftqPtr_flag;
  assign io_out_4_bits_ftqPtr_value = io_in_4_bits_ftqPtr_value;
  assign io_out_4_bits_ftqOffset = io_in_4_bits_ftqOffset;
  ...
  assign io_out_4_bits_isXSTrap = io_in_4_bits_isXSTrap;
  assign io_out_4_bits_waitForward =
    io_in_4_bits_waitForward
    & ~(isCsrr_4
        & ~(io_in_4_bits_instr[31:20] == 12'h25C | io_in_4_bits_instr[31:20] == 12'h15C
            | io_in_4_bits_instr[31:20] == 12'h35C | io_in_4_bits_instr[31:20] == 12'hEB0
            | io_in_4_bits_instr[31:20] == 12'hDB0 | io_in_4_bits_instr[31:20] == 12'hFB0
            | io_in_4_bits_instr[31:20] == 12'h251 | io_in_4_bits_instr[31:20] == 12'h151
            | io_in_4_bits_instr[31:20] == 12'h351 | io_in_4_bits_instr[31:20] == 12'hC21
            | io_in_4_bits_instr[31:20] == 12'h7B0 | io_in_4_bits_instr[31:20] == 12'h744
            | io_in_4_bits_instr[31:20] == 12'h600 | io_in_4_bits_instr[31:20] == 12'h300
            | io_in_4_bits_instr[31:20] == 12'h200 | io_in_4_bits_instr[31:20] == 12'h100
            | io_in_4_bits_instr[31:20] == 12'h8 | io_in_4_bits_instr[31:20] == 12'hF
            | io_in_4_bits_instr[31:20] == 12'h9 | io_in_4_bits_instr[31:20] == 12'h3)
        & io_in_4_bits_instr[31:20] != 12'h1);
  assign io_out_4_bits_blockBackward =
    io_in_4_bits_blockBackward
    & ~(isCsrr_4
        & ~(io_in_4_bits_instr[31:20] == 12'h25C | io_in_4_bits_instr[31:20] == 12'h15C
            | io_in_4_bits_instr[31:20] == 12'h35C | io_in_4_bits_instr[31:20] == 12'hEB0
            | io_in_4_bits_instr[31:20] == 12'hDB0 | io_in_4_bits_instr[31:20] == 12'hFB0
            | io_in_4_bits_instr[31:20] == 12'h251 | io_in_4_bits_instr[31:20] == 12'h151)
        & io_in_4_bits_instr[31:20] != 12'h351);
  ...
  assign io_out_4_bits_wfflags = io_in_4_bits_wfflags;
  ...
  assign io_out_4_bits_firstUop = io_in_4_bits_firstUop;
  assign io_out_4_bits_lastUop = io_in_4_bits_lastUop;
  assign io_out_4_bits_numWB =
    isMove_4 | (|_GEN_33) | io_in_4_bits_trigger == 4'h1 ? 7'h0 : io_in_4_bits_numWB;
  ...
  assign io_out_4_bits_robIdx_value =
    uops_4_robIdx_reverse_flag
      ? _uops_4_robIdx_diff_T_4[5:0]
      : uops_4_robIdx_new_value[5:0];
  assign io_out_4_bits_dirtyFs = io_in_4_bits_fpWen;
  assign io_out_4_bits_dirtyVs =
    (|io_in_4_bits_uopSplitType)
    & ~(io_in_4_bits_uopSplitType == 6'h35 | io_in_4_bits_uopSplitType == 6'h36
        | io_in_4_bits_uopSplitType == 6'h37)
    & ~(io_in_4_bits_fuType[24] & io_in_4_bits_fuOpType == 9'h11 | io_in_4_bits_fuType[18]
        & io_in_4_bits_fuOpType == 9'h4B | io_in_4_bits_fuType[18]
        & io_in_4_bits_fuOpType == 9'h4C | io_in_4_bits_fuType[18]
        & io_in_4_bits_fuOpType == 9'h53);
  ...
  assign io_out_4_bits_numLsElem =
    io_in_4_valid & isVlsType_4 & ~(io_in_4_bits_vpu_isVleff & io_in_4_bits_lastUop)
      ? (isVlsType_4 & ~(|(io_in_4_bits_fuOpType[6:5]))
         & (io_in_4_bits_fuOpType[8] ^ io_in_4_bits_fuOpType[7])
           ...
           : (instType_4 == 3'h0
                ...
                : 5'h0)
             | (instType_4 == 3'h2
                  ? {_GEN_21, &emul_4, _numLsElem_T_962, _numLsElem_T_961, 1'h0}
                    >> _GEN_22
                  : 5'h0)
             | (instType_4 == 3'h1
                  ? ($signed(emul_4) > $signed(io_in_4_bits_vpu_vlmul)
  ...
  assign io_out_5_bits_instr = io_in_5_bits_instr;
  ...
  assign io_out_5_bits_exceptionVec_4 = io_in_5_bits_exceptionVec_4;
  assign io_out_5_bits_exceptionVec_5 = io_in_5_bits_exceptionVec_5;
  assign io_out_5_bits_exceptionVec_6 = io_in_5_bits_exceptionVec_6;
  assign io_out_5_bits_exceptionVec_7 = io_in_5_bits_exceptionVec_7;
  assign io_out_5_bits_exceptionVec_8 = io_in_5_bits_exceptionVec_8;
  assign io_out_5_bits_exceptionVec_9 = io_in_5_bits_exceptionVec_9;
  assign io_out_5_bits_exceptionVec_10 = io_in_5_bits_exceptionVec_10;
  assign io_out_5_bits_exceptionVec_11 = io_in_5_bits_exceptionVec_11;
  assign io_out_5_bits_exceptionVec_12 = io_in_5_bits_exceptionVec_12;
  assign io_out_5_bits_exceptionVec_13 = io_in_5_bits_exceptionVec_13;
  assign io_out_5_bits_exceptionVec_14 = io_in_5_bits_exceptionVec_14;
  assign io_out_5_bits_exceptionVec_15 = io_in_5_bits_exceptionVec_15;
  assign io_out_5_bits_exceptionVec_16 = io_in_5_bits_exceptionVec_16;
  assign io_out_5_bits_exceptionVec_17 = io_in_5_bits_exceptionVec_17;
  assign io_out_5_bits_exceptionVec_18 = io_in_5_bits_exceptionVec_18;
  assign io_out_5_bits_exceptionVec_19 = io_in_5_bits_exceptionVec_19;
  assign io_out_5_bits_exceptionVec_20 = io_in_5_bits_exceptionVec_20;
  assign io_out_5_bits_exceptionVec_21 = io_in_5_bits_exceptionVec_21;
  assign io_out_5_bits_exceptionVec_22 = io_in_5_bits_exceptionVec_22;
  assign io_out_5_bits_exceptionVec_23 = io_in_5_bits_exceptionVec_23;
  assign io_out_5_bits_isFetchMalAddr = io_in_5_bits_isFetchMalAddr;
  assign io_out_5_bits_hasException = (|_GEN_34) | io_in_5_bits_trigger == 4'h1;
  ...
  assign io_out_5_bits_ftqPtr_flag = io_in_5_bits_ftqPtr_flag;
  assign io_out_5_bits_ftqPtr_value = io_in_5_bits_ftqPtr_value;
  assign io_out_5_bits_ftqOffset = io_in_5_bits_ftqOffset;
  ...
  assign io_out_5_bits_isXSTrap = io_in_5_bits_isXSTrap;
  assign io_out_5_bits_waitForward =
    io_in_5_bits_waitForward
    & ~(isCsrr_5
        & ~(io_in_5_bits_instr[31:20] == 12'h25C | io_in_5_bits_instr[31:20] == 12'h15C
            | io_in_5_bits_instr[31:20] == 12'h35C | io_in_5_bits_instr[31:20] == 12'hEB0
            | io_in_5_bits_instr[31:20] == 12'hDB0 | io_in_5_bits_instr[31:20] == 12'hFB0
            | io_in_5_bits_instr[31:20] == 12'h251 | io_in_5_bits_instr[31:20] == 12'h151
            | io_in_5_bits_instr[31:20] == 12'h351 | io_in_5_bits_instr[31:20] == 12'hC21
            | io_in_5_bits_instr[31:20] == 12'h7B0 | io_in_5_bits_instr[31:20] == 12'h744
            | io_in_5_bits_instr[31:20] == 12'h600 | io_in_5_bits_instr[31:20] == 12'h300
            | io_in_5_bits_instr[31:20] == 12'h200 | io_in_5_bits_instr[31:20] == 12'h100
            | io_in_5_bits_instr[31:20] == 12'h8 | io_in_5_bits_instr[31:20] == 12'hF
            | io_in_5_bits_instr[31:20] == 12'h9 | io_in_5_bits_instr[31:20] == 12'h3)
        & io_in_5_bits_instr[31:20] != 12'h1);
  assign io_out_5_bits_blockBackward =
    io_in_5_bits_blockBackward
    & ~(isCsrr_5
        & ~(io_in_5_bits_instr[31:20] == 12'h25C | io_in_5_bits_instr[31:20] == 12'h15C
            | io_in_5_bits_instr[31:20] == 12'h35C | io_in_5_bits_instr[31:20] == 12'hEB0
            | io_in_5_bits_instr[31:20] == 12'hDB0 | io_in_5_bits_instr[31:20] == 12'hFB0
            | io_in_5_bits_instr[31:20] == 12'h251 | io_in_5_bits_instr[31:20] == 12'h151)
        & io_in_5_bits_instr[31:20] != 12'h351);
  ...
  assign io_out_5_bits_wfflags = io_in_5_bits_wfflags;
  ...
  assign io_out_5_bits_firstUop = io_in_5_bits_firstUop;
  assign io_out_5_bits_lastUop = io_in_5_bits_lastUop;
  assign io_out_5_bits_numWB =
    isMove_5 | (|_GEN_34) | io_in_5_bits_trigger == 4'h1 ? 7'h0 : io_in_5_bits_numWB;
  ...
  assign io_out_5_bits_robIdx_value =
    uops_5_robIdx_reverse_flag
      ? _uops_5_robIdx_diff_T_4[5:0]
      : uops_5_robIdx_new_value[5:0];
  assign io_out_5_bits_dirtyFs = io_in_5_bits_fpWen;
  assign io_out_5_bits_dirtyVs =
    (|io_in_5_bits_uopSplitType)
    & ~(io_in_5_bits_uopSplitType == 6'h35 | io_in_5_bits_uopSplitType == 6'h36
        | io_in_5_bits_uopSplitType == 6'h37)
    & ~(io_in_5_bits_fuType[24] & io_in_5_bits_fuOpType == 9'h11 | io_in_5_bits_fuType[18]
        & io_in_5_bits_fuOpType == 9'h4B | io_in_5_bits_fuType[18]
        & io_in_5_bits_fuOpType == 9'h4C | io_in_5_bits_fuType[18]
        & io_in_5_bits_fuOpType == 9'h53);
    ...
    | (&io_in_5_bits_preDecodeInfo_brType)
      ? {(&io_in_5_bits_preDecodeInfo_brType)
        ...
        | {4{uops_5_traceBlockInPipe_itype_isJal
               ...
               & (|io_in_5_bits_ldest)}}
      : 4'h0;
  assign io_out_5_bits_traceBlockInPipe_iretire = {2'h0, halfWordNumVec_5};
  assign io_out_5_bits_traceBlockInPipe_ilastsize = ~io_in_5_bits_preDecodeInfo_isRVC;
  ...
  assign io_out_5_bits_numLsElem =
    io_in_5_valid & isVlsType_5 & ~(io_in_5_bits_vpu_isVleff & io_in_5_bits_lastUop)
      ? (isVlsType_5 & ~(|(io_in_5_bits_fuOpType[6:5]))
         & (io_in_5_bits_fuOpType[8] ^ io_in_5_bits_fuOpType[7])
           ? 5'h2
           : (instType_5 == 3'h0
                ? {_GEN_25, &emul_5, _numLsElem_T_1163, _numLsElem_T_1162, 1'h0}
                  >> _GEN_26
                : 5'h0)
             | (instType_5 == 3'h2
                  ? {_GEN_25, &emul_5, _numLsElem_T_1163, _numLsElem_T_1162, 1'h0}
