...
module ICacheCtrlUnit(
  ...
  output [1:0]  io_metaRead_bits_vSetIdx_0,
  output [1:0]  io_metaRead_bits_vSetIdx_1,
  input  [39:0] io_metaReadResp_metas_0_0_tag,
  input  [39:0] io_metaReadResp_metas_0_1_tag,
  input  [39:0] io_metaReadResp_metas_0_2_tag,
  input  [39:0] io_metaReadResp_metas_0_3_tag,
  ...
  wire [3:0]  waymask =
    {io_metaReadResp_entryValid_0_3
       & io_metaReadResp_metas_0_3_tag == ecciaddr_paddr[47:8],
     io_metaReadResp_entryValid_0_2
       & io_metaReadResp_metas_0_2_tag == ecciaddr_paddr[47:8],
     io_metaReadResp_entryValid_0_1
       & io_metaReadResp_metas_0_1_tag == ecciaddr_paddr[47:8],
     io_metaReadResp_entryValid_0_0
       & io_metaReadResp_metas_0_0_tag == ecciaddr_paddr[47:8]};
  ...
  assign io_metaRead_bits_vSetIdx_0 = ecciaddr_paddr[7:6];
  assign io_metaRead_bits_vSetIdx_1 = ecciaddr_paddr[7:6];
  assign io_metaWrite_valid = io_metaWrite_valid_0;
  assign io_metaWrite_bits_virIdx = ecciaddr_paddr[7:6];
  assign io_metaWrite_bits_phyTag = ecciaddr_paddr[47:8];
  ...
  assign io_dataWrite_bits_virIdx = ecciaddr_paddr[7:6];
