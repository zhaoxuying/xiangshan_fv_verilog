  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_value = _RANDOM[6'h7][20:15];
        bits_1_pdest = _RANDOM[6'h7][31:26];
        bits_1_rfWen = _RANDOM[6'h8][0];
        bits_1_loadDependency_0 = _RANDOM[6'h8][22:21];
        bits_1_loadDependency_1 = _RANDOM[6'h8][24:23];
        bits_1_loadDependency_2 = _RANDOM[6'h8][26:25];
        bits_2_fuType = {_RANDOM[6'h1C][31:28], _RANDOM[6'h1D][30:0]};
        bits_2_robIdx_flag = _RANDOM[6'h24][8];
        bits_2_robIdx_value = _RANDOM[6'h24][14:9];
        bits_2_pdest = _RANDOM[6'h24][25:20];
        bits_2_rfWen = _RANDOM[6'h24][26];
        bits_2_loadDependency_0 = _RANDOM[6'h25][16:15];
        bits_2_loadDependency_1 = _RANDOM[6'h25][18:17];
        bits_2_loadDependency_2 = _RANDOM[6'h25][20:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
