...
module Queue2_TLBundleA_10(
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[18:10];
  assign io_deq_bits_address = _ram_ext_R0_data[66:19];
  assign io_deq_bits_user_amba_prot_bufferable = _ram_ext_R0_data[67];
  assign io_deq_bits_user_amba_prot_modifiable = _ram_ext_R0_data[68];
  assign io_deq_bits_user_amba_prot_readalloc = _ram_ext_R0_data[69];
  assign io_deq_bits_user_amba_prot_writealloc = _ram_ext_R0_data[70];
  assign io_deq_bits_user_amba_prot_privileged = _ram_ext_R0_data[71];
  assign io_deq_bits_user_amba_prot_secure = _ram_ext_R0_data[72];
  assign io_deq_bits_user_amba_prot_fetch = _ram_ext_R0_data[73];
  assign io_deq_bits_echo_blockisdirty = _ram_ext_R0_data[74];
  assign io_deq_bits_mask = _ram_ext_R0_data[106:75];
  assign io_deq_bits_data = _ram_ext_R0_data[362:107];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[363];
endmodule
