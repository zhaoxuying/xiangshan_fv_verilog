  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_fuType_16 = _RANDOM[6'h0][24];
        entryReg_status_fuType_17 = _RANDOM[6'h0][25];
        ...
        entryReg_imm = _RANDOM[6'h2][26:15];
        entryReg_payload_fuOpType = _RANDOM[6'h9][10:2];
        entryReg_payload_rfWen = _RANDOM[6'h9][11];
        entryReg_payload_selImm = _RANDOM[6'h9][24:21];
        entryReg_payload_pdest = _RANDOM[6'h14][23:16];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h2A][17];
        entryReg_payload_sqIdx_value = _RANDOM[6'h2A][22:18];
        enqDelayValidReg_last_REG = _RANDOM[6'h2A][30];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
