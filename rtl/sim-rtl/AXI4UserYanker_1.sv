...
module AXI4UserYanker_1(
  ...
  wire       _Queue1_BundleMap_5_io_deq_bits_extra_id;
  wire       _Queue1_BundleMap_4_io_enq_ready;
  wire       _Queue1_BundleMap_4_io_deq_bits_extra_id;
  wire       _Queue1_BundleMap_3_io_enq_ready;
  wire       _Queue1_BundleMap_3_io_deq_bits_extra_id;
  wire       _Queue2_BundleMap_1_io_enq_ready;
  wire       _Queue2_BundleMap_1_io_deq_bits_extra_id;
  wire       _Queue1_BundleMap_2_io_enq_ready;
  wire       _Queue1_BundleMap_2_io_deq_bits_extra_id;
  wire       _Queue1_BundleMap_1_io_enq_ready;
  wire       _Queue1_BundleMap_1_io_deq_bits_extra_id;
  wire       _Queue1_BundleMap_io_enq_ready;
  wire       _Queue1_BundleMap_io_deq_bits_extra_id;
  wire       _Queue2_BundleMap_io_enq_ready;
  wire       _Queue2_BundleMap_io_deq_bits_extra_id;
  wire [3:0] _GEN =
    {{_Queue1_BundleMap_2_io_enq_ready},
     {_Queue1_BundleMap_1_io_enq_ready},
     {_Queue1_BundleMap_io_enq_ready},
     {_Queue2_BundleMap_io_enq_ready}};
  wire [3:0] _GEN_0 =
    {{_Queue1_BundleMap_2_io_deq_bits_extra_id},
     {_Queue1_BundleMap_1_io_deq_bits_extra_id},
     {_Queue1_BundleMap_io_deq_bits_extra_id},
     {_Queue2_BundleMap_io_deq_bits_extra_id}};
  ...
  wire [3:0] _GEN_3 =
    {{_Queue1_BundleMap_5_io_enq_ready},
     ...
     {_Queue2_BundleMap_1_io_enq_ready}};
  wire [3:0] _GEN_4 =
    {{_Queue1_BundleMap_5_io_deq_bits_extra_id},
     {_Queue1_BundleMap_4_io_deq_bits_extra_id},
     {_Queue1_BundleMap_3_io_deq_bits_extra_id},
     {_Queue2_BundleMap_1_io_deq_bits_extra_id}};
  wire       _GEN_5 = auto_out_b_valid & auto_in_b_ready;
  wire       _GEN_6 = auto_in_aw_valid & auto_out_aw_ready;
  Queue2_BundleMap Queue2_BundleMap (
    .clock                (clock),
    .reset                (reset),
    .io_enq_ready         (_Queue2_BundleMap_io_enq_ready),
    .io_enq_valid         (_GEN_2 & auto_in_ar_bits_id == 2'h0),
    .io_enq_bits_extra_id (auto_in_ar_bits_echo_extra_id),
    .io_deq_ready         (_GEN_1 & auto_out_r_bits_id == 2'h0 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap (
    ...
    .io_enq_valid         (_GEN_2 & auto_in_ar_bits_id == 2'h1),
    .io_enq_bits_extra_id (auto_in_ar_bits_echo_extra_id),
    .io_deq_ready         (_GEN_1 & auto_out_r_bits_id == 2'h1 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_1 (
    ...
    .io_enq_valid         (_GEN_2 & auto_in_ar_bits_id == 2'h2),
    .io_enq_bits_extra_id (auto_in_ar_bits_echo_extra_id),
    .io_deq_ready         (_GEN_1 & auto_out_r_bits_id == 2'h2 & auto_out_r_bits_last),
  ...
  Queue2_BundleMap Queue2_BundleMap_1 (
    .clock                (clock),
    .reset                (reset),
    .io_enq_ready         (_Queue2_BundleMap_1_io_enq_ready),
    .io_enq_valid         (_GEN_6 & auto_in_aw_bits_id == 2'h0),
    .io_enq_bits_extra_id (auto_in_aw_bits_echo_extra_id),
    .io_deq_ready         (_GEN_5 & auto_out_b_bits_id == 2'h0),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_3 (
    ...
    .io_enq_valid         (_GEN_6 & auto_in_aw_bits_id == 2'h1),
    .io_enq_bits_extra_id (auto_in_aw_bits_echo_extra_id),
    .io_deq_ready         (_GEN_5 & auto_out_b_bits_id == 2'h1),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_4 (
    ...
    .io_enq_valid         (_GEN_6 & auto_in_aw_bits_id == 2'h2),
    .io_enq_bits_extra_id (auto_in_aw_bits_echo_extra_id),
    .io_deq_ready         (_GEN_5 & auto_out_b_bits_id == 2'h2),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_5 (
    ...
    .io_enq_valid         (_GEN_6 & (&auto_in_aw_bits_id)),
    .io_enq_bits_extra_id (auto_in_aw_bits_echo_extra_id),
    .io_deq_ready         (_GEN_5 & (&auto_out_b_bits_id)),
  ...
  assign auto_in_b_bits_echo_extra_id = _GEN_4[auto_out_b_bits_id];
