...
module Queue2_TLBundleA_16(
  ...
  assign io_deq_bits_user_amba_prot_bufferable = _ram_ext_R0_data[59];
  assign io_deq_bits_user_amba_prot_modifiable = _ram_ext_R0_data[60];
  assign io_deq_bits_user_amba_prot_readalloc = _ram_ext_R0_data[61];
  assign io_deq_bits_user_amba_prot_writealloc = _ram_ext_R0_data[62];
  assign io_deq_bits_user_amba_prot_privileged = _ram_ext_R0_data[63];
  assign io_deq_bits_user_amba_prot_secure = _ram_ext_R0_data[64];
  assign io_deq_bits_user_amba_prot_fetch = _ram_ext_R0_data[65];
  assign io_deq_bits_mask = _ram_ext_R0_data[97:66];
  assign io_deq_bits_data = _ram_ext_R0_data[353:98];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[354];
endmodule
