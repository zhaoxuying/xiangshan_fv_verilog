...
module SourceB(
  ...
  input         io_task_valid,
  input  [40:0] io_task_bits_tag,
  input         io_task_bits_set,
  ...
  wire [40:0] _issueArb_io_out_bits_tag;
  wire        _issueArb_io_out_bits_set;
  reg         probes_0_valid;
  reg         probes_0_rdy;
  reg  [5:0]  probes_0_waitG;
  reg  [40:0] probes_0_task_tag;
  reg         probes_0_task_set;
  reg  [2:0]  probes_0_task_opcode;
  reg  [1:0]  probes_0_task_param;
  reg         probes_1_valid;
  reg         probes_1_rdy;
  reg  [5:0]  probes_1_waitG;
  reg  [40:0] probes_1_task_tag;
  reg         probes_1_task_set;
  reg  [2:0]  probes_1_task_opcode;
  reg  [1:0]  probes_1_task_param;
  reg         probes_2_valid;
  reg         probes_2_rdy;
  reg  [5:0]  probes_2_waitG;
  reg  [40:0] probes_2_task_tag;
  reg         probes_2_task_set;
  reg  [2:0]  probes_2_task_opcode;
  reg  [1:0]  probes_2_task_param;
  reg         probes_3_valid;
  reg         probes_3_rdy;
  reg  [5:0]  probes_3_waitG;
  reg  [40:0] probes_3_task_tag;
  reg         probes_3_task_set;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      probes_0_rdy <= 1'h0;
      probes_0_waitG <= 6'h0;
      probes_0_task_tag <= 41'h0;
      probes_0_task_set <= 1'h0;
      probes_0_task_opcode <= 3'h0;
      probes_0_task_param <= 2'h0;
      probes_1_valid <= 1'h0;
      probes_1_rdy <= 1'h0;
      probes_1_waitG <= 6'h0;
      probes_1_task_tag <= 41'h0;
      probes_1_task_set <= 1'h0;
      probes_1_task_opcode <= 3'h0;
      probes_1_task_param <= 2'h0;
      probes_2_valid <= 1'h0;
      probes_2_rdy <= 1'h0;
      probes_2_waitG <= 6'h0;
      probes_2_task_tag <= 41'h0;
      probes_2_task_set <= 1'h0;
      probes_2_task_opcode <= 3'h0;
      probes_2_task_param <= 2'h0;
      probes_3_valid <= 1'h0;
      probes_3_rdy <= 1'h0;
      probes_3_waitG <= 6'h0;
      probes_3_task_tag <= 41'h0;
      probes_3_task_set <= 1'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        probes_0_waitG = _RANDOM[3'h0][7:2];
        probes_0_task_tag = {_RANDOM[3'h0][31:8], _RANDOM[3'h1][16:0]};
        probes_0_task_set = _RANDOM[3'h1][17];
        probes_0_task_opcode = _RANDOM[3'h1][26:24];
        probes_0_task_param = _RANDOM[3'h1][28:27];
        probes_1_valid = _RANDOM[3'h1][29];
        probes_1_rdy = _RANDOM[3'h1][30];
        probes_1_waitG = {_RANDOM[3'h1][31], _RANDOM[3'h2][4:0]};
        probes_1_task_tag = {_RANDOM[3'h2][31:5], _RANDOM[3'h3][13:0]};
        probes_1_task_set = _RANDOM[3'h3][14];
        probes_1_task_opcode = _RANDOM[3'h3][23:21];
        probes_1_task_param = _RANDOM[3'h3][25:24];
        probes_2_valid = _RANDOM[3'h3][26];
        probes_2_rdy = _RANDOM[3'h3][27];
        probes_2_waitG = {_RANDOM[3'h3][31:28], _RANDOM[3'h4][1:0]};
        probes_2_task_tag = {_RANDOM[3'h4][31:2], _RANDOM[3'h5][10:0]};
        probes_2_task_set = _RANDOM[3'h5][11];
        probes_2_task_opcode = _RANDOM[3'h5][20:18];
        probes_2_task_param = _RANDOM[3'h5][22:21];
        probes_3_valid = _RANDOM[3'h5][23];
        probes_3_rdy = _RANDOM[3'h5][24];
        probes_3_waitG = _RANDOM[3'h5][30:25];
        probes_3_task_tag = {_RANDOM[3'h5][31], _RANDOM[3'h6], _RANDOM[3'h7][7:0]};
        probes_3_task_set = _RANDOM[3'h7][8];
        probes_3_task_opcode = _RANDOM[3'h7][17:15];
        probes_3_task_param = _RANDOM[3'h7][19:18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        probes_0_valid = 1'h0;
        probes_0_rdy = 1'h0;
