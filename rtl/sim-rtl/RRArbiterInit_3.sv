...
module RRArbiterInit_3(
  ...
  wire [7:0][4:0]  _GEN = '{5'h7, 5'h6, 5'h5, 5'h4, 5'h3, 5'h2, 5'h1, 5'h0};
  wire [7:0]       _GEN_0 =
    {{io_in_7_valid},
     {io_in_6_valid},
     {io_in_5_valid},
  ...
  wire             ctrl_validMask_grantMask_2 = ctrl_validMask_grantMask_lastGrant < 3'h2;
  wire             ctrl_validMask_grantMask_3 = ctrl_validMask_grantMask_lastGrant < 3'h3;
  wire             ctrl_validMask_grantMask_5 = ctrl_validMask_grantMask_lastGrant < 3'h5;
  wire             ctrl_validMask_grantMask_6 =
    ctrl_validMask_grantMask_lastGrant[2:1] != 2'h3;
  wire             ctrl_validMask_grantMask_7 =
    ctrl_validMask_grantMask_lastGrant != 3'h7;
  ...
  wire             _ctrl_T_7 = _ctrl_T_6 | io_in_0_valid;
  wire             _ctrl_T_8 = _ctrl_T_7 | io_in_1_valid;
  wire             _ctrl_T_9 = _ctrl_T_8 | io_in_2_valid;
  wire             _ctrl_T_10 = _ctrl_T_9 | io_in_3_valid;
  wire             _ctrl_T_11 = _ctrl_T_10 | io_in_4_valid;
  wire             _ctrl_T_12 = _ctrl_T_11 | io_in_5_valid;
  wire [2:0]       _GEN_8 =
    io_in_0_valid
      ? 3'h0
      : io_in_1_valid
      ...
      : ctrl_validMask_2
          ...
          : ctrl_validMask_3
              ...
              : ctrl_validMask_4
                  ...
                  : ctrl_validMask_5
                      ? 3'h5
                      : ctrl_validMask_6 ? 3'h6 : ctrl_validMask_7 ? 3'h7 : _GEN_8;
  always @(posedge clock or posedge reset) begin
    if (reset)
      ...
      if (ctrl_validMask_1)
        ...
        ctrl_validMask_grantMask_lastGrant <= 3'h6;
  ...
  assign io_in_0_ready = ~_ctrl_T_6 & io_out_ready;
  assign io_in_1_ready = (ctrl_validMask_grantMask_1 | ~_ctrl_T_7) & io_out_ready;
  assign io_in_2_ready =
    (~ctrl_validMask_1 & ctrl_validMask_grantMask_2 | ~_ctrl_T_8) & io_out_ready;
  assign io_in_3_ready =
    (~_ctrl_T_1 & ctrl_validMask_grantMask_3 | ~_ctrl_T_9) & io_out_ready;
  assign io_in_4_ready =
    (~_ctrl_T_2 & ~(ctrl_validMask_grantMask_lastGrant[2]) | ~_ctrl_T_10) & io_out_ready;
  assign io_in_5_ready =
    (~_ctrl_T_3 & ctrl_validMask_grantMask_5 | ~_ctrl_T_11) & io_out_ready;
  assign io_in_6_ready =
    (~_ctrl_T_4 & ctrl_validMask_grantMask_6 | ~_ctrl_T_12) & io_out_ready;
