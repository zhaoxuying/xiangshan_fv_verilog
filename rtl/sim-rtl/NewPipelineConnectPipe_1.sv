  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pdest = {_RANDOM[4'h7][31:30], _RANDOM[4'h8][3:0]};
        data_rfWen = _RANDOM[4'h8][4];
        data_pc = {_RANDOM[4'h8][31:5], _RANDOM[4'h9][22:0]};
        data_ftqIdx_flag = _RANDOM[4'h9][29];
        data_ftqIdx_value = {_RANDOM[4'h9][31:30], _RANDOM[4'hA][0]};
        data_ftqOffset = _RANDOM[4'hA][4:1];
        data_predictInfo_target = {_RANDOM[4'hA][31:5], _RANDOM[4'hB][22:0]};
        data_predictInfo_taken = _RANDOM[4'hB][23];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
