...
module SourceC(
  ...
  input          io_in_bits_task_set,
  input  [40:0]  io_in_bits_task_tag,
  ...
  input  [5:0]   io_in_bits_task_sourceId,
  ...
  input  [3:0]   io_in_bits_task_wayMask,
  ...
  input  [5:0]   io_in_bits_task_aMergeTask_sourceId,
  ...
  wire         _queue_io_deq_bits_set;
  wire [40:0]  _queue_io_deq_bits_tag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        taskR_task_set = _RANDOM[5'h0][8];
        taskR_task_tag = {_RANDOM[5'h0][31:9], _RANDOM[5'h1][17:0]};
        taskR_task_off = _RANDOM[5'h1][23:18];
        taskR_task_opcode = _RANDOM[5'h1][28:25];
        taskR_task_param = _RANDOM[5'h1][31:29];
        taskR_task_mshrId = _RANDOM[5'h2][22:15];
        taskR_task_dirty = _RANDOM[5'h2][26];
        taskR_data_data =
          {_RANDOM[5'h5][31:1],
           _RANDOM[5'h6],
           _RANDOM[5'h7],
  ...
  assign io_out_bits_address = {taskR_task_tag, taskR_task_set, taskR_task_off};
