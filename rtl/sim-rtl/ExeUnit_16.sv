  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_1_robIdx_value = _RANDOM[5'h17][23:18];
        inPipe_1_1_pdest = {_RANDOM[5'h17][31:29], _RANDOM[5'h18][4:0]};
        inPipe_1_1_fpWen = _RANDOM[5'h18][5];
        inPipe_1_1_vecWen = _RANDOM[5'h18][6];
        inPipe_1_1_v0Wen = _RANDOM[5'h18][7];
        inPipe_1_1_fpu_wflags = _RANDOM[5'h18][10];
        inPipe_1_1_vpu_vma = _RANDOM[5'h18][19];
        inPipe_1_1_vpu_vta = _RANDOM[5'h18][20];
        inPipe_1_1_vpu_vsew = _RANDOM[5'h18][22:21];
        inPipe_1_1_vpu_vlmul = _RANDOM[5'h18][25:23];
        inPipe_1_1_vpu_vm = _RANDOM[5'h19][2];
        inPipe_1_1_vpu_vstart = _RANDOM[5'h19][10:3];
        inPipe_1_1_vpu_fpu_isFoldTo1_2 = _RANDOM[5'h19][18];
        inPipe_1_1_vpu_fpu_isFoldTo1_4 = _RANDOM[5'h19][19];
        inPipe_1_1_vpu_fpu_isFoldTo1_8 = _RANDOM[5'h19][20];
        inPipe_1_1_vpu_vuopIdx = _RANDOM[5'h19][29:23];
        inPipe_1_1_vpu_lastUop = _RANDOM[5'h19][30];
        inPipe_1_1_vpu_isNarrow = _RANDOM[5'h1E][14];
        inPipe_1_1_vpu_isDstMask = _RANDOM[5'h1E][15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
