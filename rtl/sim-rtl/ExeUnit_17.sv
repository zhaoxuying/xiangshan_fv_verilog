...
module ExeUnit_17(
  ...
  wire [5:0]   _Vidiv_io_out_bits_ctrl_robIdx_value;
  ...
  wire [5:0]   _Vfdiv_io_out_bits_ctrl_robIdx_value;
  ...
  wire         Vfdiv_clock_te_cgen = cg_bore_cgen;
  wire         Vidiv_clock_te_cgen = cg_bore_1_cgen;
  reg          uncer_en_reg;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        robIdx_value = _RANDOM[/*Zero width*/ 1'b0][11:6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        uncer_en_reg = 1'h0;
        uncer_en_reg_1 = 1'h0;
  ...
  assign io_out_bits_pdest =
    (_Vfdiv_io_out_valid ? _Vfdiv_io_out_bits_ctrl_pdest : 8'h0)
    | (_Vidiv_io_out_valid ? _Vidiv_io_out_bits_ctrl_pdest : 8'h0);
  ...
  assign io_out_bits_robIdx_value =
    (_Vfdiv_io_out_valid ? _Vfdiv_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Vidiv_io_out_valid ? _Vidiv_io_out_bits_ctrl_robIdx_value : 6'h0);
