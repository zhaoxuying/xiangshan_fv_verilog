...
module Queue4_HintQueueEntry(
  ...
  assign io_deq_bits_source = empty ? io_enq_bits_source : _ram_ext_R0_data[5:0];
  assign io_deq_bits_opcode = empty ? io_enq_bits_opcode : _ram_ext_R0_data[8:6];
  assign io_deq_bits_isKeyword = empty ? io_enq_bits_isKeyword : _ram_ext_R0_data[9];
endmodule
