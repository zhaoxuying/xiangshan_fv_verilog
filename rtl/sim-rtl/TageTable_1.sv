...
module TageTable_1(
  ...
  input  [4:0]  io_req_bits_folded_hist_hist_11_folded_hist,
  input  [5:0]  io_req_bits_folded_hist_hist_8_folded_hist,
  input  [7:0]  io_req_bits_folded_hist_hist_7_folded_hist,
  ...
  wire [7:0]  s0_idx = io_req_bits_pc[8:1] ^ io_req_bits_folded_hist_hist_7_folded_hist;
  ...
  wire [7:0]  update_idx =
    io_update_pc[8:1] ^ {io_update_ghist[7:1], io_update_ghist[0] ^ io_update_ghist[8]};
  wire [5:0]  update_tag =
    io_update_pc[6:1]
    ^ {io_update_ghist[5:3], io_update_ghist[2:0] ^ io_update_ghist[8:6]}
    ^ {io_update_ghist[4], io_update_ghist[3:0] ^ io_update_ghist[8:5], 1'h0};
  ...
  always @(posedge clock) begin
    if (_s1_bank_req_1h_T) begin
      ...
      s1_tag <=
        io_req_bits_pc[6:1] ^ io_req_bits_folded_hist_hist_8_folded_hist
        ^ {io_req_bits_folded_hist_hist_11_folded_hist, 1'h0};
