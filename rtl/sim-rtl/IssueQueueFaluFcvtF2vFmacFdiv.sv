  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_1_bits_common_robIdx_value = _RANDOM[7'h10][21:16];
        deqDelay_1_bits_common_pdest = {_RANDOM[7'h10][31:27], _RANDOM[7'h11][2:0]};
        deqDelay_1_bits_common_fpWen = _RANDOM[7'h11][3];
        deqDelay_1_bits_common_fpu_wflags = _RANDOM[7'h11][6];
        deqDelay_1_bits_common_fpu_fmt = _RANDOM[7'h11][10:9];
        deqDelay_1_bits_common_fpu_rm = _RANDOM[7'h11][13:11];
        deqDelay_1_bits_common_dataSources_0_value = _RANDOM[7'h11][17:14];
        deqDelay_1_bits_common_dataSources_1_value = _RANDOM[7'h11][21:18];
        deqDelay_1_bits_common_exuSources_0_value = _RANDOM[7'h11][23:22];
        deqDelay_1_bits_common_exuSources_1_value = _RANDOM[7'h11][25:24];
        deqDelay_0_valid = _RANDOM[7'h26][19];
        deqDelay_0_bits_rf_2_0_addr = _RANDOM[7'h26][27:20];
        deqDelay_0_bits_rf_1_0_addr = {_RANDOM[7'h26][31], _RANDOM[7'h27][6:0]};
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h27][17:10];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h28][31:5], _RANDOM[7'h29][7:0]};
        deqDelay_0_bits_common_fuOpType = _RANDOM[7'h29][16:8];
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h31][17];
        deqDelay_0_bits_common_robIdx_value = _RANDOM[7'h31][23:18];
        deqDelay_0_bits_common_pdest = {_RANDOM[7'h31][31:29], _RANDOM[7'h32][4:0]};
        deqDelay_0_bits_common_rfWen = _RANDOM[7'h32][5];
        deqDelay_0_bits_common_fpWen = _RANDOM[7'h32][6];
        deqDelay_0_bits_common_vecWen = _RANDOM[7'h32][7];
        deqDelay_0_bits_common_v0Wen = _RANDOM[7'h32][8];
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[7'h32][11];
        deqDelay_0_bits_common_fpu_fmt = _RANDOM[7'h32][15:14];
        deqDelay_0_bits_common_fpu_rm = _RANDOM[7'h32][18:16];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[7'h32][22:19];
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h32][26:23];
        deqDelay_0_bits_common_dataSources_2_value = _RANDOM[7'h32][30:27];
        deqDelay_0_bits_common_exuSources_0_value =
          {_RANDOM[7'h32][31], _RANDOM[7'h33][0]};
        deqDelay_0_bits_common_exuSources_1_value = _RANDOM[7'h33][2:1];
        deqDelay_0_bits_common_exuSources_2_value = _RANDOM[7'h33][4:3];
        io_validCntDeqVec_0_REG = _RANDOM[7'h48][6:1];
        io_validCntDeqVec_1_REG = _RANDOM[7'h48][12:7];
      `endif // RANDOMIZE_REG_INIT
    end // initial
