...
module IssueQueueFaluFmacFdiv(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[7'h32][9];
        deqDelay_0_bits_common_fpu_fmt = _RANDOM[7'h32][13:12];
        deqDelay_0_bits_common_fpu_rm = _RANDOM[7'h32][16:14];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[7'h32][20:17];
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h32][24:21];
        deqDelay_0_bits_common_dataSources_2_value = _RANDOM[7'h32][28:25];
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[7'h32][30:29];
        deqDelay_0_bits_common_exuSources_1_value =
          {_RANDOM[7'h32][31], _RANDOM[7'h33][0]};
        deqDelay_0_bits_common_exuSources_2_value = _RANDOM[7'h33][2:1];
        io_validCntDeqVec_0_REG = {_RANDOM[7'h47][31], _RANDOM[7'h48][4:0]};
        io_validCntDeqVec_1_REG = _RANDOM[7'h48][10:5];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  MultiWakeupQueue_5 wakeUpQueues_0 (
    ...
    .io_enq_bits_lat
      ({1'h0,
        {1'h0, _entries_io_deqEntry_0_bits_status_fuType_11}
