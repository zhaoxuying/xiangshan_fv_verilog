...
module AXI4UserYanker_2(
  ...
  input  [2:0]  auto_in_aw_bits_echo_tl_state_source,
  ...
  output [2:0]  auto_in_b_bits_echo_tl_state_source,
  ...
  input  [2:0]  auto_in_ar_bits_echo_tl_state_source,
  ...
  output [2:0]  auto_in_r_bits_echo_tl_state_source,
  ...
  Queue1_BundleMap_134 Queue1_BundleMap (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_io_enq_ready),
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 3'h0),
    ...
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 3'h0 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_1 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_1_io_enq_ready),
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 3'h1),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 3'h1 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_2 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_2_io_enq_ready),
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 3'h2),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 3'h2 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_3 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_3_io_enq_ready),
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 3'h3),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 3'h3 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_4 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_4_io_enq_ready),
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 3'h4),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 3'h4 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_5 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_5_io_enq_ready),
    .io_enq_valid                (_GEN_8 & auto_in_aw_bits_id == 3'h0),
    ...
    .io_deq_ready                (_GEN_7 & auto_out_b_bits_id == 3'h0),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_6 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_6_io_enq_ready),
    .io_enq_valid                (_GEN_8 & auto_in_aw_bits_id == 3'h1),
    .io_enq_bits_tl_state_size   (auto_in_aw_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_aw_bits_echo_tl_state_source),
    .io_deq_ready                (_GEN_7 & auto_out_b_bits_id == 3'h1),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_7 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_7_io_enq_ready),
    .io_enq_valid                (_GEN_8 & auto_in_aw_bits_id == 3'h2),
    .io_enq_bits_tl_state_size   (auto_in_aw_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_aw_bits_echo_tl_state_source),
    .io_deq_ready                (_GEN_7 & auto_out_b_bits_id == 3'h2),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_8 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_8_io_enq_ready),
    .io_enq_valid                (_GEN_8 & auto_in_aw_bits_id == 3'h3),
    .io_enq_bits_tl_state_size   (auto_in_aw_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_aw_bits_echo_tl_state_source),
    .io_deq_ready                (_GEN_7 & auto_out_b_bits_id == 3'h3),
  ...
  Queue1_BundleMap_134 Queue1_BundleMap_9 (
    .clock                       (clock),
    .reset                       (reset),
    .io_enq_ready                (_Queue1_BundleMap_9_io_enq_ready),
    .io_enq_valid                (_GEN_8 & auto_in_aw_bits_id == 3'h4),
    .io_enq_bits_tl_state_size   (auto_in_aw_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_aw_bits_echo_tl_state_source),
    .io_deq_ready                (_GEN_7 & auto_out_b_bits_id == 3'h4),
