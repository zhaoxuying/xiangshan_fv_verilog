...
module MissEntry(
  ...
  assign io_secondary_ready_0 =
    req_addr[47:6] == io_req_bits_addr[47:6] & ~w_grantfirst & _load_miss_begin_T;
    ...
    if (reset) begin
      ...
      evict_BtoT_way <=
        ...
        & (io_main_pipe_evict_BtoT_way
           | (_GEN_0
                ? ~(_full_overwrite_T_2 | _GEN) & evict_BtoT_way
                : ~_GEN & evict_BtoT_way));
      ...
      prefetch <=
        ...
        & (_GEN
             ? (io_miss_req_pipe_reg_req_cmd == 5'h2
                | io_miss_req_pipe_reg_req_cmd == 5'h3)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_word_idx = _RANDOM[7'h5][10:8];
        req_amo_data =
          {_RANDOM[7'h5][31:11],
           _RANDOM[7'h6],
           _RANDOM[7'h7],
           _RANDOM[7'h8],
           _RANDOM[7'h9][10:0]};
        req_amo_mask = _RANDOM[7'h9][26:11];
        req_amo_cmp =
          {_RANDOM[7'h9][31:27],
           _RANDOM[7'hA],
           _RANDOM[7'hB],
           _RANDOM[7'hC],
           _RANDOM[7'hD][26:0]};
        req_req_coh_state = _RANDOM[7'hD][28:27];
        req_id = {_RANDOM[7'hD][31:29], _RANDOM[7'hE][0]};
        req_isBtoT = _RANDOM[7'hE][1];
        req_occupy_way = _RANDOM[7'hE][5:2];
        req_store_mask = {_RANDOM[7'h1C][31:13], _RANDOM[7'h1D], _RANDOM[7'h1E][12:0]};
        req_valid = _RANDOM[7'h1E][13];
        evict_BtoT_way = _RANDOM[7'h1E][14];
        isKeyword = _RANDOM[7'h1E][15];
        s_acquire = _RANDOM[7'h1E][16];
        s_grantack = _RANDOM[7'h1E][17];
        s_mainpipe_req = _RANDOM[7'h1E][18];
        w_grantfirst = _RANDOM[7'h1E][19];
        w_grantlast = _RANDOM[7'h1E][20];
        w_mainpipe_resp = _RANDOM[7'h1E][21];
        w_refill_resp = _RANDOM[7'h1E][22];
        w_l2hint = _RANDOM[7'h1E][23];
        error = _RANDOM[7'h1E][25];
        prefetch = _RANDOM[7'h1E][26];
        full_overwrite = _RANDOM[7'h1E][30];
        r_counter = _RANDOM[7'h1E][31];
        grant_param = _RANDOM[7'h1F][1:0];
        refill_and_store_data_0 =
          {_RANDOM[7'h1F][31:2], _RANDOM[7'h20], _RANDOM[7'h21][1:0]};
        refill_and_store_data_1 =
          {_RANDOM[7'h21][31:2], _RANDOM[7'h22], _RANDOM[7'h23][1:0]};
        refill_and_store_data_2 =
          {_RANDOM[7'h23][31:2], _RANDOM[7'h24], _RANDOM[7'h25][1:0]};
        refill_and_store_data_3 =
          {_RANDOM[7'h25][31:2], _RANDOM[7'h26], _RANDOM[7'h27][1:0]};
        refill_and_store_data_4 =
          {_RANDOM[7'h27][31:2], _RANDOM[7'h28], _RANDOM[7'h29][1:0]};
        refill_and_store_data_5 =
          {_RANDOM[7'h29][31:2], _RANDOM[7'h2A], _RANDOM[7'h2B][1:0]};
        refill_and_store_data_6 =
          {_RANDOM[7'h2B][31:2], _RANDOM[7'h2C], _RANDOM[7'h2D][1:0]};
        refill_and_store_data_7 =
          {_RANDOM[7'h2D][31:2], _RANDOM[7'h2E], _RANDOM[7'h2F][1:0]};
        secondary_fired = _RANDOM[7'h3F][2];
        io_primary_ready_last_REG = _RANDOM[7'h3F][10];
        io_primary_ready_last_REG_1 = _RANDOM[7'h3F][11];
        io_queryME_0_primary_ready_last_REG = _RANDOM[7'h3F][13];
        io_queryME_0_primary_ready_last_REG_1 = _RANDOM[7'h3F][14];
        io_queryME_1_primary_ready_last_REG = _RANDOM[7'h3F][16];
        io_queryME_1_primary_ready_last_REG_1 = _RANDOM[7'h3F][17];
        io_queryME_2_primary_ready_last_REG = _RANDOM[7'h3F][19];
        io_queryME_2_primary_ready_last_REG_1 = _RANDOM[7'h3F][20];
        io_queryME_3_primary_ready_last_REG = _RANDOM[7'h3F][22];
        io_queryME_3_primary_ready_last_REG_1 = _RANDOM[7'h3F][23];
        grantack_sink = _RANDOM[7'h41][20:13];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        evict_BtoT_way = 1'h0;
  ...
  assign io_queryME_0_secondary_ready =
    req_addr[47:6] == io_queryME_0_req_bits_addr[47:6] & ~w_grantfirst
  ...
  assign io_queryME_1_secondary_ready =
    req_addr[47:6] == io_queryME_1_req_bits_addr[47:6] & ~w_grantfirst
  ...
  assign io_queryME_2_secondary_ready =
    req_addr[47:6] == io_queryME_2_req_bits_addr[47:6] & ~w_grantfirst
  ...
  assign io_queryME_3_secondary_ready =
    req_addr[47:6] == io_queryME_3_req_bits_addr[47:6] & ~w_grantfirst
