...
module PipeWithFlush_9(
  ...
  input  [5:0]  io_enq_bits_robIdx_value,
  ...
  output [5:0]  io_deq_bits_robIdx_value,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_value = _RANDOM[7'h9][21:16];
        bits_1_pdest = {_RANDOM[7'h9][31:27], _RANDOM[7'hA][2:0]};
        bits_1_fpWen = _RANDOM[7'hA][4];
        bits_1_vecWen = _RANDOM[7'hA][5];
        bits_1_v0Wen = _RANDOM[7'hA][6];
        bits_2_fuType = {_RANDOM[7'h1F][31:13], _RANDOM[7'h20][15:0]};
        bits_2_robIdx_flag = _RANDOM[7'h28][25];
        bits_2_robIdx_value = _RANDOM[7'h28][31:26];
        bits_2_pdest = _RANDOM[7'h29][12:5];
        bits_2_fpWen = _RANDOM[7'h29][14];
        bits_2_vecWen = _RANDOM[7'h29][15];
        bits_2_v0Wen = _RANDOM[7'h29][16];
        bits_3_fuType = {_RANDOM[7'h3E][31:23], _RANDOM[7'h3F][25:0]};
        bits_3_robIdx_flag = _RANDOM[7'h48][3];
        bits_3_robIdx_value = _RANDOM[7'h48][9:4];
        bits_3_pdest = _RANDOM[7'h48][22:15];
        bits_3_fpWen = _RANDOM[7'h48][24];
        bits_3_vecWen = _RANDOM[7'h48][25];
        bits_3_v0Wen = _RANDOM[7'h48][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
