...
module RRArbiterInit_5(
  ...
  input  [3:0]  io_in_2_bits_wayMask,
  ...
  input  [3:0]  io_in_3_bits_wayMask,
  ...
  assign io_chosen_choice =
    ctrl_validMask_1 ? 2'h1 : ctrl_validMask_2 ? 2'h2 : ctrl_validMask_3 ? 2'h3 : _GEN_58;
  always @(posedge clock or posedge reset) begin
    if (reset)
      ...
      if (ctrl_validMask_1)
        ...
        ctrl_validMask_grantMask_lastGrant <= _GEN_58;
    end
  ...
  assign io_out_bits_isKeyword = _GEN_5[io_chosen_choice];
  assign io_out_bits_opcode = _GEN_6[io_chosen_choice];
  assign io_out_bits_param = _GEN_7[io_chosen_choice];
  assign io_out_bits_size = _GEN_8[io_chosen_choice];
  assign io_out_bits_sourceId = _GEN_9[io_chosen_choice];
  assign io_out_bits_bufIdx = _GEN_10[io_chosen_choice];
  assign io_out_bits_needProbeAckData = _GEN_11[io_chosen_choice];
  assign io_out_bits_denied = _GEN_12[io_chosen_choice];
  assign io_out_bits_corrupt = _GEN_13[io_chosen_choice];
  assign io_out_bits_mshrTask = _GEN_14[io_chosen_choice];
  assign io_out_bits_mshrId = _GEN_15[io_chosen_choice];
  assign io_out_bits_useProbeData = _GEN_16[io_chosen_choice];
  assign io_out_bits_mshrRetry = _GEN_17[io_chosen_choice];
  assign io_out_bits_readProbeDataDown = _GEN_18[io_chosen_choice];
  assign io_out_bits_dirty = _GEN_19[io_chosen_choice];
  assign io_out_bits_way = _GEN_20[io_chosen_choice];
  assign io_out_bits_meta_dirty = _GEN_21[io_chosen_choice];
  assign io_out_bits_meta_state = _GEN_22[io_chosen_choice];
  assign io_out_bits_meta_clients = _GEN_23[io_chosen_choice];
  assign io_out_bits_meta_accessed = _GEN_24[io_chosen_choice];
  assign io_out_bits_meta_tagErr = _GEN_25[io_chosen_choice];
  assign io_out_bits_meta_dataErr = _GEN_26[io_chosen_choice];
  assign io_out_bits_metaWen = _GEN_27[io_chosen_choice];
  assign io_out_bits_tagWen = _GEN_28[io_chosen_choice];
  assign io_out_bits_dsWen = _GEN_29[io_chosen_choice];
  assign io_out_bits_wayMask = _GEN_30[io_chosen_choice];
  assign io_out_bits_replTask = _GEN_31[io_chosen_choice];
  assign io_out_bits_cmoTask = _GEN_32[io_chosen_choice];
  assign io_out_bits_cmoAll = _GEN_33[io_chosen_choice];
  assign io_out_bits_reqSource = _GEN_34[io_chosen_choice];
  assign io_out_bits_mergeA = _GEN_35[io_chosen_choice];
  assign io_out_bits_aMergeTask_off = _GEN_36[io_chosen_choice];
  assign io_out_bits_aMergeTask_isKeyword = _GEN_37[io_chosen_choice];
  assign io_out_bits_aMergeTask_opcode = _GEN_38[io_chosen_choice];
  assign io_out_bits_aMergeTask_param = _GEN_39[io_chosen_choice];
  assign io_out_bits_aMergeTask_sourceId = _GEN_40[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_dirty = _GEN_41[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_state = _GEN_42[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_clients = _GEN_43[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_accessed = _GEN_44[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_tagErr = _GEN_45[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_dataErr = _GEN_46[io_chosen_choice];
  assign io_out_bits_snpHitRelease = _GEN_47[io_chosen_choice];
  assign io_out_bits_snpHitReleaseToInval = _GEN_48[io_chosen_choice];
  assign io_out_bits_snpHitReleaseToClean = _GEN_49[io_chosen_choice];
  assign io_out_bits_snpHitReleaseWithData = _GEN_50[io_chosen_choice];
  assign io_out_bits_snpHitReleaseIdx = _GEN_51[io_chosen_choice];
  assign io_out_bits_snpHitReleaseMeta_dirty = _GEN_52[io_chosen_choice];
  assign io_out_bits_snpHitReleaseMeta_state = _GEN_53[io_chosen_choice];
  assign io_out_bits_snpHitReleaseMeta_clients = _GEN_54[io_chosen_choice];
  assign io_out_bits_snpHitReleaseMeta_accessed = _GEN_55[io_chosen_choice];
  assign io_out_bits_snpHitReleaseMeta_tagErr = _GEN_56[io_chosen_choice];
  assign io_out_bits_snpHitReleaseMeta_dataErr = _GEN_57[io_chosen_choice];
endmodule
