...
module NewPipelineConnectPipe_5(
  ...
  output [2:0]  io_out_bits_ftqIdx_value,
  ...
  reg [2:0]  data_ftqIdx_value;
  reg [3:0]  data_ftqOffset;
  reg [49:0] data_predictInfo_target;
  reg        data_predictInfo_taken;
  ...
  always @(posedge clock) begin
    if (io_in_valid) begin
      ...
      data_nextPcOffset <= io_in_bits_nextPcOffset;
      ...
      data_predictInfo_target <= io_in_bits_predictInfo_target;
      data_predictInfo_taken <= io_in_bits_predictInfo_taken;
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_imm = {_RANDOM[4'h5][31:13], _RANDOM[4'h6], _RANDOM[4'h7][12:0]};
        data_nextPcOffset = _RANDOM[4'h7][17:13];
        data_robIdx_flag = _RANDOM[4'h7][18];
        data_robIdx_value = _RANDOM[4'h7][24:19];
        data_pdest = {_RANDOM[4'h7][31:30], _RANDOM[4'h8][5:0]};
        data_rfWen = _RANDOM[4'h8][6];
        data_fpWen = _RANDOM[4'h8][7];
        data_vecWen = _RANDOM[4'h8][8];
        data_v0Wen = _RANDOM[4'h8][9];
        data_vlWen = _RANDOM[4'h8][10];
        data_fpu_typeTagOut = _RANDOM[4'h8][12:11];
        data_fpu_wflags = _RANDOM[4'h8][13];
        data_fpu_typ = _RANDOM[4'h8][15:14];
        data_fpu_rm = _RANDOM[4'h8][20:18];
        data_pc = {_RANDOM[4'h8][31:21], _RANDOM[4'h9], _RANDOM[4'hA][6:0]};
        data_ftqIdx_flag = _RANDOM[4'hA][13];
        data_ftqIdx_value = _RANDOM[4'hA][16:14];
        data_ftqOffset = _RANDOM[4'hA][20:17];
        data_predictInfo_target =
          {_RANDOM[4'hA][31:21], _RANDOM[4'hB], _RANDOM[4'hC][6:0]};
        data_predictInfo_taken = _RANDOM[4'hC][7];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
  ...
  assign io_out_bits_nextPcOffset = data_nextPcOffset;
  ...
  assign io_out_bits_predictInfo_target = data_predictInfo_target;
  assign io_out_bits_predictInfo_taken = data_predictInfo_taken;
endmodule
