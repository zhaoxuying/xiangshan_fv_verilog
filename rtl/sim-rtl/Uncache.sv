...
module Uncache(
  ...
  wire             canMerge1_1 =
    ...
    & (4'({1'h0,
       ...
       | (&_canMerge1_T_26))
    & ~(auto_client_out_d_valid & auto_client_out_d_bits_source == 2'h1
        | r0_canSentVec_1);
  wire             canMerge2_1 =
  ...
  wire             canMerge1_2 =
    ...
    & (4'({1'h0,
       ...
       | (&_canMerge1_T_43))
    & ~(auto_client_out_d_valid & auto_client_out_d_bits_source == 2'h2
        | r0_canSentVec_2);
  wire             canMerge2_2 =
  ...
  wire             canMerge1_3 =
    ...
    & (4'({1'h0,
       ...
       | (&_canMerge1_T_60))
    & ~(auto_client_out_d_valid & (&auto_client_out_d_bits_source) | r0_canSentVec_3);
  wire             canMerge2_3 =
  ...
  reg  [4:0]       io_lsq_idResp_bits_mid_r;
  ...
  wire             _GEN_12 = auto_client_out_d_bits_source == 2'h1;
  wire             _GEN_13 = auto_client_out_d_bits_source == 2'h2;
  wire             _GEN_14 = auto_client_out_d_valid & ~(|auto_client_out_d_bits_source);
  wire             _GEN_15 = auto_client_out_d_valid & _GEN_12;
  wire             _GEN_16 = auto_client_out_d_valid & _GEN_13;
  wire             _GEN_17 = auto_client_out_d_valid & (&auto_client_out_d_bits_source);
  ...
  assign _f1_tagMismatchVec_0_T_12 =
  ...
  assign _f1_tagMismatchVec_1_T_12 =
  ...
  assign _f1_tagMismatchVec_2_T_12 =
  ...
  wire             _GEN_21 = e0_mergeIdx == 2'h0;
  wire             _GEN_22 = e0_mergeIdx == 2'h1;
  wire             _GEN_23 = e0_mergeIdx == 2'h2;
  wire             _GEN_24 = _GEN | ~_GEN_5;
  wire             _GEN_25 = _GEN | ~_GEN_7;
  wire             _GEN_26 = _GEN | ~_GEN_9;
  wire             _GEN_27 = _GEN | ~_GEN_10;
  wire             _GEN_28 = _GEN_11[auto_client_out_d_bits_source] == 5'h0;
  ...
  wire             _f0_flyTagMatches_T_42 = states_0_inflight | states_0_waitReturn;
  wire             _f0_flyTagMatches_T_47 = states_1_inflight | states_1_waitReturn;
  wire             _f0_flyTagMatches_T_52 = states_2_inflight | states_2_waitReturn;
  wire             _f0_flyTagMatches_T_57 = states_3_inflight | states_3_waitReturn;
  ...
  wire [49:0]      _entries_vaddr_T_2 = {_GEN_20[e0_mergeIdx][49:3], resOffset};
  ...
  wire             _f0_idleTagMatches_T_28 = f0_vtagMatches_1_0 & f0_validMask_0;
  wire             _f0_idleTagMatches_T_35 = f0_vtagMatches_1_1 & f0_validMask_1;
  wire             _f0_idleTagMatches_T_42 = f0_vtagMatches_1_2 & f0_validMask_2;
  wire             _f0_idleTagMatches_T_49 = f0_vtagMatches_1_3 & f0_validMask_3;
  wire             _f0_idleTagMatches_T_56 = f0_vtagMatches_2_0 & f0_validMask_0;
  wire             _f0_idleTagMatches_T_63 = f0_vtagMatches_2_1 & f0_validMask_1;
  wire             _f0_idleTagMatches_T_70 = f0_vtagMatches_2_2 & f0_validMask_2;
  wire             _f0_idleTagMatches_T_77 = f0_vtagMatches_2_3 & f0_validMask_3;
  always @(posedge clock) begin
    ...
    if (auto_client_out_d_valid & _GEN_28 & ~(|auto_client_out_d_bits_source))
    ...
    if (_GEN_14)
      ...
      entries_0_resp_nderr <= _GEN_24 & entries_0_resp_nderr;
    if (_GEN_25) begin
    end
    else
      entries_1_cmd <= io_lsq_req_bits_cmd;
    if (auto_client_out_d_valid & _GEN_28 & _GEN_12)
    ...
    if (_GEN_15)
      ...
      entries_1_resp_nderr <= _GEN_25 & entries_1_resp_nderr;
    if (_GEN_26) begin
    end
    else
      entries_2_cmd <= io_lsq_req_bits_cmd;
    if (auto_client_out_d_valid & _GEN_28 & _GEN_13)
    ...
    if (_GEN_16)
      ...
      entries_2_resp_nderr <= _GEN_26 & entries_2_resp_nderr;
    if (_GEN_27) begin
    end
    else
    ...
    if (_GEN_17)
      ...
      entries_3_resp_nderr <= _GEN_27 & entries_3_resp_nderr;
    ...
    if (io_forward_1_valid) begin
      f1_flyTagMatches_1_0 <=
        _f0_idleTagMatches_T_28 & io_forward_1_valid & states_0_valid
        & _f0_flyTagMatches_T_42;
      f1_flyTagMatches_1_1 <=
        _f0_idleTagMatches_T_35 & io_forward_1_valid & states_1_valid
        & _f0_flyTagMatches_T_47;
      f1_flyTagMatches_1_2 <=
        _f0_idleTagMatches_T_42 & io_forward_1_valid & states_2_valid
        & _f0_flyTagMatches_T_52;
      f1_flyTagMatches_1_3 <=
        _f0_idleTagMatches_T_49 & io_forward_1_valid & states_3_valid
        & _f0_flyTagMatches_T_57;
      f1_idleTagMatches_1_0 <=
        _f0_idleTagMatches_T_28 & io_forward_1_valid & states_0_valid & ~states_0_inflight
        & ~states_0_waitReturn;
      f1_idleTagMatches_1_1 <=
        _f0_idleTagMatches_T_35 & io_forward_1_valid & states_1_valid & ~states_1_inflight
        & ~states_1_waitReturn;
      f1_idleTagMatches_1_2 <=
        _f0_idleTagMatches_T_42 & io_forward_1_valid & states_2_valid & ~states_2_inflight
        & ~states_2_waitReturn;
      f1_idleTagMatches_1_3 <=
        _f0_idleTagMatches_T_49 & io_forward_1_valid & states_3_valid & ~states_3_inflight
        & ~states_3_waitReturn;
    ...
    if (io_forward_2_valid) begin
      f1_flyTagMatches_2_0 <=
        _f0_idleTagMatches_T_56 & io_forward_2_valid & states_0_valid
        & _f0_flyTagMatches_T_42;
      f1_flyTagMatches_2_1 <=
        _f0_idleTagMatches_T_63 & io_forward_2_valid & states_1_valid
        & _f0_flyTagMatches_T_47;
      f1_flyTagMatches_2_2 <=
        _f0_idleTagMatches_T_70 & io_forward_2_valid & states_2_valid
        & _f0_flyTagMatches_T_52;
      f1_flyTagMatches_2_3 <=
        _f0_idleTagMatches_T_77 & io_forward_2_valid & states_3_valid
        & _f0_flyTagMatches_T_57;
      f1_idleTagMatches_2_0 <=
        _f0_idleTagMatches_T_56 & io_forward_2_valid & states_0_valid & ~states_0_inflight
        & ~states_0_waitReturn;
      f1_idleTagMatches_2_1 <=
        _f0_idleTagMatches_T_63 & io_forward_2_valid & states_1_valid & ~states_1_inflight
        & ~states_1_waitReturn;
      f1_idleTagMatches_2_2 <=
        _f0_idleTagMatches_T_70 & io_forward_2_valid & states_2_valid & ~states_2_inflight
        & ~states_2_waitReturn;
      f1_idleTagMatches_2_3 <=
        _f0_idleTagMatches_T_77 & io_forward_2_valid & states_3_valid & ~states_3_inflight
        & ~states_3_waitReturn;
  ...
  wire             _GEN_29 = io_lsq_resp_ready & r0_canSent;
  ...
  wire             _GEN_30 = _perfEvents_T_17 & ~(|q0_canSentIdx) | states_0_inflight;
  wire             _GEN_31 = _perfEvents_T_17 & q0_canSentIdx == 2'h1 | states_1_inflight;
  wire             _GEN_32 = _perfEvents_T_17 & q0_canSentIdx == 2'h2 | states_2_inflight;
  wire             _GEN_33 = _perfEvents_T_17 & (&q0_canSentIdx) | states_3_inflight;
  wire             _GEN_34 =
  ...
  wire             _GEN_39 =
    auto_client_out_d_valid & auto_client_out_d_bits_source != 2'h1 & states_1_valid
    & states_1_waitSame
    & _GEN_0[auto_client_out_d_bits_source][47:3] == entries_1_addr[47:3];
  wire             _GEN_40 =
    auto_client_out_d_valid & auto_client_out_d_bits_source != 2'h2 & states_2_valid
    & states_2_waitSame
    & _GEN_0[auto_client_out_d_bits_source][47:3] == entries_2_addr[47:3];
  wire             _GEN_41 =
    auto_client_out_d_valid & ~(&auto_client_out_d_bits_source) & states_3_valid
    & states_3_waitSame
    & _GEN_0[auto_client_out_d_bits_source][47:3] == entries_3_addr[47:3];
  wire             _GEN_42 = r0_canSentIdx == 2'h0;
  wire             _GEN_43 = _GEN_29 & _GEN_42;
  wire             _GEN_44 = r0_canSentIdx == 2'h1;
  wire             _GEN_45 = _GEN_29 & _GEN_44;
  wire             _GEN_46 = r0_canSentIdx == 2'h2;
  wire             _GEN_47 = _GEN_29 & _GEN_46;
  wire             _GEN_48 = _GEN_29 & (&r0_canSentIdx);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      states_0_valid <= ~_GEN_43 & (~_GEN & _GEN_5 | states_0_valid);
      if (_GEN_29) begin
        states_0_inflight <= ~(_GEN_42 | _GEN_14) & _GEN_30;
        states_0_waitSame <= ~(_GEN_42 | _GEN_38) & _GEN_34;
        states_1_inflight <= ~(_GEN_44 | _GEN_15) & _GEN_31;
        states_1_waitSame <= ~(_GEN_44 | _GEN_39) & _GEN_35;
        states_2_inflight <= ~(_GEN_46 | _GEN_16) & _GEN_32;
        states_2_waitSame <= ~(_GEN_46 | _GEN_40) & _GEN_36;
        states_3_inflight <= ~((&r0_canSentIdx) | _GEN_17) & _GEN_33;
        states_3_waitSame <= ~((&r0_canSentIdx) | _GEN_41) & _GEN_37;
      end
      else begin
        states_0_inflight <= ~_GEN_14 & _GEN_30;
        states_0_waitSame <= ~_GEN_38 & _GEN_34;
        states_1_inflight <= ~_GEN_15 & _GEN_31;
        states_1_waitSame <= ~_GEN_39 & _GEN_35;
        states_2_inflight <= ~_GEN_16 & _GEN_32;
        states_2_waitSame <= ~_GEN_40 & _GEN_36;
        states_3_inflight <= ~_GEN_17 & _GEN_33;
        states_3_waitSame <= ~_GEN_41 & _GEN_37;
      end
      states_0_waitReturn <= ~_GEN_43 & (_GEN_14 | states_0_waitReturn);
      states_1_valid <= ~_GEN_45 & (~_GEN & _GEN_7 | states_1_valid);
      states_1_waitReturn <= ~_GEN_45 & (_GEN_15 | states_1_waitReturn);
      states_2_valid <= ~_GEN_47 & (~_GEN & _GEN_9 | states_2_valid);
      states_2_waitReturn <= ~_GEN_47 & (_GEN_16 | states_2_waitReturn);
      states_3_valid <= ~_GEN_48 & (~_GEN & _GEN_10 | states_3_valid);
      states_3_waitReturn <= ~_GEN_48 & (_GEN_17 | states_3_waitReturn);
      if (|uState) begin
        if (uState == 2'h1) begin
          if (auto_client_out_d_valid)
            uState <= 2'h2;
        end
        else if (uState == 2'h2 & _GEN_29)
          uState <= 2'h0;
      end
      ...
      do_uarch_drain <=
        ((|{|_f1_tagMismatchVec_2_T_12,
            ...
            |_f1_tagMismatchVec_0_T_12}) & (|_empty_T) | io_flush_valid) & (|_empty_T);
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entries_0_memBackTypeMM = _RANDOM[6'h5][16];
        entries_0_resp_nderr = _RANDOM[6'h5][17];
        entries_1_cmd = _RANDOM[6'h5][22:18];
        entries_1_addr = {_RANDOM[6'h5][31:23], _RANDOM[6'h6], _RANDOM[6'h7][6:0]};
        entries_1_vaddr = {_RANDOM[6'h7][31:7], _RANDOM[6'h8][24:0]};
        entries_1_data = {_RANDOM[6'h8][31:25], _RANDOM[6'h9], _RANDOM[6'hA][24:0]};
        entries_1_mask = {_RANDOM[6'hA][31:25], _RANDOM[6'hB][0]};
        entries_1_nc = _RANDOM[6'hB][1];
        entries_1_memBackTypeMM = _RANDOM[6'hB][2];
        entries_1_resp_nderr = _RANDOM[6'hB][3];
        entries_2_cmd = _RANDOM[6'hB][8:4];
        entries_2_addr = {_RANDOM[6'hB][31:9], _RANDOM[6'hC][24:0]};
        entries_2_vaddr = {_RANDOM[6'hC][31:25], _RANDOM[6'hD], _RANDOM[6'hE][10:0]};
        entries_2_data = {_RANDOM[6'hE][31:11], _RANDOM[6'hF], _RANDOM[6'h10][10:0]};
        entries_2_mask = _RANDOM[6'h10][18:11];
        entries_2_nc = _RANDOM[6'h10][19];
        entries_2_memBackTypeMM = _RANDOM[6'h10][20];
        entries_2_resp_nderr = _RANDOM[6'h10][21];
        entries_3_cmd = _RANDOM[6'h10][26:22];
        entries_3_addr = {_RANDOM[6'h10][31:27], _RANDOM[6'h11], _RANDOM[6'h12][10:0]};
        entries_3_vaddr = {_RANDOM[6'h12][31:11], _RANDOM[6'h13][28:0]};
        entries_3_data = {_RANDOM[6'h13][31:29], _RANDOM[6'h14], _RANDOM[6'h15][28:0]};
        entries_3_mask = {_RANDOM[6'h15][31:29], _RANDOM[6'h16][4:0]};
        entries_3_nc = _RANDOM[6'h16][5];
        entries_3_memBackTypeMM = _RANDOM[6'h16][6];
        entries_3_resp_nderr = _RANDOM[6'h16][7];
        states_0_valid = _RANDOM[6'h16][8];
        states_0_inflight = _RANDOM[6'h16][9];
        states_0_waitSame = _RANDOM[6'h16][10];
        states_0_waitReturn = _RANDOM[6'h16][11];
        states_1_valid = _RANDOM[6'h16][12];
        states_1_inflight = _RANDOM[6'h16][13];
        states_1_waitSame = _RANDOM[6'h16][14];
        states_1_waitReturn = _RANDOM[6'h16][15];
        states_2_valid = _RANDOM[6'h16][16];
        states_2_inflight = _RANDOM[6'h16][17];
        states_2_waitSame = _RANDOM[6'h16][18];
        states_2_waitReturn = _RANDOM[6'h16][19];
        states_3_valid = _RANDOM[6'h16][20];
        states_3_inflight = _RANDOM[6'h16][21];
        states_3_waitSame = _RANDOM[6'h16][22];
        states_3_waitReturn = _RANDOM[6'h16][23];
        uState = _RANDOM[6'h16][25:24];
        do_uarch_drain = _RANDOM[6'h16][26];
        io_lsq_idResp_valid_REG = _RANDOM[6'h16][27];
        io_lsq_idResp_bits_mid_r = {_RANDOM[6'h16][31:28], _RANDOM[6'h17][0]};
        io_lsq_idResp_bits_sid_r = _RANDOM[6'h17][2:1];
        io_lsq_idResp_bits_is2lq_r = _RANDOM[6'h17][3];
        io_lsq_idResp_bits_nc_r = _RANDOM[6'h17][4];
        f1_fwdMaskCandidates_r = _RANDOM[6'h17][15:8];
        f1_fwdMaskCandidates_r_1 = _RANDOM[6'h17][23:16];
        f1_fwdMaskCandidates_r_2 = _RANDOM[6'h17][31:24];
        f1_fwdMaskCandidates_r_3 = _RANDOM[6'h18][7:0];
        f1_fwdDataCandidates_r =
          {_RANDOM[6'h18][31:8], _RANDOM[6'h19], _RANDOM[6'h1A][7:0]};
        f1_fwdDataCandidates_r_1 =
          {_RANDOM[6'h1A][31:8], _RANDOM[6'h1B], _RANDOM[6'h1C][7:0]};
        f1_fwdDataCandidates_r_2 =
          {_RANDOM[6'h1C][31:8], _RANDOM[6'h1D], _RANDOM[6'h1E][7:0]};
        f1_fwdDataCandidates_r_3 =
          {_RANDOM[6'h1E][31:8], _RANDOM[6'h1F], _RANDOM[6'h20][7:0]};
        f1_fwdValid = _RANDOM[6'h20][8];
        f1_flyTagMatches_0 = _RANDOM[6'h20][9];
        f1_flyTagMatches_1 = _RANDOM[6'h20][10];
        f1_flyTagMatches_2 = _RANDOM[6'h20][11];
        f1_flyTagMatches_3 = _RANDOM[6'h20][12];
        f1_idleTagMatches_0 = _RANDOM[6'h20][13];
        f1_idleTagMatches_1 = _RANDOM[6'h20][14];
        f1_idleTagMatches_2 = _RANDOM[6'h20][15];
        f1_idleTagMatches_3 = _RANDOM[6'h20][16];
        f1_fwdPAddr = {_RANDOM[6'h20][31:17], _RANDOM[6'h21], _RANDOM[6'h22][0]};
        f1_ptagMatches_r = {_RANDOM[6'h22][31:1], _RANDOM[6'h23][16:0]};
        f1_ptagMatches_r_1 = {_RANDOM[6'h23][31:17], _RANDOM[6'h24], _RANDOM[6'h25][0]};
        f1_ptagMatches_r_2 = {_RANDOM[6'h25][31:1], _RANDOM[6'h26][16:0]};
        f1_ptagMatches_r_3 = {_RANDOM[6'h26][31:17], _RANDOM[6'h27], _RANDOM[6'h28][0]};
        f1_tagMismatchVec_0_r = _RANDOM[6'h28][1];
        f1_tagMismatchVec_0_r_1 = _RANDOM[6'h28][2];
        f1_tagMismatchVec_0_r_2 = _RANDOM[6'h28][3];
        f1_tagMismatchVec_0_r_3 = _RANDOM[6'h28][4];
        f1_tagMismatchVec_0_r_4 = _RANDOM[6'h28][5];
        f1_tagMismatchVec_0_r_5 = _RANDOM[6'h28][6];
        f1_tagMismatchVec_0_r_6 = _RANDOM[6'h28][7];
        f1_tagMismatchVec_0_r_7 = _RANDOM[6'h28][8];
        f1_fwdValid_1 = _RANDOM[6'h2B][15];
        f1_flyTagMatches_1_0 = _RANDOM[6'h2B][16];
        f1_flyTagMatches_1_1 = _RANDOM[6'h2B][17];
        f1_flyTagMatches_1_2 = _RANDOM[6'h2B][18];
        f1_flyTagMatches_1_3 = _RANDOM[6'h2B][19];
        f1_idleTagMatches_1_0 = _RANDOM[6'h2B][20];
        f1_idleTagMatches_1_1 = _RANDOM[6'h2B][21];
        f1_idleTagMatches_1_2 = _RANDOM[6'h2B][22];
        f1_idleTagMatches_1_3 = _RANDOM[6'h2B][23];
        f1_fwdPAddr_1 = {_RANDOM[6'h2B][31:24], _RANDOM[6'h2C], _RANDOM[6'h2D][7:0]};
        f1_ptagMatches_r_4 = {_RANDOM[6'h2D][31:8], _RANDOM[6'h2E][23:0]};
        f1_ptagMatches_r_5 = {_RANDOM[6'h2E][31:24], _RANDOM[6'h2F], _RANDOM[6'h30][7:0]};
        f1_ptagMatches_r_6 = {_RANDOM[6'h30][31:8], _RANDOM[6'h31][23:0]};
        f1_ptagMatches_r_7 = {_RANDOM[6'h31][31:24], _RANDOM[6'h32], _RANDOM[6'h33][7:0]};
        f1_tagMismatchVec_1_r = _RANDOM[6'h33][8];
        f1_tagMismatchVec_1_r_1 = _RANDOM[6'h33][9];
        f1_tagMismatchVec_1_r_2 = _RANDOM[6'h33][10];
        f1_tagMismatchVec_1_r_3 = _RANDOM[6'h33][11];
        f1_tagMismatchVec_1_r_4 = _RANDOM[6'h33][12];
        f1_tagMismatchVec_1_r_5 = _RANDOM[6'h33][13];
        f1_tagMismatchVec_1_r_6 = _RANDOM[6'h33][14];
        f1_tagMismatchVec_1_r_7 = _RANDOM[6'h33][15];
        f1_fwdValid_2 = _RANDOM[6'h36][22];
        f1_flyTagMatches_2_0 = _RANDOM[6'h36][23];
        f1_flyTagMatches_2_1 = _RANDOM[6'h36][24];
        f1_flyTagMatches_2_2 = _RANDOM[6'h36][25];
        f1_flyTagMatches_2_3 = _RANDOM[6'h36][26];
        f1_idleTagMatches_2_0 = _RANDOM[6'h36][27];
        f1_idleTagMatches_2_1 = _RANDOM[6'h36][28];
        f1_idleTagMatches_2_2 = _RANDOM[6'h36][29];
        f1_idleTagMatches_2_3 = _RANDOM[6'h36][30];
        f1_fwdPAddr_2 = {_RANDOM[6'h36][31], _RANDOM[6'h37], _RANDOM[6'h38][14:0]};
        f1_ptagMatches_r_8 = {_RANDOM[6'h38][31:15], _RANDOM[6'h39][30:0]};
        f1_ptagMatches_r_9 = {_RANDOM[6'h39][31], _RANDOM[6'h3A], _RANDOM[6'h3B][14:0]};
        f1_ptagMatches_r_10 = {_RANDOM[6'h3B][31:15], _RANDOM[6'h3C][30:0]};
        f1_ptagMatches_r_11 = {_RANDOM[6'h3C][31], _RANDOM[6'h3D], _RANDOM[6'h3E][14:0]};
        f1_tagMismatchVec_2_r = _RANDOM[6'h3E][15];
        f1_tagMismatchVec_2_r_1 = _RANDOM[6'h3E][16];
        f1_tagMismatchVec_2_r_2 = _RANDOM[6'h3E][17];
        f1_tagMismatchVec_2_r_3 = _RANDOM[6'h3E][18];
        f1_tagMismatchVec_2_r_4 = _RANDOM[6'h3E][19];
        f1_tagMismatchVec_2_r_5 = _RANDOM[6'h3E][20];
        f1_tagMismatchVec_2_r_6 = _RANDOM[6'h3E][21];
        f1_tagMismatchVec_2_r_7 = _RANDOM[6'h3E][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        states_0_valid = 1'h0;
        states_0_inflight = 1'h0;
  ...
  assign io_lsq_resp_bits_nc = _GEN_18[r0_canSentIdx];
  assign io_lsq_resp_bits_is2lq = _GEN_11[r0_canSentIdx] == 5'h0;
  assign io_lsq_resp_bits_nderr = _GEN_19[r0_canSentIdx];
