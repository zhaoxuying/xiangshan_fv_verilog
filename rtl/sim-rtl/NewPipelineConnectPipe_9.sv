  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pdest = {_RANDOM[4'h7][31:25], _RANDOM[4'h8][0]};
        data_fpWen = _RANDOM[4'h8][1];
        data_fpu_wflags = _RANDOM[4'h8][4];
        data_fpu_fmt = _RANDOM[4'h8][8:7];
        data_fpu_rm = _RANDOM[4'h8][11:9];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
