...
module AtomicsUnit(
  ...
  output [4:0]   io_feedbackSlow_bits_sqIdx_value,
  ...
  reg  [4:0]   io_feedbackSlow_bits_sqIdx_r_value;
  ...
  wire         difftest_valid = io_out_valid_0 & _difftest_valid_T_1 & isSc;
  ...
  wire         _GEN_10 = ~addrAligned | triggerAction == 4'h1 | triggerBreakpoint;
  wire         _GEN_11 = io_dtlb_req_valid_0 & _GEN_4 & ~io_dtlb_resp_bits_miss & _GEN_10;
  ...
  wire         _GEN_14 = _difftest_valid_T_1 & io_out_valid_0;
  wire         _GEN_15 = ~_GEN_14 | _io_in_ready_T_1;
  wire         _GEN_16 = _io_out_bits_data_T & io_out_valid_0;
  wire [3:0]   _GEN_17 = _GEN_10 ? 4'h7 : 4'h2;
  wire [3:0]   _GEN_18 = _GEN_12 ? 4'h7 : io_flush_sbuffer_empty ? 4'h4 : 4'h3;
  wire [3:0]   _GEN_19 = {1'h0, _GEN_12, 2'h3};
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      pdest1Valid <= ~_GEN_16 & _GEN_15 & (_GEN_2 | pdest1Valid);
      pdest2Valid <= ~_GEN_16 & _GEN_15 & (_GEN & ~_GEN_1 & _GEN_3 | pdest2Valid);
      if (_GEN_16 | ~_GEN_15)
        stdCnt <= 3'h0;
      else
        stdCnt <=
  ...
  always @(posedge clock) begin
    ...
    tdata_0_timing <= ~_GEN_20 & tdata_0_timing;
    if (_GEN_21) begin
    ...
    tdata_1_timing <= ~_GEN_21 & tdata_1_timing;
    if (_GEN_22) begin
    ...
    tdata_2_timing <= ~_GEN_22 & tdata_2_timing;
    if (_GEN_23) begin
    ...
    tdata_3_timing <= ~_GEN_23 & tdata_3_timing;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uop_fuOpType = _RANDOM[7'h6][21:13];
        uop_rfWen = _RANDOM[7'h6][22];
        uop_robIdx_flag = _RANDOM[7'h12][15];
        uop_robIdx_value = _RANDOM[7'h12][21:16];
        pdest1 = _RANDOM[7'h28][16:9];
        pdest2 = _RANDOM[7'h28][24:17];
        pdest1Valid = _RANDOM[7'h28][25];
        pdest2Valid = _RANDOM[7'h28][26];
        rs1 = {_RANDOM[7'h28][31:27], _RANDOM[7'h29], _RANDOM[7'h2A][26:0]};
        rs2_l = {_RANDOM[7'h2A][31:27], _RANDOM[7'h2B], _RANDOM[7'h2C][26:0]};
        rs2_h = {_RANDOM[7'h2C][31:27], _RANDOM[7'h2D], _RANDOM[7'h2E][26:0]};
        rd_l = {_RANDOM[7'h2E][31:27], _RANDOM[7'h2F], _RANDOM[7'h30][26:0]};
        rd_h = {_RANDOM[7'h30][31:27], _RANDOM[7'h31], _RANDOM[7'h32][26:0]};
        stdCnt = _RANDOM[7'h32][29:27];
        exceptionVec_3 = _RANDOM[7'h33][1];
        exceptionVec_4 = _RANDOM[7'h33][2];
        exceptionVec_5 = _RANDOM[7'h33][3];
        exceptionVec_6 = _RANDOM[7'h33][4];
        exceptionVec_7 = _RANDOM[7'h33][5];
        exceptionVec_13 = _RANDOM[7'h33][11];
        exceptionVec_15 = _RANDOM[7'h33][13];
        exceptionVec_21 = _RANDOM[7'h33][19];
        exceptionVec_23 = _RANDOM[7'h33][21];
        trigger = _RANDOM[7'h33][25:22];
        atom_override_xtval = _RANDOM[7'h33][26];
        have_sent_first_tlb_req = _RANDOM[7'h33][27];
        paddr = {_RANDOM[7'h33][31:28], _RANDOM[7'h34], _RANDOM[7'h35][11:0]};
        gpaddr = {_RANDOM[7'h35][31:12], _RANDOM[7'h36], _RANDOM[7'h37][11:0]};
        is_mmio = _RANDOM[7'h37][12];
        isForVSnonLeafPTE = _RANDOM[7'h37][13];
        resp_data =
          {_RANDOM[7'h37][31:14],
           _RANDOM[7'h38],
           _RANDOM[7'h39],
           _RANDOM[7'h3A],
           _RANDOM[7'h3B][13:0]};
        success = _RANDOM[7'h3B][14];
        tdata_0_matchType = _RANDOM[7'h3B][16:15];
        tdata_0_select = _RANDOM[7'h3B][17];
        tdata_0_timing = _RANDOM[7'h3B][18];
        tdata_0_action = _RANDOM[7'h3B][22:19];
        tdata_0_chain = _RANDOM[7'h3B][23];
        tdata_0_store = _RANDOM[7'h3B][25];
        tdata_0_load = _RANDOM[7'h3B][26];
        tdata_0_tdata2 = {_RANDOM[7'h3B][31:27], _RANDOM[7'h3C], _RANDOM[7'h3D][26:0]};
        tdata_1_matchType = _RANDOM[7'h3D][28:27];
        tdata_1_select = _RANDOM[7'h3D][29];
        tdata_1_timing = _RANDOM[7'h3D][30];
        tdata_1_action = {_RANDOM[7'h3D][31], _RANDOM[7'h3E][2:0]};
        tdata_1_chain = _RANDOM[7'h3E][3];
        tdata_1_store = _RANDOM[7'h3E][5];
        tdata_1_load = _RANDOM[7'h3E][6];
        tdata_1_tdata2 = {_RANDOM[7'h3E][31:7], _RANDOM[7'h3F], _RANDOM[7'h40][6:0]};
        tdata_2_matchType = _RANDOM[7'h40][8:7];
        tdata_2_select = _RANDOM[7'h40][9];
        tdata_2_timing = _RANDOM[7'h40][10];
        tdata_2_action = _RANDOM[7'h40][14:11];
        tdata_2_chain = _RANDOM[7'h40][15];
        tdata_2_store = _RANDOM[7'h40][17];
        tdata_2_load = _RANDOM[7'h40][18];
        tdata_2_tdata2 = {_RANDOM[7'h40][31:19], _RANDOM[7'h41], _RANDOM[7'h42][18:0]};
        tdata_3_matchType = _RANDOM[7'h42][20:19];
        tdata_3_select = _RANDOM[7'h42][21];
        tdata_3_timing = _RANDOM[7'h42][22];
        tdata_3_action = _RANDOM[7'h42][26:23];
        tdata_3_chain = _RANDOM[7'h42][27];
        tdata_3_store = _RANDOM[7'h42][29];
        tdata_3_load = _RANDOM[7'h42][30];
        tdata_3_tdata2 = {_RANDOM[7'h42][31], _RANDOM[7'h43], _RANDOM[7'h44][30:0]};
        tEnableVec_0 = _RANDOM[7'h44][31];
        tEnableVec_1 = _RANDOM[7'h45][0];
        tEnableVec_2 = _RANDOM[7'h45][1];
        tEnableVec_3 = _RANDOM[7'h45][2];
        backendTriggerCanFireVec_0 = _RANDOM[7'h45][3];
        backendTriggerCanFireVec_1 = _RANDOM[7'h45][4];
        backendTriggerCanFireVec_2 = _RANDOM[7'h45][5];
        backendTriggerCanFireVec_3 = _RANDOM[7'h45][6];
        pbmtReg = _RANDOM[7'h47][8:7];
        dcache_resp_data =
          {_RANDOM[7'h47][31:9],
           _RANDOM[7'h48],
           _RANDOM[7'h49],
           _RANDOM[7'h4A],
           _RANDOM[7'h4B][8:0]};
        dcache_resp_id = _RANDOM[7'h4B][12:9];
        dcache_resp_error = _RANDOM[7'h4B][13];
        io_feedbackSlow_valid_last_REG = _RANDOM[7'h4B][14];
        io_feedbackSlow_valid_last_REG_1 = _RANDOM[7'h4B][15];
        io_feedbackSlow_bits_sqIdx_r_flag = _RANDOM[7'h4B][23];
        io_feedbackSlow_bits_sqIdx_r_value = _RANDOM[7'h4B][28:24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        state = 4'h0;
        out_valid = 1'h0;
