  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_fpu_wflags = _RANDOM[5'h18][5];
        data_vpu_vma = _RANDOM[5'h18][14];
        data_vpu_vta = _RANDOM[5'h18][15];
        data_vpu_vsew = _RANDOM[5'h18][17:16];
        data_vpu_vlmul = _RANDOM[5'h18][20:18];
        data_vpu_vm = _RANDOM[5'h18][29];
        data_vpu_vstart = {_RANDOM[5'h18][31:30], _RANDOM[5'h19][5:0]};
        data_vpu_vuopIdx = _RANDOM[5'h19][24:18];
        data_vpu_isExt = _RANDOM[5'h1E][8];
        data_vpu_isNarrow = _RANDOM[5'h1E][9];
        data_vpu_isDstMask = _RANDOM[5'h1E][10];
        data_vpu_isOpMask = _RANDOM[5'h1E][11];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
