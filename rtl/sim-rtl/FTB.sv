...
module FTB(
  ...
  wire         _ftbBank_io_read_hits_bits;
  ...
  wire         _ftbBank_io_read_multi_hits_bits;
  wire         _ftbBank_io_update_hits_valid;
  wire         _ftbBank_io_update_hits_bits;
  ...
  reg  [1:0]   io_out_last_stage_meta_r;
  ...
  reg          ftbBank_io_update_write_way_REG;
  ...
  always @(posedge clock) begin
    ...
    if (io_s1_fire_0) begin
      ...
      s2_ftb_meta <= {~s1_close_ftb_req & _ftbBank_io_read_hits_bits, s1_hit};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_ftb_meta = _RANDOM[7'h2C][3:2];
        fauftb_ftb_entry_consistent_counter = _RANDOM[7'h2E][12:4];
        update_valid = _RANDOM[7'h2E][13];
        update_r_ftb_entry_isCall = _RANDOM[7'h32][14];
        update_r_ftb_entry_isRet = _RANDOM[7'h32][15];
        update_r_ftb_entry_isJalr = _RANDOM[7'h32][16];
        update_r_ftb_entry_valid = _RANDOM[7'h32][17];
        update_r_ftb_entry_brSlots_0_offset = _RANDOM[7'h32][21:18];
        update_r_ftb_entry_brSlots_0_sharing = _RANDOM[7'h32][22];
        update_r_ftb_entry_brSlots_0_valid = _RANDOM[7'h32][23];
        update_r_ftb_entry_brSlots_0_lower = {_RANDOM[7'h32][31:24], _RANDOM[7'h33][3:0]};
        update_r_ftb_entry_brSlots_0_tarStat = _RANDOM[7'h33][5:4];
        update_r_ftb_entry_tailSlot_offset = _RANDOM[7'h33][9:6];
        update_r_ftb_entry_tailSlot_sharing = _RANDOM[7'h33][10];
        update_r_ftb_entry_tailSlot_valid = _RANDOM[7'h33][11];
        update_r_ftb_entry_tailSlot_lower = _RANDOM[7'h33][31:12];
        update_r_ftb_entry_tailSlot_tarStat = _RANDOM[7'h34][1:0];
        update_r_ftb_entry_pftAddr = _RANDOM[7'h34][5:2];
        update_r_ftb_entry_carry = _RANDOM[7'h34][6];
        update_r_ftb_entry_last_may_be_rvi_call = _RANDOM[7'h34][7];
        update_r_ftb_entry_strong_bias_0 = _RANDOM[7'h34][8];
        update_r_ftb_entry_strong_bias_1 = _RANDOM[7'h34][9];
        update_r_false_hit = _RANDOM[7'h34][24];
        update_r_old_entry = _RANDOM[7'h34][27];
        update_meta_r =
          {_RANDOM[7'h40],
           _RANDOM[7'h41],
           _RANDOM[7'h42],
           ...
           _RANDOM[7'h47],
           _RANDOM[7'h48][3:0]};
        last_stage_pc_higher = {_RANDOM[7'h48][31:4], _RANDOM[7'h49][0]};
        last_stage_pc_middle = _RANDOM[7'h49][8:1];
        last_stage_pc_higher_plus_one = {_RANDOM[7'h49][31:9], _RANDOM[7'h4A][5:0]};
        last_stage_pc_higher_minus_one = {_RANDOM[7'h4A][31:6], _RANDOM[7'h4B][2:0]};
        last_stage_pc_middle_plus_one = _RANDOM[7'h4B][11:3];
        last_stage_pc_middle_minus_one = _RANDOM[7'h4B][20:12];
        io_out_s2_full_pred_0_fallThroughAddr_stashed_carry = _RANDOM[7'h4B][21];
        last_stage_pc_higher_1 = {_RANDOM[7'h4B][31:22], _RANDOM[7'h4C][18:0]};
        last_stage_pc_middle_1 = _RANDOM[7'h4C][26:19];
        last_stage_pc_higher_plus_one_1 = {_RANDOM[7'h4C][31:27], _RANDOM[7'h4D][23:0]};
        last_stage_pc_higher_minus_one_1 = {_RANDOM[7'h4D][31:24], _RANDOM[7'h4E][20:0]};
        last_stage_pc_middle_plus_one_1 = _RANDOM[7'h4E][29:21];
        last_stage_pc_middle_minus_one_1 = {_RANDOM[7'h4E][31:30], _RANDOM[7'h4F][6:0]};
        io_out_s2_full_pred_1_fallThroughAddr_stashed_carry = _RANDOM[7'h4F][7];
        last_stage_pc_higher_2 = {_RANDOM[7'h4F][31:8], _RANDOM[7'h50][4:0]};
        last_stage_pc_middle_2 = _RANDOM[7'h50][12:5];
        last_stage_pc_higher_plus_one_2 = {_RANDOM[7'h50][31:13], _RANDOM[7'h51][9:0]};
        last_stage_pc_higher_minus_one_2 = {_RANDOM[7'h51][31:10], _RANDOM[7'h52][6:0]};
        last_stage_pc_middle_plus_one_2 = _RANDOM[7'h52][15:7];
        last_stage_pc_middle_minus_one_2 = _RANDOM[7'h52][24:16];
        io_out_s2_full_pred_2_fallThroughAddr_stashed_carry = _RANDOM[7'h52][25];
        last_stage_pc_higher_3 = {_RANDOM[7'h52][31:26], _RANDOM[7'h53][22:0]};
        last_stage_pc_middle_3 = _RANDOM[7'h53][30:23];
        last_stage_pc_higher_plus_one_3 = {_RANDOM[7'h53][31], _RANDOM[7'h54][27:0]};
        last_stage_pc_higher_minus_one_3 = {_RANDOM[7'h54][31:28], _RANDOM[7'h55][24:0]};
        last_stage_pc_middle_plus_one_3 = {_RANDOM[7'h55][31:25], _RANDOM[7'h56][1:0]};
        last_stage_pc_middle_minus_one_3 = _RANDOM[7'h56][10:2];
        io_out_s2_full_pred_3_fallThroughAddr_stashed_carry = _RANDOM[7'h56][11];
        last_stage_pc_higher_4 = {_RANDOM[7'h56][31:12], _RANDOM[7'h57][8:0]};
        last_stage_pc_middle_4 = _RANDOM[7'h57][16:9];
        last_stage_pc_higher_plus_one_4 = {_RANDOM[7'h57][31:17], _RANDOM[7'h58][13:0]};
        last_stage_pc_higher_minus_one_4 = {_RANDOM[7'h58][31:14], _RANDOM[7'h59][10:0]};
        last_stage_pc_middle_plus_one_4 = _RANDOM[7'h59][19:11];
        last_stage_pc_middle_minus_one_4 = _RANDOM[7'h59][28:20];
        last_stage_pc_higher_5 = {_RANDOM[7'h59][31:29], _RANDOM[7'h5A][25:0]};
        last_stage_pc_middle_5 = {_RANDOM[7'h5A][31:26], _RANDOM[7'h5B][1:0]};
        last_stage_pc_higher_plus_one_5 = _RANDOM[7'h5B][30:2];
        last_stage_pc_higher_minus_one_5 = {_RANDOM[7'h5B][31], _RANDOM[7'h5C][27:0]};
        last_stage_pc_middle_plus_one_5 = {_RANDOM[7'h5C][31:28], _RANDOM[7'h5D][4:0]};
        last_stage_pc_middle_minus_one_5 = _RANDOM[7'h5D][13:5];
        last_stage_pc_higher_6 = {_RANDOM[7'h5D][31:14], _RANDOM[7'h5E][10:0]};
        last_stage_pc_middle_6 = _RANDOM[7'h5E][18:11];
        last_stage_pc_higher_plus_one_6 = {_RANDOM[7'h5E][31:19], _RANDOM[7'h5F][15:0]};
        last_stage_pc_higher_minus_one_6 = {_RANDOM[7'h5F][31:16], _RANDOM[7'h60][12:0]};
        last_stage_pc_middle_plus_one_6 = _RANDOM[7'h60][21:13];
        last_stage_pc_middle_minus_one_6 = _RANDOM[7'h60][30:22];
        last_stage_pc_higher_7 = {_RANDOM[7'h60][31], _RANDOM[7'h61][27:0]};
        last_stage_pc_middle_7 = {_RANDOM[7'h61][31:28], _RANDOM[7'h62][3:0]};
        last_stage_pc_higher_plus_one_7 = {_RANDOM[7'h62][31:4], _RANDOM[7'h63][0]};
        last_stage_pc_higher_minus_one_7 = _RANDOM[7'h63][29:1];
        last_stage_pc_middle_plus_one_7 = {_RANDOM[7'h63][31:30], _RANDOM[7'h64][6:0]};
        last_stage_pc_middle_minus_one_7 = _RANDOM[7'h64][15:7];
        io_out_last_stage_meta_r = _RANDOM[7'h64][17:16];
        io_s1_ready_REG = _RANDOM[7'h64][18];
        ftbBank_io_update_write_way_REG = _RANDOM[7'h64][19];
        ftbBank_io_update_write_alloc_REG = _RANDOM[7'h64][20];
        io_perf_0_value_REG = _RANDOM[7'h64][23];
        io_perf_0_value_REG_1 = _RANDOM[7'h64][24];
        io_perf_1_value_REG = _RANDOM[7'h64][25];
        io_perf_1_value_REG_1 = _RANDOM[7'h64][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s2_pc_dup_s2_pc_seg_0_value = 26'h0;
        s2_pc_dup_s2_pc_seg_1_value = 12'h0;
  ...
  FTBBank ftbBank (
    ...
    .io_update_write_data_bits_tag                        (write_pc[25:6]),
    .io_update_write_way
      (update_now ? update_meta_r[1] : ftbBank_io_update_write_way_REG),
  ...
  assign io_out_last_stage_meta = {258'h0, io_out_last_stage_meta_r};
