...
module MultiWakeupQueue(
  ...
  input  [5:0]  io_flush_redirect_bits_robIdx_value,
  ...
  input  [5:0]  io_enq_bits_uop_robIdx_value,
  ...
  wire [5:0]  _pipes_1_io_deq_bits_robIdx_value;
  wire [5:0]  _pipes_1_io_deq_bits_pdest;
  ...
  wire [5:0]  lastConnect_bits_newExuInput_pdest =
    (_pipes_0_io_deq_valid ? _pipes_0_io_deq_bits_pdest : 6'h0)
    | (pipesValidVec_1 ? _pipes_1_io_deq_bits_pdest : 6'h0);
