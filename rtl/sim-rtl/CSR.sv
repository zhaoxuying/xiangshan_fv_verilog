...
module CSR(
  ...
  input  [2:0]  io_flush_bits_ftqIdx_value,
  ...
  output [5:0]  io_out_bits_res_redirect_bits_robIdx_value,
  output        io_out_bits_res_redirect_bits_ftqIdx_flag,
  output [2:0]  io_out_bits_res_redirect_bits_ftqIdx_value,
  ...
  output [2:0]  io_out_bits_res_redirect_bits_cfiUpdate_ssp,
  output [2:0]  io_out_bits_res_redirect_bits_cfiUpdate_sctr,
  output        io_out_bits_res_redirect_bits_cfiUpdate_TOSW_flag,
  output [3:0]  io_out_bits_res_redirect_bits_cfiUpdate_TOSW_value,
  output        io_out_bits_res_redirect_bits_cfiUpdate_TOSR_flag,
  output [3:0]  io_out_bits_res_redirect_bits_cfiUpdate_TOSR_value,
  output        io_out_bits_res_redirect_bits_cfiUpdate_NOS_flag,
  output [3:0]  io_out_bits_res_redirect_bits_cfiUpdate_NOS_value,
  output [49:0] io_out_bits_res_redirect_bits_cfiUpdate_topAddr,
  output [4:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_12_folded_hist,
  output [4:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_11_folded_hist,
  output [6:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_10_folded_hist,
  output [5:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_9_folded_hist,
  output [5:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_8_folded_hist,
  output [7:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_7_folded_hist,
  output [7:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_6_folded_hist,
  output [5:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_5_folded_hist,
  output [6:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_4_folded_hist,
  output [3:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_3_folded_hist,
  output [5:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_2_folded_hist,
  output [4:0]  io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_1_folded_hist,
  ...
  output [5:0]  io_out_bits_res_redirect_bits_cfiUpdate_histPtr_value,
  ...
  output [2:0]  io_out_bits_res_redirect_bits_stFtqIdx_value,
  ...
  input  [2:0]  io_csrin_trapInstInfo_bits_ftqPtr_value,
  ...
  input  [5:0]  io_csrio_robDeqPtr_value,
  ...
  reg  [2:0]  trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_value;
  ...
  reg  [2:0]  trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_value;
  ...
  reg  [2:0]  io_out_bits_res_redirect_bits_ftqIdx_r_value;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        robIdxReg_value = _RANDOM[5'h2][18:13];
        trapInstMod_io_fromDecode_trapInstInfo_next_valid_last_REG = _RANDOM[5'h2][19];
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_instr =
          {_RANDOM[5'h2][31:20], _RANDOM[5'h3][19:0]};
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_flag =
          _RANDOM[5'h3][20];
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_value =
          _RANDOM[5'h3][23:21];
        ...
        trapInstMod_io_faultCsrUop_bits_fuOpType_r =
          {_RANDOM[5'h3][31:28], _RANDOM[5'h4][4:0]};
        trapInstMod_io_faultCsrUop_bits_imm_r =
          {_RANDOM[5'h4][31:5], _RANDOM[5'h5], _RANDOM[5'h6][4:0]};
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_flag = _RANDOM[5'h6][5];
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_value = _RANDOM[5'h6][8:6];
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqOffset_r = _RANDOM[5'h6][12:9];
        exceptionVec_3_r = _RANDOM[5'h6][13];
        exceptionVec_11_r = _RANDOM[5'h6][14];
        exceptionVec_9_r = _RANDOM[5'h6][15];
        exceptionVec_10_r = _RANDOM[5'h6][16];
        exceptionVec_8_r = _RANDOM[5'h6][17];
        io_out_bits_res_redirect_valid_r = _RANDOM[5'h6][18];
        io_out_bits_res_redirect_bits_ftqIdx_r_flag = _RANDOM[5'h6][19];
        io_out_bits_res_redirect_bits_ftqIdx_r_value = _RANDOM[5'h6][22:20];
        io_out_bits_res_redirect_bits_ftqOffset_r = _RANDOM[5'h6][26:23];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h6][27];
        io_out_bits_ctrl_robIdx_r_value = {_RANDOM[5'h6][31:28], _RANDOM[5'h7][1:0]};
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h7][9:2];
        io_out_bits_ctrl_rfWen_r = _RANDOM[5'h7][10];
        io_error_0_REG = _RANDOM[5'h1B][18];
        io_error_0_REG_1 = _RANDOM[5'h1B][19];
        io_csrio_isPerfCnt_r = _RANDOM[5'h1B][20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        waddrReg = 12'h0;
        wdataReg = 64'h0;
  ...
  NewCSR csrMod (
    ...
    .io_fromRob_commit_vl                                   (io_csrio_vpu_vl[7:0]),
    ...
    .fromAIA_vseip                                          (_imsic_toCSR_pendings[6:2]),
    .fromAIA_mtopei_IID
  ...
  assign io_out_bits_res_redirect_bits_cfiUpdate_TOSW_value = 4'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_TOSR_flag = 1'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_TOSR_value = 4'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_NOS_flag = 1'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_NOS_value = 4'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_topAddr = 50'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_12_folded_hist = 5'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_11_folded_hist = 5'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_10_folded_hist = 7'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_9_folded_hist = 6'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_8_folded_hist = 6'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_7_folded_hist = 8'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_6_folded_hist = 8'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_5_folded_hist = 6'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_4_folded_hist = 7'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_3_folded_hist = 4'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_2_folded_hist = 6'h0;
  assign io_out_bits_res_redirect_bits_cfiUpdate_folded_hist_hist_1_folded_hist = 5'h0;
  ...
  assign io_out_bits_res_redirect_bits_cfiUpdate_histPtr_value = 6'h0;
  ...
  assign io_out_bits_res_redirect_bits_stFtqIdx_value = 3'h0;
  ...
  assign io_csrio_isPerfCnt =
    _csrMod_io_out_valid & _csrMod_io_out_bits_isPerfCnt & io_csrio_isPerfCnt_r;
