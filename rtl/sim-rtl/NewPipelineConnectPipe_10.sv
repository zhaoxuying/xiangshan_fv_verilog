  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_robIdx_value = _RANDOM[4'h9][19:14];
        data_pdest = {_RANDOM[4'h9][31:25], _RANDOM[4'hA][0]};
        data_rfWen = _RANDOM[4'hA][1];
        data_fpWen = _RANDOM[4'hA][2];
        data_fpu_wflags = _RANDOM[4'hA][5];
        data_fpu_fmt = _RANDOM[4'hA][9:8];
        data_fpu_rm = _RANDOM[4'hA][12:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
