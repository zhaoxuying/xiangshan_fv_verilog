  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_fuOpType = _RANDOM[6'h6][16:8];
        data_uop_vecWen = _RANDOM[6'h6][19];
        data_uop_v0Wen = _RANDOM[6'h6][20];
        data_uop_vlWen = _RANDOM[6'h6][21];
        data_uop_flushPipe = _RANDOM[6'h6][25];
        data_uop_vpu_vma = _RANDOM[6'h8][10];
        data_uop_vpu_vta = _RANDOM[6'h8][11];
        data_uop_vpu_vsew = _RANDOM[6'h8][13:12];
        data_uop_vpu_vlmul = _RANDOM[6'h8][16:14];
        data_uop_vpu_vm = _RANDOM[6'h8][25];
        data_uop_vpu_vstart = {_RANDOM[6'h8][31:26], _RANDOM[6'h9][1:0]};
        data_uop_vpu_vuopIdx = _RANDOM[6'h9][20:14];
        data_uop_vpu_vmask =
          {_RANDOM[6'h9][31:22],
           _RANDOM[6'hA],
           _RANDOM[6'hB],
           _RANDOM[6'hC],
           _RANDOM[6'hD][21:0]};
        data_uop_vpu_vl = _RANDOM[6'hD][29:22];
        data_uop_vpu_nf = {_RANDOM[6'hD][31:30], _RANDOM[6'hE][0]};
        data_uop_vpu_veew = _RANDOM[6'hE][2:1];
        data_uop_pdest = _RANDOM[6'h11][29:22];
        data_uop_robIdx_flag = _RANDOM[6'h12][10];
        data_uop_robIdx_value = _RANDOM[6'h12][16:11];
        data_uop_replayInst = _RANDOM[6'h27][30];
        data_data =
          {_RANDOM[6'h28][31:4],
           _RANDOM[6'h29],
           _RANDOM[6'h2A],
           _RANDOM[6'h2B],
           _RANDOM[6'h2C][3:0]};
        data_vdIdx = _RANDOM[6'h30][6:4];
        data_vdIdxInField = _RANDOM[6'h30][9:7];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
