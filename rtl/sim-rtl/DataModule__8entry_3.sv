  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_0_gpaddr = {_RANDOM[4'h0], _RANDOM[4'h1][23:0]};
        data_0_isForVSnonLeafPTE = _RANDOM[4'h1][24];
        data_1_gpaddr = {_RANDOM[4'h1][31:25], _RANDOM[4'h2], _RANDOM[4'h3][16:0]};
        data_1_isForVSnonLeafPTE = _RANDOM[4'h3][17];
        data_2_gpaddr = {_RANDOM[4'h3][31:18], _RANDOM[4'h4], _RANDOM[4'h5][9:0]};
        data_2_isForVSnonLeafPTE = _RANDOM[4'h5][10];
        data_3_gpaddr = {_RANDOM[4'h5][31:11], _RANDOM[4'h6], _RANDOM[4'h7][2:0]};
        data_3_isForVSnonLeafPTE = _RANDOM[4'h7][3];
        data_4_gpaddr = {_RANDOM[4'h7][31:4], _RANDOM[4'h8][27:0]};
        data_4_isForVSnonLeafPTE = _RANDOM[4'h8][28];
        data_5_gpaddr = {_RANDOM[4'h8][31:29], _RANDOM[4'h9], _RANDOM[4'hA][20:0]};
        data_5_isForVSnonLeafPTE = _RANDOM[4'hA][21];
        data_6_gpaddr = {_RANDOM[4'hA][31:22], _RANDOM[4'hB], _RANDOM[4'hC][13:0]};
        data_6_isForVSnonLeafPTE = _RANDOM[4'hC][14];
        data_7_gpaddr = {_RANDOM[4'hC][31:15], _RANDOM[4'hD], _RANDOM[4'hE][6:0]};
        data_7_isForVSnonLeafPTE = _RANDOM[4'hE][7];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_rdata_0_gpaddr =
    read_by_0
      ...
      : (_io_rdata_0_T ? data_0_gpaddr : 56'h0)
        ...
        | ((&io_raddr_0) ? data_7_gpaddr : 56'h0);
  assign io_rdata_0_isForVSnonLeafPTE =
    read_by_0
      ...
      : _io_rdata_0_T & data_0_isForVSnonLeafPTE | _io_rdata_0_T_1
        ...
        | _io_rdata_0_T_6 & data_6_isForVSnonLeafPTE | (&io_raddr_0)
        & data_7_isForVSnonLeafPTE;
endmodule
