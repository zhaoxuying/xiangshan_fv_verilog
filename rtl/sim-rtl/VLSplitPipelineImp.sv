...
module VLSplitPipelineImp(
  ...
  always @(posedge clock) begin
    if (s0_fire) begin
      ...
      s1_in_r_fof <=
        ~(|(io_in_bits_uop_fuOpType[6:5])) & io_in_bits_uop_fuOpType == 9'h90;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_uop_ftqPtr_value = _RANDOM[6'h13][13:11];
        s1_in_r_uop_ftqOffset = _RANDOM[6'h13][17:14];
        s1_in_r_uop_fuOpType = _RANDOM[6'h15][23:15];
        s1_in_r_uop_vecWen = _RANDOM[6'h15][26];
        s1_in_r_uop_v0Wen = _RANDOM[6'h15][27];
        s1_in_r_uop_vlWen = _RANDOM[6'h15][28];
        s1_in_r_uop_vpu_vma = _RANDOM[6'h17][17];
        s1_in_r_uop_vpu_vta = _RANDOM[6'h17][18];
        s1_in_r_uop_vpu_vsew = _RANDOM[6'h17][20:19];
        s1_in_r_uop_vpu_vlmul = _RANDOM[6'h17][23:21];
        s1_in_r_uop_vpu_vm = _RANDOM[6'h18][0];
        s1_in_r_uop_vpu_vstart = _RANDOM[6'h18][8:1];
        s1_in_r_uop_vpu_vuopIdx = _RANDOM[6'h18][27:21];
        s1_in_r_uop_vpu_vl = {_RANDOM[6'h1C][31:29], _RANDOM[6'h1D][4:0]};
        s1_in_r_uop_vpu_nf = _RANDOM[6'h1D][7:5];
        s1_in_r_uop_vpu_veew = _RANDOM[6'h1D][9:8];
        s1_in_r_uop_uopIdx = _RANDOM[6'h1D][29:23];
        s1_in_r_uop_pdest = {_RANDOM[6'h20][31:29], _RANDOM[6'h21][4:0]};
        s1_in_r_uop_robIdx_flag = _RANDOM[6'h21][17];
        s1_in_r_uop_robIdx_value = _RANDOM[6'h21][23:18];
        s1_in_r_uop_lqIdx_flag = _RANDOM[6'h36][24];
        s1_in_r_uop_lqIdx_value = _RANDOM[6'h36][29:25];
        s1_in_r_uop_sqIdx_flag = _RANDOM[6'h36][30];
        s1_in_r_uop_sqIdx_value = {_RANDOM[6'h36][31], _RANDOM[6'h37][3:0]};
        s1_in_r_fof = _RANDOM[6'h37][11];
        s1_in_r_vdIdxInField = _RANDOM[6'h37][14:12];
        s1_in_r_preIsSplit = _RANDOM[6'h3B][15];
        s1_in_r_alignedType = _RANDOM[6'h3B][22:20];
        s1_in_r_indexVlMaxInVd = _RANDOM[6'h3B][30:23];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial
