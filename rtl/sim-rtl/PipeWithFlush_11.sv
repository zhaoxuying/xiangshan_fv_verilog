  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_2_robIdx_flag = _RANDOM[7'h28][23];
        bits_2_robIdx_value = _RANDOM[7'h28][29:24];
        bits_2_pdest = _RANDOM[7'h29][10:3];
        bits_2_fpWen = _RANDOM[7'h29][12];
        bits_3_robIdx_flag = _RANDOM[7'h47][31];
        bits_3_robIdx_value = _RANDOM[7'h48][5:0];
        bits_3_pdest = _RANDOM[7'h48][18:11];
        bits_3_fpWen = _RANDOM[7'h48][20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
