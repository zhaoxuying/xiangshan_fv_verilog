...
module ICacheDataArray(
  ...
  input  [1:0]   io_read_0_bits_vSetIdx_0,
  input  [1:0]   io_read_0_bits_vSetIdx_1,
  ...
  input  [1:0]   io_read_1_bits_vSetIdx_0,
  input  [1:0]   io_read_1_bits_vSetIdx_1,
  input          io_read_2_valid,
  input  [1:0]   io_read_2_bits_vSetIdx_0,
  input  [1:0]   io_read_2_bits_vSetIdx_1,
  output         io_read_3_ready,
  input          io_read_3_valid,
  input  [1:0]   io_read_3_bits_vSetIdx_0,
  input  [1:0]   io_read_3_bits_vSetIdx_1,
  ...
  wire [1:0]  _GEN_1 = lineSel_2 ? io_read_2_bits_vSetIdx_1 : io_read_2_bits_vSetIdx_0;
  wire [1:0]  _GEN_2 =
    io_read_0_bits_blkOffset[5] ? io_read_3_bits_vSetIdx_1 : io_read_3_bits_vSetIdx_0;
  wire [1:0]  _GEN_3 = lineSel_4 ? io_read_0_bits_vSetIdx_1 : io_read_0_bits_vSetIdx_0;
  wire [1:0]  _GEN_4 = lineSel_5 ? io_read_1_bits_vSetIdx_1 : io_read_1_bits_vSetIdx_0;
  wire [1:0]  _GEN_5 =
    (&(io_read_0_bits_blkOffset[5:3]))
