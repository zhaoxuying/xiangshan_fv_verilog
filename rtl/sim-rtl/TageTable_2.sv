...
module TageTable_2(
  ...
  input  [7:0]  io_req_bits_folded_hist_hist_6_folded_hist,
  input  [5:0]  io_req_bits_folded_hist_hist_5_folded_hist,
  input  [4:0]  io_req_bits_folded_hist_hist_1_folded_hist,
  ...
  wire [7:0]  s0_idx = io_req_bits_pc[8:1] ^ io_req_bits_folded_hist_hist_6_folded_hist;
  ...
  wire [7:0]  update_idx =
    io_update_pc[8:1] ^ io_update_ghist[7:0]
    ^ {io_update_ghist[15:11], io_update_ghist[10:8] ^ io_update_ghist[18:16]};
  wire [5:0]  update_tag =
    io_update_pc[6:1] ^ io_update_ghist[5:0] ^ io_update_ghist[11:6]
    ^ {io_update_ghist[17:13], io_update_ghist[12] ^ io_update_ghist[18]}
    ^ {io_update_ghist[4:0] ^ io_update_ghist[9:5]
         ^ {io_update_ghist[14], io_update_ghist[13:10] ^ io_update_ghist[18:15]},
       1'h0};
  ...
  always @(posedge clock) begin
    if (_s1_bank_req_1h_T) begin
      ...
      s1_tag <=
        io_req_bits_pc[6:1] ^ io_req_bits_folded_hist_hist_5_folded_hist
        ^ {io_req_bits_folded_hist_hist_1_folded_hist, 1'h0};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_tag = _RANDOM[2'h1][30:25];
        s1_bank_req_1h_0 = _RANDOM[2'h3][17];
        s1_bank_req_1h_1 = _RANDOM[2'h3][18];
        s1_bank_req_1h_2 = _RANDOM[2'h3][19];
        s1_bank_req_1h_3 = _RANDOM[2'h3][20];
        s1_bank_has_write_on_this_req_0 = _RANDOM[2'h3][21];
        s1_bank_has_write_on_this_req_1 = _RANDOM[2'h3][22];
        s1_bank_has_write_on_this_req_2 = _RANDOM[2'h3][23];
        s1_bank_has_write_on_this_req_3 = _RANDOM[2'h3][24];
        powerOnResetState = _RANDOM[2'h3][25];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        powerOnResetState = 1'h1;
    end // initial
  ...
  FoldedSRAMTemplate_1 table_banks_0 (
    ...
    .io_r_req_bits_setIdx     (s0_idx[7:2]),
    ...
    .io_w_req_bits_setIdx     (update_idx[7:2]),
