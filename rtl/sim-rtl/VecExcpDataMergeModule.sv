...
module VecExcpDataMergeModule(
  ...
  reg  [7:0]      regMaps_0_newPreg;
  reg  [7:0]      regMaps_0_oldPreg;
  reg  [5:0]      regMaps_1_lreg;
  reg  [7:0]      regMaps_1_newPreg;
  reg  [7:0]      regMaps_1_oldPreg;
  reg  [5:0]      regMaps_2_lreg;
  reg  [7:0]      regMaps_2_newPreg;
  reg  [7:0]      regMaps_2_oldPreg;
  reg  [5:0]      regMaps_3_lreg;
  reg  [7:0]      regMaps_3_newPreg;
  reg  [7:0]      regMaps_3_oldPreg;
  reg  [5:0]      regMaps_4_lreg;
  reg  [7:0]      regMaps_4_newPreg;
  reg  [7:0]      regMaps_4_oldPreg;
  reg  [5:0]      regMaps_5_lreg;
  reg  [7:0]      regMaps_5_newPreg;
  reg  [7:0]      regMaps_5_oldPreg;
  reg  [5:0]      regMaps_6_lreg;
  reg  [7:0]      regMaps_6_newPreg;
  reg  [7:0]      regMaps_6_oldPreg;
  reg  [5:0]      regMaps_7_lreg;
  reg  [7:0]      regMaps_7_newPreg;
  reg  [7:0]      regMaps_7_oldPreg;
  reg  [3:0]      currentIdx;
  ...
  wire [7:0]      _oldPregVecFromRat_0_bits_T_2 =
    (i_fromRat_vecOldVdPdest_0_valid ? i_fromRat_vecOldVdPdest_0_bits : 8'h0)
    | (i_fromRat_v0OldVdPdest_0_valid ? i_fromRat_v0OldVdPdest_0_bits : 8'h0);
  wire [7:0]      _oldPregVecFromRat_1_bits_T_2 =
    (i_fromRat_vecOldVdPdest_1_valid ? i_fromRat_vecOldVdPdest_1_bits : 8'h0)
    | (i_fromRat_v0OldVdPdest_1_valid ? i_fromRat_v0OldVdPdest_1_bits : 8'h0);
  wire [7:0]      _oldPregVecFromRat_2_bits_T_2 =
    (i_fromRat_vecOldVdPdest_2_valid ? i_fromRat_vecOldVdPdest_2_bits : 8'h0)
    | (i_fromRat_v0OldVdPdest_2_valid ? i_fromRat_v0OldVdPdest_2_bits : 8'h0);
  wire [7:0]      _oldPregVecFromRat_3_bits_T_2 =
    (i_fromRat_vecOldVdPdest_3_valid ? i_fromRat_vecOldVdPdest_3_bits : 8'h0)
    | (i_fromRat_v0OldVdPdest_3_valid ? i_fromRat_v0OldVdPdest_3_bits : 8'h0);
  wire [7:0]      _oldPregVecFromRat_4_bits_T_2 =
    (i_fromRat_vecOldVdPdest_4_valid ? i_fromRat_vecOldVdPdest_4_bits : 8'h0)
    | (i_fromRat_v0OldVdPdest_4_valid ? i_fromRat_v0OldVdPdest_4_bits : 8'h0);
  wire [7:0]      _oldPregVecFromRat_5_bits_T_2 =
    (i_fromRat_vecOldVdPdest_5_valid ? i_fromRat_vecOldVdPdest_5_bits : 8'h0)
    | (i_fromRat_v0OldVdPdest_5_valid ? i_fromRat_v0OldVdPdest_5_bits : 8'h0);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        regMaps_0_newPreg = _RANDOM[5'h1][13:6];
        regMaps_0_oldPreg = _RANDOM[5'h1][21:14];
        regMaps_1_lreg = _RANDOM[5'h1][27:22];
        regMaps_1_newPreg = {_RANDOM[5'h1][31:28], _RANDOM[5'h2][3:0]};
        regMaps_1_oldPreg = _RANDOM[5'h2][11:4];
        regMaps_2_lreg = _RANDOM[5'h2][17:12];
        regMaps_2_newPreg = _RANDOM[5'h2][25:18];
        regMaps_2_oldPreg = {_RANDOM[5'h2][31:26], _RANDOM[5'h3][1:0]};
        regMaps_3_lreg = _RANDOM[5'h3][7:2];
        regMaps_3_newPreg = _RANDOM[5'h3][15:8];
        regMaps_3_oldPreg = _RANDOM[5'h3][23:16];
        regMaps_4_lreg = _RANDOM[5'h3][29:24];
        regMaps_4_newPreg = {_RANDOM[5'h3][31:30], _RANDOM[5'h4][5:0]};
        regMaps_4_oldPreg = _RANDOM[5'h4][13:6];
        regMaps_5_lreg = _RANDOM[5'h4][19:14];
        regMaps_5_newPreg = _RANDOM[5'h4][27:20];
        regMaps_5_oldPreg = {_RANDOM[5'h4][31:28], _RANDOM[5'h5][3:0]};
        regMaps_6_lreg = _RANDOM[5'h5][9:4];
        regMaps_6_newPreg = _RANDOM[5'h5][17:10];
        regMaps_6_oldPreg = _RANDOM[5'h5][25:18];
        regMaps_7_lreg = _RANDOM[5'h5][31:26];
        regMaps_7_newPreg = _RANDOM[5'h6][7:0];
        regMaps_7_oldPreg = _RANDOM[5'h6][15:8];
        currentIdx = _RANDOM[5'h6][19:16];
        mergedVd_0_rawData =
          {_RANDOM[5'h6][31:20],
           _RANDOM[5'h7],
           _RANDOM[5'h8],
        ...
        mergedVd_3_rawData =
          {_RANDOM[5'h12][31:20],
           ...
           _RANDOM[5'h15],
           _RANDOM[5'h16][19:0]};
        sWaitRab_vecExcpInfo_next_bits_r_nf = _RANDOM[5'h17][5:3];
        sWaitRab_vecExcpInfo_next_bits_r_isStride = _RANDOM[5'h17][6];
        sWaitRab_vecExcpInfo_next_bits_r_isWhole = _RANDOM[5'h17][8];
        sWaitRab_useNewVdUntil = _RANDOM[5'h17][12:10];
        sWaitRab_needMergeUntil = _RANDOM[5'h17][16:13];
        sWaitRab_e8offset = _RANDOM[5'h17][20:17];
        sWaitRab_handleUntil = _RANDOM[5'h1B][25:22];
        sWaitRab_nonSegIndexed = _RANDOM[5'h1B][26];
        sWaitRab_vemul_i_d_0 = _RANDOM[5'h1B][27];
        sWaitRab_vemul_i_d_1 = _RANDOM[5'h1B][28];
        sWaitRab_vemul_i_d_2 = _RANDOM[5'h1B][29];
        sWaitRab_vemul_i_d_3 = _RANDOM[5'h1B][30];
        sWaitRab_dvemulNoLessThanM1 = {_RANDOM[5'h1B][31], _RANDOM[5'h1C][0]};
        sWaitRab_rabWriteOffset = _RANDOM[5'h1C][4:1];
        sWaitRab_ratWriteOffset = _RANDOM[5'h1C][8:5];
        state = _RANDOM[5'h1C][11:9];
        o_toVPRF_w_0_valid_REG = _RANDOM[5'h1C][12];
        o_toVPRF_w_1_valid_REG = _RANDOM[5'h1C][13];
        o_toVPRF_w_2_valid_REG = _RANDOM[5'h1C][14];
        o_toVPRF_w_3_valid_REG = _RANDOM[5'h1C][15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        commitNeeded_0 = 1'h0;
        commitNeeded_1 = 1'h0;
  ...
  DelayN_216 o_status_busy_delay (
    .clock  (clock),
  ...
  assign o_toVPRF_r_4_bits_addr = _o_status_busy_T_1 ? _GEN_47[newVdLocVec_0] : 8'h0;
  assign o_toVPRF_r_5_valid = _o_status_busy_T_1 & _GEN_49 & ~_GEN_48 & _hasReadRf_T_3;
  assign o_toVPRF_r_5_bits_addr = _o_status_busy_T_1 ? _GEN_47[newVdLocVec_1] : 8'h0;
  assign o_toVPRF_r_6_valid = _o_status_busy_T_1 & _GEN_51 & ~_GEN_50 & _hasReadRf_T_5;
  assign o_toVPRF_r_6_bits_addr = _o_status_busy_T_1 ? _GEN_47[newVdLocVec_2] : 8'h0;
  assign o_toVPRF_r_7_valid = _o_status_busy_T_1 & _GEN_53 & ~_GEN_52 & _hasReadRf_T_7;
  assign o_toVPRF_r_7_bits_addr = _o_status_busy_T_1 ? _GEN_47[newVdLocVec_3] : 8'h0;
