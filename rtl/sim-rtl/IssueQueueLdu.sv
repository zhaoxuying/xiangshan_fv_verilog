...
module IssueQueueLdu(
  ...
  input  [4:0]  io_enq_0_bits_sqIdx_value,
  ...
  input  [4:0]  io_enq_1_bits_sqIdx_value,
  ...
  input  [4:0]  io_finalIssueResp_0_bits_lqIdx_value,
  input         io_memAddrIssueResp_0_valid,
  input         io_memAddrIssueResp_0_bits_lqIdx_flag,
  input  [4:0]  io_memAddrIssueResp_0_bits_lqIdx_value,
  ...
  output [2:0]  io_deqDelay_0_bits_common_ftqIdx_value,
  ...
  output [5:0]  io_deqDelay_0_bits_common_waitForRobIdx_value,
  ...
  output [4:0]  io_deqDelay_0_bits_common_sqIdx_value,
  output        io_deqDelay_0_bits_common_lqIdx_flag,
  output [4:0]  io_deqDelay_0_bits_common_lqIdx_value,
  ...
  wire [2:0]  _entries_io_deqEntry_0_bits_payload_ftqPtr_value;
  ...
  wire [5:0]  _entries_io_deqEntry_0_bits_payload_waitForRobIdx_value;
  ...
  wire [4:0]  _entries_io_deqEntry_0_bits_payload_lqIdx_value;
  wire        _entries_io_deqEntry_0_bits_payload_sqIdx_flag;
  wire [4:0]  _entries_io_deqEntry_0_bits_payload_sqIdx_value;
  ...
  reg  [2:0]  deqDelay_0_bits_common_ftqIdx_value;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[6'h4][6:1];
        deqDelay_0_bits_rcIdx_0 = _RANDOM[6'h4][18:14];
        deqDelay_0_bits_common_fuType = {_RANDOM[6'h4][31:23], _RANDOM[6'h5][25:0]};
        deqDelay_0_bits_common_fuOpType = {_RANDOM[6'h5][31:26], _RANDOM[6'h6][2:0]};
        deqDelay_0_bits_common_imm =
          {_RANDOM[6'h8][31:3], _RANDOM[6'h9], _RANDOM[6'hA][2:0]};
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[6'hA][3];
        deqDelay_0_bits_common_robIdx_value = _RANDOM[6'hA][9:4];
        deqDelay_0_bits_common_pdest = _RANDOM[6'hA][22:15];
        deqDelay_0_bits_common_rfWen = _RANDOM[6'hA][23];
        deqDelay_0_bits_common_fpWen = _RANDOM[6'hA][24];
        deqDelay_0_bits_common_preDecode_isRVC = _RANDOM[6'hC][13];
        deqDelay_0_bits_common_ftqIdx_flag = _RANDOM[6'hC][18];
        deqDelay_0_bits_common_ftqIdx_value = _RANDOM[6'hC][21:19];
        deqDelay_0_bits_common_ftqOffset = _RANDOM[6'hC][25:22];
        deqDelay_0_bits_common_loadWaitBit = _RANDOM[6'hC][26];
        deqDelay_0_bits_common_waitForRobIdx_flag = _RANDOM[6'hC][27];
        deqDelay_0_bits_common_waitForRobIdx_value =
          {_RANDOM[6'hC][31:28], _RANDOM[6'hD][1:0]};
        deqDelay_0_bits_common_storeSetHit = _RANDOM[6'hD][2];
        deqDelay_0_bits_common_loadWaitStrict = _RANDOM[6'hD][3];
        deqDelay_0_bits_common_sqIdx_flag = _RANDOM[6'hD][9];
        deqDelay_0_bits_common_sqIdx_value = _RANDOM[6'hD][14:10];
        deqDelay_0_bits_common_lqIdx_flag = _RANDOM[6'hD][15];
        deqDelay_0_bits_common_lqIdx_value = _RANDOM[6'hD][20:16];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[6'hD][24:21];
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[6'hD][27:25];
        deqDelay_0_bits_common_loadDependency_0 = {_RANDOM[6'hD][31], _RANDOM[6'hE][0]};
        deqDelay_0_bits_common_loadDependency_1 = _RANDOM[6'hE][2:1];
        deqDelay_0_bits_common_loadDependency_2 = _RANDOM[6'hE][4:3];
        io_validCntDeqVec_0_REG_1 = _RANDOM[6'h22][31:27];
        io_wakeupToIQ_0_valid_last_REG = _RANDOM[6'h23][0];
        io_wakeupToIQ_0_bits_rfWen_last_REG = _RANDOM[6'h23][1];
        io_wakeupToIQ_0_bits_fpWen_last_REG = _RANDOM[6'h23][2];
        io_wakeupToIQ_0_bits_pdest_r = _RANDOM[6'h23][10:3];
        io_wakeupToIQ_0_bits_rfWenCopy_0_last_REG = _RANDOM[6'h23][11];
        io_wakeupToIQ_0_bits_rfWenCopy_1_last_REG = _RANDOM[6'h23][12];
        io_wakeupToIQ_0_bits_rfWenCopy_2_last_REG = _RANDOM[6'h23][13];
        io_wakeupToIQ_0_bits_rfWenCopy_3_last_REG = _RANDOM[6'h23][14];
        io_wakeupToIQ_0_bits_rfWenCopy_4_last_REG = _RANDOM[6'h23][15];
        io_wakeupToIQ_0_bits_rfWenCopy_5_last_REG = _RANDOM[6'h23][16];
        io_wakeupToIQ_0_bits_pdestCopy_0_r = _RANDOM[6'h23][30:23];
        io_wakeupToIQ_0_bits_pdestCopy_1_r = {_RANDOM[6'h23][31], _RANDOM[6'h24][6:0]};
        io_wakeupToIQ_0_bits_pdestCopy_2_r = _RANDOM[6'h24][14:7];
        io_wakeupToIQ_0_bits_pdestCopy_3_r = _RANDOM[6'h24][22:15];
        io_wakeupToIQ_0_bits_pdestCopy_4_r = _RANDOM[6'h24][30:23];
        io_wakeupToIQ_0_bits_pdestCopy_5_r = {_RANDOM[6'h24][31], _RANDOM[6'h25][6:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        io_wakeupToIQ_0_valid_last_REG = 1'h0;
        io_wakeupToIQ_0_bits_rfWen_last_REG = 1'h0;
