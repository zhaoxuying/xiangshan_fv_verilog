...
module TLXbar(
  ...
  wire [5:0]  _GEN_5 = auto_in_a_bits_address[29:24] ^ 6'h39;
  wire        requestAIO_0_1 =
    ...
    | {auto_in_a_bits_address[47:30], _GEN[11:8], _GEN[6:0]} == 29'h0
    | {auto_in_a_bits_address[47:30], _GEN_0[10:7], _GEN_0[5:0]} == 28'h0
    | {auto_in_a_bits_address[47:30], _GEN_1[9:6], _GEN_1[4:0]} == 27'h0
    | {auto_in_a_bits_address[47:30], _GEN_2[8:5], _GEN_2[3:0]} == 26'h0
    | {auto_in_a_bits_address[47:30], _GEN_3[7:4], _GEN_3[2:0]} == 25'h0
    | {auto_in_a_bits_address[47:30], _GEN_4[6:3], _GEN_4[1:0]} == 24'h0
    | {auto_in_a_bits_address[47:30], _GEN_5[5:2], _GEN_5[0]} == 23'h0
  ...
  wire [11:0] _GEN_6 =
    ...
    | {_readys_filter_T_1,
       ...
       auto_out_3_d_valid,
       auto_out_2_d_valid};
  wire [10:0] _GEN_7 = _GEN_6[10:0] | {_readys_filter_T_1[6], _GEN_6[11:2]};
  wire [8:0]  _GEN_8 = _GEN_7[8:0] | {_readys_filter_T_1[6], _GEN_6[11], _GEN_7[10:4]};
  wire [6:0]  readys_readys =
    ~({readys_mask[6],
       _readys_filter_T_1[6] | readys_mask[5],
       _GEN_6[11] | readys_mask[4],
       _GEN_7[10:9] | readys_mask[3:2],
       _GEN_8[8:7] | readys_mask[1:0]} & _GEN_8[6:0]);
  ...
  wire        in_0_d_valid =
    idle
      ...
      : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid | state_2
        ...
        | state_5 & auto_out_5_d_valid | state_6 & auto_out_6_d_valid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM[/*Zero width*/ 1'b0][9:3];
        state_0 = _RANDOM[/*Zero width*/ 1'b0][10];
        state_1 = _RANDOM[/*Zero width*/ 1'b0][11];
        state_2 = _RANDOM[/*Zero width*/ 1'b0][12];
        state_3 = _RANDOM[/*Zero width*/ 1'b0][13];
        state_4 = _RANDOM[/*Zero width*/ 1'b0][14];
        state_5 = _RANDOM[/*Zero width*/ 1'b0][15];
        state_6 = _RANDOM[/*Zero width*/ 1'b0][16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        beatsLeft = 3'h0;
        readys_mask = 7'h7F;
  ...
  assign auto_in_a_ready =
    ...
    | requestAIO_0_6 & auto_out_6_a_ready;
