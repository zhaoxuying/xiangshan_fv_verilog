...
module ICacheMainPipe(
  ...
  output [1:0]   io_dataArray_toIData_0_bits_vSetIdx_0,
  output [1:0]   io_dataArray_toIData_0_bits_vSetIdx_1,
  ...
  output [1:0]   io_dataArray_toIData_1_bits_vSetIdx_0,
  output [1:0]   io_dataArray_toIData_1_bits_vSetIdx_1,
  output         io_dataArray_toIData_2_valid,
  output [1:0]   io_dataArray_toIData_2_bits_vSetIdx_0,
  output [1:0]   io_dataArray_toIData_2_bits_vSetIdx_1,
  input          io_dataArray_toIData_3_ready,
  output         io_dataArray_toIData_3_valid,
  output [1:0]   io_dataArray_toIData_3_bits_vSetIdx_0,
  output [1:0]   io_dataArray_toIData_3_bits_vSetIdx_1,
  ...
  input  [39:0]  io_wayLookupRead_bits_entry_ptag_0,
  input  [39:0]  io_wayLookupRead_bits_entry_ptag_1,
  ...
  output [1:0]   io_mshr_req_bits_vSetIdx,
  input          io_mshr_resp_valid,
  input  [41:0]  io_mshr_resp_bits_blkPaddr,
  input  [1:0]   io_mshr_resp_bits_vSetIdx,
  ...
  reg  [39:0] s1_req_ptags_0;
  reg  [39:0] s1_req_ptags_1;
  ...
  wire        s1_bankMSHRHit_7 =
    s1_valid & s1_req_vaddr_0[7:6] == io_mshr_resp_bits_vSetIdx
    & s1_req_ptags_0 == io_mshr_resp_bits_blkPaddr[41:2] & io_mshr_resp_valid
    & ~io_mshr_resp_bits_corrupt;
  wire        s1_MSHR_hits_1 =
    s1_valid & s1_req_vaddr_1[7:6] == io_mshr_resp_bits_vSetIdx
    & s1_req_ptags_1 == io_mshr_resp_bits_blkPaddr[41:2] & io_mshr_resp_valid
  ...
  reg  [39:0] s2_req_ptags_0;
  reg  [39:0] s2_req_ptags_1;
  ...
  reg         s2_waymasks_1_2;
  reg         s2_waymasks_1_3;
  wire [47:0] s2_req_paddr_0 = {s2_req_ptags_0, s2_req_vaddr_0[7:0]};
  wire [47:0] s2_req_paddr_1 = {s2_req_ptags_1, s2_req_vaddr_1[7:0]};
  reg         s2_SRAMhits_0;
  reg         s2_SRAMhits_1;
  reg         s2_codes_0;
  reg         s2_codes_1;
  ...
  wire        s2_bankMSHRHit_7 =
    s2_valid & s2_req_vaddr_0[7:6] == io_mshr_resp_bits_vSetIdx
    & s2_req_ptags_0 == io_mshr_resp_bits_blkPaddr[41:2] & io_mshr_resp_valid;
  wire        s2_MSHR_hits_1 =
    s2_valid & s2_req_vaddr_1[7:6] == io_mshr_resp_bits_vSetIdx
    & s2_req_ptags_1 == io_mshr_resp_bits_blkPaddr[41:2] & io_mshr_resp_valid
    & s2_doubleline;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      s1_req_ptags_0 <= 40'h0;
      s1_req_ptags_1 <= 40'h0;
      s1_req_gpaddr <= 56'h0;
      ...
      s2_req_ptags_0 <= 40'h0;
      s2_req_ptags_1 <= 40'h0;
      s2_req_gpaddr <= 56'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_ptags_0 = {_RANDOM[6'h4][31:5], _RANDOM[6'h5][12:0]};
        s1_req_ptags_1 = {_RANDOM[6'h5][31:13], _RANDOM[6'h6][20:0]};
        s1_req_gpaddr = {_RANDOM[6'h6][31:21], _RANDOM[6'h7], _RANDOM[6'h8][12:0]};
        s1_req_isForVSnonLeafPTE = _RANDOM[6'h8][13];
        s1_doubleline = _RANDOM[6'h8][14];
        s1_SRAMhits_0 = _RANDOM[6'h8][15];
        s1_SRAMhits_1 = _RANDOM[6'h8][16];
        s1_itlb_exception_0 = _RANDOM[6'h8][18:17];
        s1_itlb_exception_1 = _RANDOM[6'h8][20:19];
        s1_backendException = _RANDOM[6'h8][21];
        s1_itlb_pbmt_0 = _RANDOM[6'h8][23:22];
        s1_itlb_pbmt_1 = _RANDOM[6'h8][25:24];
        s1_waymasks_0_0 = _RANDOM[6'h8][26];
        s1_waymasks_0_1 = _RANDOM[6'h8][27];
        s1_waymasks_0_2 = _RANDOM[6'h8][28];
        s1_waymasks_0_3 = _RANDOM[6'h8][29];
        s1_waymasks_1_0 = _RANDOM[6'h8][30];
        s1_waymasks_1_1 = _RANDOM[6'h8][31];
        s1_waymasks_1_2 = _RANDOM[6'h9][0];
        s1_waymasks_1_3 = _RANDOM[6'h9][1];
        s1_meta_codes_0 = _RANDOM[6'h9][2];
        s1_meta_codes_1 = _RANDOM[6'h9][3];
        io_touch_0_valid_REG = _RANDOM[6'h9][4];
        io_touch_1_valid_REG = _RANDOM[6'h9][5];
        s1_hits_REG = _RANDOM[6'h9][6];
        s1_hits_valid = _RANDOM[6'h9][7];
        s1_hits_REG_1 = _RANDOM[6'h9][8];
        s1_hits_valid_1 = _RANDOM[6'h9][9];
        s1_datas_REG = _RANDOM[6'h9][10];
        s1_datas_r = {_RANDOM[6'h9][31:11], _RANDOM[6'hA], _RANDOM[6'hB][10:0]};
        s1_datas_REG_1 = _RANDOM[6'hB][11];
        s1_datas_r_1 = {_RANDOM[6'hB][31:12], _RANDOM[6'hC], _RANDOM[6'hD][11:0]};
        s1_datas_REG_2 = _RANDOM[6'hD][12];
        s1_datas_r_2 = {_RANDOM[6'hD][31:13], _RANDOM[6'hE], _RANDOM[6'hF][12:0]};
        s1_datas_REG_3 = _RANDOM[6'hF][13];
        s1_datas_r_3 = {_RANDOM[6'hF][31:14], _RANDOM[6'h10], _RANDOM[6'h11][13:0]};
        s1_datas_REG_4 = _RANDOM[6'h11][14];
        s1_datas_r_4 = {_RANDOM[6'h11][31:15], _RANDOM[6'h12], _RANDOM[6'h13][14:0]};
        s1_datas_REG_5 = _RANDOM[6'h13][15];
        s1_datas_r_5 = {_RANDOM[6'h13][31:16], _RANDOM[6'h14], _RANDOM[6'h15][15:0]};
        s1_datas_REG_6 = _RANDOM[6'h15][16];
        s1_datas_r_6 = {_RANDOM[6'h15][31:17], _RANDOM[6'h16], _RANDOM[6'h17][16:0]};
        s1_datas_REG_7 = _RANDOM[6'h17][17];
        s1_datas_r_7 = {_RANDOM[6'h17][31:18], _RANDOM[6'h18], _RANDOM[6'h19][17:0]};
        s1_data_is_from_MSHR_REG = _RANDOM[6'h19][18];
        s1_data_is_from_MSHR_r = _RANDOM[6'h19][19];
        s1_data_is_from_MSHR_REG_1 = _RANDOM[6'h19][20];
        s1_data_is_from_MSHR_r_1 = _RANDOM[6'h19][21];
        s1_data_is_from_MSHR_REG_2 = _RANDOM[6'h19][22];
        s1_data_is_from_MSHR_r_2 = _RANDOM[6'h19][23];
        s1_data_is_from_MSHR_REG_3 = _RANDOM[6'h19][24];
        s1_data_is_from_MSHR_r_3 = _RANDOM[6'h19][25];
        s1_data_is_from_MSHR_REG_4 = _RANDOM[6'h19][26];
        s1_data_is_from_MSHR_r_4 = _RANDOM[6'h19][27];
        s1_data_is_from_MSHR_REG_5 = _RANDOM[6'h19][28];
        s1_data_is_from_MSHR_r_5 = _RANDOM[6'h19][29];
        s1_data_is_from_MSHR_REG_6 = _RANDOM[6'h19][30];
        s1_data_is_from_MSHR_r_6 = _RANDOM[6'h19][31];
        s1_data_is_from_MSHR_REG_7 = _RANDOM[6'h1A][0];
        s1_data_is_from_MSHR_r_7 = _RANDOM[6'h1A][1];
        s1_codes_REG = _RANDOM[6'h1A][2];
        s1_codes_r_0 = _RANDOM[6'h1A][3];
        s1_codes_r_1 = _RANDOM[6'h1A][4];
        s1_codes_r_2 = _RANDOM[6'h1A][5];
        s1_codes_r_3 = _RANDOM[6'h1A][6];
        s1_codes_r_4 = _RANDOM[6'h1A][7];
        s1_codes_r_5 = _RANDOM[6'h1A][8];
        s1_codes_r_6 = _RANDOM[6'h1A][9];
        s1_codes_r_7 = _RANDOM[6'h1A][10];
        s2_valid = _RANDOM[6'h1A][11];
        s2_req_vaddr_0 = {_RANDOM[6'h1A][31:12], _RANDOM[6'h1B][29:0]};
        s2_req_vaddr_1 = {_RANDOM[6'h1B][31:30], _RANDOM[6'h1C], _RANDOM[6'h1D][15:0]};
        s2_req_ptags_0 = {_RANDOM[6'h1D][31:16], _RANDOM[6'h1E][23:0]};
        s2_req_ptags_1 = {_RANDOM[6'h1E][31:24], _RANDOM[6'h1F]};
        s2_req_gpaddr = {_RANDOM[6'h20], _RANDOM[6'h21][23:0]};
        s2_req_isForVSnonLeafPTE = _RANDOM[6'h21][24];
        s2_doubleline = _RANDOM[6'h21][25];
        s2_exception_0 = _RANDOM[6'h21][27:26];
        s2_exception_1 = _RANDOM[6'h21][29:28];
        s2_backendException = _RANDOM[6'h21][30];
        s2_pmp_mmio_0 = _RANDOM[6'h21][31];
        s2_pmp_mmio_1 = _RANDOM[6'h22][0];
        s2_itlb_pbmt_0 = _RANDOM[6'h22][2:1];
        s2_itlb_pbmt_1 = _RANDOM[6'h22][4:3];
        s2_waymasks_0_0 = _RANDOM[6'h22][5];
        s2_waymasks_0_1 = _RANDOM[6'h22][6];
        s2_waymasks_0_2 = _RANDOM[6'h22][7];
        s2_waymasks_0_3 = _RANDOM[6'h22][8];
        s2_waymasks_1_0 = _RANDOM[6'h22][9];
        s2_waymasks_1_1 = _RANDOM[6'h22][10];
        s2_waymasks_1_2 = _RANDOM[6'h22][11];
        s2_waymasks_1_3 = _RANDOM[6'h22][12];
        s2_SRAMhits_0 = _RANDOM[6'h22][13];
        s2_SRAMhits_1 = _RANDOM[6'h22][14];
        s2_codes_0 = _RANDOM[6'h22][15];
        s2_codes_1 = _RANDOM[6'h22][16];
        s2_codes_2 = _RANDOM[6'h22][17];
        s2_codes_3 = _RANDOM[6'h22][18];
        s2_codes_4 = _RANDOM[6'h22][19];
        s2_codes_5 = _RANDOM[6'h22][20];
        s2_codes_6 = _RANDOM[6'h22][21];
        s2_codes_7 = _RANDOM[6'h22][22];
        s2_hits_0 = _RANDOM[6'h22][23];
        s2_hits_1 = _RANDOM[6'h22][24];
        s2_datas_0 = {_RANDOM[6'h22][31:25], _RANDOM[6'h23], _RANDOM[6'h24][24:0]};
        s2_datas_1 = {_RANDOM[6'h24][31:25], _RANDOM[6'h25], _RANDOM[6'h26][24:0]};
        s2_datas_2 = {_RANDOM[6'h26][31:25], _RANDOM[6'h27], _RANDOM[6'h28][24:0]};
        s2_datas_3 = {_RANDOM[6'h28][31:25], _RANDOM[6'h29], _RANDOM[6'h2A][24:0]};
        s2_datas_4 = {_RANDOM[6'h2A][31:25], _RANDOM[6'h2B], _RANDOM[6'h2C][24:0]};
        s2_datas_5 = {_RANDOM[6'h2C][31:25], _RANDOM[6'h2D], _RANDOM[6'h2E][24:0]};
        s2_datas_6 = {_RANDOM[6'h2E][31:25], _RANDOM[6'h2F], _RANDOM[6'h30][24:0]};
        s2_datas_7 = {_RANDOM[6'h30][31:25], _RANDOM[6'h31], _RANDOM[6'h32][24:0]};
        s2_data_is_from_MSHR_0 = _RANDOM[6'h32][25];
        s2_data_is_from_MSHR_1 = _RANDOM[6'h32][26];
        s2_data_is_from_MSHR_2 = _RANDOM[6'h32][27];
        s2_data_is_from_MSHR_3 = _RANDOM[6'h32][28];
        s2_data_is_from_MSHR_4 = _RANDOM[6'h32][29];
        s2_data_is_from_MSHR_5 = _RANDOM[6'h32][30];
        s2_data_is_from_MSHR_6 = _RANDOM[6'h32][31];
        s2_data_is_from_MSHR_7 = _RANDOM[6'h33][0];
        s2_meta_corrupt_0 = _RANDOM[6'h33][1];
        s2_meta_corrupt_1 = _RANDOM[6'h33][2];
        io_errors_0_valid_REG = _RANDOM[6'h33][3];
        io_errors_0_bits_report_to_beu_REG = _RANDOM[6'h33][4];
        io_errors_1_valid_REG = _RANDOM[6'h33][5];
        io_errors_1_bits_report_to_beu_REG = _RANDOM[6'h33][6];
        io_metaArrayFlush_0_valid_REG = _RANDOM[6'h33][7];
        io_metaArrayFlush_1_valid_REG = _RANDOM[6'h33][8];
        s2_l2_corrupt_0 = _RANDOM[6'h33][13];
        s2_l2_corrupt_1 = _RANDOM[6'h33][14];
        s2_has_send_0 = _RANDOM[6'h33][15];
        s2_has_send_1 = _RANDOM[6'h33][16];
        REG_4 = _RANDOM[6'h33][17];
        io_errors_0_bits_paddr_REG =
          {_RANDOM[6'h33][31:18], _RANDOM[6'h34], _RANDOM[6'h35][1:0]};
        REG_5 = _RANDOM[6'h35][2];
        io_errors_1_bits_paddr_REG = {_RANDOM[6'h35][31:3], _RANDOM[6'h36][18:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_req_vaddr_0 = 50'h0;
  ...
  Arbiter2_ICacheMissReq toMSHRArbiter (
    ...
    .io_in_0_bits_blkPaddr ({s2_req_ptags_0, s2_req_vaddr_0[7:6]}),
    .io_in_0_bits_vSetIdx  (s2_req_vaddr_0[7:6]),
    .io_in_1_ready         (_toMSHRArbiter_io_in_1_ready),
    .io_in_1_valid         (_toMSHRArbiter_io_in_1_valid_T_4),
    .io_in_1_bits_blkPaddr ({s2_req_ptags_1, s2_req_vaddr_1[7:6]}),
    .io_in_1_bits_vSetIdx  (s2_req_vaddr_1[7:6]),
  ...
  assign io_dataArray_toIData_0_bits_vSetIdx_0 =
    io_fetch_req_bits_pcMemRead_0_startAddr[7:6];
  assign io_dataArray_toIData_0_bits_vSetIdx_1 =
    io_fetch_req_bits_pcMemRead_0_nextlineStart[7:6];
  ...
  assign io_metaArrayFlush_1_bits_virIdx = s2_req_vaddr_1[7:6];
  ...
  assign io_touch_0_bits_vSetIdx = s1_req_vaddr_0[7:6];
  ...
  assign io_touch_1_bits_vSetIdx = s1_req_vaddr_1[7:6];
  ...
  assign io_pmp_0_req_bits_addr = {s1_req_ptags_0, s1_req_vaddr_0[7:0]};
  assign io_pmp_1_req_bits_addr = {s1_req_ptags_1, s1_req_vaddr_1[7:0]};
