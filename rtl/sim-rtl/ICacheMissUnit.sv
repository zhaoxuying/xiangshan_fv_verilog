...
module ICacheMissUnit(
  ...
  input  [1:0]   io_fetch_req_bits_vSetIdx,
  output         io_fetch_resp_valid,
  output [41:0]  io_fetch_resp_bits_blkPaddr,
  output [1:0]   io_fetch_resp_bits_vSetIdx,
  ...
  wire [1:0]        _prefetchMSHRs_9_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_9_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_8_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_8_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_7_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_7_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_6_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_6_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_5_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_5_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_4_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_4_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_3_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_3_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_2_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_2_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_1_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_1_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_0_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _prefetchMSHRs_0_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _fetchMSHRs_3_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _fetchMSHRs_3_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _fetchMSHRs_2_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _fetchMSHRs_2_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _fetchMSHRs_1_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _fetchMSHRs_1_io_resp_bits_vSetIdx;
  ...
  wire [1:0]        _fetchMSHRs_0_io_acquire_bits_vSetIdx;
  ...
  wire [1:0]        _fetchMSHRs_0_io_resp_bits_vSetIdx;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mshr_resp_vSetIdx = _RANDOM[5'h11][19:18];
        mshr_resp_way = _RANDOM[5'h11][21:20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        readBeatCnt = 1'h0;
        respDataReg_0 = 256'h0;
  ...
  assign io_meta_write_bits_phyTag = mshr_resp_blkPaddr[41:2];
