...
module RedirectGenerator(
  ...
  input  [5:0]  io_oldestExuRedirect_bits_robIdx_value,
  input         io_oldestExuRedirect_bits_ftqIdx_flag,
  input  [2:0]  io_oldestExuRedirect_bits_ftqIdx_value,
  ...
  input  [5:0]  io_loadReplay_bits_robIdx_value,
  ...
  reg  [5:0]  flushAfter_bits_robIdx_value;
  reg         flushAfter_bits_level;
  wire [6:0]  _needFlushVec_flushItself_T_6 =
  ...
  reg  [5:0]  s1_redirect_bits_reg_robIdx_value;
  reg         s1_redirect_bits_reg_ftqIdx_flag;
  reg  [2:0]  s1_redirect_bits_reg_ftqIdx_value;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      flushAfter_bits_robIdx_value <= 6'h0;
      ...
      if (robFlushOrExuFlushValid) begin
        flushAfter_bits_robIdx_flag <=
          io_robFlush_valid ? io_robFlush_bits_robIdx_flag : _oldestRedirect_T_227;
        flushAfter_bits_robIdx_value <=
          io_robFlush_valid ? io_robFlush_bits_robIdx_value : _oldestRedirect_T_224;
        flushAfter_bits_level <=
          io_robFlush_valid ? io_robFlush_bits_level : _oldestRedirect_T_212;
      end
  ...
  always @(posedge clock) begin
    if (|_oldestValid_T_4) begin
      s1_redirect_bits_reg_robIdx_flag <= _oldestRedirect_T_227;
      s1_redirect_bits_reg_robIdx_value <= _oldestRedirect_T_224;
      ...
      s1_redirect_bits_reg_ftqIdx_value <=
        ((&_oldestOneHot_resultOnehot_T_3)
           ...
           : 3'h0)
        | ((&_oldestOneHot_resultOnehot_T_7) ? io_loadReplay_bits_ftqIdx_value : 3'h0);
      ...
      s1_redirect_bits_reg_level <= _oldestRedirect_T_212;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        flushAfter_bits_robIdx_value = _RANDOM[5'h0][8:3];
        flushAfter_bits_level = _RANDOM[5'h0][17];
        s1_redirect_bits_reg_robIdx_flag = _RANDOM[5'hE][30];
        s1_redirect_bits_reg_robIdx_value = {_RANDOM[5'hE][31], _RANDOM[5'hF][4:0]};
        s1_redirect_bits_reg_ftqIdx_flag = _RANDOM[5'hF][5];
        s1_redirect_bits_reg_ftqIdx_value = _RANDOM[5'hF][8:6];
        s1_redirect_bits_reg_ftqOffset = _RANDOM[5'hF][12:9];
        s1_redirect_bits_reg_level = _RANDOM[5'hF][13];
        s1_redirect_bits_reg_cfiUpdate_pc =
          {_RANDOM[5'hF][31:15], _RANDOM[5'h10], _RANDOM[5'h11][0]};
        s1_redirect_bits_reg_cfiUpdate_target =
          {_RANDOM[5'h17][31:21], _RANDOM[5'h18], _RANDOM[5'h19][6:0]};
        s1_redirect_bits_reg_cfiUpdate_taken = _RANDOM[5'h19][7];
        s1_redirect_bits_reg_cfiUpdate_isMisPred = _RANDOM[5'h19][8];
        s1_redirect_bits_reg_cfiUpdate_backendIGPF = _RANDOM[5'h19][12];
        s1_redirect_bits_reg_cfiUpdate_backendIPF = _RANDOM[5'h19][13];
        s1_redirect_bits_reg_cfiUpdate_backendIAF = _RANDOM[5'h19][14];
        s1_redirect_bits_reg_fullTarget =
          {_RANDOM[5'h19][31:15], _RANDOM[5'h1A], _RANDOM[5'h1B][14:0]};
        s1_redirect_valid_reg_last_REG = _RANDOM[5'h1D][25];
        s1_redirect_onehot_last_REG = _RANDOM[5'h1D][26];
        s1_redirect_onehot_last_REG_1 = _RANDOM[5'h1D][27];
        flushAfterCounter = _RANDOM[5'h1D][30:28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        flushAfter_valid = 1'h0;
        flushAfter_bits_robIdx_flag = 1'h0;
