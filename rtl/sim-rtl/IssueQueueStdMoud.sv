  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_common_robIdx_value = _RANDOM[4'hA][22:17];
        deqDelay_0_bits_common_sqIdx_flag = _RANDOM[4'hA][28];
        deqDelay_0_bits_common_sqIdx_value = {_RANDOM[4'hA][31:29], _RANDOM[4'hB][1:0]};
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[4'hB][5:2];
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[4'hB][8:6];
        deqDelay_0_bits_common_loadDependency_0 = _RANDOM[4'hB][13:12];
        deqDelay_0_bits_common_loadDependency_1 = _RANDOM[4'hB][15:14];
        deqDelay_0_bits_common_loadDependency_2 = _RANDOM[4'hB][17:16];
      `endif // RANDOMIZE_REG_INIT
    end // initial
