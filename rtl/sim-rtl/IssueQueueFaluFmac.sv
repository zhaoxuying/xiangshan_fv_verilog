  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_common_robIdx_value = {_RANDOM[6'hE][31], _RANDOM[6'hF][4:0]};
        deqDelay_0_bits_common_pdest = _RANDOM[6'hF][17:10];
        deqDelay_0_bits_common_rfWen = _RANDOM[6'hF][18];
        deqDelay_0_bits_common_fpWen = _RANDOM[6'hF][19];
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[6'hF][22];
        deqDelay_0_bits_common_fpu_fmt = _RANDOM[6'hF][26:25];
        deqDelay_0_bits_common_fpu_rm = _RANDOM[6'hF][29:27];
        deqDelay_0_bits_common_dataSources_0_value =
          {_RANDOM[6'hF][31:30], _RANDOM[6'h10][1:0]};
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[6'h10][5:2];
        deqDelay_0_bits_common_dataSources_2_value = _RANDOM[6'h10][9:6];
        deqDelay_0_bits_common_exuSources_0_value = _RANDOM[6'h10][11:10];
        deqDelay_0_bits_common_exuSources_1_value = _RANDOM[6'h10][13:12];
        deqDelay_0_bits_common_exuSources_2_value = _RANDOM[6'h10][15:14];
        io_validCntDeqVec_0_REG_1 = _RANDOM[6'h25][23:18];
      `endif // RANDOMIZE_REG_INIT
    end // initial
