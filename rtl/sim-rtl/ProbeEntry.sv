...
module ProbeEntry(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_addr = {_RANDOM[2'h0][31:9], _RANDOM[2'h1][24:0]};
        req_vaddr = {_RANDOM[2'h1][31:25], _RANDOM[2'h2], _RANDOM[2'h3][10:0]};
        req_param = _RANDOM[2'h3][12:11];
        req_needData = _RANDOM[2'h3][13];
        io_pipe_req_valid_REG = _RANDOM[2'h3][16];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 2'h0;
    end // initial
  ...
  assign io_pipe_req_bits_id = {2'h0, io_id};
