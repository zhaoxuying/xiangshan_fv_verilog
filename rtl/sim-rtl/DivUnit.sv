  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        robIdxReg_value = _RANDOM[/*Zero width*/ 1'b0][6:1];
        ctrlReg_isW = _RANDOM[/*Zero width*/ 1'b0][8];
        ctrlReg_isHi = _RANDOM[/*Zero width*/ 1'b0][9];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[/*Zero width*/ 1'b0][10];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[/*Zero width*/ 1'b0][16:11];
        io_out_bits_ctrl_pdest_r = _RANDOM[/*Zero width*/ 1'b0][24:17];
        io_out_bits_ctrl_rfWen_r = _RANDOM[/*Zero width*/ 1'b0][25];
      `endif // RANDOMIZE_REG_INIT
    end // initial
