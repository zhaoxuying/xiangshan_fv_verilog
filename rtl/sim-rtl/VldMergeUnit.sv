...
module VldMergeUnit(
  ...
  input  [7:0]   io_writeback_bits_pdest,
  input          io_writeback_bits_robIdx_flag,
  input  [5:0]   io_writeback_bits_robIdx_value,
  ...
  output [7:0]   io_writebackAfterMerge_bits_pdest,
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        wbReg_bits_data_0 =
          {_RANDOM[4'h0][31:1],
           ...
           _RANDOM[4'h3],
           _RANDOM[4'h4][0]};
        wbReg_bits_pdest = _RANDOM[4'h4][8:1];
        wbReg_bits_vecWen = _RANDOM[4'h4][16];
        wbReg_bits_v0Wen = _RANDOM[4'h4][17];
        wbReg_bits_vlWen = _RANDOM[4'h4][18];
        wbReg_bits_vls_vpu_vma = _RANDOM[4'h5][18];
        wbReg_bits_vls_vpu_vta = _RANDOM[4'h5][19];
        wbReg_bits_vls_vpu_vsew = _RANDOM[4'h5][21:20];
        wbReg_bits_vls_vpu_vm = _RANDOM[4'h6][1];
        wbReg_bits_vls_vpu_vstart = _RANDOM[4'h6][9:2];
        wbReg_bits_vls_vpu_vmask =
          {_RANDOM[4'h6][31:30],
           ...
           _RANDOM[4'h9],
           _RANDOM[4'hA][29:0]};
        wbReg_bits_vls_vpu_vl = {_RANDOM[4'hA][31:30], _RANDOM[4'hB][5:0]};
        wbReg_bits_vls_vpu_veew = _RANDOM[4'hB][10:9];
        wbReg_bits_vls_vdIdxInField = {_RANDOM[4'hB][31], _RANDOM[4'hC][1:0]};
        wbReg_bits_vls_isIndexed = _RANDOM[4'hC][2];
        wbReg_bits_vls_isMasked = _RANDOM[4'hC][3];
      `endif // RANDOMIZE_REG_INIT
    end // initial
