...
module TLBFA(
  ...
  wire [3:0]       _refill_mask_T_2 = 4'h1 << io_w_bits_wayIdx;
  ...
  wire [3:0]       refill_mask = io_w_valid ? _refill_mask_T_2 : 4'h0;
  wire [3:0]       refill_mask_1 = io_w_valid ? _refill_mask_T_2 : 4'h0;
  wire [3:0]       refill_mask_2 = io_w_valid ? _refill_mask_T_2 : 4'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        hitVecReg_2_0 = _RANDOM[5'h1B][8];
        hitVecReg_2_1 = _RANDOM[5'h1B][9];
        hitVecReg_2_2 = _RANDOM[5'h1B][10];
        hitVecReg_2_3 = _RANDOM[5'h1B][11];
        io_r_resp_2_valid_last_REG = _RANDOM[5'h1B][12];
        reqVpn_2 = {_RANDOM[5'h1B][31:13], _RANDOM[5'h1C][18:0]};
        refill_wayIdx_reg = _RANDOM[5'h1D][23:22];
        last_REG = _RANDOM[5'h1D][24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        v_0 = 1'h0;
        v_1 = 1'h0;
       ...
       ? {entries_0_ppn[32:24],
          ...
          (|entries_0_level)
            ...
            : entries_0_n
                ...
                : {entries_0_ppn[5:0], _GEN_11[reqVpn_2[2:0]]}}
       : 36'h0)
    | (hitVecReg_2_1
         ? {entries_1_ppn[32:24],
            ...
            (|entries_1_level)
              ...
              : entries_1_n
                  ...
                  : {entries_1_ppn[5:0], _GEN_12[reqVpn_2[2:0]]}}
         : 36'h0)
    | (hitVecReg_2_2
         ? {entries_2_ppn[32:24],
            ...
            (|entries_2_level)
              ...
              : entries_2_n
                  ...
                  : {entries_2_ppn[5:0], _GEN_13[reqVpn_2[2:0]]}}
         : 36'h0)
    | (hitVecReg_2_3
         ? {entries_3_ppn[32:24],
            ...
            (|entries_3_level)
              ...
              : entries_3_n
                  ...
                  : {entries_3_ppn[5:0], _GEN_14[reqVpn_2[2:0]]}}
         : 36'h0);
