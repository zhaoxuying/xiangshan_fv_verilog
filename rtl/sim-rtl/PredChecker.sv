...
module PredChecker(
  ...
  assign io_out_stage1Out_fixedTaken_0 =
    ...
    & (io_in_pds_0_isRet | _GEN | (&io_in_pds_0_brType) | _GEN_31 & io_in_ftqOffset_valid
       & (|io_in_pds_0_brType));
  assign io_out_stage1Out_fixedTaken_1 =
    io_in_instrValid_1 & _GEN_32
    & (io_in_pds_1_isRet | _GEN_1 | (&io_in_pds_1_brType) | _GEN_33
       & io_in_ftqOffset_valid & (|io_in_pds_1_brType));
  assign io_out_stage1Out_fixedTaken_2 =
    io_in_instrValid_2 & _GEN_34
    & (io_in_pds_2_isRet | _GEN_3 | (&io_in_pds_2_brType) | _GEN_35
       & io_in_ftqOffset_valid & (|io_in_pds_2_brType));
  assign io_out_stage1Out_fixedTaken_3 =
    io_in_instrValid_3 & _GEN_36
    & (io_in_pds_3_isRet | _GEN_5 | (&io_in_pds_3_brType) | _GEN_37
       & io_in_ftqOffset_valid & (|io_in_pds_3_brType));
  assign io_out_stage1Out_fixedTaken_4 =
    io_in_instrValid_4 & _GEN_38
    & (io_in_pds_4_isRet | _GEN_7 | (&io_in_pds_4_brType) | _GEN_39
       & io_in_ftqOffset_valid & (|io_in_pds_4_brType));
  assign io_out_stage1Out_fixedTaken_5 =
    io_in_instrValid_5 & _GEN_40
    & (io_in_pds_5_isRet | _GEN_9 | (&io_in_pds_5_brType) | _GEN_41
       & io_in_ftqOffset_valid & (|io_in_pds_5_brType));
  assign io_out_stage1Out_fixedTaken_6 =
    io_in_instrValid_6 & _GEN_42
    & (io_in_pds_6_isRet | _GEN_11 | (&io_in_pds_6_brType) | _GEN_43
       & io_in_ftqOffset_valid & (|io_in_pds_6_brType));
  assign io_out_stage1Out_fixedTaken_7 =
    io_in_instrValid_7 & _GEN_44
    & (io_in_pds_7_isRet | _GEN_13 | (&io_in_pds_7_brType) | _GEN_45
       & io_in_ftqOffset_valid & (|io_in_pds_7_brType));
  assign io_out_stage1Out_fixedTaken_8 =
    io_in_instrValid_8 & _GEN_46
    & (io_in_pds_8_isRet | _GEN_15 | (&io_in_pds_8_brType) | _GEN_47
       & io_in_ftqOffset_valid & (|io_in_pds_8_brType));
  assign io_out_stage1Out_fixedTaken_9 =
    io_in_instrValid_9 & _GEN_48
    & (io_in_pds_9_isRet | _GEN_17 | (&io_in_pds_9_brType) | _GEN_49
       & io_in_ftqOffset_valid & (|io_in_pds_9_brType));
  assign io_out_stage1Out_fixedTaken_10 =
    io_in_instrValid_10 & _GEN_50
    & (io_in_pds_10_isRet | _GEN_19 | (&io_in_pds_10_brType) | _GEN_51
       & io_in_ftqOffset_valid & (|io_in_pds_10_brType));
  assign io_out_stage1Out_fixedTaken_11 =
    io_in_instrValid_11 & _GEN_52
    & (io_in_pds_11_isRet | _GEN_21 | (&io_in_pds_11_brType) | _GEN_53
       & io_in_ftqOffset_valid & (|io_in_pds_11_brType));
  assign io_out_stage1Out_fixedTaken_12 =
    io_in_instrValid_12 & _GEN_54
    & (io_in_pds_12_isRet | _GEN_23 | (&io_in_pds_12_brType) | _GEN_55
       & io_in_ftqOffset_valid & (|io_in_pds_12_brType));
  assign io_out_stage1Out_fixedTaken_13 =
    io_in_instrValid_13 & _GEN_56
    & (io_in_pds_13_isRet | _GEN_25 | (&io_in_pds_13_brType) | _GEN_57
       & io_in_ftqOffset_valid & (|io_in_pds_13_brType));
  assign io_out_stage1Out_fixedTaken_14 =
    io_in_instrValid_14 & _GEN_58
    & (io_in_pds_14_isRet | _GEN_27 | (&io_in_pds_14_brType) | _GEN_59
       & io_in_ftqOffset_valid & (|io_in_pds_14_brType));
  assign io_out_stage1Out_fixedTaken_15 =
    io_in_instrValid_15 & _GEN_60
    & (io_in_pds_15_isRet | _GEN_29 | (&io_in_pds_15_brType) | (&io_in_ftqOffset_bits)
       & io_in_ftqOffset_valid & (|io_in_pds_15_brType));
