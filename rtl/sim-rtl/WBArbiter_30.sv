...
module WBArbiter_30(
  ...
  wire       _GEN_5 = ~hasFull | ~(io_in_0_valid & isFull_0 | io_in_1_valid & isFull_1);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        isFull_0 = _RANDOM[/*Zero width*/ 1'b0][6];
        isFull_1 = _RANDOM[/*Zero width*/ 1'b0][7];
        hasFull = _RANDOM[/*Zero width*/ 1'b0][8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        cancelCounter_0 = 3'h0;
        cancelCounter_1 = 3'h0;
  ...
  assign io_out_valid = finalValid_0 | finalValid_1;
  assign io_out_bits_addr = finalValid_0 ? io_in_0_bits_addr : io_in_1_bits_addr;
endmodule
