...
module Queue2_TLBundleD_37(
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[22:15];
  assign io_deq_bits_denied = _ram_ext_R0_data[23];
  assign io_deq_bits_echo_isKeyword = _ram_ext_R0_data[24];
  assign io_deq_bits_data = _ram_ext_R0_data[280:25];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[281];
endmodule
