...
module RealWBCollideChecker_1(
  ...
  RealWBArbiter_8 arbiters_0 (
    ...
    .io_in_1_bits_fpWen (io_in_6_bits_fpWen),
  ...
  RealWBArbiter_8 arbiters_1 (
    ...
    .io_in_1_bits_fpWen (io_in_7_bits_fpWen),
  ...
  RealWBArbiter_8 arbiters_3 (
    ...
    .io_in_1_ready      (io_in_2_ready),
    .io_in_1_valid      (io_in_2_valid),
    .io_in_1_bits_fpWen (io_in_2_bits_fpWen),
    .io_in_1_bits_pdest (io_in_2_bits_pdest),
    .io_in_1_bits_data  (io_in_2_bits_data),
  ...
  RealWBArbiter_8 arbiters_4 (
    ...
    .io_in_1_ready      (io_in_4_ready),
    .io_in_1_valid      (io_in_4_valid),
    .io_in_1_bits_fpWen (io_in_4_bits_fpWen),
  ...
  RealWBArbiter_13 arbiters_5 (
    .io_in_0_valid      (io_in_10_valid),
    .io_in_0_bits_fpWen (io_in_10_bits_fpWen),
    .io_in_0_bits_pdest (io_in_10_bits_pdest),
    .io_in_0_bits_data  (io_in_10_bits_data),
