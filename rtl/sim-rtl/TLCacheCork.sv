...
module TLCacheCork(
  ...
  input  [8:0]   auto_in_c_bits_source,
  input  [47:0]  auto_in_c_bits_address,
  input          auto_in_c_bits_user_amba_prot_bufferable,
  input          auto_in_c_bits_user_amba_prot_modifiable,
  input          auto_in_c_bits_user_amba_prot_readalloc,
  input          auto_in_c_bits_user_amba_prot_writealloc,
  input          auto_in_c_bits_user_amba_prot_privileged,
  input          auto_in_c_bits_user_amba_prot_secure,
  input          auto_in_c_bits_user_amba_prot_fetch,
  ...
  wire [8:0]   _q_1_io_deq_bits_source;
  wire         _q_1_io_deq_bits_denied;
  wire         _q_1_io_deq_bits_echo_blockisdirty;
  ...
  wire [8:0]   _q_io_deq_bits_source;
  wire         _q_io_deq_bits_denied;
  wire         _q_io_deq_bits_echo_blockisdirty;
  ...
  reg          d_first_counter;
  wire         d_grant = _in_d_bits_T_44 == 4'h5 | _in_d_bits_T_44 == 4'h4;
    ...
    if (reset) begin
      ...
      if (_beatsLeft_T_4) begin
        if (d_first_counter)
          ...
          d_first_counter <= _in_d_bits_T_44[0] & ~(_d_first_beats1_decode_T[5]);
      end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_first_counter = _RANDOM[4'h0][0];
        nodeIn_d_bits_sink_r = _RANDOM[4'h0][3:1];
        beatsLeft = _RANDOM[4'h8][10];
        state_0 = _RANDOM[4'h8][11];
        state_1 = _RANDOM[4'h8][12];
        beatsLeft_1 = _RANDOM[4'h8][13];
        state_1_0 = _RANDOM[4'h8][14];
        state_1_1 = _RANDOM[4'h8][15];
        state_1_2 = _RANDOM[4'h8][16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        d_first_counter = 1'h0;
        beatsLeft = 1'h0;
  ...
  Queue2_TLBundleD_2 q (
    ...
    .io_enq_bits_echo_blockisdirty (1'h0),
    .io_enq_bits_data              (256'h0),
    .io_enq_bits_corrupt           (1'h0),
    .io_deq_ready
      (in_d_ready & (beatsLeft_1 ? state_1_1 : ~auto_out_d_valid)),
    ...
    .io_deq_bits_echo_blockisdirty (_q_io_deq_bits_echo_blockisdirty),
  ...
  Queue2_TLBundleD_2 q_1 (
    ...
    .io_deq_bits_echo_blockisdirty (_q_1_io_deq_bits_echo_blockisdirty),
  ...
  assign auto_in_d_bits_opcode = _in_d_bits_T_44;
  ...
  assign auto_in_d_bits_size = _in_d_bits_T_34;
  assign auto_in_d_bits_source =
    (muxState_1_0 ? auto_out_d_bits_source[9:1] : 9'h0)
    | (muxState_1_1 ? _q_io_deq_bits_source : 9'h0)
    | (muxState_1_2 ? _q_1_io_deq_bits_source : 9'h0);
  ...
  assign auto_in_d_bits_echo_blockisdirty =
    muxState_1_0 & auto_out_d_bits_echo_blockisdirty | muxState_1_1
    & _q_io_deq_bits_echo_blockisdirty | muxState_1_2
    & _q_1_io_deq_bits_echo_blockisdirty;
  ...
  assign auto_out_a_bits_source =
    (muxState_0 ? {auto_in_c_bits_source, 1'h0} : 10'h0)
    | (muxState_1
