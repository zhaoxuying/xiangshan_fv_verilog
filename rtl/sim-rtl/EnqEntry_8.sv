  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_fuType_4 = _RANDOM[6'h0][12];
        entryReg_status_fuType_11 = _RANDOM[6'h0][19];
        entryReg_status_fuType_12 = _RANDOM[6'h0][20];
        entryReg_status_fuType_13 = _RANDOM[6'h0][21];
        entryReg_status_fuType_14 = _RANDOM[6'h0][22];
        ...
        entryReg_status_srcStatus_0_exuSources_value = _RANDOM[6'h2][3:2];
        entryReg_status_srcStatus_1_psrc = _RANDOM[6'h2][11:4];
        entryReg_status_srcStatus_1_srcType = _RANDOM[6'h2][15:12];
        entryReg_status_srcStatus_1_srcState = _RANDOM[6'h2][16];
        entryReg_status_srcStatus_1_dataSources_value = _RANDOM[6'h2][20:17];
        entryReg_status_srcStatus_1_exuSources_value = _RANDOM[6'h2][28:27];
        entryReg_status_srcStatus_2_psrc = {_RANDOM[6'h2][31:29], _RANDOM[6'h3][4:0]};
        entryReg_status_srcStatus_2_srcType = _RANDOM[6'h3][8:5];
        entryReg_status_srcStatus_2_srcState = _RANDOM[6'h3][9];
        entryReg_status_srcStatus_2_dataSources_value = _RANDOM[6'h3][13:10];
        entryReg_status_srcStatus_2_exuSources_value = _RANDOM[6'h3][21:20];
        entryReg_status_issued = _RANDOM[6'h3][23];
        entryReg_status_issueTimer = _RANDOM[6'h3][26:25];
        entryReg_status_deqPortIdx = _RANDOM[6'h3][27];
        entryReg_payload_fuOpType = _RANDOM[6'hA][11:3];
        entryReg_payload_rfWen = _RANDOM[6'hA][12];
        entryReg_payload_fpWen = _RANDOM[6'hA][13];
        entryReg_payload_vecWen = _RANDOM[6'hA][14];
        entryReg_payload_v0Wen = _RANDOM[6'hA][15];
        entryReg_payload_fpu_wflags = _RANDOM[6'hB][28];
        entryReg_payload_fpu_fmt = {_RANDOM[6'hB][31], _RANDOM[6'hC][0]};
        entryReg_payload_fpu_rm = _RANDOM[6'hC][3:1];
        entryReg_payload_pdest = _RANDOM[6'h15][24:17];
        enqDelayValidReg_last_REG = _RANDOM[6'h2B][31];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
