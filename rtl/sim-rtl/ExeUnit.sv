...
module ExeUnit(
  ...
  wire [5:0]  _Bku_io_out_bits_ctrl_robIdx_value;
  ...
  wire        Bku_clock_te_cgen = cg_bore_1_cgen;
  reg         fuVld_en_reg_1;
  reg         fuVldVec_1;
  reg         fuVldVec_2;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_1_robIdx_value = _RANDOM[6'h7][31:26];
        inPipe_1_1_pdest = _RANDOM[6'h8][10:5];
        inPipe_1_1_rfWen = _RANDOM[6'h8][11];
        inPipe_1_2_robIdx_flag = _RANDOM[6'h24][19];
        inPipe_1_2_robIdx_value = _RANDOM[6'h24][25:20];
        inPipe_1_2_pdest = {_RANDOM[6'h24][31], _RANDOM[6'h25][4:0]};
        inPipe_1_2_rfWen = _RANDOM[6'h25][5];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg_1 = 1'h0;
        fuVldVec_1 = 1'h0;
  ...
  Alu Alu (
    ...
    .io_in_bits_ctrlPipe_0_pdest        ({2'h0, io_in_bits_pdest}),
  ...
  MulUnit Mul (
    ...
    .io_in_bits_ctrlPipe_2_pdest        (_GEN),
  ...
  assign io_out_bits_pdest =
    (_Alu_io_out_valid ? _Alu_io_out_bits_ctrl_pdest[5:0] : 6'h0)
    | (_Mul_io_out_valid ? _Mul_io_out_bits_ctrl_pdest[5:0] : 6'h0)
    | (_Bku_io_out_valid ? _Bku_io_out_bits_ctrl_pdest[5:0] : 6'h0);
  ...
  assign io_out_bits_robIdx_value =
    (_Alu_io_out_valid ? _Alu_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Mul_io_out_valid ? _Mul_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Bku_io_out_valid ? _Bku_io_out_bits_ctrl_robIdx_value : 6'h0);
