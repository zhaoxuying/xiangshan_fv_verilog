  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_1_robIdx_value = _RANDOM[7'h9][30:25];
        inPipe_1_1_pdest = _RANDOM[7'hA][11:4];
        inPipe_1_1_rfWen = _RANDOM[7'hA][12];
        inPipe_1_1_fpWen = _RANDOM[7'hA][13];
        inPipe_1_1_fpu_wflags = _RANDOM[7'hA][16];
        inPipe_1_2_robIdx_flag = _RANDOM[7'h29][0];
        inPipe_1_2_robIdx_value = _RANDOM[7'h29][6:1];
        inPipe_1_2_pdest = _RANDOM[7'h29][19:12];
        inPipe_1_2_fpWen = _RANDOM[7'h29][21];
        inPipe_1_2_fpu_wflags = _RANDOM[7'h29][24];
        inPipe_1_3_robIdx_flag = _RANDOM[7'h48][8];
        inPipe_1_3_robIdx_value = _RANDOM[7'h48][14:9];
        inPipe_1_3_pdest = _RANDOM[7'h48][27:20];
        inPipe_1_3_fpWen = _RANDOM[7'h48][29];
        inPipe_1_3_fpu_wflags = _RANDOM[7'h49][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
