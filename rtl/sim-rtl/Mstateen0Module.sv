  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reg_SE0 = _RANDOM[/*Zero width*/ 1'b0][2];
        reg_ENVCFG = _RANDOM[/*Zero width*/ 1'b0][3];
        reg_CSRIND = _RANDOM[/*Zero width*/ 1'b0][4];
        reg_AIA = _RANDOM[/*Zero width*/ 1'b0][5];
        reg_IMSIC = _RANDOM[/*Zero width*/ 1'b0][6];
        reg_CONTEXT = _RANDOM[/*Zero width*/ 1'b0][7];
        reg_C = _RANDOM[/*Zero width*/ 1'b0][9];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        reg_SE0 = 1'h0;
        reg_ENVCFG = 1'h0;
