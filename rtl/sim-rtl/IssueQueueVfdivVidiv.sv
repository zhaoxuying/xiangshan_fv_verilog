  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[6'h1E][20];
        deqDelay_0_bits_common_vpu_vma = _RANDOM[6'h1E][29];
        deqDelay_0_bits_common_vpu_vta = _RANDOM[6'h1E][30];
        deqDelay_0_bits_common_vpu_vsew = {_RANDOM[6'h1E][31], _RANDOM[6'h1F][0]};
        deqDelay_0_bits_common_vpu_vlmul = _RANDOM[6'h1F][3:1];
        deqDelay_0_bits_common_vpu_vm = _RANDOM[6'h1F][12];
        deqDelay_0_bits_common_vpu_vstart = _RANDOM[6'h1F][20:13];
        deqDelay_0_bits_common_vpu_vuopIdx = _RANDOM[6'h20][7:1];
        deqDelay_0_bits_common_vpu_isExt = _RANDOM[6'h24][23];
        deqDelay_0_bits_common_vpu_isNarrow = _RANDOM[6'h24][24];
        deqDelay_0_bits_common_vpu_isDstMask = _RANDOM[6'h24][25];
        deqDelay_0_bits_common_vpu_isOpMask = _RANDOM[6'h24][26];
        deqDelay_0_bits_common_dataSources_0_value =
          {_RANDOM[6'h24][31], _RANDOM[6'h25][2:0]};
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[6'h25][6:3];
        deqDelay_0_bits_common_dataSources_2_value = _RANDOM[6'h25][10:7];
        deqDelay_0_bits_common_dataSources_3_value = _RANDOM[6'h25][14:11];
        deqDelay_0_bits_common_dataSources_4_value = _RANDOM[6'h25][18:15];
      `endif // RANDOMIZE_REG_INIT
    end // initial
