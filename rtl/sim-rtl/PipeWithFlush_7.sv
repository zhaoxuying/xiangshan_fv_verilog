  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_flag = _RANDOM[6'h9][14];
        bits_1_robIdx_value = _RANDOM[6'h9][20:15];
        bits_1_pdest = {_RANDOM[6'h9][31:26], _RANDOM[6'hA][1:0]};
        bits_1_fpWen = _RANDOM[6'hA][3];
        bits_1_vecWen = _RANDOM[6'hA][4];
        bits_1_v0Wen = _RANDOM[6'hA][5];
        bits_2_fuType = {_RANDOM[6'h1F][31:12], _RANDOM[6'h20][14:0]};
        bits_2_robIdx_flag = _RANDOM[6'h28][24];
        bits_2_robIdx_value = _RANDOM[6'h28][30:25];
        bits_2_pdest = _RANDOM[6'h29][11:4];
        bits_2_fpWen = _RANDOM[6'h29][13];
        bits_2_vecWen = _RANDOM[6'h29][14];
        bits_2_v0Wen = _RANDOM[6'h29][15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_1 = 1'h0;
        valids_2 = 1'h0;
