...
module VSSplitBufferImp(
  ...
  output [4:0]   io_vstd_bits_uop_sqIdx_value,
    ...
    {15'h0,
     {8'h0,
      {4'h0, {2'h0, {1'h0, _flowData_T_15} | {2{_flowData_T_16}}} | {4{_flowData_T_17}}}
        | {8{_flowData_T_18}}} | {16{_flowData_T_19}} | {16{&uopq_alignedType}}}
    << _vaddr_T[3:0];
  ...
  wire [5:0]   sqIdx_new_value = 6'({1'h0, uopq_uop_sqIdx_value} + {1'h0, splitIdx});
  wire [6:0]   _sqIdx_diff_T_4 = 7'({1'h0, sqIdx_new_value} - 7'h14);
  wire         sqIdx_reverse_flag = $signed(_sqIdx_diff_T_4) > -7'sh1;
  wire         sqIdx_flag = sqIdx_reverse_flag ^ uopq_uop_sqIdx_flag;
  wire [4:0]   _sqIdx_new_ptr_value_T_1 =
    sqIdx_reverse_flag ? _sqIdx_diff_T_4[4:0] : sqIdx_new_value[4:0];
  always @(posedge clock) begin
    if (doEnqueue) begin
      ...
      uopq_uop_trigger <= io_in_bits_uop_trigger;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_uop_trigger = _RANDOM[7'h12][29:26];
        ...
        uopq_mBIndex = _RANDOM[7'h3B][14:12];
        uopq_alignedType = _RANDOM[7'h3B][17:15];
        uopq_indexVlMaxInVd = _RANDOM[7'h3B][25:18];
        uopq_usAligned128 = _RANDOM[7'h3B][30];
        uopq_usMask = {_RANDOM[7'h3B][31], _RANDOM[7'h3C][30:0]};
        allocated = _RANDOM[7'h3C][31];
        splitIdx = _RANDOM[7'h3D][4:0];
        strideOffsetReg =
          {_RANDOM[7'h3D][31:5],
           _RANDOM[7'h3E],
           _RANDOM[7'h3F],
  ...
  assign io_out_bits_uop_trigger = uopq_uop_trigger;
