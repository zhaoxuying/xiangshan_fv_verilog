...
module DatamoduleResultBuffer(
  ...
  input  [4:0]   io_enq_0_bits_sqPtr_value,
  ...
  input  [4:0]   io_enq_1_bits_sqPtr_value,
  ...
  output [4:0]   io_deq_0_bits_sqPtr_value,
  ...
  output [4:0]   io_deq_1_bits_sqPtr_value,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_0_sqPtr_value = _RANDOM[4'h7][24:20];
        data_0_vecValid = _RANDOM[4'h7][26];
        data_0_sqNeedDeq = _RANDOM[4'h7][27];
        data_1_addr = {_RANDOM[4'h7][31:28], _RANDOM[4'h8], _RANDOM[4'h9][11:0]};
        data_1_vaddr = {_RANDOM[4'h9][31:12], _RANDOM[4'hA][29:0]};
        data_1_data =
          {_RANDOM[4'hA][31:30],
           _RANDOM[4'hB],
           _RANDOM[4'hC],
           _RANDOM[4'hD],
           _RANDOM[4'hE][29:0]};
        data_1_mask = {_RANDOM[4'hE][31:30], _RANDOM[4'hF][13:0]};
        data_1_wline = _RANDOM[4'hF][14];
        data_1_sqPtr_value = _RANDOM[4'hF][20:16];
        data_1_vecValid = _RANDOM[4'hF][22];
        data_1_sqNeedDeq = _RANDOM[4'hF][23];
        valids_0 = _RANDOM[4'hF][24];
        valids_1 = _RANDOM[4'hF][25];
        enq_flag = _RANDOM[4'hF][26];
        deq_flag = _RANDOM[4'hF][27];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
