...
module FreeList_3(
  ...
  reg  [4:0]       freeSlotCnt;
  wire [5:0]       _GEN = {1'h0, headPtr_value};
  wire [6:0]       _deqPtr_diff_T_4 = 7'({2'h0, headPtr_value} - 7'h18);
  wire             deqPtr_reverse_flag = $signed(_deqPtr_diff_T_4) > -7'sh1;
  wire [4:0]       _deqPtr_new_ptr_value_T_1 =
    deqPtr_reverse_flag ? _deqPtr_diff_T_4[4:0] : headPtr_value;
  wire [31:0][4:0] _GEN_0 =
    {{freeList_0},
     ...
     {freeList_1},
     {freeList_0}};
  wire [5:0]       deqPtr_new_value_1 = 6'(_GEN + 6'h1);
  wire [6:0]       _deqPtr_diff_T_10 = 7'({1'h0, deqPtr_new_value_1} - 7'h18);
  wire             deqPtr_reverse_flag_1 = $signed(_deqPtr_diff_T_10) > -7'sh1;
  wire [4:0]       _deqPtr_new_ptr_value_T_3 =
    deqPtr_reverse_flag_1 ? _deqPtr_diff_T_10[4:0] : deqPtr_new_value_1[4:0];
  wire [5:0]       deqPtr_new_value_2 = 6'(_GEN + 6'h2);
  wire [6:0]       _deqPtr_diff_T_16 = 7'({1'h0, deqPtr_new_value_2} - 7'h18);
  wire             deqPtr_reverse_flag_2 = $signed(_deqPtr_diff_T_16) > -7'sh1;
  wire [4:0]       _deqPtr_new_ptr_value_T_5 =
    deqPtr_reverse_flag_2 ? _deqPtr_diff_T_16[4:0] : deqPtr_new_value_2[4:0];
  ...
  wire [5:0]       _GEN_1 = {1'h0, tailPtr_value};
  ...
  wire [5:0]       enqPtr_new_value_1 = 6'(_GEN_1 + {5'h0, freeReq_next_nextVec_0_r});
  ...
  wire [5:0]       enqPtr_new_value_3 =
    6'(_GEN_1 + {4'h0, 2'(_GEN_2 + 2'(_GEN_3 + _GEN_4))});
  ...
  wire [5:0]       tailPtrNext_new_value =
    6'(_GEN_1
       + {3'h0,
          3'({1'h0, offset} + {1'h0, 2'(_GEN_4 + {1'h0, freeReq_next_nextVec_3_r})})});
  ...
  wire [6:0]       _headPtrNext_diff_T_4 = 7'({1'h0, headPtrNext_new_value} - 7'h18);
  wire             headPtrNext_reverse_flag = $signed(_headPtrNext_diff_T_4) > -7'sh1;
  wire [4:0]       _headPtrNext_new_ptr_value_T_1 =
    headPtrNext_reverse_flag ? _headPtrNext_diff_T_4[4:0] : headPtrNext_new_value[4:0];
  ...
  assign io_validCount = 5'(5'h18 - freeSlotCnt);
