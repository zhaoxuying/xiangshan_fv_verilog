...
module Queue2_TLBundleD_24(
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[19:12];
  assign io_deq_bits_denied = _ram_ext_R0_data[20];
  assign io_deq_bits_data = _ram_ext_R0_data[276:21];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[277];
endmodule
