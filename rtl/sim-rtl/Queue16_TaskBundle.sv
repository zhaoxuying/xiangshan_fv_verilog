...
module Queue16_TaskBundle(
  ...
  input  [5:0]  io_enq_bits_aMergeTask_sourceId,
  ...
  assign io_deq_bits_set = empty ? io_enq_bits_set : _ram_ext_R0_data[0];
  assign io_deq_bits_tag = empty ? io_enq_bits_tag : _ram_ext_R0_data[41:1];
  assign io_deq_bits_off = empty ? io_enq_bits_off : _ram_ext_R0_data[47:42];
  assign io_deq_bits_opcode = empty ? io_enq_bits_opcode : _ram_ext_R0_data[51:48];
  assign io_deq_bits_param = empty ? io_enq_bits_param : _ram_ext_R0_data[54:52];
  assign io_deq_bits_mshrId = empty ? io_enq_bits_mshrId : _ram_ext_R0_data[62:55];
  assign io_deq_bits_dirty = empty ? io_enq_bits_dirty : _ram_ext_R0_data[63];
