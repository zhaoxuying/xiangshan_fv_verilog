...
module skidBufferConnect(
  ...
  reg  [3:0]   dataBuffer_uop_trigger;
  ...
  reg  [5:0]   dataBuffer_uop_waitForRobIdx_value;
  ...
  reg  [4:0]   dataBuffer_uop_sqIdx_value;
  ...
  always @(posedge clock) begin
    if (_dataBuffer_T_2) begin
      ...
      dataBuffer_uop_waitForRobIdx_value <= 6'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataBuffer_uop_trigger = _RANDOM[6'h12][30:27];
        dataBuffer_uop_preDecodeInfo_isRVC = _RANDOM[6'h13][0];
        dataBuffer_uop_ftqPtr_flag = _RANDOM[6'h13][7];
        dataBuffer_uop_ftqPtr_value = _RANDOM[6'h13][10:8];
        dataBuffer_uop_ftqOffset = _RANDOM[6'h13][14:11];
        dataBuffer_uop_fuOpType = _RANDOM[6'h15][20:12];
        dataBuffer_uop_rfWen = _RANDOM[6'h15][21];
        dataBuffer_uop_fpWen = _RANDOM[6'h15][22];
        dataBuffer_uop_vpu_vstart = {_RANDOM[6'h17][31:30], _RANDOM[6'h18][5:0]};
        dataBuffer_uop_vpu_vuopIdx = _RANDOM[6'h18][24:18];
        dataBuffer_uop_vpu_veew = _RANDOM[6'h1D][6:5];
        dataBuffer_uop_uopIdx = _RANDOM[6'h1D][26:20];
        dataBuffer_uop_pdest = {_RANDOM[6'h20][31:26], _RANDOM[6'h21][1:0]};
        dataBuffer_uop_robIdx_flag = _RANDOM[6'h21][14];
        dataBuffer_uop_robIdx_value = _RANDOM[6'h21][20:15];
        dataBuffer_uop_storeSetHit = _RANDOM[6'h36][6];
        dataBuffer_uop_waitForRobIdx_flag = _RANDOM[6'h36][7];
        dataBuffer_uop_waitForRobIdx_value = _RANDOM[6'h36][13:8];
        dataBuffer_uop_loadWaitBit = _RANDOM[6'h36][14];
        dataBuffer_uop_loadWaitStrict = _RANDOM[6'h36][15];
        dataBuffer_uop_lqIdx_flag = _RANDOM[6'h36][21];
        dataBuffer_uop_lqIdx_value = _RANDOM[6'h36][26:22];
        dataBuffer_uop_sqIdx_flag = _RANDOM[6'h36][27];
        dataBuffer_uop_sqIdx_value = {_RANDOM[6'h36][31:28], _RANDOM[6'h37][0]};
        dataBuffer_preIsSplit = _RANDOM[6'h3B][12];
        dataBuffer_mBIndex = _RANDOM[6'h3B][16:13];
        dataBuffer_alignedType = _RANDOM[6'h3B][19:17];
        dataBuffer_indexVlMaxInVd = _RANDOM[6'h3B][27:20];
        dataBuffer_usLowBitsAddr = _RANDOM[6'h3B][31:28];
        dataBuffer_usAligned128 = _RANDOM[6'h3C][0];
        dataBuffer_usMask = {_RANDOM[6'h3C][31:1], _RANDOM[6'h3D][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 1'h0;
    end // initial
  ...
  assign io_out_bits_uop_trigger = state ? dataBuffer_uop_trigger : 4'h0;
  ...
  assign io_out_bits_uop_waitForRobIdx_value =
    state ? dataBuffer_uop_waitForRobIdx_value : 6'h0;
