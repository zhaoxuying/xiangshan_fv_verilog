...
module TLEdgeBuffer(
  ...
  output [8:0]   auto_out_c_bits_source,
  output [47:0]  auto_out_c_bits_address,
  output         auto_out_c_bits_user_amba_prot_bufferable,
  output         auto_out_c_bits_user_amba_prot_modifiable,
  output         auto_out_c_bits_user_amba_prot_readalloc,
  output         auto_out_c_bits_user_amba_prot_writealloc,
  output         auto_out_c_bits_user_amba_prot_privileged,
  output         auto_out_c_bits_user_amba_prot_secure,
  output         auto_out_c_bits_user_amba_prot_fetch,
  ...
  TLBufferModule nodeOut_L3_in_buffer_edge_0 (
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_in_a_bits_echo_blockisdirty          (auto_in_a_bits_echo_blockisdirty),
    ...
    .io_out_a_bits_user_amba_prot_bufferable (auto_out_a_bits_user_amba_prot_bufferable),
    .io_out_a_bits_user_amba_prot_modifiable (auto_out_a_bits_user_amba_prot_modifiable),
    .io_out_a_bits_user_amba_prot_readalloc  (auto_out_a_bits_user_amba_prot_readalloc),
    .io_out_a_bits_user_amba_prot_writealloc (auto_out_a_bits_user_amba_prot_writealloc),
    .io_out_a_bits_user_amba_prot_privileged (auto_out_a_bits_user_amba_prot_privileged),
    .io_out_a_bits_user_amba_prot_secure     (auto_out_a_bits_user_amba_prot_secure),
    .io_out_a_bits_user_amba_prot_fetch      (auto_out_a_bits_user_amba_prot_fetch),
    ...
    .io_out_c_bits_user_amba_prot_bufferable (auto_out_c_bits_user_amba_prot_bufferable),
    .io_out_c_bits_user_amba_prot_modifiable (auto_out_c_bits_user_amba_prot_modifiable),
    .io_out_c_bits_user_amba_prot_readalloc  (auto_out_c_bits_user_amba_prot_readalloc),
    .io_out_c_bits_user_amba_prot_writealloc (auto_out_c_bits_user_amba_prot_writealloc),
    .io_out_c_bits_user_amba_prot_privileged (auto_out_c_bits_user_amba_prot_privileged),
    .io_out_c_bits_user_amba_prot_secure     (auto_out_c_bits_user_amba_prot_secure),
    .io_out_c_bits_user_amba_prot_fetch      (auto_out_c_bits_user_amba_prot_fetch),
