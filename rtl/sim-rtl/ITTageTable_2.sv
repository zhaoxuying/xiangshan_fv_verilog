...
module ITTageTable_2(
  ...
  input  [6:0]  io_req_bits_folded_hist_hist_4_folded_hist,
  input  [5:0]  io_req_bits_folded_hist_hist_2_folded_hist,
  ...
  wire [6:0] _update_folded_hist_hist_4_folded_hist_T_3 =
    io_update_ghist[6:0]
    ^ {io_update_ghist[13:9], io_update_ghist[8:7] ^ io_update_ghist[15:14]};
  wire [6:0] update_idx = io_update_pc[7:1] ^ _update_folded_hist_hist_4_folded_hist_T_3;
  reg        needReset;
  ...
  always @(posedge clock) begin
    if (_useful_can_reset_T)
      s1_tag <=
        io_req_bits_pc[14:8] ^ io_req_bits_folded_hist_hist_4_folded_hist
  ...
  FoldedSRAMTemplate_16 table_0 (
    ...
    .io_r_req_bits_setIdx
      (io_req_bits_pc[7:1] ^ io_req_bits_folded_hist_hist_4_folded_hist),
    ...
    .io_w_req_bits_data_0_tag
      (io_update_pc[14:8] ^ _update_folded_hist_hist_4_folded_hist_T_3
       ^ {io_update_ghist[5:0]
            ^ {io_update_ghist[11:10], io_update_ghist[9:6] ^ io_update_ghist[15:12]},
          1'h0}),
