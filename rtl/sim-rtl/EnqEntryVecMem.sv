...
module EnqEntryVecMem(
  ...
  input  [7:0]   io_commonIn_enq_bits_status_srcStatus_4_psrc,
  ...
  input  [4:0]   io_commonIn_enq_bits_status_vecMem_sqIdx_value,
  input          io_commonIn_enq_bits_status_vecMem_lqIdx_flag,
  input  [4:0]   io_commonIn_enq_bits_status_vecMem_lqIdx_value,
  ...
  input  [4:0]   io_commonIn_enq_bits_payload_lqIdx_value,
  input          io_commonIn_enq_bits_payload_sqIdx_flag,
  input  [4:0]   io_commonIn_enq_bits_payload_sqIdx_value,
  ...
  input  [4:0]   io_commonIn_fromLsq_lqDeqPtr_value,
  ...
  output [7:0]   io_commonOut_entry_bits_status_srcStatus_4_psrc,
  output         io_commonOut_entry_bits_status_vecMem_sqIdx_flag,
  output [4:0]   io_commonOut_entry_bits_status_vecMem_sqIdx_value,
  output         io_commonOut_entry_bits_status_vecMem_lqIdx_flag,
  output [4:0]   io_commonOut_entry_bits_status_vecMem_lqIdx_value,
  ...
  output [4:0]   io_commonOut_entry_bits_payload_lqIdx_value,
  output         io_commonOut_entry_bits_payload_sqIdx_flag,
  output [4:0]   io_commonOut_entry_bits_payload_sqIdx_value,
  ...
  output [7:0]   io_commonOut_transEntry_bits_status_srcStatus_4_psrc,
  ...
  output         io_commonOut_transEntry_bits_status_vecMem_sqIdx_flag,
  output [4:0]   io_commonOut_transEntry_bits_status_vecMem_sqIdx_value,
  output         io_commonOut_transEntry_bits_status_vecMem_lqIdx_flag,
  output [4:0]   io_commonOut_transEntry_bits_status_vecMem_lqIdx_value,
  output [4:0]   io_commonOut_transEntry_bits_status_vecMem_numLsElem,
  ...
  output [4:0]   io_commonOut_transEntry_bits_payload_lqIdx_value,
  output         io_commonOut_transEntry_bits_payload_sqIdx_flag,
  output [4:0]   io_commonOut_transEntry_bits_payload_sqIdx_value
);
  ...
  reg  [7:0]   entryReg_status_srcStatus_4_psrc;
  ...
  reg  [4:0]   entryReg_status_vecMem_sqIdx_value;
  reg          entryReg_status_vecMem_lqIdx_flag;
  reg  [4:0]   entryReg_status_vecMem_lqIdx_value;
  ...
  reg  [4:0]   entryReg_payload_lqIdx_value;
  reg          entryReg_payload_sqIdx_flag;
  reg  [4:0]   entryReg_payload_sqIdx_value;
  ...
  wire         pdestMatch_64 =
    io_commonIn_wakeUpFromWB_12_bits_pdest == entryReg_status_srcStatus_4_psrc;
  wire         pdestMatch_69 =
    io_commonIn_wakeUpFromWB_13_bits_pdest == entryReg_status_srcStatus_4_psrc;
  ...
  assign currentStatus_srcStatus_3_srcState =
    ...
    & (io_enqDelayIn1_wakeUpFromWB_6_bits_pdest == entryReg_status_srcStatus_3_psrc
       ...
       | io_enqDelayIn1_wakeUpFromWB_10_bits_pdest == entryReg_status_srcStatus_3_psrc
       & entryReg_status_srcStatus_3_srcType[3]
       & io_enqDelayIn1_wakeUpFromWB_10_bits_v0Wen & io_enqDelayIn1_wakeUpFromWB_10_valid
       | io_enqDelayIn1_wakeUpFromWB_11_bits_pdest == entryReg_status_srcStatus_3_psrc
       & entryReg_status_srcStatus_3_srcType[3]
  ...
  assign currentStatus_srcStatus_4_srcState =
    enqDelayValidReg_last_REG
    & (io_enqDelayIn1_wakeUpFromWB_12_bits_pdest == entryReg_status_srcStatus_4_psrc
       & entryReg_status_srcStatus_4_srcType[2]
       & io_enqDelayIn1_wakeUpFromWB_12_bits_vlWen & io_enqDelayIn1_wakeUpFromWB_12_valid
       | io_enqDelayIn1_wakeUpFromWB_13_bits_pdest == entryReg_status_srcStatus_4_psrc
       & entryReg_status_srcStatus_4_srcType[2]
       & io_enqDelayIn1_wakeUpFromWB_13_bits_vlWen & io_enqDelayIn1_wakeUpFromWB_13_valid
       | io_enqDelayIn1_wakeUpFromWB_14_bits_pdest == entryReg_status_srcStatus_4_psrc
       & entryReg_status_srcStatus_4_srcType[2]
       & io_enqDelayIn1_wakeUpFromWB_14_bits_vlWen & io_enqDelayIn1_wakeUpFromWB_14_valid
       | io_enqDelayIn1_wakeUpFromWB_15_bits_pdest == entryReg_status_srcStatus_4_psrc
       & entryReg_status_srcStatus_4_srcType[2]
  ...
  wire         entryUpdate_status_srcStatus_3_srcState =
    ...
    | (|{io_commonIn_wakeUpFromWB_11_bits_pdest == entryReg_status_srcStatus_3_psrc
           & entryReg_status_srcStatus_3_srcType[3]
           & io_commonIn_wakeUpFromWB_11_bits_v0Wen & io_commonIn_wakeUpFromWB_11_valid,
         io_commonIn_wakeUpFromWB_10_bits_pdest == entryReg_status_srcStatus_3_psrc
           & entryReg_status_srcStatus_3_srcType[3]
  ...
  wire         entryUpdate_status_srcStatus_4_srcState =
    ...
    | (|{io_commonIn_wakeUpFromWB_15_bits_pdest == entryReg_status_srcStatus_4_psrc
           & entryReg_status_srcStatus_4_srcType[2]
           & io_commonIn_wakeUpFromWB_15_bits_vlWen & io_commonIn_wakeUpFromWB_15_valid,
         io_commonIn_wakeUpFromWB_14_bits_pdest == entryReg_status_srcStatus_4_psrc
           & entryReg_status_srcStatus_4_srcType[2]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_fuType_34 = _RANDOM[6'h1][10];
        entryReg_status_srcStatus_0_psrc = _RANDOM[6'h1][18:11];
        entryReg_status_srcStatus_0_srcType = _RANDOM[6'h1][22:19];
        entryReg_status_srcStatus_0_srcState = _RANDOM[6'h1][23];
        entryReg_status_srcStatus_0_dataSources_value = _RANDOM[6'h1][27:24];
        entryReg_status_srcStatus_1_psrc = _RANDOM[6'h2][9:2];
        ...
        entryReg_status_srcStatus_2_psrc = {_RANDOM[6'h2][31:25], _RANDOM[6'h3][0]};
        entryReg_status_srcStatus_2_srcType = _RANDOM[6'h3][4:1];
        entryReg_status_srcStatus_2_srcState = _RANDOM[6'h3][5];
        entryReg_status_srcStatus_2_dataSources_value = _RANDOM[6'h3][9:6];
        entryReg_status_srcStatus_3_psrc = _RANDOM[6'h3][23:16];
        entryReg_status_srcStatus_3_srcType = _RANDOM[6'h3][27:24];
        entryReg_status_srcStatus_3_srcState = _RANDOM[6'h3][28];
        entryReg_status_srcStatus_3_dataSources_value =
          {_RANDOM[6'h3][31:29], _RANDOM[6'h4][0]};
        entryReg_status_srcStatus_4_psrc = _RANDOM[6'h4][14:7];
        entryReg_status_srcStatus_4_srcType = _RANDOM[6'h4][18:15];
        entryReg_status_srcStatus_4_srcState = _RANDOM[6'h4][19];
        entryReg_status_srcStatus_4_dataSources_value = _RANDOM[6'h4][23:20];
        entryReg_status_blocked = _RANDOM[6'h4][30];
        entryReg_status_issued = _RANDOM[6'h4][31];
        entryReg_status_issueTimer = _RANDOM[6'h5][2:1];
        entryReg_status_vecMem_sqIdx_flag = _RANDOM[6'h5][4];
        entryReg_status_vecMem_sqIdx_value = _RANDOM[6'h5][9:5];
        entryReg_status_vecMem_lqIdx_flag = _RANDOM[6'h5][10];
        entryReg_status_vecMem_lqIdx_value = _RANDOM[6'h5][15:11];
        entryReg_status_vecMem_numLsElem = _RANDOM[6'h5][20:16];
        entryReg_payload_ftqPtr_flag = _RANDOM[6'h9][23];
        entryReg_payload_ftqPtr_value = _RANDOM[6'h9][26:24];
        entryReg_payload_ftqOffset = _RANDOM[6'h9][30:27];
        entryReg_payload_fuOpType = {_RANDOM[6'hB][31:28], _RANDOM[6'hC][4:0]};
        entryReg_payload_vecWen = _RANDOM[6'hC][7];
        entryReg_payload_v0Wen = _RANDOM[6'hC][8];
        entryReg_payload_vlWen = _RANDOM[6'hC][9];
        entryReg_payload_vpu_vma = _RANDOM[6'hD][30];
        entryReg_payload_vpu_vta = _RANDOM[6'hD][31];
        entryReg_payload_vpu_vsew = _RANDOM[6'hE][1:0];
        entryReg_payload_vpu_vlmul = _RANDOM[6'hE][4:2];
        entryReg_payload_vpu_vm = _RANDOM[6'hE][13];
        entryReg_payload_vpu_vstart = _RANDOM[6'hE][21:14];
        entryReg_payload_vpu_vmask =
          {_RANDOM[6'hF][31:10],
           ...
           _RANDOM[6'h12],
           _RANDOM[6'h13][9:0]};
        entryReg_payload_vpu_nf = _RANDOM[6'h13][20:18];
        entryReg_payload_vpu_veew = _RANDOM[6'h13][22:21];
        entryReg_payload_vpu_isDependOldVd = _RANDOM[6'h13][29];
        entryReg_payload_vpu_isWritePartVd = _RANDOM[6'h13][30];
        entryReg_payload_vpu_isVleff = _RANDOM[6'h13][31];
        entryReg_payload_uopIdx = _RANDOM[6'h14][10:4];
        entryReg_payload_lastUop = _RANDOM[6'h14][13];
        entryReg_payload_pdest = _RANDOM[6'h17][17:10];
        entryReg_payload_lqIdx_flag = _RANDOM[6'h2D][5];
        entryReg_payload_lqIdx_value = _RANDOM[6'h2D][10:6];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h2D][11];
        entryReg_payload_sqIdx_value = _RANDOM[6'h2D][16:12];
        enqDelayValidReg_last_REG = _RANDOM[6'h2D][24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
  ...
  assign io_commonOut_transEntry_bits_status_issueTimer =
    io_commonIn_deqSel
      ...
      : entryReg_status_issued
          ...
          : 2'h3;
  assign io_commonOut_transEntry_bits_status_vecMem_sqIdx_flag =
    entryReg_status_vecMem_sqIdx_flag;
  assign io_commonOut_transEntry_bits_status_vecMem_sqIdx_value =
    entryReg_status_vecMem_sqIdx_value;
  assign io_commonOut_transEntry_bits_status_vecMem_lqIdx_flag =
    entryReg_status_vecMem_lqIdx_flag;
  assign io_commonOut_transEntry_bits_status_vecMem_lqIdx_value =
    entryReg_status_vecMem_lqIdx_value;
  assign io_commonOut_transEntry_bits_status_vecMem_numLsElem =
    entryReg_status_vecMem_numLsElem;
