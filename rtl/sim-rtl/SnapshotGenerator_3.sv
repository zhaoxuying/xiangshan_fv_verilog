...
module SnapshotGenerator_3(
  ...
  output [5:0] io_snapshots_0_0_value,
  output       io_snapshots_1_0_flag,
  output [5:0] io_snapshots_1_0_value,
  output       io_snapshots_2_0_flag,
  output [5:0] io_snapshots_2_0_value,
  output       io_snapshots_3_0_flag,
  output [5:0] io_snapshots_3_0_value
);

  reg        snapshots_0_0_flag;
  reg  [5:0] snapshots_0_0_value;
  reg        snapshots_1_0_flag;
  reg  [5:0] snapshots_1_0_value;
  reg        snapshots_2_0_flag;
  reg  [5:0] snapshots_2_0_value;
  reg        snapshots_3_0_flag;
  reg  [5:0] snapshots_3_0_value;
  reg        snptEnqPtr_flag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        snapshots_0_0_flag = _RANDOM[3'h0][0];
        snapshots_0_0_value = _RANDOM[3'h0][6:1];
        snapshots_1_0_flag = _RANDOM[3'h1][24];
        snapshots_1_0_value = _RANDOM[3'h1][30:25];
        snapshots_2_0_flag = _RANDOM[3'h3][16];
        snapshots_2_0_value = _RANDOM[3'h3][22:17];
        snapshots_3_0_flag = _RANDOM[3'h5][8];
        snapshots_3_0_value = _RANDOM[3'h5][14:9];
        snptEnqPtr_flag = _RANDOM[3'h7][0];
        snptEnqPtr_value = _RANDOM[3'h7][2:1];
        snptDeqPtr_flag = _RANDOM[3'h7][3];
        snptDeqPtr_value = _RANDOM[3'h7][5:4];
        snptValids_0 = _RANDOM[3'h7][6];
        snptValids_1 = _RANDOM[3'h7][7];
        snptValids_2 = _RANDOM[3'h7][8];
        snptValids_3 = _RANDOM[3'h7][9];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        snptEnqPtr_flag = 1'h0;
        snptEnqPtr_value = 2'h0;
