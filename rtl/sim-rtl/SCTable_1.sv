...
module SCTable_1(
  ...
  input  [4:0]  io_req_bits_folded_hist_hist_12_folded_hist,
  ...
  wire        updateWayMask_3 =
    io_update_mask_0 & io_update_pc[1] & io_update_tagePreds_0 | io_update_mask_1
    & ~(io_update_pc[1]) & io_update_tagePreds_1;
  wire [5:0]  update_idx = {io_update_pc[6], io_update_pc[5:1] ^ io_update_ghist[4:0]};
  wire        ctrPos =
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_pc = {_RANDOM[1'h0][31:6], _RANDOM[1'h1][23:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  SRAMTemplate_61 table_0 (
    .clock                 (clock),
    .reset                 (reset),
    .io_r_req_valid        (io_req_valid),
    .io_r_req_bits_setIdx
      ({io_req_bits_pc[6],
        io_req_bits_pc[5:1] ^ io_req_bits_folded_hist_hist_12_folded_hist}),
