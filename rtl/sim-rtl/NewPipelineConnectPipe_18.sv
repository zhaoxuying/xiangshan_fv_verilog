  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_robIdx_value = _RANDOM[3'h5][19:14];
        data_pdest = _RANDOM[3'h5][30:25];
        data_rfWen = _RANDOM[3'h5][31];
        data_sqIdx_flag = _RANDOM[3'h6][9];
        data_sqIdx_value = _RANDOM[3'h6][14:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
