  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_fpWen = _RANDOM[5'h18][1];
        data_vecWen = _RANDOM[5'h18][2];
        data_v0Wen = _RANDOM[5'h18][3];
        data_fpu_wflags = _RANDOM[5'h18][6];
        data_vpu_vma = _RANDOM[5'h18][15];
        data_vpu_vta = _RANDOM[5'h18][16];
        data_vpu_vsew = _RANDOM[5'h18][18:17];
        data_vpu_vlmul = _RANDOM[5'h18][21:19];
        data_vpu_vm = _RANDOM[5'h18][30];
        data_vpu_vstart = {_RANDOM[5'h18][31], _RANDOM[5'h19][6:0]};
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[5'h19][14];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[5'h19][15];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[5'h19][16];
        data_vpu_vuopIdx = _RANDOM[5'h19][25:19];
        data_vpu_lastUop = _RANDOM[5'h19][26];
        data_vpu_isNarrow = _RANDOM[5'h1E][10];
        data_vpu_isDstMask = _RANDOM[5'h1E][11];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
