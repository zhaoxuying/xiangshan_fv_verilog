...
module SplittedSRAMTemplate_22(
  input          clock,
  input          reset,
  ...
  wire [79:0] _array_0_0_3_io_r_resp_data_0;
  wire [79:0] _array_0_0_2_io_r_resp_data_0;
  wire [79:0] _array_0_0_1_io_r_resp_data_0;
  wire [79:0] _array_0_0_0_io_r_resp_data_0;
  SRAMTemplate_66 array_0_0_0 (
    .clock                (clock),
    .reset                (reset),
    ...
    .io_w_req_bits_data_0
      ({io_w_req_bits_data_0_meta[19:0],
  ...
  SRAMTemplate_66 array_0_0_1 (
    ...
    .io_w_req_valid       (io_w_req_valid),
    .io_w_req_bits_setIdx (io_w_req_bits_setIdx),
    .io_w_req_bits_data_0 (io_w_req_bits_data_0_meta[99:20])
  );
  SRAMTemplate_66 array_0_0_2 (
    .clock                (clock),
    .reset                (reset),
    .io_r_req_valid       (io_r_req_valid),
    .io_r_req_bits_setIdx (io_r_req_bits_setIdx),
    ...
    .io_w_req_valid       (io_w_req_valid),
    .io_w_req_bits_setIdx (io_w_req_bits_setIdx),
    .io_w_req_bits_data_0 (io_w_req_bits_data_0_meta[179:100])
  );
  SRAMTemplate_66 array_0_0_3 (
    .clock                (clock),
    .reset                (reset),
    .io_r_req_valid       (io_r_req_valid),
    .io_r_req_bits_setIdx (io_r_req_bits_setIdx),
