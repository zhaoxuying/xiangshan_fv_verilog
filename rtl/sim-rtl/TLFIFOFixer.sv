...
module TLFIFOFixer(
  ...
  wire        nodeIn_a_ready;
  wire [1:0]  a_id =
    {auto_in_a_bits_address[47:31] == 17'h0,
  ...
  wire        stall =
    ...
    & (a_noDomain | stalls_id != a_id) | auto_in_a_bits_source[1] & ~a_first_counter
    & (flight_2 | flight_3) & (a_noDomain | stalls_id_1 != a_id);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stalls_id = _RANDOM[/*Zero width*/ 1'b0][7:6];
        stalls_id_1 = _RANDOM[/*Zero width*/ 1'b0][9:8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        a_first_counter = 1'h0;
        d_first_counter = 1'h0;
