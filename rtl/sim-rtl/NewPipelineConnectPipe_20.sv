...
module NewPipelineConnectPipe_20(
  ...
  input  [5:0]  io_in_bits_waitForRobIdx_value,
  ...
  output [5:0]  io_out_bits_waitForRobIdx_value,
  ...
  reg  [5:0]  data_waitForRobIdx_value;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_robIdx_value = _RANDOM[4'h5][19:14];
        data_pdest = {_RANDOM[4'h5][31:25], _RANDOM[4'h6][0]};
        data_rfWen = _RANDOM[4'h6][1];
        data_fpWen = _RANDOM[4'h6][2];
        data_preDecode_isRVC = _RANDOM[4'h7][23];
        data_ftqIdx_flag = _RANDOM[4'h7][28];
        data_ftqIdx_value = _RANDOM[4'h7][31:29];
        data_ftqOffset = _RANDOM[4'h8][3:0];
        data_loadWaitBit = _RANDOM[4'h8][4];
        data_waitForRobIdx_flag = _RANDOM[4'h8][5];
        data_waitForRobIdx_value = _RANDOM[4'h8][11:6];
        data_storeSetHit = _RANDOM[4'h8][12];
        data_loadWaitStrict = _RANDOM[4'h8][13];
        data_sqIdx_flag = _RANDOM[4'h8][19];
        data_sqIdx_value = _RANDOM[4'h8][24:20];
        data_lqIdx_flag = _RANDOM[4'h8][25];
        data_lqIdx_value = _RANDOM[4'h8][30:26];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
