...
module VSSplitPipelineImp(
  ...
  output [4:0]   io_toMergeBuffer_req_bits_uop_lqIdx_value,
  output         io_toMergeBuffer_req_bits_uop_sqIdx_flag,
  output [4:0]   io_toMergeBuffer_req_bits_uop_sqIdx_value,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_alignedType = _RANDOM[6'h3B][21:19];
        s1_in_r_indexVlMaxInVd = _RANDOM[6'h3B][29:22];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial
