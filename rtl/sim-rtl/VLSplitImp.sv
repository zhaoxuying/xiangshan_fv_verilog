...
module VLSplitImp(
  ...
  wire [5:0]   _VSSplitSkidBuffer_io_out_bits_uop_waitForRobIdx_value;
  ...
  VLSplitBufferImp splitBuffer (
    ...
    .io_in_bits_uop_storeSetHit          (_VSSplitSkidBuffer_io_out_bits_uop_storeSetHit),
    ...
    .io_in_bits_uop_loadWaitBit          (_VSSplitSkidBuffer_io_out_bits_uop_loadWaitBit),
  ...
  skidBufferConnect VSSplitSkidBuffer (
    ...
    .io_out_bits_indexedSplitOffset
      (_VSSplitSkidBuffer_io_out_bits_indexedSplitOffset),
    .io_out_bits_uop_trigger             (/* unused */),
  ...
  assign io_in_ready =
    ...
    & ~(io_threshold_valid
        & {io_threshold_bits_flag,
           io_threshold_bits_value} != {io_in_bits_uop_lqIdx_flag,
