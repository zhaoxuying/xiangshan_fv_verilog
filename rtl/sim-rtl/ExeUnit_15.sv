  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inPipe_1_1_robIdx_value = _RANDOM[8'h17][30:25];
        inPipe_1_1_pdest = _RANDOM[8'h18][11:4];
        inPipe_1_1_vecWen = _RANDOM[8'h18][12];
        inPipe_1_1_v0Wen = _RANDOM[8'h18][13];
        inPipe_1_1_fpu_wflags = _RANDOM[8'h18][16];
        inPipe_1_1_vpu_vma = _RANDOM[8'h18][25];
        inPipe_1_1_vpu_vta = _RANDOM[8'h18][26];
        inPipe_1_1_vpu_vsew = _RANDOM[8'h18][28:27];
        inPipe_1_1_vpu_vlmul = _RANDOM[8'h18][31:29];
        inPipe_1_1_vpu_vm = _RANDOM[8'h19][8];
        inPipe_1_1_vpu_vstart = _RANDOM[8'h19][16:9];
        inPipe_1_1_vpu_vuopIdx = {_RANDOM[8'h19][31:29], _RANDOM[8'h1A][3:0]};
        inPipe_1_1_vpu_isExt = _RANDOM[8'h1E][19];
        inPipe_1_1_vpu_isNarrow = _RANDOM[8'h1E][20];
        inPipe_1_1_vpu_isDstMask = _RANDOM[8'h1E][21];
        inPipe_1_1_vpu_isOpMask = _RANDOM[8'h1E][22];
        inPipe_1_2_fuOpType = _RANDOM[8'h34][27:19];
        inPipe_1_2_src_2 =
          {_RANDOM[8'h3C][31:28],
           _RANDOM[8'h3D],
           _RANDOM[8'h3E],
        ...
        inPipe_1_2_src_4 =
          {_RANDOM[8'h44][31:28],
           ...
           _RANDOM[8'h47],
           _RANDOM[8'h48][27:0]};
        inPipe_1_2_robIdx_flag = _RANDOM[8'h4A][28];
        inPipe_1_2_robIdx_value = {_RANDOM[8'h4A][31:29], _RANDOM[8'h4B][2:0]};
        inPipe_1_2_pdest = _RANDOM[8'h4B][15:8];
        inPipe_1_2_vecWen = _RANDOM[8'h4B][16];
        inPipe_1_2_v0Wen = _RANDOM[8'h4B][17];
        inPipe_1_2_fpu_wflags = _RANDOM[8'h4B][20];
        inPipe_1_2_vpu_vma = _RANDOM[8'h4B][29];
        inPipe_1_2_vpu_vta = _RANDOM[8'h4B][30];
        inPipe_1_2_vpu_vsew = {_RANDOM[8'h4B][31], _RANDOM[8'h4C][0]};
        inPipe_1_2_vpu_vlmul = _RANDOM[8'h4C][3:1];
        inPipe_1_2_vpu_vm = _RANDOM[8'h4C][12];
        inPipe_1_2_vpu_vstart = _RANDOM[8'h4C][20:13];
        inPipe_1_2_vpu_vuopIdx = _RANDOM[8'h4D][7:1];
        inPipe_1_2_vpu_isNarrow = _RANDOM[8'h51][24];
        inPipe_1_2_vpu_isDstMask = _RANDOM[8'h51][25];
        inPipe_1_3_fuOpType = _RANDOM[8'h67][31:23];
        inPipe_1_3_src_2 =
          {_RANDOM[8'h70], _RANDOM[8'h71], _RANDOM[8'h72], _RANDOM[8'h73]};
        inPipe_1_3_src_3 =
          {_RANDOM[8'h74], _RANDOM[8'h75], _RANDOM[8'h76], _RANDOM[8'h77]};
        inPipe_1_3_src_4 =
          {_RANDOM[8'h78], _RANDOM[8'h79], _RANDOM[8'h7A], _RANDOM[8'h7B]};
        inPipe_1_3_robIdx_flag = _RANDOM[8'h7E][0];
        inPipe_1_3_robIdx_value = _RANDOM[8'h7E][6:1];
        inPipe_1_3_pdest = _RANDOM[8'h7E][19:12];
        inPipe_1_3_vecWen = _RANDOM[8'h7E][20];
        inPipe_1_3_v0Wen = _RANDOM[8'h7E][21];
        inPipe_1_3_fpu_wflags = _RANDOM[8'h7E][24];
        inPipe_1_3_vpu_vma = _RANDOM[8'h7F][1];
        inPipe_1_3_vpu_vta = _RANDOM[8'h7F][2];
        inPipe_1_3_vpu_vsew = _RANDOM[8'h7F][4:3];
        inPipe_1_3_vpu_vlmul = _RANDOM[8'h7F][7:5];
        inPipe_1_3_vpu_vm = _RANDOM[8'h7F][16];
        inPipe_1_3_vpu_vstart = _RANDOM[8'h7F][24:17];
        inPipe_1_3_vpu_vuopIdx = _RANDOM[8'h80][11:5];
        inPipe_1_3_vpu_isNarrow = _RANDOM[8'h84][28];
        inPipe_1_3_vpu_isDstMask = _RANDOM[8'h84][29];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
