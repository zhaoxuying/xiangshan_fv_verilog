  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_robIdx_flag = _RANDOM[4'h7][13];
        data_robIdx_value = _RANDOM[4'h7][19:14];
        data_pdest = _RANDOM[4'h7][30:25];
        data_rfWen = _RANDOM[4'h7][31];
        data_flushPipe = _RANDOM[4'h8][0];
        data_ftqIdx_flag = _RANDOM[4'h8][7];
        data_ftqIdx_value = _RANDOM[4'h8][10:8];
        data_ftqOffset = _RANDOM[4'h8][14:11];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
