...
module LoadUnit(
  ...
  input  [2:0]   io_ldin_bits_uop_ftqPtr_value,
  ...
  output [5:0]   io_ldout_bits_uop_robIdx_value,
  ...
  input  [4:0]   io_vecldin_bits_uop_sqIdx_value,
  ...
  input  [2:0]   io_misalign_ldin_bits_uop_ftqPtr_value,
  ...
  input  [5:0]   io_misalign_ldin_bits_uop_robIdx_value,
  input          io_misalign_ldin_bits_uop_storeSetHit,
  input          io_misalign_ldin_bits_uop_waitForRobIdx_flag,
  input  [5:0]   io_misalign_ldin_bits_uop_waitForRobIdx_value,
  ...
  input  [4:0]   io_misalign_ldin_bits_uop_lqIdx_value,
  input          io_misalign_ldin_bits_uop_sqIdx_flag,
  input  [4:0]   io_misalign_ldin_bits_uop_sqIdx_value,
  ...
  input  [1:0]   io_misalign_ldin_bits_mshrid,
  input  [4:0]   io_misalign_ldin_bits_schedIndex,
  ...
  output [4:0]   io_dcache_req_bits_lqIdx_value,
  ...
  output [2:0]   io_lsq_ldin_bits_uop_ftqPtr_value,
  ...
  output [4:0]   io_lsq_ldin_bits_schedIndex,
  ...
  output [4:0]   io_lsq_ldin_bits_rep_info_data_inv_sq_idx_value,
  output         io_lsq_ldin_bits_rep_info_addr_inv_sq_idx_flag,
  output [4:0]   io_lsq_ldin_bits_rep_info_addr_inv_sq_idx_value,
  ...
  input  [2:0]   io_lsq_uncache_bits_uop_ftqPtr_value,
  ...
  input  [5:0]   io_lsq_uncache_bits_uop_robIdx_value,
  input          io_lsq_uncache_bits_uop_storeSetHit,
  input          io_lsq_uncache_bits_uop_waitForRobIdx_flag,
  input  [5:0]   io_lsq_uncache_bits_uop_waitForRobIdx_value,
  ...
  input  [4:0]   io_lsq_uncache_bits_uop_lqIdx_value,
  input          io_lsq_uncache_bits_uop_sqIdx_flag,
  input  [4:0]   io_lsq_uncache_bits_uop_sqIdx_value,
  ...
  input  [2:0]   io_lsq_nc_ldin_bits_uop_ftqPtr_value,
  ...
  input  [5:0]   io_lsq_nc_ldin_bits_uop_robIdx_value,
  input          io_lsq_nc_ldin_bits_uop_storeSetHit,
  input          io_lsq_nc_ldin_bits_uop_waitForRobIdx_flag,
  input  [5:0]   io_lsq_nc_ldin_bits_uop_waitForRobIdx_value,
  ...
  input  [4:0]   io_lsq_nc_ldin_bits_uop_lqIdx_value,
  input          io_lsq_nc_ldin_bits_uop_sqIdx_flag,
  input  [4:0]   io_lsq_nc_ldin_bits_uop_sqIdx_value,
  ...
  input  [4:0]   io_lsq_nc_ldin_bits_schedIndex,
  ...
  output [19:0]  io_lsq_forward_sqIdxMask,
  input          io_lsq_forward_dataInvalidSqIdx_flag,
  input  [4:0]   io_lsq_forward_dataInvalidSqIdx_value,
  input          io_lsq_forward_addrInvalidSqIdx_flag,
  input  [4:0]   io_lsq_forward_addrInvalidSqIdx_value,
  ...
  output [2:0]   io_lsq_stld_nuke_query_req_bits_uop_ftqPtr_value,
  output [3:0]   io_lsq_stld_nuke_query_req_bits_uop_ftqOffset,
  output         io_lsq_stld_nuke_query_req_bits_uop_robIdx_flag,
  output [5:0]   io_lsq_stld_nuke_query_req_bits_uop_robIdx_value,
  output         io_lsq_stld_nuke_query_req_bits_uop_sqIdx_flag,
  output [4:0]   io_lsq_stld_nuke_query_req_bits_uop_sqIdx_value,
  ...
  output [5:0]   io_lsq_ldld_nuke_query_req_bits_uop_robIdx_value,
  output         io_lsq_ldld_nuke_query_req_bits_uop_lqIdx_flag,
  output [4:0]   io_lsq_ldld_nuke_query_req_bits_uop_lqIdx_value,
  ...
  input  [4:0]   io_lsq_lqDeqPtr_value,
  ...
  input  [5:0]   io_stld_nuke_query_0_bits_robIdx_value,
  ...
  input  [5:0]   io_stld_nuke_query_1_bits_robIdx_value,
  ...
  input  [4:0]   io_replay_bits_uop_sqIdx_value,
  ...
  input  [4:0]   io_replay_bits_schedIndex,
  ...
  input  [2:0]   io_fast_rep_in_bits_uop_ftqPtr_value,
  ...
  input  [5:0]   io_fast_rep_in_bits_uop_robIdx_value,
  input          io_fast_rep_in_bits_uop_storeSetHit,
  input          io_fast_rep_in_bits_uop_waitForRobIdx_flag,
  input  [5:0]   io_fast_rep_in_bits_uop_waitForRobIdx_value,
  ...
  input  [4:0]   io_fast_rep_in_bits_uop_lqIdx_value,
  input          io_fast_rep_in_bits_uop_sqIdx_flag,
  input  [4:0]   io_fast_rep_in_bits_uop_sqIdx_value,
  ...
  input  [4:0]   io_fast_rep_in_bits_schedIndex,
  ...
  output [2:0]   io_fast_rep_out_bits_uop_ftqPtr_value,
  ...
  output [5:0]   io_fast_rep_out_bits_uop_robIdx_value,
  output         io_fast_rep_out_bits_uop_storeSetHit,
  output         io_fast_rep_out_bits_uop_waitForRobIdx_flag,
  output [5:0]   io_fast_rep_out_bits_uop_waitForRobIdx_value,
  ...
  output [4:0]   io_fast_rep_out_bits_uop_lqIdx_value,
  output         io_fast_rep_out_bits_uop_sqIdx_flag,
  output [4:0]   io_fast_rep_out_bits_uop_sqIdx_value,
  ...
  output [4:0]   io_fast_rep_out_bits_schedIndex,
  ...
  output [2:0]   io_misalign_enq_req_bits_uop_ftqPtr_value,
  ...
  output [5:0]   io_misalign_enq_req_bits_uop_waitForRobIdx_value,
  ...
  output [4:0]   io_misalign_enq_req_bits_uop_lqIdx_value,
  ...
  wire             io_misalign_ldout_bits_rep_info_cause_10_0;
  wire             io_misalign_ldout_bits_rep_info_cause_9_0;
  wire             io_misalign_ldout_bits_rep_info_cause_8_0;
  wire             io_misalign_ldout_bits_rep_info_cause_7_0;
  wire             io_misalign_ldout_bits_rep_info_cause_6_0;
  wire             io_misalign_ldout_bits_rep_info_cause_5_0;
  wire             io_misalign_ldout_bits_rep_info_cause_4_0;
  wire             io_misalign_ldout_bits_rep_info_cause_3_0;
  wire             io_misalign_ldout_bits_rep_info_cause_2_0;
  wire             io_misalign_ldout_bits_rep_info_cause_1_0;
  ...
  wire             s2_fwd_mask_0;
  wire             s2_full_fwd;
  reg  [5:0]       s2_in_r_uop_robIdx_value;
  reg              s2_in_r_uop_robIdx_flag;
  wire             s2_ready;
  wire             s2_kill;
  wire             s1_trigger_breakpoint;
  wire             s1_kill;
  wire             s1_exception_new_vec_19;
  ...
  wire             s0_src_select_vec_7 = io_vecldin_valid & ~_s0_src_ready_vec_7_T_4;
  wire             s0_src_select_vec_8 = io_ldin_valid & ~_s0_src_ready_vec_8_T_6;
  wire             s0_out_tlbNoQuery =
    s0_sel_src_prf_i | s0_src_select_vec_2 | s0_src_select_vec_3 | s0_src_select_vec_4;
  wire             _s3_misalign_wakeup_req_valid_T =
    io_misalign_ldin_ready_0 & io_misalign_ldin_valid;
  assign s0_valid =
    s0_src_select_vec_4
    | (_s0_tlb_valid_T | io_fast_rep_in_valid | s0_src_selector_5 | io_vecldin_valid
       | io_ldin_valid) & ~s0_src_select_vec_3 & io_dcache_req_ready
  ...
  wire             _s0_sel_src_T_10 = s0_src_selector_5 | io_vecldin_valid;
  ...
  wire [5:0]       s0_sel_src_uop_robIdx_value =
    _s0_sel_src_T_6
      ? (_s0_sel_src_T
           ? (io_misalign_ldin_valid
      ...
      : _s0_sel_src_T_10
          ...
          : io_ldin_valid ? io_ldin_bits_uop_robIdx_value : 6'h0;
  ...
  wire [4:0]       s0_sel_src_uop_lqIdx_value =
    _s0_sel_src_T_6
      ? (_s0_sel_src_T
           ? (io_misalign_ldin_valid
      ...
      : _s0_sel_src_T_10
          ...
          : io_ldin_valid ? io_ldin_bits_uop_lqIdx_value : 5'h0;
  assign s0_sel_src_prf =
    _s0_sel_src_T_6
      ...
      : _s0_sel_src_T_10
          ? s0_src_selector_5 & io_replay_bits_uop_fuOpType[3]
            & ~(|(io_replay_bits_uop_fuOpType[5:4]))
            & ~(|(io_replay_bits_uop_fuOpType[8:7])) & ~io_replay_bits_isvec
  ...
  assign s0_sel_src_prf_rd =
    _s0_sel_src_T_6
      ...
      : _s0_sel_src_T_10
          ? s0_src_selector_5 & s0_src_format_5_prf_rd
          : ~io_ldin_valid | io_ldin_bits_uop_fuOpType == 9'h9;
  assign s0_sel_src_prf_wr =
    _s0_sel_src_T_6
      ...
      : _s0_sel_src_T_10
          ? s0_src_selector_5 & s0_src_format_5_prf_wr
          : io_ldin_valid & io_ldin_bits_uop_fuOpType == 9'hA;
  assign s0_sel_src_prf_i =
    ~(_s0_sel_src_T_6 | _s0_sel_src_T_10) & io_ldin_valid
    & io_ldin_bits_uop_fuOpType == 9'h8;
  ...
  wire             s0_sel_src_isvec =
    _s0_sel_src_T_6
      ...
      : _s0_sel_src_T_10 & (~s0_src_selector_5 | io_replay_bits_isvec);
  wire             s0_sel_src_vecActive =
    _s0_sel_src_T_6
      ...
      : _s0_sel_src_T_10
          ? (s0_src_selector_5 ? io_replay_bits_vecActive : io_vecldin_bits_vecActive)
          : io_ldin_valid;
  wire [2:0]       s0_sel_src_alignedType =
    _s0_sel_src_T_6
      ...
      : _s0_sel_src_T_10
          ? (s0_src_selector_5 ? io_replay_bits_alignedType : io_vecldin_bits_alignedType)
          : 3'h0;
  ...
  wire             s0_out_misalignWith16Byte =
  ...
  wire             s0_is128bit =
    (_s0_sel_src_T_6
       ...
       : _s0_sel_src_T_10
         & (s0_src_selector_5 ? io_replay_bits_is128bit : io_vecldin_bits_alignedType[2]))
    | s0_out_misalignWith16Byte;
  ...
  reg  [5:0]       s1_in_r_uop_waitForRobIdx_value;
  ...
  reg  [4:0]       s1_in_r_uop_sqIdx_value;
  ...
  reg  [1:0]       s1_in_r_mshrid;
  reg              s1_in_r_forward_tlDchannel;
  reg  [4:0]       s1_in_r_schedIndex;
  ...
  assign s1_exception_new_vec_4 =
    ~s1_out_delayedLoadError & ~_GEN_0 & s1_in_r_uop_exceptionVec_4;
  assign s1_exception_new_vec_5 =
    ~s1_out_delayedLoadError & io_tlb_resp_bits_excp_0_af_ld & s1_vecActive & ~s1_tlb_miss
    & ~s1_in_r_tlbNoQuery;
  assign s1_exception_new_vec_19 =
  ...
  reg  [5:0]       s1_redirect_reg_bits_r_robIdx_value;
  reg              s1_redirect_reg_bits_r_level;
  reg              s1_redirect_reg_valid_last_REG;
  wire [6:0]       _s1_kill_flushItself_T_5 =
    {s1_in_r_uop_robIdx_flag, s1_in_r_uop_robIdx_value};
  wire [6:0]       _io_vecldout_valid_flushItself_T_2 =
  ...
  reg  [5:0]       s2_mmio_req_bits_REG_uop_robIdx_value;
  reg              s2_mmio_req_bits_REG_uop_replayInst;
  reg              s2_mmio_req_bits_REG_debug_isMMIO;
  reg              s2_mmio_req_bits_REG_debug_isNCIO;
  ...
  reg  [5:0]       s2_mmio_req_bits_REG_1_uop_robIdx_value;
  reg              s2_mmio_req_bits_REG_1_uop_replayInst;
  reg              s2_mmio_req_bits_REG_1_debug_isMMIO;
  reg              s2_mmio_req_bits_REG_1_debug_isNCIO;
  ...
  reg              s3_misalign_wakeup_req_bits_REG_nc;
  reg              s3_misalign_wakeup_req_bits_REG_mmio;
  reg              s3_misalign_wakeup_req_bits_REG_memBackTypeMM;
  ...
  reg              s3_misalign_wakeup_req_bits_REG_1_nc;
  reg              s3_misalign_wakeup_req_bits_REG_1_mmio;
  reg              s3_misalign_wakeup_req_bits_REG_1_memBackTypeMM;
  ...
  reg              s3_misalign_wakeup_req_bits_REG_2_nc;
  reg              s3_misalign_wakeup_req_bits_REG_2_mmio;
  reg              s3_misalign_wakeup_req_bits_REG_2_memBackTypeMM;
  ...
  reg  [2:0]       s2_in_r_uop_ftqPtr_value;
  ...
  wire             s2_exception_vec_3 = ~_GEN_1 & s2_in_r_uop_exceptionVec_3;
  wire             s2_exception_vec_5 =
    ~_GEN_1
    & (s2_in_r_delayedLoadError
         ? s2_in_r_uop_exceptionVec_5
         : s2_vecActive
           & (s2_in_r_uop_exceptionVec_5 | io_pmp_ld | s2_isvec & s2_uncache));
  wire             s2_exception_vec_13 = ~_GEN_1 & s2_in_r_uop_exceptionVec_13;
  wire             s2_exception_vec_19 = ~_GEN_1 & s2_in_r_uop_exceptionVec_19;
  wire             s2_exception_vec_21 = ~_GEN_1 & s2_in_r_uop_exceptionVec_21;
  wire             s2_exception =
    s2_vecActive
    & (s2_trigger_debug_mode
       | (|{s2_exception_vec_21,
            ...
            s2_exception_vec_13,
            s2_exception_vec_5,
            ~_GEN_1 & s2_in_r_uop_exceptionVec_4,
            s2_exception_vec_3}));
  ...
  reg  [2:0]       s3_in_uop_ftqPtr_value;
  ...
  reg  [5:0]       s3_mmio_req_bits_uop_robIdx_value;
  reg              s3_mmio_req_bits_uop_replayInst;
  reg              s3_mmio_req_bits_debug_isMMIO;
  reg              s3_mmio_req_bits_debug_isNCIO;
  ...
  wire             s3_replayqueue_rep_cause_0 = ~_GEN_2 & s3_lrq_sel_rep_cause[0];
  wire             s3_replayqueue_rep_cause_1 = ~_GEN_2 & s3_lrq_sel_rep_cause[1];
  wire             s3_replayqueue_rep_cause_2 = ~_GEN_2 & s3_lrq_sel_rep_cause[2];
  wire             s3_replayqueue_rep_cause_3 = ~_GEN_2 & s3_lrq_sel_rep_cause[3];
  wire             s3_replayqueue_rep_cause_4 = ~_GEN_2 & s3_lrq_sel_rep_cause[4];
  wire             s3_replayqueue_rep_cause_5 = ~_GEN_2 & s3_lrq_sel_rep_cause[5];
  wire             s3_replayqueue_rep_cause_6 = ~_GEN_2 & s3_lrq_sel_rep_cause[6];
  wire             s3_replayqueue_rep_cause_7 = ~_GEN_2 & s3_lrq_sel_rep_cause[7];
  wire             s3_replayqueue_rep_cause_8 = ~_GEN_2 & s3_lrq_sel_rep_cause[8];
  wire             s3_replayqueue_rep_cause_9 = ~_GEN_2 & s3_lrq_sel_rep_cause[9];
  wire             s3_replayqueue_rep_cause_10 = ~_GEN_2 & s3_lrq_sel_rep_cause[10];
  wire             s3_out_valid =
  ...
  wire             s3_frm_mis_flush =
    ...
    & (io_misalign_ldout_bits_rep_info_cause_2_0
       ...
       | io_misalign_ldout_bits_rep_info_cause_8_0);
  wire             s3_revoke =
    s3_exception
    | (|{s3_replayqueue_rep_cause_10,
         ...
         s3_replayqueue_rep_cause_0}) | s3_mis_align | s3_in_isFrmMisAlignBuf
    & (|{io_misalign_ldout_bits_rep_info_cause_10_0,
         io_misalign_ldout_bits_rep_info_cause_9_0,
         io_misalign_ldout_bits_rep_info_cause_8_0,
         io_misalign_ldout_bits_rep_info_cause_7_0,
         io_misalign_ldout_bits_rep_info_cause_6_0,
         io_misalign_ldout_bits_rep_info_cause_5_0,
         io_misalign_ldout_bits_rep_info_cause_4_0,
         io_misalign_ldout_bits_rep_info_cause_3_0,
         io_misalign_ldout_bits_rep_info_cause_2_0,
         io_misalign_ldout_bits_rep_info_cause_1_0,
         io_misalign_ldout_bits_rep_info_cause_0_0});
  ...
  assign io_misalign_ldout_bits_rep_info_cause_1_0 =
  ...
  assign io_misalign_ldout_bits_rep_info_cause_3_0 =
    ~s3_misalign_wakeup_req_valid_REG_2 & s3_mab_sel_rep_cause[3];
  assign io_misalign_ldout_bits_rep_info_cause_4_0 =
    ~s3_misalign_wakeup_req_valid_REG_2 & s3_mab_sel_rep_cause[4];
  assign io_misalign_ldout_bits_rep_info_cause_5_0 =
    ~s3_misalign_wakeup_req_valid_REG_2 & s3_mab_sel_rep_cause[5];
  assign io_misalign_ldout_bits_rep_info_cause_6_0 =
  ...
  assign io_misalign_ldout_bits_rep_info_cause_8_0 =
  ...
  assign io_misalign_ldout_bits_rep_info_cause_10_0 =
  ...
  wire [22:0]      _GEN_9 = {19'h0, io_replay_bits_vaddr[3:0]};
  wire             _GEN_10 = _s0_sel_src_T_10 & s0_src_selector_5;
  wire             s0_sel_src_uop_exceptionVec_4 =
    _s0_sel_src_T_6
      ...
      : _s0_sel_src_T_10 & ~s0_src_selector_5 & io_vecldin_bits_uop_exceptionVec_4;
  wire [4:0]       s0_sel_src_uop_sqIdx_value =
    _s0_sel_src_T_6
      ? (_s0_sel_src_T
           ? (io_misalign_ldin_valid
      ...
      : _s0_sel_src_T_10
          ...
          : io_ldin_valid ? io_ldin_bits_uop_sqIdx_value : 5'h0;
    ...
    {15'h0,
     {4'h0,
      {2'h0,
       ...
       | {8{&(io_replay_bits_uop_fuOpType[1:0])}}} << _GEN_9;
     ...
     {4'h0,
      {2'h0,
       {1'h0, ~(|(io_replay_bits_uop_fuOpType[1:0]))}
        ...
        | {4{io_replay_bits_uop_fuOpType[1:0] == 2'h2}}}
       | {8{&(io_replay_bits_uop_fuOpType[1:0])}}} << _GEN_9;
  wire [31:0]      _s1_sqIdx_mask_T = 32'h1 << s0_sel_src_uop_sqIdx_value;
  ...
  wire             s2_isMisalign = ~_GEN_1 & s2_in_r_isMisalign;
  wire             s2_mis_align =
  ...
  always @(posedge clock) begin
    ...
    if (s0_fire) begin
      ...
      s1_in_r_uop_ftqPtr_value <=
        _s0_sel_src_T_6
          ...
          : _s0_sel_src_T_10
              ...
              : io_ldin_valid ? io_ldin_bits_uop_ftqPtr_value : 3'h0;
      ...
      s1_in_r_uop_rfWen <=
        _s0_sel_src_T_6
          ...
          : _s0_sel_src_T_10
              ? (s0_src_selector_5 ? io_replay_bits_uop_rfWen : io_vecldin_bits_uop_rfWen)
      ...
      s1_in_r_uop_fpWen <=
        _s0_sel_src_T_6
          ...
          : _s0_sel_src_T_10
              ? (s0_src_selector_5 ? io_replay_bits_uop_fpWen : io_vecldin_bits_uop_fpWen)
      ...
      s1_in_r_uop_pdest <=
        _s0_sel_src_T_6
          ...
          : _s0_sel_src_T_10
              ? (s0_src_selector_5 ? io_replay_bits_uop_pdest : io_vecldin_bits_uop_pdest)
      ...
      s1_in_r_uop_waitForRobIdx_value <=
        _s0_sel_src_T_6
          ...
          : _s0_sel_src_T_10
              ...
              : io_ldin_valid ? io_ldin_bits_uop_waitForRobIdx_value : 6'h0;
      ...
      s1_in_r_uop_loadWaitStrict <=
        _s0_sel_src_T_6
          ...
          : _s0_sel_src_T_10
              ? ~s0_src_selector_5 & io_vecldin_bits_uop_loadWaitStrict
      ...
      s1_in_r_paddr <=
        s0_src_select_vec_4
          ...
          : s0_src_select_vec_2 ? io_fast_rep_in_bits_paddr : 48'h0;
      s1_in_r_mask <=
        _s0_sel_src_T_6
          ? (_s0_sel_src_T
               ? (io_misalign_ldin_valid
      ...
      s1_in_r_elemIdx <=
        _s0_sel_src_T_6
          ...
          : _s0_sel_src_T_10
              ? (s0_src_selector_5 ? io_replay_bits_elemIdx : io_vecldin_bits_elemIdx)
              : 8'h0;
      ...
      s1_in_r_mbIndex <=
        _s0_sel_src_T_6
          ...
          : _s0_sel_src_T_10
              ? (s0_src_selector_5 ? io_replay_bits_mbIndex : io_vecldin_bits_mBIndex)
              : 4'h0;
      s1_in_r_reg_offset <=
        _s0_sel_src_T_6
          ? (_s0_sel_src_T
      ...
      s1_in_r_vecBaseVaddr <=
        _s0_sel_src_T_6 | ~_s0_sel_src_T_10 | s0_src_selector_5
          ? 50'h0
      ...
      s1_in_r_mshrid <=
        _s0_sel_src_T_6
          ? (_s0_sel_src_T
               ...
               : io_fast_rep_in_valid ? io_fast_rep_in_bits_rep_info_mshr_id : 2'h0)
          : _GEN_10 ? io_replay_bits_mshrid : 2'h0;
        ...
        _s0_sel_src_T_6
          ? (_s0_sel_src_T
               ...
               : io_fast_rep_in_valid
                   ...
                   : io_lsq_uncache_valid ? 5'h0 : io_lsq_nc_ldin_bits_schedIndex)
          : _GEN_10 ? io_replay_bits_schedIndex : 5'h0;
      ...
      s1_in_r_misalignWith16Byte <= s0_out_misalignWith16Byte;
      s1_in_r_misalignNeedWakeUp <=
        s0_sel_src_frm_mabuf & io_misalign_ldin_bits_misalignNeedWakeUp;
      s1_sqIdx_mask <= 20'(_s1_sqIdx_mask_T[19:0] - 20'h1);
    end
    ...
    if (s1_fire) begin
      ...
      s2_in_r_uop_exceptionVec_19 <= s1_exception_new_vec_19;
      ...
      s2_in_r_nc <= (s1_in_r_nc | s1_pbmt == 2'h1) & ~s1_in_r_isPrefetch;
      ...
      s2_in_r_isMisalign <= ~s1_out_delayedLoadError & ~_GEN_0 & s1_in_r_isMisalign;
    ...
    s2_mmio_req_bits_REG_debug_isNCIO <= 1'h0;
    ...
    s2_mmio_req_bits_REG_1_debug_isNCIO <= s2_mmio_req_bits_REG_debug_isNCIO;
    ...
    s3_misalign_wakeup_req_bits_REG_nc <= io_misalign_ldin_bits_nc;
    s3_misalign_wakeup_req_bits_REG_mmio <= io_misalign_ldin_bits_mmio;
    s3_misalign_wakeup_req_bits_REG_memBackTypeMM <= io_misalign_ldin_bits_memBackTypeMM;
    ...
    s3_misalign_wakeup_req_bits_REG_1_nc <= s3_misalign_wakeup_req_bits_REG_nc;
    s3_misalign_wakeup_req_bits_REG_1_mmio <= s3_misalign_wakeup_req_bits_REG_mmio;
    s3_misalign_wakeup_req_bits_REG_1_memBackTypeMM <=
      s3_misalign_wakeup_req_bits_REG_memBackTypeMM;
    ...
    s3_misalign_wakeup_req_bits_REG_2_uop_trigger <=
      s3_misalign_wakeup_req_bits_REG_1_uop_trigger;
    s3_misalign_wakeup_req_bits_REG_2_nc <= s3_misalign_wakeup_req_bits_REG_1_nc;
    s3_misalign_wakeup_req_bits_REG_2_mmio <= s3_misalign_wakeup_req_bits_REG_1_mmio;
    s3_misalign_wakeup_req_bits_REG_2_memBackTypeMM <=
      s3_misalign_wakeup_req_bits_REG_1_memBackTypeMM;
    ...
    s3_mmio_req_bits_debug_isNCIO <= s2_mmio_req_bits_REG_1_debug_isNCIO;
  ...
  wire [63:0]      _GEN_12 = _GEN_11[s1_paddr_dup_lsu[4:3]];
  wire [63:0]      _GEN_13 =
    s1_paddr_dup_lsu[3] ? _GEN_12 : _GEN_11[2'(s1_paddr_dup_lsu[4:3] + 2'h1)];
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (all_match) begin
        s2_fwd_data_frm_d_chan_0 <= _GEN_12[7:0];
        s2_fwd_data_frm_d_chan_1 <= _GEN_12[15:8];
        s2_fwd_data_frm_d_chan_2 <= _GEN_12[23:16];
        s2_fwd_data_frm_d_chan_3 <= _GEN_12[31:24];
        s2_fwd_data_frm_d_chan_4 <= _GEN_12[39:32];
        s2_fwd_data_frm_d_chan_5 <= _GEN_12[47:40];
        s2_fwd_data_frm_d_chan_6 <= _GEN_12[55:48];
        s2_fwd_data_frm_d_chan_7 <= _GEN_12[63:56];
        s2_fwd_data_frm_d_chan_8 <= _GEN_13[7:0];
        s2_fwd_data_frm_d_chan_9 <= _GEN_13[15:8];
        s2_fwd_data_frm_d_chan_10 <= _GEN_13[23:16];
        s2_fwd_data_frm_d_chan_11 <= _GEN_13[31:24];
        s2_fwd_data_frm_d_chan_12 <= _GEN_13[39:32];
        s2_fwd_data_frm_d_chan_13 <= _GEN_13[47:40];
        s2_fwd_data_frm_d_chan_14 <= _GEN_13[55:48];
        s2_fwd_data_frm_d_chan_15 <= _GEN_13[63:56];
      end
      s3_valid_last_REG <=
        s2_valid
        & ~(io_redirect_valid
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:990];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [9:0] i = 10'h0; i < 10'h3DF; i += 10'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        s1_in_r_uop_ftqPtr_value = _RANDOM[10'h7][27:25];
        s1_in_r_uop_ftqOffset = _RANDOM[10'h7][31:28];
        s1_in_r_uop_fuOpType = {_RANDOM[10'h9][31:29], _RANDOM[10'hA][5:0]};
        s1_in_r_uop_rfWen = _RANDOM[10'hA][6];
        s1_in_r_uop_fpWen = _RANDOM[10'hA][7];
        s1_in_r_uop_vpu_vstart = _RANDOM[10'hC][22:15];
        s1_in_r_uop_vpu_veew = _RANDOM[10'h11][23:22];
        s1_in_r_uop_uopIdx = _RANDOM[10'h12][11:5];
        s1_in_r_uop_pdest = _RANDOM[10'h15][18:11];
        s1_in_r_uop_robIdx_flag = _RANDOM[10'h15][31];
        s1_in_r_uop_robIdx_value = _RANDOM[10'h16][5:0];
        s1_in_r_uop_storeSetHit = _RANDOM[10'h2A][23];
        s1_in_r_uop_waitForRobIdx_flag = _RANDOM[10'h2A][24];
        s1_in_r_uop_waitForRobIdx_value = _RANDOM[10'h2A][30:25];
        s1_in_r_uop_loadWaitBit = _RANDOM[10'h2A][31];
        s1_in_r_uop_loadWaitStrict = _RANDOM[10'h2B][0];
        s1_in_r_uop_lqIdx_flag = _RANDOM[10'h2B][6];
        s1_in_r_uop_lqIdx_value = _RANDOM[10'h2B][11:7];
        s1_in_r_uop_sqIdx_flag = _RANDOM[10'h2B][12];
        s1_in_r_uop_sqIdx_value = _RANDOM[10'h2B][17:13];
        s1_in_r_vaddr = {_RANDOM[10'h2B][31:25], _RANDOM[10'h2C], _RANDOM[10'h2D][10:0]};
        s1_in_r_paddr = {_RANDOM[10'h2F][31:12], _RANDOM[10'h30][27:0]};
        s1_in_r_mask = {_RANDOM[10'h32][31:28], _RANDOM[10'h33][11:0]};
        s1_in_r_data =
          {_RANDOM[10'h33][31:12],
           _RANDOM[10'h34],
           _RANDOM[10'h35],
           _RANDOM[10'h36],
           _RANDOM[10'h37][12:0]};
        s1_in_r_nc = _RANDOM[10'h37][18];
        s1_in_r_isPrefetch = _RANDOM[10'h37][24];
        s1_in_r_isvec = _RANDOM[10'h3C][13];
        s1_in_r_is128bit = _RANDOM[10'h3C][15];
        s1_in_r_elemIdx = _RANDOM[10'h3C][25:18];
        s1_in_r_alignedType = _RANDOM[10'h3C][28:26];
        s1_in_r_mbIndex = {_RANDOM[10'h3C][31:29], _RANDOM[10'h3D][0]};
        s1_in_r_reg_offset = _RANDOM[10'h3D][4:1];
        s1_in_r_elemIdxInsideVd = _RANDOM[10'h3D][12:5];
        s1_in_r_vecBaseVaddr = {_RANDOM[10'h3D][31:14], _RANDOM[10'h3E]};
        s1_in_r_vecActive = _RANDOM[10'h41][2];
        s1_in_r_isLoadReplay = _RANDOM[10'h41][3];
        s1_in_r_isFastReplay = _RANDOM[10'h41][5];
        s1_in_r_mshrid = _RANDOM[10'h41][14:13];
        s1_in_r_forward_tlDchannel = _RANDOM[10'h41][18];
        s1_in_r_schedIndex = _RANDOM[10'h41][27:23];
        s1_in_r_tlbNoQuery = _RANDOM[10'h41][28];
        s1_in_r_isFrmMisAlignBuf = _RANDOM[10'h41][29];
        s1_in_r_isMisalign = _RANDOM[10'h41][30];
        s1_in_r_isFinalSplit = _RANDOM[10'h41][31];
        s1_in_r_misalignWith16Byte = _RANDOM[10'h42][0];
        s1_in_r_misalignNeedWakeUp = _RANDOM[10'h42][1];
        s1_fast_rep_dly_kill_r = _RANDOM[10'h55][16];
        s1_fast_rep_dly_err_r = _RANDOM[10'h55][17];
        REG = _RANDOM[10'h57][19];
        s1_redirect_reg_bits_r_robIdx_flag = _RANDOM[10'h57][29];
        s1_redirect_reg_bits_r_robIdx_value =
          {_RANDOM[10'h57][31:30], _RANDOM[10'h58][3:0]};
        s1_redirect_reg_bits_r_level = _RANDOM[10'h58][12];
        s1_redirect_reg_valid_last_REG = _RANDOM[10'h66][24];
        s1_sqIdx_mask = {_RANDOM[10'h66][31:27], _RANDOM[10'h67][14:0]};
        s2_valid = _RANDOM[10'h67][15];
        s2_vecActive = _RANDOM[10'h67][16];
        s2_isvec = _RANDOM[10'h67][17];
        s2_pbmt = _RANDOM[10'h67][19:18];
        s2_trigger_debug_mode = _RANDOM[10'h67][20];
        s2_nc_with_data = _RANDOM[10'h67][21];
        s2_mmio_req_valid_REG = _RANDOM[10'h67][22];
        s2_mmio_req_valid_REG_1 = _RANDOM[10'h67][23];
        s2_mmio_req_bits_REG_uop_exceptionVec_3 = _RANDOM[10'h6A][23];
        s2_mmio_req_bits_REG_uop_exceptionVec_4 = _RANDOM[10'h6A][24];
        s2_mmio_req_bits_REG_uop_exceptionVec_5 = _RANDOM[10'h6A][25];
        s2_mmio_req_bits_REG_uop_exceptionVec_13 = _RANDOM[10'h6B][1];
        s2_mmio_req_bits_REG_uop_exceptionVec_19 = _RANDOM[10'h6B][7];
        s2_mmio_req_bits_REG_uop_exceptionVec_21 = _RANDOM[10'h6B][9];
        s2_mmio_req_bits_REG_uop_trigger = _RANDOM[10'h6B][17:14];
        s2_mmio_req_bits_REG_uop_rfWen = _RANDOM[10'h6E][8];
        s2_mmio_req_bits_REG_uop_fpWen = _RANDOM[10'h6E][9];
        s2_mmio_req_bits_REG_uop_flushPipe = _RANDOM[10'h6E][16];
        s2_mmio_req_bits_REG_uop_pdest = _RANDOM[10'h79][20:13];
        s2_mmio_req_bits_REG_uop_robIdx_flag = _RANDOM[10'h7A][1];
        s2_mmio_req_bits_REG_uop_robIdx_value = _RANDOM[10'h7A][7:2];
        s2_mmio_req_bits_REG_uop_replayInst = _RANDOM[10'h8F][21];
        s2_mmio_req_bits_REG_debug_isMMIO = _RANDOM[10'h91][28];
        s2_mmio_req_bits_REG_debug_isNCIO = _RANDOM[10'h91][29];
        s2_mmio_req_bits_REG_debug_isPerfCnt = _RANDOM[10'h91][30];
        s2_mmio_req_bits_REG_1_uop_exceptionVec_3 = _RANDOM[10'h98][0];
        s2_mmio_req_bits_REG_1_uop_exceptionVec_4 = _RANDOM[10'h98][1];
        s2_mmio_req_bits_REG_1_uop_exceptionVec_5 = _RANDOM[10'h98][2];
        s2_mmio_req_bits_REG_1_uop_exceptionVec_13 = _RANDOM[10'h98][10];
        s2_mmio_req_bits_REG_1_uop_exceptionVec_19 = _RANDOM[10'h98][16];
        s2_mmio_req_bits_REG_1_uop_exceptionVec_21 = _RANDOM[10'h98][18];
        s2_mmio_req_bits_REG_1_uop_trigger = _RANDOM[10'h98][26:23];
        s2_mmio_req_bits_REG_1_uop_rfWen = _RANDOM[10'h9B][17];
        s2_mmio_req_bits_REG_1_uop_fpWen = _RANDOM[10'h9B][18];
        s2_mmio_req_bits_REG_1_uop_flushPipe = _RANDOM[10'h9B][25];
        s2_mmio_req_bits_REG_1_uop_pdest = _RANDOM[10'hA6][29:22];
        s2_mmio_req_bits_REG_1_uop_robIdx_flag = _RANDOM[10'hA7][10];
        s2_mmio_req_bits_REG_1_uop_robIdx_value = _RANDOM[10'hA7][16:11];
        s2_mmio_req_bits_REG_1_uop_replayInst = _RANDOM[10'hBC][30];
        s2_mmio_req_bits_REG_1_debug_isMMIO = _RANDOM[10'hBF][5];
        s2_mmio_req_bits_REG_1_debug_isNCIO = _RANDOM[10'hBF][6];
        s2_mmio_req_bits_REG_1_debug_isPerfCnt = _RANDOM[10'hBF][7];
        s3_misalign_wakeup_req_valid_REG = _RANDOM[10'hC2][10];
        s3_misalign_wakeup_req_valid_REG_1 = _RANDOM[10'hC2][11];
        s3_misalign_wakeup_req_valid_REG_2 = _RANDOM[10'hC2][12];
        s3_misalign_wakeup_req_bits_REG_uop_exceptionVec_3 = _RANDOM[10'hC5][12];
        s3_misalign_wakeup_req_bits_REG_uop_exceptionVec_4 = _RANDOM[10'hC5][13];
        s3_misalign_wakeup_req_bits_REG_uop_exceptionVec_5 = _RANDOM[10'hC5][14];
        s3_misalign_wakeup_req_bits_REG_uop_exceptionVec_13 = _RANDOM[10'hC5][22];
        s3_misalign_wakeup_req_bits_REG_uop_exceptionVec_19 = _RANDOM[10'hC5][28];
        s3_misalign_wakeup_req_bits_REG_uop_exceptionVec_21 = _RANDOM[10'hC5][30];
        s3_misalign_wakeup_req_bits_REG_uop_trigger = _RANDOM[10'hC6][6:3];
        s3_misalign_wakeup_req_bits_REG_nc = _RANDOM[10'hF6][9];
        s3_misalign_wakeup_req_bits_REG_mmio = _RANDOM[10'hF6][10];
        s3_misalign_wakeup_req_bits_REG_memBackTypeMM = _RANDOM[10'hF6][11];
        s3_misalign_wakeup_req_bits_REG_vecActive = _RANDOM[10'hFF][25];
        s3_misalign_wakeup_req_bits_REG_misalignNeedWakeUp = _RANDOM[10'h100][24];
        s3_misalign_wakeup_req_bits_REG_1_uop_exceptionVec_3 = _RANDOM[10'h117][6];
        s3_misalign_wakeup_req_bits_REG_1_uop_exceptionVec_4 = _RANDOM[10'h117][7];
        s3_misalign_wakeup_req_bits_REG_1_uop_exceptionVec_5 = _RANDOM[10'h117][8];
        s3_misalign_wakeup_req_bits_REG_1_uop_exceptionVec_13 = _RANDOM[10'h117][16];
        s3_misalign_wakeup_req_bits_REG_1_uop_exceptionVec_19 = _RANDOM[10'h117][22];
        s3_misalign_wakeup_req_bits_REG_1_uop_exceptionVec_21 = _RANDOM[10'h117][24];
        s3_misalign_wakeup_req_bits_REG_1_uop_trigger =
          {_RANDOM[10'h117][31:29], _RANDOM[10'h118][0]};
        s3_misalign_wakeup_req_bits_REG_1_nc = _RANDOM[10'h148][3];
        s3_misalign_wakeup_req_bits_REG_1_mmio = _RANDOM[10'h148][4];
        s3_misalign_wakeup_req_bits_REG_1_memBackTypeMM = _RANDOM[10'h148][5];
        s3_misalign_wakeup_req_bits_REG_1_vecActive = _RANDOM[10'h151][19];
        s3_misalign_wakeup_req_bits_REG_1_misalignNeedWakeUp = _RANDOM[10'h152][18];
        s3_misalign_wakeup_req_bits_REG_2_uop_exceptionVec_3 = _RANDOM[10'h169][0];
        s3_misalign_wakeup_req_bits_REG_2_uop_exceptionVec_4 = _RANDOM[10'h169][1];
        s3_misalign_wakeup_req_bits_REG_2_uop_exceptionVec_5 = _RANDOM[10'h169][2];
        s3_misalign_wakeup_req_bits_REG_2_uop_exceptionVec_13 = _RANDOM[10'h169][10];
        s3_misalign_wakeup_req_bits_REG_2_uop_exceptionVec_19 = _RANDOM[10'h169][16];
        s3_misalign_wakeup_req_bits_REG_2_uop_exceptionVec_21 = _RANDOM[10'h169][18];
        s3_misalign_wakeup_req_bits_REG_2_uop_trigger = _RANDOM[10'h169][26:23];
        s3_misalign_wakeup_req_bits_REG_2_nc = _RANDOM[10'h199][29];
        s3_misalign_wakeup_req_bits_REG_2_mmio = _RANDOM[10'h199][30];
        s3_misalign_wakeup_req_bits_REG_2_memBackTypeMM = _RANDOM[10'h199][31];
        s3_misalign_wakeup_req_bits_REG_2_vecActive = _RANDOM[10'h1A3][13];
        s3_misalign_wakeup_req_bits_REG_2_misalignNeedWakeUp = _RANDOM[10'h1A4][12];
        s2_in_r_uop_exceptionVec_3 = _RANDOM[10'h1BA][26];
        s2_in_r_uop_exceptionVec_4 = _RANDOM[10'h1BA][27];
        s2_in_r_uop_exceptionVec_5 = _RANDOM[10'h1BA][28];
        s2_in_r_uop_exceptionVec_13 = _RANDOM[10'h1BB][4];
        s2_in_r_uop_exceptionVec_19 = _RANDOM[10'h1BB][10];
        s2_in_r_uop_exceptionVec_21 = _RANDOM[10'h1BB][12];
        s2_in_r_uop_trigger = _RANDOM[10'h1BB][20:17];
        s2_in_r_uop_preDecodeInfo_isRVC = _RANDOM[10'h1BB][22];
        s2_in_r_uop_ftqPtr_flag = _RANDOM[10'h1BB][29];
        s2_in_r_uop_ftqPtr_value = {_RANDOM[10'h1BB][31:30], _RANDOM[10'h1BC][0]};
        s2_in_r_uop_ftqOffset = _RANDOM[10'h1BC][4:1];
        s2_in_r_uop_fuOpType = _RANDOM[10'h1BE][10:2];
        s2_in_r_uop_rfWen = _RANDOM[10'h1BE][11];
        s2_in_r_uop_fpWen = _RANDOM[10'h1BE][12];
        s2_in_r_uop_vpu_vstart = _RANDOM[10'h1C0][27:20];
        s2_in_r_uop_vpu_veew = _RANDOM[10'h1C5][28:27];
        s2_in_r_uop_uopIdx = _RANDOM[10'h1C6][16:10];
        s2_in_r_uop_pdest = _RANDOM[10'h1C9][23:16];
        s2_in_r_uop_robIdx_flag = _RANDOM[10'h1CA][4];
        s2_in_r_uop_robIdx_value = _RANDOM[10'h1CA][10:5];
        s2_in_r_uop_storeSetHit = _RANDOM[10'h1DE][28];
        s2_in_r_uop_waitForRobIdx_flag = _RANDOM[10'h1DE][29];
        s2_in_r_uop_waitForRobIdx_value =
          {_RANDOM[10'h1DE][31:30], _RANDOM[10'h1DF][3:0]};
        s2_in_r_uop_loadWaitBit = _RANDOM[10'h1DF][4];
        s2_in_r_uop_loadWaitStrict = _RANDOM[10'h1DF][5];
        s2_in_r_uop_lqIdx_flag = _RANDOM[10'h1DF][11];
        s2_in_r_uop_lqIdx_value = _RANDOM[10'h1DF][16:12];
        s2_in_r_uop_sqIdx_flag = _RANDOM[10'h1DF][17];
        s2_in_r_uop_sqIdx_value = _RANDOM[10'h1DF][22:18];
        s2_in_r_vaddr =
          {_RANDOM[10'h1DF][31:30], _RANDOM[10'h1E0], _RANDOM[10'h1E1][15:0]};
        s2_in_r_fullva =
          {_RANDOM[10'h1E1][31:16], _RANDOM[10'h1E2], _RANDOM[10'h1E3][15:0]};
        s2_in_r_vaNeedExt = _RANDOM[10'h1E3][16];
        s2_in_r_paddr = {_RANDOM[10'h1E3][31:17], _RANDOM[10'h1E4], _RANDOM[10'h1E5][0]};
        s2_in_r_gpaddr = {_RANDOM[10'h1E5][31:1], _RANDOM[10'h1E6], _RANDOM[10'h1E7][0]};
        s2_in_r_mask = _RANDOM[10'h1E7][16:1];
        s2_in_r_data =
          {_RANDOM[10'h1E7][31:17],
           _RANDOM[10'h1E8],
           _RANDOM[10'h1E9],
           _RANDOM[10'h1EA],
           _RANDOM[10'h1EB][17:0]};
        s2_in_r_tlbMiss = _RANDOM[10'h1EB][20];
        s2_in_r_nc = _RANDOM[10'h1EB][23];
        s2_in_r_mmio = _RANDOM[10'h1EB][24];
        s2_in_r_isHyper = _RANDOM[10'h1EB][27];
        s2_in_r_isForVSnonLeafPTE = _RANDOM[10'h1EB][28];
        s2_in_r_isPrefetch = _RANDOM[10'h1EB][29];
        s2_in_r_isvec = _RANDOM[10'h1F0][18];
        s2_in_r_is128bit = _RANDOM[10'h1F0][20];
        s2_in_r_elemIdx = _RANDOM[10'h1F0][30:23];
        s2_in_r_alignedType = {_RANDOM[10'h1F0][31], _RANDOM[10'h1F1][1:0]};
        s2_in_r_mbIndex = _RANDOM[10'h1F1][5:2];
        s2_in_r_reg_offset = _RANDOM[10'h1F1][9:6];
        s2_in_r_elemIdxInsideVd = _RANDOM[10'h1F1][17:10];
        s2_in_r_vecVaddrOffset = {_RANDOM[10'h1F3][31:5], _RANDOM[10'h1F4][22:0]};
        s2_in_r_vecTriggerMask = {_RANDOM[10'h1F4][31:23], _RANDOM[10'h1F5][6:0]};
        s2_in_r_vecActive = _RANDOM[10'h1F5][7];
        s2_in_r_isLoadReplay = _RANDOM[10'h1F5][8];
        s2_in_r_isFastReplay = _RANDOM[10'h1F5][10];
        s2_in_r_delayedLoadError = _RANDOM[10'h1F5][25];
        s2_in_r_schedIndex = {_RANDOM[10'h1F5][31:28], _RANDOM[10'h1F6][0]};
        s2_in_r_isFrmMisAlignBuf = _RANDOM[10'h1F6][2];
        s2_in_r_isMisalign = _RANDOM[10'h1F6][3];
        s2_in_r_isFinalSplit = _RANDOM[10'h1F6][4];
        s2_in_r_misalignWith16Byte = _RANDOM[10'h1F6][5];
        s2_in_r_misalignNeedWakeUp = _RANDOM[10'h1F6][6];
        s2_in_r_rep_info_cause_9 = _RANDOM[10'h1F7][6];
        s2_mis_align_last_REG = _RANDOM[10'h209][22];
        s2_fwd_frm_d_chan = _RANDOM[10'h209][23];
        s2_fwd_data_frm_d_chan_0 = _RANDOM[10'h209][31:24];
        s2_fwd_data_frm_d_chan_1 = _RANDOM[10'h20A][7:0];
        s2_fwd_data_frm_d_chan_2 = _RANDOM[10'h20A][15:8];
        s2_fwd_data_frm_d_chan_3 = _RANDOM[10'h20A][23:16];
        s2_fwd_data_frm_d_chan_4 = _RANDOM[10'h20A][31:24];
        s2_fwd_data_frm_d_chan_5 = _RANDOM[10'h20B][7:0];
        s2_fwd_data_frm_d_chan_6 = _RANDOM[10'h20B][15:8];
        s2_fwd_data_frm_d_chan_7 = _RANDOM[10'h20B][23:16];
        s2_fwd_data_frm_d_chan_8 = _RANDOM[10'h20B][31:24];
        s2_fwd_data_frm_d_chan_9 = _RANDOM[10'h20C][7:0];
        s2_fwd_data_frm_d_chan_10 = _RANDOM[10'h20C][15:8];
        s2_fwd_data_frm_d_chan_11 = _RANDOM[10'h20C][23:16];
        s2_fwd_data_frm_d_chan_12 = _RANDOM[10'h20C][31:24];
        s2_fwd_data_frm_d_chan_13 = _RANDOM[10'h20D][7:0];
        s2_fwd_data_frm_d_chan_14 = _RANDOM[10'h20D][15:8];
        s2_fwd_data_frm_d_chan_15 = _RANDOM[10'h20D][23:16];
        s2_tlb_hit = _RANDOM[10'h20D][24];
        s2_mem_amb_REG = _RANDOM[10'h20D][25];
        s2_fwd_fail_REG = _RANDOM[10'h20D][26];
        s3_valid_last_REG = _RANDOM[10'h2DA][8];
        s3_in_uop_exceptionVec_3 = _RANDOM[10'h2DD][8];
        s3_in_uop_exceptionVec_4 = _RANDOM[10'h2DD][9];
        s3_in_uop_exceptionVec_5 = _RANDOM[10'h2DD][10];
        s3_in_uop_exceptionVec_13 = _RANDOM[10'h2DD][18];
        s3_in_uop_exceptionVec_19 = _RANDOM[10'h2DD][24];
        s3_in_uop_exceptionVec_21 = _RANDOM[10'h2DD][26];
        s3_in_uop_trigger = {_RANDOM[10'h2DD][31], _RANDOM[10'h2DE][2:0]};
        s3_in_uop_preDecodeInfo_isRVC = _RANDOM[10'h2DE][4];
        s3_in_uop_ftqPtr_flag = _RANDOM[10'h2DE][11];
        s3_in_uop_ftqPtr_value = _RANDOM[10'h2DE][14:12];
        s3_in_uop_ftqOffset = _RANDOM[10'h2DE][18:15];
        s3_in_uop_fuOpType = _RANDOM[10'h2E0][24:16];
        s3_in_uop_rfWen = _RANDOM[10'h2E0][25];
        s3_in_uop_fpWen = _RANDOM[10'h2E0][26];
        s3_in_uop_vpu_vstart = _RANDOM[10'h2E3][9:2];
        s3_in_uop_vpu_veew = _RANDOM[10'h2E8][10:9];
        s3_in_uop_uopIdx = _RANDOM[10'h2E8][30:24];
        s3_in_uop_pdest = {_RANDOM[10'h2EB][31:30], _RANDOM[10'h2EC][5:0]};
        s3_in_uop_robIdx_flag = _RANDOM[10'h2EC][18];
        s3_in_uop_robIdx_value = _RANDOM[10'h2EC][24:19];
        s3_in_uop_storeSetHit = _RANDOM[10'h301][10];
        s3_in_uop_waitForRobIdx_flag = _RANDOM[10'h301][11];
        s3_in_uop_waitForRobIdx_value = _RANDOM[10'h301][17:12];
        s3_in_uop_loadWaitBit = _RANDOM[10'h301][18];
        s3_in_uop_loadWaitStrict = _RANDOM[10'h301][19];
        s3_in_uop_lqIdx_flag = _RANDOM[10'h301][25];
        s3_in_uop_lqIdx_value = _RANDOM[10'h301][30:26];
        s3_in_uop_sqIdx_flag = _RANDOM[10'h301][31];
        s3_in_uop_sqIdx_value = _RANDOM[10'h302][4:0];
        s3_in_vaddr = {_RANDOM[10'h302][31:12], _RANDOM[10'h303][29:0]};
        s3_in_fullva =
          {_RANDOM[10'h303][31:30], _RANDOM[10'h304], _RANDOM[10'h305][29:0]};
        s3_in_vaNeedExt = _RANDOM[10'h305][30];
        s3_in_paddr = {_RANDOM[10'h305][31], _RANDOM[10'h306], _RANDOM[10'h307][14:0]};
        s3_in_gpaddr =
          {_RANDOM[10'h307][31:15], _RANDOM[10'h308], _RANDOM[10'h309][14:0]};
        s3_in_mask = _RANDOM[10'h309][30:15];
        s3_in_data =
          {_RANDOM[10'h309][31],
           _RANDOM[10'h30A],
           _RANDOM[10'h30B],
           _RANDOM[10'h30C],
           _RANDOM[10'h30D]};
        s3_in_tlbMiss = _RANDOM[10'h30E][2];
        s3_in_nc = _RANDOM[10'h30E][5];
        s3_in_mmio = _RANDOM[10'h30E][6];
        s3_in_memBackTypeMM = _RANDOM[10'h30E][7];
        s3_in_isHyper = _RANDOM[10'h30E][9];
        s3_in_isForVSnonLeafPTE = _RANDOM[10'h30E][10];
        s3_in_isvec = _RANDOM[10'h313][0];
        s3_in_is128bit = _RANDOM[10'h313][2];
        s3_in_elemIdx = _RANDOM[10'h313][12:5];
        s3_in_alignedType = _RANDOM[10'h313][15:13];
        s3_in_mbIndex = _RANDOM[10'h313][19:16];
        s3_in_reg_offset = _RANDOM[10'h313][23:20];
        s3_in_elemIdxInsideVd = _RANDOM[10'h313][31:24];
        s3_in_vecTriggerMask = _RANDOM[10'h317][20:5];
        s3_in_vecActive = _RANDOM[10'h317][21];
        s3_in_isLoadReplay = _RANDOM[10'h317][22];
        s3_in_handledByMSHR = _RANDOM[10'h318][2];
        s3_in_schedIndex = _RANDOM[10'h318][14:10];
        s3_in_isFrmMisAlignBuf = _RANDOM[10'h318][16];
        s3_in_isFinalSplit = _RANDOM[10'h318][18];
        s3_in_misalignWith16Byte = _RANDOM[10'h318][19];
        s3_in_misalignNeedWakeUp = _RANDOM[10'h318][20];
        s3_in_rep_info_mshr_id = _RANDOM[10'h318][23:22];
        s3_in_rep_info_full_fwd = _RANDOM[10'h318][24];
        s3_in_rep_info_data_inv_sq_idx_flag = _RANDOM[10'h318][25];
        s3_in_rep_info_data_inv_sq_idx_value = _RANDOM[10'h318][30:26];
        s3_in_rep_info_addr_inv_sq_idx_flag = _RANDOM[10'h318][31];
        s3_in_rep_info_addr_inv_sq_idx_value = _RANDOM[10'h319][4:0];
        s3_in_rep_info_last_beat = _RANDOM[10'h319][10];
        s3_in_rep_info_cause_0 = _RANDOM[10'h319][11];
        s3_in_rep_info_cause_1 = _RANDOM[10'h319][12];
        s3_in_rep_info_cause_2 = _RANDOM[10'h319][13];
        s3_in_rep_info_cause_3 = _RANDOM[10'h319][14];
        s3_in_rep_info_cause_4 = _RANDOM[10'h319][15];
        s3_in_rep_info_cause_6 = _RANDOM[10'h319][17];
        s3_in_rep_info_cause_7 = _RANDOM[10'h319][18];
        s3_in_rep_info_cause_8 = _RANDOM[10'h319][19];
        s3_in_rep_info_cause_9 = _RANDOM[10'h319][20];
        s3_in_rep_info_tlb_id = _RANDOM[10'h32B][26:23];
        s3_in_rep_info_tlb_full = _RANDOM[10'h32B][27];
        s3_nc_with_data = _RANDOM[10'h32C][10];
        s3_troublem_last_REG = _RANDOM[10'h32C][11];
        s3_vecActive = _RANDOM[10'h32C][12];
        s3_isvec = _RANDOM[10'h32C][13];
        s3_vec_alignedType = _RANDOM[10'h32C][16:14];
        s3_vec_mBIndex = _RANDOM[10'h32C][20:17];
        s3_mmio_req_valid = _RANDOM[10'h32C][21];
        s3_mmio_req_bits_uop_exceptionVec_3 = _RANDOM[10'h32F][21];
        s3_mmio_req_bits_uop_exceptionVec_4 = _RANDOM[10'h32F][22];
        s3_mmio_req_bits_uop_exceptionVec_5 = _RANDOM[10'h32F][23];
        s3_mmio_req_bits_uop_exceptionVec_13 = _RANDOM[10'h32F][31];
        s3_mmio_req_bits_uop_exceptionVec_19 = _RANDOM[10'h330][5];
        s3_mmio_req_bits_uop_exceptionVec_21 = _RANDOM[10'h330][7];
        s3_mmio_req_bits_uop_trigger = _RANDOM[10'h330][15:12];
        s3_mmio_req_bits_uop_flushPipe = _RANDOM[10'h333][14];
        s3_mmio_req_bits_uop_robIdx_flag = _RANDOM[10'h33E][31];
        s3_mmio_req_bits_uop_robIdx_value = _RANDOM[10'h33F][5:0];
        s3_mmio_req_bits_uop_replayInst = _RANDOM[10'h354][19];
        s3_mmio_req_bits_debug_isMMIO = _RANDOM[10'h356][26];
        s3_mmio_req_bits_debug_isNCIO = _RANDOM[10'h356][27];
        s3_mmio_req_bits_debug_isPerfCnt = _RANDOM[10'h356][28];
        s3_pdest = {_RANDOM[10'h359][31], _RANDOM[10'h35A][6:0]};
        s3_rfWen = _RANDOM[10'h35A][7];
        s3_fpWen = _RANDOM[10'h35A][8];
        s3_data_select = _RANDOM[10'h35A][17:9];
        s3_data_select_by_offset_0 = _RANDOM[10'h35A][18];
        s3_data_select_by_offset_1 = _RANDOM[10'h35A][19];
        s3_data_select_by_offset_2 = _RANDOM[10'h35A][20];
        s3_data_select_by_offset_3 = _RANDOM[10'h35A][21];
        s3_data_select_by_offset_4 = _RANDOM[10'h35A][22];
        s3_data_select_by_offset_5 = _RANDOM[10'h35A][23];
        s3_data_select_by_offset_6 = _RANDOM[10'h35A][24];
        s3_data_select_by_offset_7 = _RANDOM[10'h35A][25];
        s3_data_select_by_offset_8 = _RANDOM[10'h35A][26];
        s3_data_select_by_offset_9 = _RANDOM[10'h35A][27];
        s3_data_select_by_offset_10 = _RANDOM[10'h35A][28];
        s3_data_select_by_offset_11 = _RANDOM[10'h35A][29];
        s3_data_select_by_offset_12 = _RANDOM[10'h35A][30];
        s3_data_select_by_offset_13 = _RANDOM[10'h35A][31];
        s3_data_select_by_offset_14 = _RANDOM[10'h35B][0];
        s3_data_select_by_offset_15 = _RANDOM[10'h35B][1];
        s3_hw_err_last_REG = _RANDOM[10'h35B][2];
        s3_safe_wakeup = _RANDOM[10'h35B][3];
        s3_safe_writeback_r = _RANDOM[10'h35B][4];
        s3_exception = _RANDOM[10'h35B][5];
        s3_mis_align_r = _RANDOM[10'h35B][6];
        s3_misalign_can_go = _RANDOM[10'h35B][7];
        s3_vp_match_fail_last_REG = _RANDOM[10'h35B][10];
        s3_ldld_rep_inst_last_REG = _RANDOM[10'h35B][11];
        s3_fast_rep_REG = _RANDOM[10'h35B][12];
        s3_ld_raw_data_frm_mmio_REG_lqData =
          {_RANDOM[10'h35B][31:13], _RANDOM[10'h35C], _RANDOM[10'h35D][12:0]};
        s3_ld_raw_data_frm_mmio_REG_uop_fuOpType = _RANDOM[10'h363][28:20];
        s3_ld_raw_data_frm_mmio_REG_uop_fpWen = _RANDOM[10'h363][30];
        s3_ld_raw_data_frm_mmio_REG_addrOffset = _RANDOM[10'h385][18:16];
        s3_ld_raw_data_frm_mmio_REG_1_lqData =
          {_RANDOM[10'h385][31:19], _RANDOM[10'h386], _RANDOM[10'h387][18:0]};
        s3_ld_raw_data_frm_mmio_REG_1_uop_fuOpType =
          {_RANDOM[10'h38D][31:26], _RANDOM[10'h38E][2:0]};
        s3_ld_raw_data_frm_mmio_REG_1_uop_fpWen = _RANDOM[10'h38E][4];
        s3_ld_raw_data_frm_mmio_REG_1_addrOffset = _RANDOM[10'h3AF][24:22];
        s3_ld_raw_data_frm_mmio_lqData =
          {_RANDOM[10'h3AF][31:25], _RANDOM[10'h3B0], _RANDOM[10'h3B1][24:0]};
        s3_ld_raw_data_frm_mmio_uop_fuOpType = _RANDOM[10'h3B8][8:0];
        s3_ld_raw_data_frm_mmio_uop_fpWen = _RANDOM[10'h3B8][10];
        s3_ld_raw_data_frm_mmio_addrOffset = _RANDOM[10'h3D9][30:28];
        s3_merged_data_frm_pipe =
          {_RANDOM[10'h3D9][31],
           _RANDOM[10'h3DA],
           _RANDOM[10'h3DB],
           _RANDOM[10'h3DC],
           _RANDOM[10'h3DD][30:0]};
        s3_ldout_valid_REG = _RANDOM[10'h3DD][31];
        io_perf_0_value_REG = _RANDOM[10'h3DE][3];
        io_perf_0_value_REG_1 = _RANDOM[10'h3DE][4];
        io_perf_1_value_REG = _RANDOM[10'h3DE][5];
        io_perf_1_value_REG_1 = _RANDOM[10'h3DE][6];
        io_perf_2_value_REG = _RANDOM[10'h3DE][7];
        io_perf_2_value_REG_1 = _RANDOM[10'h3DE][8];
        io_perf_3_value_REG = _RANDOM[10'h3DE][9];
        io_perf_3_value_REG_1 = _RANDOM[10'h3DE][10];
        io_perf_4_value_REG = _RANDOM[10'h3DE][11];
        io_perf_4_value_REG_1 = _RANDOM[10'h3DE][12];
        io_perf_5_value_REG = _RANDOM[10'h3DE][13];
        io_perf_5_value_REG_1 = _RANDOM[10'h3DE][14];
        io_perf_6_value_REG = _RANDOM[10'h3DE][15];
        io_perf_6_value_REG_1 = _RANDOM[10'h3DE][16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        io_ifetchPrefetch_bits_vaddr_r = 50'h0;
        s1_valid = 1'h0;
    ...
    s3_valid_last_REG
      ...
      : (s3_ld_raw_data_frm_mmio_uop_fuOpType == 9'h0
        ...
        | (s3_ld_raw_data_frm_mmio_uop_fuOpType == 9'h1
             ? {{48{_GEN_8[15]}}, _GEN_8[15:8], _s3_ld_data_frm_mmio_T_58}
             : 64'h0)
        | (s3_ld_raw_data_frm_mmio_uop_fuOpType == 9'h2
             ? {s3_ld_raw_data_frm_mmio_uop_fpWen ? 32'hFFFFFFFF : {32{_GEN_6[31]}},
                _GEN_6[31:24],
                _GEN_7[23:16],
                _GEN_8[15:8],
                _s3_ld_data_frm_mmio_T_58}
        ...
        | (s3_ld_raw_data_frm_mmio_uop_fuOpType == 9'h5
             ? {48'h0, _GEN_8[15:8], _s3_ld_data_frm_mmio_T_58}
             : 64'h0)
  ...
  assign io_ldout_bits_debug_isNCIO =
    s3_valid_last_REG ? s3_in_nc & ~s3_in_memBackTypeMM : s3_mmio_req_bits_debug_isNCIO;
  assign io_ldout_bits_debug_isPerfCnt =
    ~s3_valid_last_REG & s3_mmio_req_bits_debug_isPerfCnt;
  assign io_vecldin_ready = io_misalign_ldin_ready_0 & ~_s0_src_ready_vec_7_T_4;
  ...
  assign io_misalign_ldout_bits_data =
    {65'h0,
     (s3_data_select_by_offset_0 ? s3_merged_data_frm_pipe[63:0] : 64'h0)
       ...
       | (s3_data_select_by_offset_14 ? s3_data_frm_pipe_2_14 : 64'h0)
       | (s3_data_select_by_offset_15 ? s3_data_frm_pipe_2_15 : 64'h0)};
  assign io_misalign_ldout_bits_nc =
    s3_misalign_wakeup_req_valid_REG_2 ? s3_misalign_wakeup_req_bits_REG_2_nc : s3_in_nc;
  assign io_misalign_ldout_bits_mmio =
    s3_misalign_wakeup_req_valid_REG_2
      ? s3_misalign_wakeup_req_bits_REG_2_mmio
      : s3_in_mmio;
  assign io_misalign_ldout_bits_memBackTypeMM =
    s3_misalign_wakeup_req_valid_REG_2
      ? s3_misalign_wakeup_req_bits_REG_2_memBackTypeMM
      : s3_in_memBackTypeMM;
  ...
  assign io_wakeup_valid =
    ...
    & (_io_wakeup_valid_T_4 | s0_src_selector_5 | io_ldin_valid & ~s0_sel_src_prf
       & ~io_vecldin_valid) | s0_mmio_fire | s0_nc_fire | s0_misalign_wakeup_fire;
  ...
  assign io_misalign_enq_req_bits_uop_exceptionVec_3 = s3_in_uop_exceptionVec_3;
  assign io_misalign_enq_req_bits_uop_exceptionVec_5 = s3_in_uop_exceptionVec_5;
  assign io_misalign_enq_req_bits_uop_exceptionVec_13 = s3_in_uop_exceptionVec_13;
  assign io_misalign_enq_req_bits_uop_exceptionVec_19 = s3_in_uop_exceptionVec_19;
  assign io_misalign_enq_req_bits_uop_exceptionVec_21 = s3_in_uop_exceptionVec_21;
  assign io_misalign_enq_req_bits_uop_trigger = s3_in_uop_trigger;
  assign io_misalign_enq_req_bits_uop_preDecodeInfo_isRVC = s3_in_uop_preDecodeInfo_isRVC;
  assign io_misalign_enq_req_bits_uop_ftqPtr_flag = s3_in_uop_ftqPtr_flag;
  assign io_misalign_enq_req_bits_uop_ftqPtr_value = s3_in_uop_ftqPtr_value;
  assign io_misalign_enq_req_bits_uop_ftqOffset = s3_in_uop_ftqOffset;
  assign io_misalign_enq_req_bits_uop_fuOpType = s3_in_uop_fuOpType;
  assign io_misalign_enq_req_bits_uop_rfWen = s3_in_uop_rfWen;
  assign io_misalign_enq_req_bits_uop_fpWen = s3_in_uop_fpWen;
  assign io_misalign_enq_req_bits_uop_vpu_vstart = s3_in_uop_vpu_vstart;
  assign io_misalign_enq_req_bits_uop_vpu_veew = s3_in_uop_vpu_veew;
  assign io_misalign_enq_req_bits_uop_uopIdx = s3_in_uop_uopIdx;
  assign io_misalign_enq_req_bits_uop_pdest = s3_in_uop_pdest;
  assign io_misalign_enq_req_bits_uop_robIdx_flag = s3_in_uop_robIdx_flag;
  assign io_misalign_enq_req_bits_uop_robIdx_value = s3_in_uop_robIdx_value;
  assign io_misalign_enq_req_bits_uop_storeSetHit = s3_in_uop_storeSetHit;
  assign io_misalign_enq_req_bits_uop_waitForRobIdx_flag = s3_in_uop_waitForRobIdx_flag;
  assign io_misalign_enq_req_bits_uop_waitForRobIdx_value = s3_in_uop_waitForRobIdx_value;
  assign io_misalign_enq_req_bits_uop_loadWaitBit = s3_in_uop_loadWaitBit;
  assign io_misalign_enq_req_bits_uop_loadWaitStrict = s3_in_uop_loadWaitStrict;
  assign io_misalign_enq_req_bits_uop_lqIdx_flag = s3_in_uop_lqIdx_flag;
  assign io_misalign_enq_req_bits_uop_lqIdx_value = s3_in_uop_lqIdx_value;
  assign io_misalign_enq_req_bits_uop_sqIdx_flag = s3_in_uop_sqIdx_flag;
  assign io_misalign_enq_req_bits_uop_sqIdx_value = s3_in_uop_sqIdx_value;
