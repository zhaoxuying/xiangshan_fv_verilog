  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_1_bits_common_fpWen = _RANDOM[7'h22][16];
        deqDelay_1_bits_common_vecWen = _RANDOM[7'h22][17];
        deqDelay_1_bits_common_v0Wen = _RANDOM[7'h22][18];
        deqDelay_1_bits_common_fpu_wflags = _RANDOM[7'h22][21];
        deqDelay_1_bits_common_vpu_vma = _RANDOM[7'h22][30];
        deqDelay_1_bits_common_vpu_vta = _RANDOM[7'h22][31];
        deqDelay_1_bits_common_vpu_vsew = _RANDOM[7'h23][1:0];
        deqDelay_1_bits_common_vpu_vlmul = _RANDOM[7'h23][4:2];
        deqDelay_1_bits_common_vpu_vm = _RANDOM[7'h23][13];
        deqDelay_1_bits_common_vpu_vstart = _RANDOM[7'h23][21:14];
        deqDelay_1_bits_common_vpu_fpu_isFoldTo1_2 = _RANDOM[7'h23][29];
        deqDelay_1_bits_common_vpu_fpu_isFoldTo1_4 = _RANDOM[7'h23][30];
        deqDelay_1_bits_common_vpu_fpu_isFoldTo1_8 = _RANDOM[7'h23][31];
        deqDelay_1_bits_common_vpu_vuopIdx = _RANDOM[7'h24][8:2];
        deqDelay_1_bits_common_vpu_lastUop = _RANDOM[7'h24][9];
        deqDelay_1_bits_common_vpu_isNarrow = _RANDOM[7'h28][25];
        deqDelay_1_bits_common_vpu_isDstMask = _RANDOM[7'h28][26];
        deqDelay_1_bits_common_dataSources_0_value = _RANDOM[7'h29][3:0];
        deqDelay_1_bits_common_dataSources_1_value = _RANDOM[7'h29][7:4];
        deqDelay_1_bits_common_dataSources_2_value = _RANDOM[7'h29][11:8];
        deqDelay_1_bits_common_dataSources_3_value = _RANDOM[7'h29][15:12];
        deqDelay_1_bits_common_dataSources_4_value = _RANDOM[7'h29][19:16];
        deqDelay_0_valid = _RANDOM[7'h3E][5];
        deqDelay_0_bits_rf_4_0_addr = _RANDOM[7'h3E][13:6];
        deqDelay_0_bits_rf_3_0_addr = _RANDOM[7'h3E][24:17];
        deqDelay_0_bits_rf_2_0_addr = {_RANDOM[7'h3E][31:28], _RANDOM[7'h3F][3:0]};
        deqDelay_0_bits_rf_1_0_addr = _RANDOM[7'h3F][14:7];
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h3F][25:18];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h40][31:21], _RANDOM[7'h41][23:0]};
        deqDelay_0_bits_common_fuOpType = {_RANDOM[7'h41][31:24], _RANDOM[7'h42][0]};
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h58][1];
        deqDelay_0_bits_common_robIdx_value = _RANDOM[7'h58][7:2];
        deqDelay_0_bits_common_pdest = _RANDOM[7'h58][20:13];
        deqDelay_0_bits_common_vecWen = _RANDOM[7'h58][21];
        deqDelay_0_bits_common_v0Wen = _RANDOM[7'h58][22];
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[7'h58][25];
        deqDelay_0_bits_common_vpu_vma = _RANDOM[7'h59][2];
        deqDelay_0_bits_common_vpu_vta = _RANDOM[7'h59][3];
        deqDelay_0_bits_common_vpu_vsew = _RANDOM[7'h59][5:4];
        deqDelay_0_bits_common_vpu_vlmul = _RANDOM[7'h59][8:6];
        deqDelay_0_bits_common_vpu_vm = _RANDOM[7'h59][17];
        deqDelay_0_bits_common_vpu_vstart = _RANDOM[7'h59][25:18];
        deqDelay_0_bits_common_vpu_vuopIdx = _RANDOM[7'h5A][12:6];
        deqDelay_0_bits_common_vpu_isExt = _RANDOM[7'h5E][28];
        deqDelay_0_bits_common_vpu_isNarrow = _RANDOM[7'h5E][29];
        deqDelay_0_bits_common_vpu_isDstMask = _RANDOM[7'h5E][30];
        deqDelay_0_bits_common_vpu_isOpMask = _RANDOM[7'h5E][31];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[7'h5F][7:4];
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h5F][11:8];
        deqDelay_0_bits_common_dataSources_2_value = _RANDOM[7'h5F][15:12];
        deqDelay_0_bits_common_dataSources_3_value = _RANDOM[7'h5F][19:16];
        deqDelay_0_bits_common_dataSources_4_value = _RANDOM[7'h5F][23:20];
        io_validCntDeqVec_0_REG = _RANDOM[7'h74][13:9];
        io_validCntDeqVec_1_REG = _RANDOM[7'h74][18:14];
      `endif // RANDOMIZE_REG_INIT
    end // initial
