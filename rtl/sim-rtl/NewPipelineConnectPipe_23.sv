...
module NewPipelineConnectPipe_23(
  ...
  output [4:0]   io_out_bits_sqIdx_value,
  output         io_out_bits_lqIdx_flag,
  output [4:0]   io_out_bits_lqIdx_value,
  ...
  reg          data_sqIdx_flag;
  reg  [4:0]   data_sqIdx_value;
  reg          data_lqIdx_flag;
  reg  [4:0]   data_lqIdx_value;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_robIdx_value = _RANDOM[5'h17][19:14];
        data_pdest = {_RANDOM[5'h17][31:25], _RANDOM[5'h18][0]};
        data_vecWen = _RANDOM[5'h18][1];
        data_v0Wen = _RANDOM[5'h18][2];
        data_vlWen = _RANDOM[5'h18][3];
        data_vpu_vma = _RANDOM[5'h18][5];
        data_vpu_vta = _RANDOM[5'h18][6];
        data_vpu_vsew = _RANDOM[5'h18][8:7];
        data_vpu_vlmul = _RANDOM[5'h18][11:9];
        data_vpu_vm = _RANDOM[5'h18][20];
        data_vpu_vstart = _RANDOM[5'h18][28:21];
        data_vpu_vuopIdx = _RANDOM[5'h19][15:9];
        data_vpu_lastUop = _RANDOM[5'h19][16];
        data_vpu_vmask =
          {_RANDOM[5'h19][31:17],
           _RANDOM[5'h1A],
           _RANDOM[5'h1B],
           _RANDOM[5'h1C],
           _RANDOM[5'h1D][16:0]};
        data_vpu_nf = _RANDOM[5'h1D][27:25];
        data_vpu_veew = _RANDOM[5'h1D][29:28];
        data_vpu_isVleff = _RANDOM[5'h1E][6];
        data_ftqIdx_flag = _RANDOM[5'h1E][8];
        data_ftqIdx_value = _RANDOM[5'h1E][11:9];
        data_ftqOffset = _RANDOM[5'h1E][15:12];
        data_numLsElem = _RANDOM[5'h1E][20:16];
        data_sqIdx_flag = _RANDOM[5'h1E][21];
        data_sqIdx_value = _RANDOM[5'h1E][26:22];
        data_lqIdx_flag = _RANDOM[5'h1E][27];
        data_lqIdx_value = {_RANDOM[5'h1E][31:28], _RANDOM[5'h1F][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
