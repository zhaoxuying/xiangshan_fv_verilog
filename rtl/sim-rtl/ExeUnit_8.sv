...
module ExeUnit_8(
  ...
  wire         Fcvt_clock_te_cgen = cg_bore_1_cgen;
  wire         Fmac_clock_te_cgen = cg_bore_2_cgen;
  reg          fuVld_en_reg;
  reg          fuVldVec_1;
  ...
  reg          fuVldVec_3;
  wire         fuVld_en_3 =
    _in1ToN_io_out_3_valid | fuVldVec_1_2 | fuVldVec_2_1 | fuVldVec_3;
  reg          inPipe_2_1;
  reg          inPipe_2_2;
  reg          inPipe_2_3;
  ...
  wire [127:0] _GEN_0 =
    {64'h0, _GEN} | (_f2v_io_out_valid ? _f2v_io_out_bits_res_data : 128'h0);
  wire [127:0] io_out_bits_data_2_0 =
    {_GEN_0[127:64],
     _GEN_0[63:0] | (_Fmac_io_out_valid ? _Fmac_io_out_bits_res_data : 64'h0)};
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      fuVldVec_1_2 <= _in1ToN_io_out_3_valid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fuVld_en_reg_3 = _RANDOM[7'h0][9];
        fuVldVec_1_2 = _RANDOM[7'h0][11];
        fuVldVec_2_1 = _RANDOM[7'h0][12];
        fuVldVec_3 = _RANDOM[7'h0][13];
        inPipe_2_1 = _RANDOM[7'h0][15];
        inPipe_2_2 = _RANDOM[7'h0][16];
        inPipe_2_3 = _RANDOM[7'h0][17];
        inPipe_1_1_fuOpType = _RANDOM[7'h1][29:21];
        inPipe_1_1_robIdx_flag = _RANDOM[7'h9][30];
        inPipe_1_1_robIdx_value = {_RANDOM[7'h9][31], _RANDOM[7'hA][4:0]};
        inPipe_1_1_pdest = _RANDOM[7'hA][17:10];
        inPipe_1_1_rfWen = _RANDOM[7'hA][18];
        inPipe_1_1_fpWen = _RANDOM[7'hA][19];
        inPipe_1_1_fpu_wflags = _RANDOM[7'hA][24];
        inPipe_1_2_fuOpType = {_RANDOM[7'h20][31], _RANDOM[7'h21][7:0]};
        inPipe_1_2_robIdx_flag = _RANDOM[7'h29][8];
        inPipe_1_2_robIdx_value = _RANDOM[7'h29][14:9];
        inPipe_1_2_pdest = _RANDOM[7'h29][27:20];
        inPipe_1_2_rfWen = _RANDOM[7'h29][28];
        inPipe_1_2_fpWen = _RANDOM[7'h29][29];
        inPipe_1_2_fpu_wflags = _RANDOM[7'h2A][2];
        inPipe_1_3_robIdx_flag = _RANDOM[7'h48][18];
        inPipe_1_3_robIdx_value = _RANDOM[7'h48][24:19];
        inPipe_1_3_pdest = {_RANDOM[7'h48][31:30], _RANDOM[7'h49][5:0]};
        inPipe_1_3_fpWen = _RANDOM[7'h49][7];
        inPipe_1_3_fpu_wflags = _RANDOM[7'h49][12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
  ...
  assign io_out_bits_data_1 = {64'h0, _GEN};
  ...
  assign io_out_bits_robIdx_value =
    (_Falu_io_out_valid ? _Falu_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Fcvt_io_out_valid ? _Fcvt_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_f2v_io_out_valid ? _f2v_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Fmac_io_out_valid ? _Fmac_io_out_bits_ctrl_robIdx_value : 6'h0);
  ...
  assign io_out_bits_fpWen =
    ...
    & _Fcvt_io_out_bits_ctrl_fpWen | _f2v_io_out_valid & _f2v_io_out_bits_ctrl_fpWen
    | _Fmac_io_out_valid & _Fmac_io_out_bits_ctrl_fpWen;
