...
module Queue2_TLBundleD_17(
  ...
  assign io_deq_bits_param = _ram_ext_R0_data[5:4];
  assign io_deq_bits_size = _ram_ext_R0_data[8:6];
  assign io_deq_bits_source = _ram_ext_R0_data[16:9];
  assign io_deq_bits_sink = _ram_ext_R0_data[19:17];
  assign io_deq_bits_denied = _ram_ext_R0_data[20];
  assign io_deq_bits_echo_blockisdirty = _ram_ext_R0_data[21];
  assign io_deq_bits_data = _ram_ext_R0_data[277:22];
  assign io_deq_bits_corrupt = _ram_ext_R0_data[278];
endmodule
