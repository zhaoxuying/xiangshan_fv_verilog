  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outIsVwsll = _RANDOM[6'h2F][7];
        outIsVwsllEewVdIs64 = _RANDOM[6'h2F][8];
        outIsVwsllEewVdIs32 = _RANDOM[6'h2F][9];
        outIsVwsllEewVdIs16 = _RANDOM[6'h2F][10];
        outEewVs1_oneHot = _RANDOM[6'h2F][14:11];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validVecThisFu_1 = 1'h0;
    end // initial
