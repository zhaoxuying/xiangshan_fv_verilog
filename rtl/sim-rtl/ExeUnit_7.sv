...
module ExeUnit_7(
  ...
  wire [5:0]  _csr_io_csrio_robDeqPtr_delay_io_out_value;
  ...
  wire [5:0]  _in1ToN_io_out_0_bits_pdest;
  ...
  wire [5:0]  _in1ToN_io_out_1_bits_pdest;
  ...
  wire [5:0]  _in1ToN_io_out_2_bits_pdest;
  ...
  wire [5:0]  _Fence_io_out_bits_ctrl_robIdx_value;
  ...
  wire [5:0]  _csr_io_out_bits_ctrl_robIdx_value;
  ...
  wire [6:0]  _inPipe_flushVec_flushItself_T_2 =
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        robIdx_value = _RANDOM[/*Zero width*/ 1'b0][13:8];
        io_error_0_REG = _RANDOM[/*Zero width*/ 1'b0][14];
        io_error_0_REG_1 = _RANDOM[/*Zero width*/ 1'b0][15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        uncer_en_reg_2 = 1'h0;
        busy = 1'h0;
  ...
  CSR csr (
    ...
    .io_in_bits_ctrl_pdest
      ({2'h0, _in1ToN_io_out_0_bits_pdest}),
  ...
  Fence Fence (
    ...
    .io_in_bits_ctrl_pdest            ({2'h0, _in1ToN_io_out_1_bits_pdest}),
  ...
  DivUnit Div (
    ...
    .io_in_bits_ctrl_pdest         ({2'h0, _in1ToN_io_out_2_bits_pdest}),
  ...
  DelayN_214 csr_io_csrio_exception_delay (
    .clock                         (clock),
  ...
  DelayN_215 csr_io_csrio_robDeqPtr_delay (
    .clock        (clock),
  ...
  assign io_out_bits_pdest =
    (_csr_io_out_valid ? _csr_io_out_bits_ctrl_pdest[5:0] : 6'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_ctrl_pdest[5:0] : 6'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_ctrl_pdest[5:0] : 6'h0);
  ...
  assign io_out_bits_robIdx_value =
    (_csr_io_out_valid ? _csr_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_ctrl_robIdx_value : 6'h0);
