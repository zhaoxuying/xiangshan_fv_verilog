...
module SRAMTemplate_44(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        rdata_last_REG = _RANDOM[3'h4][31];
        rdata_hold_data_0 = _RANDOM[3'h5][0];
        rdata_hold_data_1 = _RANDOM[3'h5][1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 8'h0;
  ...
  sram_array_1p256x2m1s1h0l1_bp_tage_us array (
    ...
    .RW0_wdata (_resetState ? 2'h0 : {io_w_req_bits_data_1, io_w_req_bits_data_0}),
