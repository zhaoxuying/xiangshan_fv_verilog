...
module PipelineConnectPipe(
  ...
  always @(posedge clock) begin
    if (leftFire) begin
      ...
      data_isXSTrap <= io_in_bits_isXSTrap;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_ftqPtr_value = _RANDOM[5'h4][5:3];
        data_ftqOffset = _RANDOM[5'h4][9:6];
        data_srcType_0 = _RANDOM[5'h4][13:10];
        data_srcType_1 = _RANDOM[5'h4][17:14];
        data_srcType_2 = _RANDOM[5'h4][21:18];
        data_srcType_3 = _RANDOM[5'h4][25:22];
        data_srcType_4 = _RANDOM[5'h4][29:26];
        data_lsrc_0 = {_RANDOM[5'h4][31:30], _RANDOM[5'h5][3:0]};
        data_lsrc_1 = _RANDOM[5'h5][9:4];
        data_lsrc_2 = _RANDOM[5'h5][15:10];
        data_lsrc_3 = _RANDOM[5'h5][21:16];
        data_lsrc_4 = _RANDOM[5'h5][27:22];
        data_ldest = {_RANDOM[5'h5][31:28], _RANDOM[5'h6][1:0]};
        data_fuType = {_RANDOM[5'h6][31:2], _RANDOM[5'h7][4:0]};
        data_fuOpType = _RANDOM[5'h7][13:5];
        data_rfWen = _RANDOM[5'h7][14];
        data_fpWen = _RANDOM[5'h7][15];
        data_vecWen = _RANDOM[5'h7][16];
        data_v0Wen = _RANDOM[5'h7][17];
        data_vlWen = _RANDOM[5'h7][18];
        data_isXSTrap = _RANDOM[5'h7][19];
        data_waitForward = _RANDOM[5'h7][20];
        data_blockBackward = _RANDOM[5'h7][21];
        data_flushPipe = _RANDOM[5'h7][22];
        data_selImm = _RANDOM[5'h7][27:24];
        data_imm = {_RANDOM[5'h7][31:28], _RANDOM[5'h8][17:0]};
        data_fpu_typeTagOut = _RANDOM[5'h8][19:18];
        data_fpu_wflags = _RANDOM[5'h8][20];
        data_fpu_typ = _RANDOM[5'h8][22:21];
        data_fpu_fmt = _RANDOM[5'h8][24:23];
        data_fpu_rm = _RANDOM[5'h8][27:25];
        data_vpu_vill = _RANDOM[5'h8][28];
        data_vpu_vma = _RANDOM[5'h8][29];
        data_vpu_vta = _RANDOM[5'h8][30];
        data_vpu_vsew = {_RANDOM[5'h8][31], _RANDOM[5'h9][0]};
        data_vpu_vlmul = _RANDOM[5'h9][3:1];
        data_vpu_specVill = _RANDOM[5'h9][4];
        data_vpu_specVma = _RANDOM[5'h9][5];
        data_vpu_specVta = _RANDOM[5'h9][6];
        data_vpu_specVsew = _RANDOM[5'h9][8:7];
        data_vpu_specVlmul = _RANDOM[5'h9][11:9];
        data_vpu_vm = _RANDOM[5'h9][12];
        data_vpu_vstart = _RANDOM[5'h9][20:13];
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[5'h9][28];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[5'h9][29];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[5'h9][30];
        data_vpu_vmask =
          {_RANDOM[5'hA][31:9],
           _RANDOM[5'hB],
           _RANDOM[5'hC],
           _RANDOM[5'hD],
           _RANDOM[5'hE][8:0]};
        data_vpu_nf = _RANDOM[5'hE][19:17];
        data_vpu_veew = _RANDOM[5'hE][21:20];
        data_vpu_isExt = _RANDOM[5'hE][23];
        data_vpu_isNarrow = _RANDOM[5'hE][24];
        data_vpu_isDstMask = _RANDOM[5'hE][25];
        data_vpu_isOpMask = _RANDOM[5'hE][26];
        data_vpu_isDependOldVd = _RANDOM[5'hE][28];
        data_vpu_isWritePartVd = _RANDOM[5'hE][29];
        data_vpu_isVleff = _RANDOM[5'hE][30];
        data_vlsInstr = _RANDOM[5'hE][31];
        data_wfflags = _RANDOM[5'hF][0];
        data_isMove = _RANDOM[5'hF][1];
        data_uopIdx = _RANDOM[5'hF][8:2];
        data_uopSplitType = _RANDOM[5'hF][14:9];
        data_isVset = _RANDOM[5'hF][15];
        data_firstUop = _RANDOM[5'hF][16];
        data_lastUop = _RANDOM[5'hF][17];
        data_numWB = _RANDOM[5'hF][31:25];
        data_commitType = _RANDOM[5'h10][2:0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
  ...
  assign io_out_bits_isXSTrap = data_isXSTrap;
