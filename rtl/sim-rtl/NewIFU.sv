...
module NewIFU(
  ...
  reg  [2:0]        f1_ftq_req_ftqIdx_value;
  ...
  reg  [2:0]        f2_ftq_req_ftqIdx_value;
  ...
  reg  [2:0]        f3_ftq_req_ftqIdx_value;
  ...
  reg  [2:0]        fromFtqRedirectReg_bits_r_ftqIdx_value;
  ...
  wire              mmioFlushWb_bits_pd_0_isRVC =
    f3_req_is_mmio ? mmio_is_RVC : f3_pd_wire_0_isRVC;
  ...
  reg  [2:0]        wb_ftq_req_ftqIdx_value;
  ...
  wire [1:0]        _GEN_11 = {1'h0, ~_predChecker_io_out_stage2Out_fixedMissPred_0};
  ...
  wire              _GEN_14 = io_iTLBInter_resp_ready_0 & io_iTLBInter_resp_valid;
  wire              _GEN_15 = mmio_state == 4'h9;
  wire              _GEN_16 = mmio_state != 4'hA;
  wire              _GEN_17 = _GEN_7 | _GEN_8 | _GEN_9 | _GEN_15;
  wire              _GEN_18 = _GEN_5 | _GEN_6 | _GEN_17 | _GEN_16;
  wire              _GEN_19 = _GEN_17 | _GEN_16;
  wire              _GEN_20 = _GEN_0 | _GEN_1 | _GEN_2 | _GEN_3 | _GEN_5;
  wire              f3_hasLastHalf =
  ...
  wire [15:0][3:0]  _GEN_21 =
    {{mmio_state},
     ...
     {(|exception_2) ? 4'h9 : 4'h7},
     {_GEN_14 ? ((|exception_1) ? 4'h9 : 4'h6) : mmio_state},
     {{3'h2, io_iTLBInter_req_ready & io_iTLBInter_req_valid_0}},
     {io_uncacheInter_fromUncache_valid ? (needResend ? 4'h4 : 4'h9) : mmio_state},
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      fromFtqRedirectReg_bits_r_ftqIdx_value <= 3'h0;
        ...
        if (~_GEN_4) begin
          if (_GEN_3) begin
            if (io_uncacheInter_fromUncache_valid)
              mmio_exception <= {2{io_uncacheInter_fromUncache_bits_corrupt}};
          end
          else if (~_GEN_5) begin
            if (_GEN_6) begin
              if (_GEN_14)
                mmio_exception <= exception_1;
            end
            else if (_GEN_7)
              mmio_exception <= exception_2;
            else if (~_GEN_8) begin
              if (_GEN_9) begin
                if (io_uncacheInter_fromUncache_valid)
                  mmio_exception <= {2{io_uncacheInter_fromUncache_bits_corrupt}};
              end
              else if (_GEN_15 | _GEN_16) begin
              end
              else
                mmio_exception <= 2'h0;
            end
      ...
      mmio_has_resend <=
        ...
        & (_GEN_4
             ? mmio_has_resend
             : _GEN_3
                 ? (io_uncacheInter_fromUncache_valid ? needResend : mmio_has_resend)
                 : _GEN_18 & mmio_has_resend);
        ...
        & (_GEN_20
             ...
             : _GEN_6
                 ? (_GEN_14
                      ...
                      : mmio_resend_isForVSnonLeafPTE)
                 : _GEN_19 & mmio_resend_isForVSnonLeafPTE);
  ...
  wire [11:0]       _GEN_22 = {1'h0, f1_ftq_req_startAddr[10:0]};
  wire [6:0]        _GEN_23 = {2'h0, f1_ftq_req_startAddr[5:1]};
  ...
  wire [3:0]        _io_mmioCommitRead_mmioFtqPtr_flipped_new_ptr_new_ptr_T_1 =
    4'({f3_ftq_req_ftqIdx_flag, f3_ftq_req_ftqIdx_value} + 4'h7);
  ...
  always @(posedge clock) begin
    ...
    if (f1_fire) begin
      ...
      f2_pc_lower_result_1 <= 12'(_GEN_22 + 12'h2);
      f2_pc_lower_result_2 <= 12'(_GEN_22 + 12'h4);
      f2_pc_lower_result_3 <= 12'(_GEN_22 + 12'h6);
      f2_pc_lower_result_4 <= 12'(_GEN_22 + 12'h8);
      f2_pc_lower_result_5 <= 12'(_GEN_22 + 12'hA);
      f2_pc_lower_result_6 <= 12'(_GEN_22 + 12'hC);
      f2_pc_lower_result_7 <= 12'(_GEN_22 + 12'hE);
      f2_pc_lower_result_8 <= 12'(_GEN_22 + 12'h10);
      f2_pc_lower_result_9 <= 12'(_GEN_22 + 12'h12);
      f2_pc_lower_result_10 <= 12'(_GEN_22 + 12'h14);
      f2_pc_lower_result_11 <= 12'(_GEN_22 + 12'h16);
      f2_pc_lower_result_12 <= 12'(_GEN_22 + 12'h18);
      f2_pc_lower_result_13 <= 12'(_GEN_22 + 12'h1A);
      f2_pc_lower_result_14 <= 12'(_GEN_22 + 12'h1C);
      f2_pc_lower_result_15 <= 12'(_GEN_22 + 12'h1E);
      ...
      f2_cut_ptr_1 <= 7'(_GEN_23 + 7'h1);
      f2_cut_ptr_2 <= 7'(_GEN_23 + 7'h2);
      f2_cut_ptr_3 <= 7'(_GEN_23 + 7'h3);
      f2_cut_ptr_4 <= 7'(_GEN_23 + 7'h4);
      f2_cut_ptr_5 <= 7'(_GEN_23 + 7'h5);
      f2_cut_ptr_6 <= 7'(_GEN_23 + 7'h6);
      f2_cut_ptr_7 <= 7'(_GEN_23 + 7'h7);
      f2_cut_ptr_8 <= 7'(_GEN_23 + 7'h8);
      f2_cut_ptr_9 <= 7'(_GEN_23 + 7'h9);
      f2_cut_ptr_10 <= 7'(_GEN_23 + 7'hA);
      f2_cut_ptr_11 <= 7'(_GEN_23 + 7'hB);
      f2_cut_ptr_12 <= 7'(_GEN_23 + 7'hC);
      f2_cut_ptr_13 <= 7'(_GEN_23 + 7'hD);
      f2_cut_ptr_14 <= 7'(_GEN_23 + 7'hE);
      f2_cut_ptr_15 <= 7'(_GEN_23 + 7'hF);
      f2_cut_ptr_16 <= 7'(_GEN_23 + 7'h10);
    ...
    io_mmioCommitRead_mmioFtqPtr_REG_flag <=
      ~(_io_mmioCommitRead_mmioFtqPtr_flipped_new_ptr_new_ptr_T_1[3]);
    io_mmioCommitRead_mmioFtqPtr_REG_value <=
      _io_mmioCommitRead_mmioFtqPtr_flipped_new_ptr_new_ptr_T_1[2:0];
    ...
    if (wb_enable) begin
      ...
      wb_false_lastHalf_r <=
        ~_GEN_27[f3_last_validIdx] & _GEN_26[f3_last_validIdx] & _GEN_25[f3_last_validIdx]
        & ~_GEN_24[f3_last_validIdx] & ~f3_req_is_mmio;
      wb_false_target <= _GEN_28[f3_last_validIdx];
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        f1_valid = _RANDOM[8'h3][30];
        f1_ftq_req_startAddr = {_RANDOM[8'h3][31], _RANDOM[8'h4], _RANDOM[8'h5][16:0]};
        f1_ftq_req_nextlineStart =
          {_RANDOM[8'h5][31:17], _RANDOM[8'h6], _RANDOM[8'h7][2:0]};
        f1_ftq_req_nextStartAddr = {_RANDOM[8'h7][31:3], _RANDOM[8'h8][20:0]};
        f1_ftq_req_ftqIdx_flag = _RANDOM[8'h8][21];
        f1_ftq_req_ftqIdx_value = _RANDOM[8'h8][24:22];
        f1_ftq_req_ftqOffset_valid = _RANDOM[8'h8][25];
        f1_ftq_req_ftqOffset_bits = _RANDOM[8'h8][29:26];
        f1_doubleLine = _RANDOM[8'hA][8];
        f2_valid = _RANDOM[8'hA][13];
        f2_ftq_req_startAddr = {_RANDOM[8'hA][31:14], _RANDOM[8'hB]};
        f2_ftq_req_nextlineStart = {_RANDOM[8'hC], _RANDOM[8'hD][17:0]};
        f2_ftq_req_nextStartAddr =
          {_RANDOM[8'hD][31:18], _RANDOM[8'hE], _RANDOM[8'hF][3:0]};
        f2_ftq_req_ftqIdx_flag = _RANDOM[8'hF][4];
        f2_ftq_req_ftqIdx_value = _RANDOM[8'hF][7:5];
        f2_ftq_req_ftqOffset_valid = _RANDOM[8'hF][8];
        f2_ftq_req_ftqOffset_bits = _RANDOM[8'hF][12:9];
        f2_doubleLine = _RANDOM[8'h10][23];
        f2_icache_all_resp_reg = _RANDOM[8'h10][28];
        f2_pc_lower_result_0 = {_RANDOM[8'h10][31:29], _RANDOM[8'h11][8:0]};
        f2_pc_lower_result_1 = _RANDOM[8'h11][20:9];
        f2_pc_lower_result_2 = {_RANDOM[8'h11][31:21], _RANDOM[8'h12][0]};
        f2_pc_lower_result_3 = _RANDOM[8'h12][12:1];
        f2_pc_lower_result_4 = _RANDOM[8'h12][24:13];
        f2_pc_lower_result_5 = {_RANDOM[8'h12][31:25], _RANDOM[8'h13][4:0]};
        f2_pc_lower_result_6 = _RANDOM[8'h13][16:5];
        f2_pc_lower_result_7 = _RANDOM[8'h13][28:17];
        f2_pc_lower_result_8 = {_RANDOM[8'h13][31:29], _RANDOM[8'h14][8:0]};
        f2_pc_lower_result_9 = _RANDOM[8'h14][20:9];
        f2_pc_lower_result_10 = {_RANDOM[8'h14][31:21], _RANDOM[8'h15][0]};
        f2_pc_lower_result_11 = _RANDOM[8'h15][12:1];
        f2_pc_lower_result_12 = _RANDOM[8'h15][24:13];
        f2_pc_lower_result_13 = {_RANDOM[8'h15][31:25], _RANDOM[8'h16][4:0]};
        f2_pc_lower_result_14 = _RANDOM[8'h16][16:5];
        f2_pc_lower_result_15 = _RANDOM[8'h16][28:17];
        f2_pc_high = {_RANDOM[8'h16][31:29], _RANDOM[8'h17], _RANDOM[8'h18][3:0]};
        f2_pc_high_plus1 = {_RANDOM[8'h18][31:4], _RANDOM[8'h19][10:0]};
        f2_cut_ptr_0 = _RANDOM[8'h19][17:11];
        f2_cut_ptr_1 = _RANDOM[8'h19][24:18];
        f2_cut_ptr_2 = _RANDOM[8'h19][31:25];
        f2_cut_ptr_3 = _RANDOM[8'h1A][6:0];
        f2_cut_ptr_4 = _RANDOM[8'h1A][13:7];
        f2_cut_ptr_5 = _RANDOM[8'h1A][20:14];
        f2_cut_ptr_6 = _RANDOM[8'h1A][27:21];
        f2_cut_ptr_7 = {_RANDOM[8'h1A][31:28], _RANDOM[8'h1B][2:0]};
        f2_cut_ptr_8 = _RANDOM[8'h1B][9:3];
        f2_cut_ptr_9 = _RANDOM[8'h1B][16:10];
        f2_cut_ptr_10 = _RANDOM[8'h1B][23:17];
        f2_cut_ptr_11 = _RANDOM[8'h1B][30:24];
        f2_cut_ptr_12 = {_RANDOM[8'h1B][31], _RANDOM[8'h1C][5:0]};
        f2_cut_ptr_13 = _RANDOM[8'h1C][12:6];
        f2_cut_ptr_14 = _RANDOM[8'h1C][19:13];
        f2_cut_ptr_15 = _RANDOM[8'h1C][26:20];
        f2_cut_ptr_16 = {_RANDOM[8'h1C][31:27], _RANDOM[8'h1D][1:0]};
        f2_resend_vaddr = {_RANDOM[8'h1D][31:2], _RANDOM[8'h1E][19:0]};
        f3_valid = _RANDOM[8'h1E][20];
        f3_ftq_req_startAddr =
          {_RANDOM[8'h1E][31:21], _RANDOM[8'h1F], _RANDOM[8'h20][6:0]};
        f3_ftq_req_nextStartAddr =
          {_RANDOM[8'h21][31:25], _RANDOM[8'h22], _RANDOM[8'h23][10:0]};
        f3_ftq_req_ftqIdx_flag = _RANDOM[8'h23][11];
        f3_ftq_req_ftqIdx_value = _RANDOM[8'h23][14:12];
        f3_ftq_req_ftqOffset_valid = _RANDOM[8'h23][15];
        f3_ftq_req_ftqOffset_bits = _RANDOM[8'h23][19:16];
        f3_doubleLine = _RANDOM[8'h24][30];
        f3_exception_0 = _RANDOM[8'h2D][16:15];
        f3_exception_1 = _RANDOM[8'h2D][18:17];
        f3_pmp_mmio = _RANDOM[8'h2D][19];
        f3_itlb_pbmt = _RANDOM[8'h2D][21:20];
        f3_backendException = _RANDOM[8'h2D][22];
        f3_instr_0 = {_RANDOM[8'h2D][31:23], _RANDOM[8'h2E][22:0]};
        f3_instr_1 = {_RANDOM[8'h2E][31:23], _RANDOM[8'h2F][22:0]};
        f3_instr_2 = {_RANDOM[8'h2F][31:23], _RANDOM[8'h30][22:0]};
        f3_instr_3 = {_RANDOM[8'h30][31:23], _RANDOM[8'h31][22:0]};
        f3_instr_4 = {_RANDOM[8'h31][31:23], _RANDOM[8'h32][22:0]};
        f3_instr_5 = {_RANDOM[8'h32][31:23], _RANDOM[8'h33][22:0]};
        f3_instr_6 = {_RANDOM[8'h33][31:23], _RANDOM[8'h34][22:0]};
        f3_instr_7 = {_RANDOM[8'h34][31:23], _RANDOM[8'h35][22:0]};
        f3_instr_8 = {_RANDOM[8'h35][31:23], _RANDOM[8'h36][22:0]};
        f3_instr_9 = {_RANDOM[8'h36][31:23], _RANDOM[8'h37][22:0]};
        f3_instr_10 = {_RANDOM[8'h37][31:23], _RANDOM[8'h38][22:0]};
        f3_instr_11 = {_RANDOM[8'h38][31:23], _RANDOM[8'h39][22:0]};
        f3_instr_12 = {_RANDOM[8'h39][31:23], _RANDOM[8'h3A][22:0]};
        f3_instr_13 = {_RANDOM[8'h3A][31:23], _RANDOM[8'h3B][22:0]};
        f3_instr_14 = {_RANDOM[8'h3B][31:23], _RANDOM[8'h3C][22:0]};
        f3_instr_15 = {_RANDOM[8'h3C][31:23], _RANDOM[8'h3D][22:0]};
        f3_pd_wire_0_isRVC = _RANDOM[8'h3D][24];
        f3_pd_wire_1_valid = _RANDOM[8'h3D][29];
        f3_pd_wire_1_isRVC = _RANDOM[8'h3D][30];
        f3_pd_wire_2_valid = _RANDOM[8'h3E][3];
        f3_pd_wire_2_isRVC = _RANDOM[8'h3E][4];
        f3_pd_wire_3_valid = _RANDOM[8'h3E][9];
        f3_pd_wire_3_isRVC = _RANDOM[8'h3E][10];
        f3_pd_wire_4_valid = _RANDOM[8'h3E][15];
        f3_pd_wire_4_isRVC = _RANDOM[8'h3E][16];
        f3_pd_wire_5_valid = _RANDOM[8'h3E][21];
        f3_pd_wire_5_isRVC = _RANDOM[8'h3E][22];
        f3_pd_wire_6_valid = _RANDOM[8'h3E][27];
        f3_pd_wire_6_isRVC = _RANDOM[8'h3E][28];
        f3_pd_wire_7_valid = _RANDOM[8'h3F][1];
        f3_pd_wire_7_isRVC = _RANDOM[8'h3F][2];
        f3_pd_wire_8_valid = _RANDOM[8'h3F][7];
        f3_pd_wire_8_isRVC = _RANDOM[8'h3F][8];
        f3_pd_wire_9_valid = _RANDOM[8'h3F][13];
        f3_pd_wire_9_isRVC = _RANDOM[8'h3F][14];
        f3_pd_wire_10_valid = _RANDOM[8'h3F][19];
        f3_pd_wire_10_isRVC = _RANDOM[8'h3F][20];
        f3_pd_wire_11_valid = _RANDOM[8'h3F][25];
        f3_pd_wire_11_isRVC = _RANDOM[8'h3F][26];
        f3_pd_wire_12_valid = _RANDOM[8'h3F][31];
        f3_pd_wire_12_isRVC = _RANDOM[8'h40][0];
        f3_pd_wire_13_valid = _RANDOM[8'h40][5];
        f3_pd_wire_13_isRVC = _RANDOM[8'h40][6];
        f3_pd_wire_14_valid = _RANDOM[8'h40][11];
        f3_pd_wire_14_isRVC = _RANDOM[8'h40][12];
        f3_pd_wire_15_valid = _RANDOM[8'h40][17];
        f3_pd_wire_15_isRVC = _RANDOM[8'h40][18];
        f3_jump_offset_0 = {_RANDOM[8'h40][31:23], _RANDOM[8'h41], _RANDOM[8'h42][22:0]};
        f3_jump_offset_1 = {_RANDOM[8'h42][31:23], _RANDOM[8'h43], _RANDOM[8'h44][22:0]};
        f3_jump_offset_2 = {_RANDOM[8'h44][31:23], _RANDOM[8'h45], _RANDOM[8'h46][22:0]};
        f3_jump_offset_3 = {_RANDOM[8'h46][31:23], _RANDOM[8'h47], _RANDOM[8'h48][22:0]};
        f3_jump_offset_4 = {_RANDOM[8'h48][31:23], _RANDOM[8'h49], _RANDOM[8'h4A][22:0]};
        f3_jump_offset_5 = {_RANDOM[8'h4A][31:23], _RANDOM[8'h4B], _RANDOM[8'h4C][22:0]};
        f3_jump_offset_6 = {_RANDOM[8'h4C][31:23], _RANDOM[8'h4D], _RANDOM[8'h4E][22:0]};
        f3_jump_offset_7 = {_RANDOM[8'h4E][31:23], _RANDOM[8'h4F], _RANDOM[8'h50][22:0]};
        f3_jump_offset_8 = {_RANDOM[8'h50][31:23], _RANDOM[8'h51], _RANDOM[8'h52][22:0]};
        f3_jump_offset_9 = {_RANDOM[8'h52][31:23], _RANDOM[8'h53], _RANDOM[8'h54][22:0]};
        f3_jump_offset_10 = {_RANDOM[8'h54][31:23], _RANDOM[8'h55], _RANDOM[8'h56][22:0]};
        f3_jump_offset_11 = {_RANDOM[8'h56][31:23], _RANDOM[8'h57], _RANDOM[8'h58][22:0]};
        f3_jump_offset_12 = {_RANDOM[8'h58][31:23], _RANDOM[8'h59], _RANDOM[8'h5A][22:0]};
        f3_jump_offset_13 = {_RANDOM[8'h5A][31:23], _RANDOM[8'h5B], _RANDOM[8'h5C][22:0]};
        f3_jump_offset_14 = {_RANDOM[8'h5C][31:23], _RANDOM[8'h5D], _RANDOM[8'h5E][22:0]};
        f3_jump_offset_15 = {_RANDOM[8'h5E][31:23], _RANDOM[8'h5F], _RANDOM[8'h60][22:0]};
        f3_exception_vec_0 = _RANDOM[8'h60][24:23];
        f3_exception_vec_1 = _RANDOM[8'h60][26:25];
        f3_exception_vec_2 = _RANDOM[8'h60][28:27];
        f3_exception_vec_3 = _RANDOM[8'h60][30:29];
        f3_exception_vec_4 = {_RANDOM[8'h60][31], _RANDOM[8'h61][0]};
        f3_exception_vec_5 = _RANDOM[8'h61][2:1];
        f3_exception_vec_6 = _RANDOM[8'h61][4:3];
        f3_exception_vec_7 = _RANDOM[8'h61][6:5];
        f3_exception_vec_8 = _RANDOM[8'h61][8:7];
        f3_exception_vec_9 = _RANDOM[8'h61][10:9];
        f3_exception_vec_10 = _RANDOM[8'h61][12:11];
        f3_exception_vec_11 = _RANDOM[8'h61][14:13];
        f3_exception_vec_12 = _RANDOM[8'h61][16:15];
        f3_exception_vec_13 = _RANDOM[8'h61][18:17];
        f3_exception_vec_14 = _RANDOM[8'h61][20:19];
        f3_exception_vec_15 = _RANDOM[8'h61][22:21];
        f3_crossPage_exception_vec_0 = _RANDOM[8'h61][24:23];
        f3_crossPage_exception_vec_1 = _RANDOM[8'h61][26:25];
        f3_crossPage_exception_vec_2 = _RANDOM[8'h61][28:27];
        f3_crossPage_exception_vec_3 = _RANDOM[8'h61][30:29];
        f3_crossPage_exception_vec_4 = {_RANDOM[8'h61][31], _RANDOM[8'h62][0]};
        f3_crossPage_exception_vec_5 = _RANDOM[8'h62][2:1];
        f3_crossPage_exception_vec_6 = _RANDOM[8'h62][4:3];
        f3_crossPage_exception_vec_7 = _RANDOM[8'h62][6:5];
        f3_crossPage_exception_vec_8 = _RANDOM[8'h62][8:7];
        f3_crossPage_exception_vec_9 = _RANDOM[8'h62][10:9];
        f3_crossPage_exception_vec_10 = _RANDOM[8'h62][12:11];
        f3_crossPage_exception_vec_11 = _RANDOM[8'h62][14:13];
        f3_crossPage_exception_vec_12 = _RANDOM[8'h62][16:15];
        f3_crossPage_exception_vec_13 = _RANDOM[8'h62][18:17];
        f3_crossPage_exception_vec_14 = _RANDOM[8'h62][20:19];
        f3_crossPage_exception_vec_15 = _RANDOM[8'h62][22:21];
        f3_pc_lower_result_0 = {_RANDOM[8'h62][31:23], _RANDOM[8'h63][2:0]};
        f3_pc_lower_result_1 = _RANDOM[8'h63][14:3];
        f3_pc_lower_result_2 = _RANDOM[8'h63][26:15];
        f3_pc_lower_result_3 = {_RANDOM[8'h63][31:27], _RANDOM[8'h64][6:0]};
        f3_pc_lower_result_4 = _RANDOM[8'h64][18:7];
        f3_pc_lower_result_5 = _RANDOM[8'h64][30:19];
        f3_pc_lower_result_6 = {_RANDOM[8'h64][31], _RANDOM[8'h65][10:0]};
        f3_pc_lower_result_7 = _RANDOM[8'h65][22:11];
        f3_pc_lower_result_8 = {_RANDOM[8'h65][31:23], _RANDOM[8'h66][2:0]};
        f3_pc_lower_result_9 = _RANDOM[8'h66][14:3];
        f3_pc_lower_result_10 = _RANDOM[8'h66][26:15];
        f3_pc_lower_result_11 = {_RANDOM[8'h66][31:27], _RANDOM[8'h67][6:0]};
        f3_pc_lower_result_12 = _RANDOM[8'h67][18:7];
        f3_pc_lower_result_13 = _RANDOM[8'h67][30:19];
        f3_pc_lower_result_14 = {_RANDOM[8'h67][31], _RANDOM[8'h68][10:0]};
        f3_pc_lower_result_15 = _RANDOM[8'h68][22:11];
        f3_pc_high = {_RANDOM[8'h68][31:23], _RANDOM[8'h69][29:0]};
        f3_pc_high_plus1 = {_RANDOM[8'h69][31:30], _RANDOM[8'h6A], _RANDOM[8'h6B][4:0]};
        f3_pc_last_lower_result_plus2 = _RANDOM[8'h6B][16:5];
        f3_pc_last_lower_result_plus4 = _RANDOM[8'h6B][28:17];
        f3_instr_range = {_RANDOM[8'h6B][31:29], _RANDOM[8'h6C][12:0]};
        f3_hasHalfValid_2 = _RANDOM[8'h71][15];
        f3_hasHalfValid_3 = _RANDOM[8'h71][16];
        f3_hasHalfValid_4 = _RANDOM[8'h71][17];
        f3_hasHalfValid_5 = _RANDOM[8'h71][18];
        f3_hasHalfValid_6 = _RANDOM[8'h71][19];
        f3_hasHalfValid_7 = _RANDOM[8'h71][20];
        f3_hasHalfValid_8 = _RANDOM[8'h71][21];
        f3_hasHalfValid_9 = _RANDOM[8'h71][22];
        f3_hasHalfValid_10 = _RANDOM[8'h71][23];
        f3_hasHalfValid_11 = _RANDOM[8'h71][24];
        f3_hasHalfValid_12 = _RANDOM[8'h71][25];
        f3_hasHalfValid_13 = _RANDOM[8'h71][26];
        f3_hasHalfValid_14 = _RANDOM[8'h71][27];
        f3_hasHalfValid_15 = _RANDOM[8'h71][28];
        f3_paddrs_0 = {_RANDOM[8'h71][31:29], _RANDOM[8'h72], _RANDOM[8'h73][12:0]};
        f3_gpaddr = {_RANDOM[8'h74][31:29], _RANDOM[8'h75], _RANDOM[8'h76][20:0]};
        f3_isForVSnonLeafPTE = _RANDOM[8'h76][21];
        f3_resend_vaddr = {_RANDOM[8'h76][31:22], _RANDOM[8'h77], _RANDOM[8'h78][7:0]};
        f3_mmio_data_0 = _RANDOM[8'h78][23:8];
        f3_mmio_data_1 = {_RANDOM[8'h78][31:24], _RANDOM[8'h79][7:0]};
        mmio_exception = _RANDOM[8'h79][9:8];
        mmio_is_RVC = _RANDOM[8'h79][10];
        mmio_has_resend = _RANDOM[8'h79][11];
        mmio_resend_addr = {_RANDOM[8'h79][31:12], _RANDOM[8'h7A][27:0]};
        mmio_resend_gpaddr =
          {_RANDOM[8'h7A][31:28], _RANDOM[8'h7B], _RANDOM[8'h7C][19:0]};
        mmio_resend_isForVSnonLeafPTE = _RANDOM[8'h7C][20];
        is_first_instr = _RANDOM[8'h7C][21];
        io_mmioCommitRead_mmioFtqPtr_REG_flag = _RANDOM[8'h7C][22];
        io_mmioCommitRead_mmioFtqPtr_REG_value = _RANDOM[8'h7C][25:23];
        mmio_state = _RANDOM[8'h7C][29:26];
        f3_mmio_to_commit_next = _RANDOM[8'h7C][30];
        fromFtqRedirectReg_bits_r_ftqIdx_flag = _RANDOM[8'h7D][7];
        fromFtqRedirectReg_bits_r_ftqIdx_value = _RANDOM[8'h7D][10:8];
        fromFtqRedirectReg_bits_r_ftqOffset = _RANDOM[8'h7D][14:11];
        fromFtqRedirectReg_bits_r_level = _RANDOM[8'h7D][15];
        fromFtqRedirectReg_valid_REG = _RANDOM[8'h8B][28];
        mmioF3Flush = _RANDOM[8'h8B][29];
        f3_mmio_use_seq_pc = _RANDOM[8'h8B][30];
        REG = _RANDOM[8'h8B][31];
        f3_lastHalf_valid = _RANDOM[8'h8C][0];
        predChecker_io_in_fire_in_REG = _RANDOM[8'h8D][19];
        f3_lastHalf_disable = _RANDOM[8'h8D][20];
        mmioFlushWb_valid_REG = _RANDOM[8'h8D][22];
        mmio_redirect_REG = _RANDOM[8'h8D][23];
        wb_enable_REG = _RANDOM[8'h8D][24];
        wb_valid = _RANDOM[8'h8D][25];
        wb_ftq_req_ftqIdx_flag = _RANDOM[8'h92][16];
        wb_ftq_req_ftqIdx_value = _RANDOM[8'h92][19:17];
        wb_check_result_stage1_fixedTaken_0 = _RANDOM[8'h94][19];
        wb_check_result_stage1_fixedTaken_1 = _RANDOM[8'h94][20];
        wb_check_result_stage1_fixedTaken_2 = _RANDOM[8'h94][21];
        wb_check_result_stage1_fixedTaken_3 = _RANDOM[8'h94][22];
        wb_check_result_stage1_fixedTaken_4 = _RANDOM[8'h94][23];
        wb_check_result_stage1_fixedTaken_5 = _RANDOM[8'h94][24];
        wb_check_result_stage1_fixedTaken_6 = _RANDOM[8'h94][25];
        wb_check_result_stage1_fixedTaken_7 = _RANDOM[8'h94][26];
        wb_check_result_stage1_fixedTaken_8 = _RANDOM[8'h94][27];
        wb_check_result_stage1_fixedTaken_9 = _RANDOM[8'h94][28];
        wb_check_result_stage1_fixedTaken_10 = _RANDOM[8'h94][29];
        wb_check_result_stage1_fixedTaken_11 = _RANDOM[8'h94][30];
        wb_check_result_stage1_fixedTaken_12 = _RANDOM[8'h94][31];
        wb_check_result_stage1_fixedTaken_13 = _RANDOM[8'h95][0];
        wb_check_result_stage1_fixedTaken_14 = _RANDOM[8'h95][1];
        wb_check_result_stage1_fixedTaken_15 = _RANDOM[8'h95][2];
        wb_instr_range = _RANDOM[8'h95][18:3];
        wb_pc_lower_result_0 = _RANDOM[8'h95][30:19];
        wb_pc_lower_result_1 = {_RANDOM[8'h95][31], _RANDOM[8'h96][10:0]};
        wb_pc_lower_result_2 = _RANDOM[8'h96][22:11];
        wb_pc_lower_result_3 = {_RANDOM[8'h96][31:23], _RANDOM[8'h97][2:0]};
        wb_pc_lower_result_4 = _RANDOM[8'h97][14:3];
        wb_pc_lower_result_5 = _RANDOM[8'h97][26:15];
        wb_pc_lower_result_6 = {_RANDOM[8'h97][31:27], _RANDOM[8'h98][6:0]};
        wb_pc_lower_result_7 = _RANDOM[8'h98][18:7];
        wb_pc_lower_result_8 = _RANDOM[8'h98][30:19];
        wb_pc_lower_result_9 = {_RANDOM[8'h98][31], _RANDOM[8'h99][10:0]};
        wb_pc_lower_result_10 = _RANDOM[8'h99][22:11];
        wb_pc_lower_result_11 = {_RANDOM[8'h99][31:23], _RANDOM[8'h9A][2:0]};
        wb_pc_lower_result_12 = _RANDOM[8'h9A][14:3];
        wb_pc_lower_result_13 = _RANDOM[8'h9A][26:15];
        wb_pc_lower_result_14 = {_RANDOM[8'h9A][31:27], _RANDOM[8'h9B][6:0]};
        wb_pc_lower_result_15 = _RANDOM[8'h9B][18:7];
        wb_pc_high = {_RANDOM[8'h9B][31:19], _RANDOM[8'h9C][25:0]};
        wb_pc_high_plus1 = {_RANDOM[8'h9C][31:26], _RANDOM[8'h9D], _RANDOM[8'h9E][0]};
        wb_pd_0_isRVC = _RANDOM[8'h9E][2];
        wb_pd_0_brType = _RANDOM[8'h9E][4:3];
        wb_pd_0_isCall = _RANDOM[8'h9E][5];
        wb_pd_0_isRet = _RANDOM[8'h9E][6];
        wb_pd_1_isRVC = _RANDOM[8'h9E][8];
        wb_pd_1_brType = _RANDOM[8'h9E][10:9];
        wb_pd_1_isCall = _RANDOM[8'h9E][11];
        wb_pd_1_isRet = _RANDOM[8'h9E][12];
        wb_pd_2_isRVC = _RANDOM[8'h9E][14];
        wb_pd_2_brType = _RANDOM[8'h9E][16:15];
        wb_pd_2_isCall = _RANDOM[8'h9E][17];
        wb_pd_2_isRet = _RANDOM[8'h9E][18];
        wb_pd_3_isRVC = _RANDOM[8'h9E][20];
        wb_pd_3_brType = _RANDOM[8'h9E][22:21];
        wb_pd_3_isCall = _RANDOM[8'h9E][23];
        wb_pd_3_isRet = _RANDOM[8'h9E][24];
        wb_pd_4_isRVC = _RANDOM[8'h9E][26];
        wb_pd_4_brType = _RANDOM[8'h9E][28:27];
        wb_pd_4_isCall = _RANDOM[8'h9E][29];
        wb_pd_4_isRet = _RANDOM[8'h9E][30];
        wb_pd_5_isRVC = _RANDOM[8'h9F][0];
        wb_pd_5_brType = _RANDOM[8'h9F][2:1];
        wb_pd_5_isCall = _RANDOM[8'h9F][3];
        wb_pd_5_isRet = _RANDOM[8'h9F][4];
        wb_pd_6_isRVC = _RANDOM[8'h9F][6];
        wb_pd_6_brType = _RANDOM[8'h9F][8:7];
        wb_pd_6_isCall = _RANDOM[8'h9F][9];
        wb_pd_6_isRet = _RANDOM[8'h9F][10];
        wb_pd_7_isRVC = _RANDOM[8'h9F][12];
        wb_pd_7_brType = _RANDOM[8'h9F][14:13];
        wb_pd_7_isCall = _RANDOM[8'h9F][15];
        wb_pd_7_isRet = _RANDOM[8'h9F][16];
        wb_pd_8_isRVC = _RANDOM[8'h9F][18];
        wb_pd_8_brType = _RANDOM[8'h9F][20:19];
        wb_pd_8_isCall = _RANDOM[8'h9F][21];
        wb_pd_8_isRet = _RANDOM[8'h9F][22];
        wb_pd_9_isRVC = _RANDOM[8'h9F][24];
        wb_pd_9_brType = _RANDOM[8'h9F][26:25];
        wb_pd_9_isCall = _RANDOM[8'h9F][27];
        wb_pd_9_isRet = _RANDOM[8'h9F][28];
        wb_pd_10_isRVC = _RANDOM[8'h9F][30];
        wb_pd_10_brType = {_RANDOM[8'h9F][31], _RANDOM[8'hA0][0]};
        wb_pd_10_isCall = _RANDOM[8'hA0][1];
        wb_pd_10_isRet = _RANDOM[8'hA0][2];
        wb_pd_11_isRVC = _RANDOM[8'hA0][4];
        wb_pd_11_brType = _RANDOM[8'hA0][6:5];
        wb_pd_11_isCall = _RANDOM[8'hA0][7];
        wb_pd_11_isRet = _RANDOM[8'hA0][8];
        wb_pd_12_isRVC = _RANDOM[8'hA0][10];
        wb_pd_12_brType = _RANDOM[8'hA0][12:11];
        wb_pd_12_isCall = _RANDOM[8'hA0][13];
        wb_pd_12_isRet = _RANDOM[8'hA0][14];
        wb_pd_13_isRVC = _RANDOM[8'hA0][16];
        wb_pd_13_brType = _RANDOM[8'hA0][18:17];
        wb_pd_13_isCall = _RANDOM[8'hA0][19];
        wb_pd_13_isRet = _RANDOM[8'hA0][20];
        wb_pd_14_isRVC = _RANDOM[8'hA0][22];
        wb_pd_14_brType = _RANDOM[8'hA0][24:23];
        wb_pd_14_isCall = _RANDOM[8'hA0][25];
        wb_pd_14_isRet = _RANDOM[8'hA0][26];
        wb_pd_15_isRVC = _RANDOM[8'hA0][28];
        wb_pd_15_brType = _RANDOM[8'hA0][30:29];
        wb_pd_15_isCall = _RANDOM[8'hA0][31];
        wb_pd_15_isRet = _RANDOM[8'hA1][0];
        wb_instr_valid_0 = _RANDOM[8'hA1][1];
        wb_instr_valid_1 = _RANDOM[8'hA1][2];
        wb_instr_valid_2 = _RANDOM[8'hA1][3];
        wb_instr_valid_3 = _RANDOM[8'hA1][4];
        wb_instr_valid_4 = _RANDOM[8'hA1][5];
        wb_instr_valid_5 = _RANDOM[8'hA1][6];
        wb_instr_valid_6 = _RANDOM[8'hA1][7];
        wb_instr_valid_7 = _RANDOM[8'hA1][8];
        wb_instr_valid_8 = _RANDOM[8'hA1][9];
        wb_instr_valid_9 = _RANDOM[8'hA1][10];
        wb_instr_valid_10 = _RANDOM[8'hA1][11];
        wb_instr_valid_11 = _RANDOM[8'hA1][12];
        wb_instr_valid_12 = _RANDOM[8'hA1][13];
        wb_instr_valid_13 = _RANDOM[8'hA1][14];
        wb_instr_valid_14 = _RANDOM[8'hA1][15];
        wb_instr_valid_15 = _RANDOM[8'hA1][16];
        wb_lastIdx = _RANDOM[8'hA1][20:17];
        wb_false_lastHalf_r = _RANDOM[8'hA1][21];
        wb_false_target = {_RANDOM[8'hA1][31:22], _RANDOM[8'hA2], _RANDOM[8'hA3][7:0]};
        REG_1 = _RANDOM[8'hA3][8];
        REG_2 = _RANDOM[8'hA3][9];
        REG_3 = _RANDOM[8'hA3][10];
        f3_perf_info_only_0_hit = _RANDOM[8'hA3][11];
        f3_perf_info_only_0_miss = _RANDOM[8'hA3][12];
        f3_perf_info_hit_0_hit_1 = _RANDOM[8'hA3][13];
        f3_perf_info_hit_0_miss_1 = _RANDOM[8'hA3][14];
        f3_perf_info_miss_0_hit_1 = _RANDOM[8'hA3][15];
        f3_perf_info_miss_0_miss_1 = _RANDOM[8'hA3][16];
        f3_perf_info_bank_hit_1 = _RANDOM[8'hA3][21];
        f3_perf_info_hit = _RANDOM[8'hA3][22];
        io_perf_0_value_REG = _RANDOM[8'hA3][23];
        io_perf_0_value_REG_1 = _RANDOM[8'hA3][24];
        io_perf_1_value_REG = _RANDOM[8'hA3][25];
        io_perf_1_value_REG_1 = _RANDOM[8'hA3][26];
        io_perf_2_value_REG = _RANDOM[8'hA3][27];
        io_perf_2_value_REG_1 = _RANDOM[8'hA3][28];
        io_perf_3_value_REG = _RANDOM[8'hA3][29];
        io_perf_3_value_REG_1 = _RANDOM[8'hA3][30];
        io_perf_4_value_REG = _RANDOM[8'hA3][31];
        io_perf_4_value_REG_1 = _RANDOM[8'hA4][0];
        io_perf_5_value_REG = _RANDOM[8'hA4][1];
        io_perf_5_value_REG_1 = _RANDOM[8'hA4][2];
        io_perf_6_value_REG = _RANDOM[8'hA4][3];
        io_perf_6_value_REG_1 = _RANDOM[8'hA4][4];
        io_perf_7_value_REG = _RANDOM[8'hA4][5];
        io_perf_7_value_REG_1 = _RANDOM[8'hA4][6];
        io_perf_8_value_REG = _RANDOM[8'hA4][7];
        io_perf_8_value_REG_1 = _RANDOM[8'hA4][8];
        io_perf_9_value_REG = _RANDOM[8'hA4][9];
        io_perf_9_value_REG_1 = _RANDOM[8'hA4][10];
        io_perf_10_value_REG = _RANDOM[8'hA4][11];
        io_perf_10_value_REG_1 = _RANDOM[8'hA4][12];
        io_perf_11_value_REG = _RANDOM[8'hA4][13];
        io_perf_11_value_REG_1 = _RANDOM[8'hA4][14];
        io_perf_12_value_REG = _RANDOM[8'hA4][15];
        io_perf_12_value_REG_1 = _RANDOM[8'hA4][16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        f1_valid = 1'h0;
        f2_valid = 1'h0;
  ...
  assign io_ftqInter_toFtq_pdWb_bits_target =
    wb_valid
      ? (wb_false_lastHalf
           ? wb_false_target
           : _GEN_12[_checkFlushWbTargetIdx_T_4 | _checkFlushWb_bits_misOffset_bits_T_6
                     | _checkFlushWb_bits_misOffset_bits_T_8
                       ? {1'h0,
  ...
  assign io_ftqInter_toFtq_pdWb_bits_jalTarget =
    wb_valid
      ? _GEN_13[_checkFlushWbjalTargetIdx_T_36 | _checkFlushWbjalTargetIdx_T_38
  ...
  assign io_toIbuffer_bits_crossPageIPFFix_0 =
    f3_req_is_mmio
      ? mmio_has_resend & (|mmio_exception)
      : (|f3_crossPage_exception_vec_0);
