...
module CustomL1Hint(
  ...
  wire [5:0] _hint_s1Queue_io_deq_bits_source;
  ...
  wire [5:0] _hintQueue_io_deq_bits_source;
  ...
  assign io_l1Hint_bits_sourceId = {26'h0, _hintQueue_io_deq_bits_source};
endmodule
