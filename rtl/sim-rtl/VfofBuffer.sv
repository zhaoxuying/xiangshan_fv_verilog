...
module VfofBuffer(
  ...
  input  [5:0]   io_mergeUopWriteback_0_bits_uop_robIdx_value,
  ...
  input  [5:0]   io_mergeUopWriteback_1_bits_uop_robIdx_value,
  ...
  wire [5:0] enqBits_uop_robIdx_value =
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entries_uop_fuOpType = _RANDOM[6'h6][15:7];
        entries_uop_vecWen = _RANDOM[6'h6][18];
        entries_uop_v0Wen = _RANDOM[6'h6][19];
        entries_uop_vlWen = _RANDOM[6'h6][20];
        entries_uop_vpu_vma = _RANDOM[6'h8][9];
        entries_uop_vpu_vta = _RANDOM[6'h8][10];
        entries_uop_vpu_vsew = _RANDOM[6'h8][12:11];
        entries_uop_vpu_vlmul = _RANDOM[6'h8][15:13];
        entries_uop_vpu_vm = _RANDOM[6'h8][24];
        entries_uop_vpu_vstart = {_RANDOM[6'h8][31:25], _RANDOM[6'h9][0]};
        entries_uop_vpu_vuopIdx = _RANDOM[6'h9][19:13];
        entries_uop_vpu_lastUop = _RANDOM[6'h9][20];
        entries_uop_vpu_nf = _RANDOM[6'hD][31:29];
        entries_uop_vpu_veew = _RANDOM[6'hE][1:0];
        entries_uop_vpu_isVleff = _RANDOM[6'hE][10];
        entries_uop_pdest = _RANDOM[6'h11][28:21];
        entries_uop_robIdx_flag = _RANDOM[6'h12][9];
        entries_uop_robIdx_value = _RANDOM[6'h12][15:10];
        entries_vl = _RANDOM[6'h28][10:3];
        entries_hasException = _RANDOM[6'h28][11];
        valid = _RANDOM[6'h28][12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        entries_uop_fuOpType = 9'h0;
        entries_uop_vecWen = 1'h0;
