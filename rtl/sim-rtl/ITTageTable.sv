...
module ITTageTable(
  ...
  wire [6:0] update_idx = {io_update_pc[7:5], io_update_pc[4:1] ^ io_update_ghist[3:0]};
  reg        needReset;
  ...
  always @(posedge clock) begin
    if (_useful_can_reset_T)
      s1_tag <=
        {io_req_bits_pc[14:13],
         {io_req_bits_pc[12],
          io_req_bits_pc[11:8] ^ io_req_bits_folded_hist_hist_3_folded_hist}
  ...
  FoldedSRAMTemplate_16 table_0 (
    ...
    .io_r_req_bits_setIdx
      ({io_req_bits_pc[7:5],
        io_req_bits_pc[4:1] ^ io_req_bits_folded_hist_hist_3_folded_hist}),
    ...
    .io_w_req_bits_data_0_tag
      ({io_update_pc[14:13],
        {io_update_pc[12], io_update_pc[11:8] ^ io_update_ghist[3:0]}
