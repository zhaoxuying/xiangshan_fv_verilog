...
module NewPipelineConnectPipe_35(
  input         clock,
  input         reset,
  output        io_in_ready,
  input         io_in_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_uop_ftqPtr_value = _RANDOM[6'h8][20:18];
        data_uop_ftqOffset = _RANDOM[6'h8][24:21];
        data_uop_fuOpType = _RANDOM[6'hA][30:22];
        data_uop_rfWen = _RANDOM[6'hA][31];
        data_uop_fpWen = _RANDOM[6'hB][0];
        ...
        data_uop_pdest = _RANDOM[6'h16][11:4];
        data_uop_robIdx_flag = _RANDOM[6'h16][24];
        data_uop_robIdx_value = _RANDOM[6'h16][30:25];
        data_uop_storeSetHit = _RANDOM[6'h2B][16];
        data_uop_waitForRobIdx_flag = _RANDOM[6'h2B][17];
        data_uop_waitForRobIdx_value = _RANDOM[6'h2B][23:18];
        data_uop_loadWaitBit = _RANDOM[6'h2B][24];
        data_uop_loadWaitStrict = _RANDOM[6'h2B][25];
        data_uop_lqIdx_flag = _RANDOM[6'h2B][31];
        data_uop_lqIdx_value = _RANDOM[6'h2C][4:0];
        data_uop_sqIdx_flag = _RANDOM[6'h2C][5];
        data_uop_sqIdx_value = _RANDOM[6'h2C][10:6];
        data_mBIndex = _RANDOM[6'h2C][22:19];
        data_elemIdx = _RANDOM[6'h2C][30:23];
        data_elemIdxInsideVd = {_RANDOM[6'h2C][31], _RANDOM[6'h2D][6:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
