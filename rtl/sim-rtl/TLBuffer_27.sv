...
module TLBuffer_27(
  ...
  Queue2_TLBundleA_34 nodeOut_a_q (
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue2_TLBundleD_37 nodeIn_d_q (
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue2_TLBundleC_3 nodeOut_c_q (
    .clock                      (clock),
    .reset                      (reset),
    ...
    .io_enq_bits_user_vaddr     (auto_in_c_bits_user_vaddr),
    .io_enq_bits_user_needHint  (auto_in_c_bits_user_needHint),
    .io_enq_bits_user_reqSource (auto_in_c_bits_user_reqSource),
    .io_enq_bits_echo_isKeyword (auto_in_c_bits_echo_isKeyword),
  ...
  Queue2_TLBundleE_2 nodeOut_e_q (
    .clock            (clock),
    .reset            (reset),
