  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        bits_1_robIdx_value = _RANDOM[4'h9][19:14];
        bits_1_pdest = {_RANDOM[4'h9][31:25], _RANDOM[4'hA][0]};
        bits_1_fpWen = _RANDOM[4'hA][2];
        bits_1_vecWen = _RANDOM[4'hA][3];
        bits_1_v0Wen = _RANDOM[4'hA][4];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valids_1 = 1'h0;
    end // initial
