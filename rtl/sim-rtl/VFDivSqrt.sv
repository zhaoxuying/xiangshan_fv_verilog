...
module VFDivSqrt(
  ...
  wire [7:0]   outData_src_4 =
    _io_out_bits_debug_seqNum_T ? io_in_bits_data_src_4 : outData_r_src_4;
  ...
  wire         _GEN = io_in_ready_0 | _io_out_bits_debug_seqNum_T;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_robIdx_value = _RANDOM[5'h0][15:10];
        outCtrl_r_vpu_vma = _RANDOM[5'h1][5];
        outCtrl_r_vpu_vta = _RANDOM[5'h1][6];
        outCtrl_r_vpu_vsew = _RANDOM[5'h1][8:7];
        outCtrl_r_vpu_vlmul = _RANDOM[5'h1][11:9];
        outCtrl_r_vpu_vm = _RANDOM[5'h1][20];
        outCtrl_r_vpu_vstart = _RANDOM[5'h1][28:21];
        outCtrl_r_vpu_vuopIdx = _RANDOM[5'h2][15:9];
        outCtrl_r_vpu_isNarrow = _RANDOM[5'h7][0];
        outCtrl_r_vpu_isDstMask = _RANDOM[5'h7][1];
        outData_r_src_4 = _RANDOM[5'h7][14:7];
        outData_r_src_3 =
          {_RANDOM[5'h7][31:15],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[5'hB][31:15],
           ...
           _RANDOM[5'hE],
           _RANDOM[5'hF][14:0]};
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h1B][15];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h1B][21:16];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h1B][29:22];
        io_out_bits_ctrl_vecWen_r = _RANDOM[5'h1B][30];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[5'h1B][31];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[5'h1C][2];
      `endif // RANDOMIZE_REG_INIT
    end // initial
