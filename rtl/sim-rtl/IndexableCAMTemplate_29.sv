...
module IndexableCAMTemplate_29(
  input        clock,
  input  [6:0] io_r_req_0_idx,
  output       io_r_resp_0_0,
  output       io_r_resp_0_1,
  output       io_r_resp_0_2,
  output       io_r_resp_0_3,
  input        io_w_valid,
  input  [6:0] io_w_bits_data_idx,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        array_0 = _RANDOM[/*Zero width*/ 1'b0][6:0];
        array_1 = _RANDOM[/*Zero width*/ 1'b0][13:7];
        array_2 = _RANDOM[/*Zero width*/ 1'b0][20:14];
        array_3 = _RANDOM[/*Zero width*/ 1'b0][27:21];
      `endif // RANDOMIZE_REG_INIT
    end // initial
