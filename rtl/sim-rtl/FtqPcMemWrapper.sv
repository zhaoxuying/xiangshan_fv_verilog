...
module FtqPcMemWrapper(
  input         clock,
  input         reset,
  input  [2:0]  io_ifuPtr_w_value,
  input  [2:0]  io_ifuPtrPlus1_w_value,
  input  [2:0]  io_ifuPtrPlus2_w_value,
  input  [2:0]  io_pfPtr_w_value,
  input  [2:0]  io_pfPtrPlus1_w_value,
  input  [2:0]  io_commPtr_w_value,
  input  [2:0]  io_commPtrPlus1_w_value,
  ...
  SyncDataModuleTemplate_FtqPC_8entry mem (
    .clock                    (clock),
    .reset                    (reset),
