...
module IssueQueueVfmaVialuFixVimacVppuVfaluVfcvtVipuVsetrvfwvf(
  ...
  output [7:0]  io_deqDelay_1_bits_rf_4_0_addr,
  output [7:0]  io_deqDelay_1_bits_rf_3_0_addr,
  output [7:0]  io_deqDelay_1_bits_rf_2_0_addr,
  ...
  output [7:0]  io_deqDelay_0_bits_rf_4_0_addr,
  output [7:0]  io_deqDelay_0_bits_rf_3_0_addr,
  ...
  wire [7:0]  _entries_io_deqEntry_0_bits_status_srcStatus_3_psrc;
  wire [7:0]  _entries_io_deqEntry_0_bits_status_srcStatus_4_psrc;
  ...
  wire [7:0]  _entries_io_deqEntry_1_bits_status_srcStatus_2_psrc;
  wire [7:0]  _entries_io_deqEntry_1_bits_status_srcStatus_3_psrc;
  wire [7:0]  _entries_io_deqEntry_1_bits_status_srcStatus_4_psrc;
  ...
  reg  [7:0]  deqDelay_1_bits_rf_4_0_addr;
  reg  [7:0]  deqDelay_1_bits_rf_3_0_addr;
  reg  [7:0]  deqDelay_1_bits_rf_2_0_addr;
  ...
  reg  [7:0]  deqDelay_0_bits_rf_4_0_addr;
  reg  [7:0]  deqDelay_0_bits_rf_3_0_addr;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqDelay_1_bits_rf_4_0_addr = _RANDOM[7'h8][8:1];
        deqDelay_1_bits_rf_3_0_addr = _RANDOM[7'h8][19:12];
        deqDelay_1_bits_rf_2_0_addr = _RANDOM[7'h8][30:23];
        deqDelay_1_bits_rf_1_0_addr = _RANDOM[7'h9][9:2];
        deqDelay_1_bits_rf_0_0_addr = _RANDOM[7'h9][20:13];
        deqDelay_1_bits_immType = _RANDOM[7'hA][15:12];
        deqDelay_1_bits_common_fuType = {_RANDOM[7'hA][31:16], _RANDOM[7'hB][18:0]};
        deqDelay_1_bits_common_fuOpType = _RANDOM[7'hB][27:19];
        deqDelay_1_bits_common_imm =
          {_RANDOM[7'h1F][31:28], _RANDOM[7'h20], _RANDOM[7'h21][27:0]};
        deqDelay_1_bits_common_robIdx_flag = _RANDOM[7'h21][28];
        deqDelay_1_bits_common_robIdx_value =
          {_RANDOM[7'h21][31:29], _RANDOM[7'h22][2:0]};
        deqDelay_1_bits_common_pdest = _RANDOM[7'h22][15:8];
        deqDelay_1_bits_common_rfWen = _RANDOM[7'h22][16];
        deqDelay_1_bits_common_fpWen = _RANDOM[7'h22][17];
        deqDelay_1_bits_common_vecWen = _RANDOM[7'h22][18];
        deqDelay_1_bits_common_v0Wen = _RANDOM[7'h22][19];
        deqDelay_1_bits_common_vlWen = _RANDOM[7'h22][20];
        deqDelay_1_bits_common_fpu_wflags = _RANDOM[7'h22][23];
        deqDelay_1_bits_common_vpu_vma = _RANDOM[7'h23][0];
        deqDelay_1_bits_common_vpu_vta = _RANDOM[7'h23][1];
        deqDelay_1_bits_common_vpu_vsew = _RANDOM[7'h23][3:2];
        deqDelay_1_bits_common_vpu_vlmul = _RANDOM[7'h23][6:4];
        deqDelay_1_bits_common_vpu_vm = _RANDOM[7'h23][15];
        deqDelay_1_bits_common_vpu_vstart = _RANDOM[7'h23][23:16];
        deqDelay_1_bits_common_vpu_fpu_isFoldTo1_2 = _RANDOM[7'h23][31];
        deqDelay_1_bits_common_vpu_fpu_isFoldTo1_4 = _RANDOM[7'h24][0];
        deqDelay_1_bits_common_vpu_fpu_isFoldTo1_8 = _RANDOM[7'h24][1];
        deqDelay_1_bits_common_vpu_vuopIdx = _RANDOM[7'h24][10:4];
        deqDelay_1_bits_common_vpu_lastUop = _RANDOM[7'h24][11];
        deqDelay_1_bits_common_vpu_isNarrow = _RANDOM[7'h28][27];
        deqDelay_1_bits_common_vpu_isDstMask = _RANDOM[7'h28][28];
        deqDelay_1_bits_common_dataSources_0_value = _RANDOM[7'h29][5:2];
        deqDelay_1_bits_common_dataSources_1_value = _RANDOM[7'h29][9:6];
        deqDelay_1_bits_common_dataSources_2_value = _RANDOM[7'h29][13:10];
        deqDelay_1_bits_common_dataSources_3_value = _RANDOM[7'h29][17:14];
        deqDelay_1_bits_common_dataSources_4_value = _RANDOM[7'h29][21:18];
        deqDelay_0_valid = _RANDOM[7'h3E][7];
        deqDelay_0_bits_rf_4_0_addr = _RANDOM[7'h3E][15:8];
        deqDelay_0_bits_rf_3_0_addr = _RANDOM[7'h3E][26:19];
        deqDelay_0_bits_rf_2_0_addr = {_RANDOM[7'h3E][31:30], _RANDOM[7'h3F][5:0]};
        deqDelay_0_bits_rf_1_0_addr = _RANDOM[7'h3F][16:9];
        deqDelay_0_bits_rf_0_0_addr = _RANDOM[7'h3F][27:20];
        deqDelay_0_bits_common_fuType = {_RANDOM[7'h40][31:23], _RANDOM[7'h41][25:0]};
        deqDelay_0_bits_common_fuOpType = {_RANDOM[7'h41][31:26], _RANDOM[7'h42][2:0]};
        deqDelay_0_bits_common_robIdx_flag = _RANDOM[7'h58][3];
        deqDelay_0_bits_common_robIdx_value = _RANDOM[7'h58][9:4];
        deqDelay_0_bits_common_pdest = _RANDOM[7'h58][22:15];
        deqDelay_0_bits_common_vecWen = _RANDOM[7'h58][23];
        deqDelay_0_bits_common_v0Wen = _RANDOM[7'h58][24];
        deqDelay_0_bits_common_fpu_wflags = _RANDOM[7'h58][27];
        deqDelay_0_bits_common_vpu_vma = _RANDOM[7'h59][4];
        deqDelay_0_bits_common_vpu_vta = _RANDOM[7'h59][5];
        deqDelay_0_bits_common_vpu_vsew = _RANDOM[7'h59][7:6];
        deqDelay_0_bits_common_vpu_vlmul = _RANDOM[7'h59][10:8];
        deqDelay_0_bits_common_vpu_vm = _RANDOM[7'h59][19];
        deqDelay_0_bits_common_vpu_vstart = _RANDOM[7'h59][27:20];
        deqDelay_0_bits_common_vpu_vuopIdx = _RANDOM[7'h5A][14:8];
        deqDelay_0_bits_common_vpu_isExt = _RANDOM[7'h5E][30];
        deqDelay_0_bits_common_vpu_isNarrow = _RANDOM[7'h5E][31];
        deqDelay_0_bits_common_vpu_isDstMask = _RANDOM[7'h5F][0];
        deqDelay_0_bits_common_vpu_isOpMask = _RANDOM[7'h5F][1];
        deqDelay_0_bits_common_dataSources_0_value = _RANDOM[7'h5F][9:6];
        deqDelay_0_bits_common_dataSources_1_value = _RANDOM[7'h5F][13:10];
        deqDelay_0_bits_common_dataSources_2_value = _RANDOM[7'h5F][17:14];
        deqDelay_0_bits_common_dataSources_3_value = _RANDOM[7'h5F][21:18];
        deqDelay_0_bits_common_dataSources_4_value = _RANDOM[7'h5F][25:22];
        io_validCntDeqVec_0_REG = _RANDOM[7'h74][15:11];
        io_validCntDeqVec_1_REG = _RANDOM[7'h74][20:16];
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  EntriesVfmaVialuFixVimacVppuVfaluVfcvtVipuVsetrvfwvf entries (
    ...
    .io_enq_0_bits_status_srcStatus_4_psrc              (io_enq_0_bits_psrc_4),
    ...
    .io_enq_1_bits_status_srcStatus_4_psrc              (io_enq_1_bits_psrc_4),
