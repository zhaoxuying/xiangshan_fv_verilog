  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_srcStatus_0_exuSources_value = _RANDOM[5'h2][3:2];
        entryReg_status_srcStatus_1_psrc = _RANDOM[5'h2][11:4];
        ...
        entryReg_status_srcStatus_1_exuSources_value = _RANDOM[5'h2][28:27];
        entryReg_status_srcStatus_2_psrc = {_RANDOM[5'h2][31:29], _RANDOM[5'h3][4:0]};
        entryReg_status_srcStatus_2_srcType = _RANDOM[5'h3][8:5];
        entryReg_status_srcStatus_2_srcState = _RANDOM[5'h3][9];
        entryReg_status_srcStatus_2_dataSources_value = _RANDOM[5'h3][13:10];
        entryReg_status_srcStatus_2_exuSources_value = _RANDOM[5'h3][21:20];
        entryReg_status_issued = _RANDOM[5'h3][23];
        entryReg_status_issueTimer = _RANDOM[5'h3][26:25];
        entryReg_status_deqPortIdx = _RANDOM[5'h3][27];
        entryReg_payload_fuOpType = _RANDOM[5'hA][11:3];
        entryReg_payload_rfWen = _RANDOM[5'hA][12];
        entryReg_payload_fpWen = _RANDOM[5'hA][13];
        entryReg_payload_vecWen = _RANDOM[5'hA][14];
        entryReg_payload_v0Wen = _RANDOM[5'hA][15];
        entryReg_payload_fpu_wflags = _RANDOM[5'hB][28];
        entryReg_payload_fpu_fmt = {_RANDOM[5'hB][31], _RANDOM[5'hC][0]};
        entryReg_payload_fpu_rm = _RANDOM[5'hC][3:1];
        entryReg_payload_pdest = _RANDOM[5'h15][24:17];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validReg_last_REG = 1'h0;
    end // initial
