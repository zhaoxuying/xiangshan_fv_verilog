...
module ExeUnit_13(
  ...
  wire         _in1ToN_io_out_3_bits_vpu_vma;
  wire         _in1ToN_io_out_3_bits_vpu_vta;
  wire [1:0]   _in1ToN_io_out_3_bits_vpu_vsew;
  wire [2:0]   _in1ToN_io_out_3_bits_vpu_vlmul;
  wire         _in1ToN_io_out_3_bits_vpu_vm;
  wire [7:0]   _in1ToN_io_out_3_bits_vpu_vstart;
  wire [6:0]   _in1ToN_io_out_3_bits_vpu_vuopIdx;
  wire         _ClockGate_3_Q;
  wire         _ClockGate_2_Q;
  wire         _ClockGate_1_Q;
  wire         _ClockGate_Q;
  ...
  wire [5:0]   _Vppu_io_out_bits_ctrl_robIdx_value;
  ...
  wire [5:0]   _Vimac_io_out_bits_ctrl_robIdx_value;
  ...
  wire [5:0]   _VialuFix_io_out_bits_ctrl_robIdx_value;
  ...
  wire [5:0]   _Vfma_io_out_bits_ctrl_robIdx_value;
  ...
  wire         Vfma_clock_te_cgen = cg_bore_cgen;
  wire         VialuFix_clock_te_cgen = cg_bore_1_cgen;
  wire         Vimac_clock_te_cgen = cg_bore_2_cgen;
  wire         Vppu_clock_te_cgen = cg_bore_3_cgen;
  reg          fuVld_en_reg;
  reg          fuVldVec_1;
  reg          fuVldVec_2;
  reg          fuVldVec_3;
  ...
  reg          fuVldVec_1_3;
  reg          fuVldVec_2_2;
  wire         fuVld_en_3 = _in1ToN_io_out_3_valid | fuVldVec_1_3 | fuVldVec_2_2;
  reg          inPipe_2_1;
  reg          inPipe_2_2;
  reg          inPipe_2_3;
  ...
  wire [127:0] io_out_bits_data_2_0 =
    ...
    | (_Vimac_io_out_valid ? _Vimac_io_out_bits_res_data : 128'h0)
    | (_Vppu_io_out_valid ? _Vppu_io_out_bits_res_data : 128'h0);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fuVld_en_reg_2 = _RANDOM[8'h0][8];
        fuVldVec_1_2 = _RANDOM[8'h0][10];
        fuVldVec_2_1 = _RANDOM[8'h0][11];
        fuVld_en_reg_3 = _RANDOM[8'h0][12];
        fuVldVec_1_3 = _RANDOM[8'h0][14];
        fuVldVec_2_2 = _RANDOM[8'h0][15];
        inPipe_2_1 = _RANDOM[8'h0][17];
        inPipe_2_2 = _RANDOM[8'h0][18];
        inPipe_2_3 = _RANDOM[8'h0][19];
        inPipe_1_1_fuOpType = _RANDOM[8'h1][31:23];
        inPipe_1_1_src_2 = {_RANDOM[8'hA], _RANDOM[8'hB], _RANDOM[8'hC], _RANDOM[8'hD]};
        inPipe_1_1_src_3 = {_RANDOM[8'hE], _RANDOM[8'hF], _RANDOM[8'h10], _RANDOM[8'h11]};
        inPipe_1_1_src_4 =
          {_RANDOM[8'h12], _RANDOM[8'h13], _RANDOM[8'h14], _RANDOM[8'h15]};
        inPipe_1_1_robIdx_flag = _RANDOM[8'h18][0];
        inPipe_1_1_robIdx_value = _RANDOM[8'h18][6:1];
        inPipe_1_1_pdest = _RANDOM[8'h18][19:12];
        inPipe_1_1_vecWen = _RANDOM[8'h18][20];
        inPipe_1_1_v0Wen = _RANDOM[8'h18][21];
        inPipe_1_1_fpu_wflags = _RANDOM[8'h18][24];
        inPipe_1_1_vpu_vma = _RANDOM[8'h19][1];
        inPipe_1_1_vpu_vta = _RANDOM[8'h19][2];
        inPipe_1_1_vpu_vsew = _RANDOM[8'h19][4:3];
        inPipe_1_1_vpu_vlmul = _RANDOM[8'h19][7:5];
        inPipe_1_1_vpu_vm = _RANDOM[8'h19][16];
        inPipe_1_1_vpu_vstart = _RANDOM[8'h19][24:17];
        inPipe_1_1_vpu_vuopIdx = _RANDOM[8'h1A][11:5];
        inPipe_1_1_vpu_isExt = _RANDOM[8'h1E][27];
        inPipe_1_1_vpu_isNarrow = _RANDOM[8'h1E][28];
        inPipe_1_1_vpu_isDstMask = _RANDOM[8'h1E][29];
        inPipe_1_1_vpu_isOpMask = _RANDOM[8'h1E][30];
        inPipe_1_2_fuOpType = {_RANDOM[8'h34][31:27], _RANDOM[8'h35][3:0]};
        inPipe_1_2_src_2 =
          {_RANDOM[8'h3D][31:4],
           _RANDOM[8'h3E],
           _RANDOM[8'h3F],
        ...
        inPipe_1_2_src_4 =
          {_RANDOM[8'h45][31:4],
           ...
           _RANDOM[8'h48],
           _RANDOM[8'h49][3:0]};
        inPipe_1_2_robIdx_flag = _RANDOM[8'h4B][4];
        inPipe_1_2_robIdx_value = _RANDOM[8'h4B][10:5];
        inPipe_1_2_pdest = _RANDOM[8'h4B][23:16];
        inPipe_1_2_vecWen = _RANDOM[8'h4B][24];
        inPipe_1_2_v0Wen = _RANDOM[8'h4B][25];
        inPipe_1_2_fpu_wflags = _RANDOM[8'h4B][28];
        inPipe_1_2_vpu_vma = _RANDOM[8'h4C][5];
        inPipe_1_2_vpu_vta = _RANDOM[8'h4C][6];
        inPipe_1_2_vpu_vsew = _RANDOM[8'h4C][8:7];
        inPipe_1_2_vpu_vlmul = _RANDOM[8'h4C][11:9];
        inPipe_1_2_vpu_vm = _RANDOM[8'h4C][20];
        inPipe_1_2_vpu_vstart = _RANDOM[8'h4C][28:21];
        inPipe_1_2_vpu_vuopIdx = _RANDOM[8'h4D][15:9];
        inPipe_1_2_vpu_isNarrow = _RANDOM[8'h52][0];
        inPipe_1_2_vpu_isDstMask = _RANDOM[8'h52][1];
        inPipe_1_3_fuOpType = {_RANDOM[8'h67][31], _RANDOM[8'h68][7:0]};
        inPipe_1_3_src_2 =
          {_RANDOM[8'h70][31:8],
           _RANDOM[8'h71],
           _RANDOM[8'h72],
        ...
        inPipe_1_3_src_4 =
          {_RANDOM[8'h78][31:8],
           ...
           _RANDOM[8'h7B],
           _RANDOM[8'h7C][7:0]};
        inPipe_1_3_robIdx_flag = _RANDOM[8'h7E][8];
        inPipe_1_3_robIdx_value = _RANDOM[8'h7E][14:9];
        inPipe_1_3_pdest = _RANDOM[8'h7E][27:20];
        inPipe_1_3_vecWen = _RANDOM[8'h7E][28];
        inPipe_1_3_v0Wen = _RANDOM[8'h7E][29];
        inPipe_1_3_fpu_wflags = _RANDOM[8'h7F][0];
        inPipe_1_3_vpu_vma = _RANDOM[8'h7F][9];
        inPipe_1_3_vpu_vta = _RANDOM[8'h7F][10];
        inPipe_1_3_vpu_vsew = _RANDOM[8'h7F][12:11];
        inPipe_1_3_vpu_vlmul = _RANDOM[8'h7F][15:13];
        inPipe_1_3_vpu_vm = _RANDOM[8'h7F][24];
        inPipe_1_3_vpu_vstart = {_RANDOM[8'h7F][31:25], _RANDOM[8'h80][0]};
        inPipe_1_3_vpu_vuopIdx = _RANDOM[8'h80][19:13];
        inPipe_1_3_vpu_isNarrow = _RANDOM[8'h85][4];
        inPipe_1_3_vpu_isDstMask = _RANDOM[8'h85][5];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fuVld_en_reg = 1'h0;
        fuVldVec_1 = 1'h0;
  ...
  VIMacU Vimac (
    ...
    .io_in_bits_ctrlPipe_2_fuOpType     (inPipe_1_2_fuOpType),
    ...
    .io_in_bits_ctrlPipe_2_vpu_vsew     (inPipe_1_2_vpu_vsew),
  ...
  VPPU Vppu (
    ...
    .io_in_bits_ctrl_vpu_vma            (_in1ToN_io_out_3_bits_vpu_vma),
    .io_in_bits_ctrl_vpu_vta            (_in1ToN_io_out_3_bits_vpu_vta),
    .io_in_bits_ctrl_vpu_vsew           (_in1ToN_io_out_3_bits_vpu_vsew),
    .io_in_bits_ctrl_vpu_vlmul          (_in1ToN_io_out_3_bits_vpu_vlmul),
    .io_in_bits_ctrl_vpu_vm             (_in1ToN_io_out_3_bits_vpu_vm),
    .io_in_bits_ctrl_vpu_vstart         (_in1ToN_io_out_3_bits_vpu_vstart),
    .io_in_bits_ctrl_vpu_vuopIdx        (_in1ToN_io_out_3_bits_vpu_vuopIdx),
    .io_in_bits_ctrlPipe_2_robIdx_flag  (inPipe_1_2_robIdx_flag),
    .io_in_bits_ctrlPipe_2_robIdx_value (inPipe_1_2_robIdx_value),
    .io_in_bits_ctrlPipe_2_pdest        (inPipe_1_2_pdest),
    .io_in_bits_ctrlPipe_2_vecWen       (inPipe_1_2_vecWen),
  ...
  Dispatcher_13 in1ToN (
    ...
    .io_out_3_bits_vpu_vma       (_in1ToN_io_out_3_bits_vpu_vma),
    .io_out_3_bits_vpu_vta       (_in1ToN_io_out_3_bits_vpu_vta),
    .io_out_3_bits_vpu_vsew      (_in1ToN_io_out_3_bits_vpu_vsew),
    .io_out_3_bits_vpu_vlmul     (_in1ToN_io_out_3_bits_vpu_vlmul),
    .io_out_3_bits_vpu_vm        (_in1ToN_io_out_3_bits_vpu_vm),
    .io_out_3_bits_vpu_vstart    (_in1ToN_io_out_3_bits_vpu_vstart),
    .io_out_3_bits_vpu_vuopIdx   (_in1ToN_io_out_3_bits_vpu_vuopIdx)
  );
  assign io_out_valid =
    |{_Vfma_io_out_valid,
  ...
  assign io_out_bits_pdest =
    (_Vfma_io_out_valid ? _Vfma_io_out_bits_ctrl_pdest : 8'h0)
    | (_VialuFix_io_out_valid ? _VialuFix_io_out_bits_ctrl_pdest : 8'h0)
    | (_Vimac_io_out_valid ? _Vimac_io_out_bits_ctrl_pdest : 8'h0)
    | (_Vppu_io_out_valid ? _Vppu_io_out_bits_ctrl_pdest : 8'h0);
  assign io_out_bits_robIdx_flag =
    _Vfma_io_out_valid & _Vfma_io_out_bits_ctrl_robIdx_flag | _VialuFix_io_out_valid
    & _VialuFix_io_out_bits_ctrl_robIdx_flag | _Vimac_io_out_valid
    & _Vimac_io_out_bits_ctrl_robIdx_flag | _Vppu_io_out_valid
    & _Vppu_io_out_bits_ctrl_robIdx_flag;
  assign io_out_bits_robIdx_value =
    (_Vfma_io_out_valid ? _Vfma_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_VialuFix_io_out_valid ? _VialuFix_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Vimac_io_out_valid ? _Vimac_io_out_bits_ctrl_robIdx_value : 6'h0)
    | (_Vppu_io_out_valid ? _Vppu_io_out_bits_ctrl_robIdx_value : 6'h0);
  assign io_out_bits_vecWen =
    _Vfma_io_out_valid & _Vfma_io_out_bits_ctrl_vecWen | _VialuFix_io_out_valid
    & _VialuFix_io_out_bits_ctrl_vecWen | _Vimac_io_out_valid
    & _Vimac_io_out_bits_ctrl_vecWen | _Vppu_io_out_valid & _Vppu_io_out_bits_ctrl_vecWen;
  assign io_out_bits_v0Wen =
    _Vfma_io_out_valid & _Vfma_io_out_bits_ctrl_v0Wen | _VialuFix_io_out_valid
    & _VialuFix_io_out_bits_ctrl_v0Wen | _Vimac_io_out_valid
    & _Vimac_io_out_bits_ctrl_v0Wen | _Vppu_io_out_valid & _Vppu_io_out_bits_ctrl_v0Wen;
  ...
  assign io_out_bits_vxsat =
    _VialuFix_io_out_valid & _VialuFix_io_out_bits_res_vxsat | _Vimac_io_out_valid
    & _Vimac_io_out_bits_res_vxsat;
  assign io_out_bits_exceptionVec_2 =
    _Vppu_io_out_valid & _Vppu_io_out_bits_ctrl_exceptionVec_2;
endmodule
