  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uop_ctrl_robIdx_value = _RANDOM[5'h0][18:13];
        uop_ctrl_pdest = _RANDOM[5'h0][26:19];
        uop_ctrl_flushPipe = _RANDOM[5'h0][27];
        uop_data_imm = {_RANDOM[5'h4][31:28], _RANDOM[5'h5], _RANDOM[5'h6][27:0]};
        io_fenceio_sfence_bits_addr_r =
          {_RANDOM[5'h1A][31:29], _RANDOM[5'h1B], _RANDOM[5'h1C][28:0]};
        io_fenceio_sfence_bits_id_r =
          {_RANDOM[5'h1C][31:29], _RANDOM[5'h1D], _RANDOM[5'h1E][28:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 3'h0;
    end // initial
