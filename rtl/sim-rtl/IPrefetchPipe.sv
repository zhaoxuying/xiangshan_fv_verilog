...
module IPrefetchPipe(
  ...
  input  [2:0]  io_req_bits_ftqIdx_value,
  ...
  input  [2:0]  io_flushFromBpu_s2_bits_value,
  ...
  output [1:0]  io_metaRead_toIMeta_bits_vSetIdx_0,
  output [1:0]  io_metaRead_toIMeta_bits_vSetIdx_1,
  output        io_metaRead_toIMeta_bits_isDoubleLine,
  input  [39:0] io_metaRead_fromIMeta_metas_0_0_tag,
  input  [39:0] io_metaRead_fromIMeta_metas_0_1_tag,
  input  [39:0] io_metaRead_fromIMeta_metas_0_2_tag,
  input  [39:0] io_metaRead_fromIMeta_metas_0_3_tag,
  input  [39:0] io_metaRead_fromIMeta_metas_1_0_tag,
  input  [39:0] io_metaRead_fromIMeta_metas_1_1_tag,
  input  [39:0] io_metaRead_fromIMeta_metas_1_2_tag,
  input  [39:0] io_metaRead_fromIMeta_metas_1_3_tag,
  ...
  output [1:0]  io_MSHRReq_bits_vSetIdx,
  input         io_MSHRResp_valid,
  input  [41:0] io_MSHRResp_bits_blkPaddr,
  input  [1:0]  io_MSHRResp_bits_vSetIdx,
  ...
  output [1:0]  io_wayLookupWrite_bits_entry_vSetIdx_0,
  output [1:0]  io_wayLookupWrite_bits_entry_vSetIdx_1,
  output [3:0]  io_wayLookupWrite_bits_entry_waymask_0,
  output [3:0]  io_wayLookupWrite_bits_entry_waymask_1,
  output [39:0] io_wayLookupWrite_bits_entry_ptag_0,
  output [39:0] io_wayLookupWrite_bits_entry_ptag_1,
  ...
  wire [3:0]  s1_SRAM_waymasks_0 =
    tlb_valid_pulse_0
      ? {io_metaRead_fromIMeta_metas_0_3_tag == io_itlb_0_resp_bits_paddr_0[47:8]
           & io_metaRead_fromIMeta_entryValid_0_3,
         io_metaRead_fromIMeta_metas_0_2_tag == io_itlb_0_resp_bits_paddr_0[47:8]
           & io_metaRead_fromIMeta_entryValid_0_2,
         io_metaRead_fromIMeta_metas_0_1_tag == io_itlb_0_resp_bits_paddr_0[47:8]
           & io_metaRead_fromIMeta_entryValid_0_1,
         io_metaRead_fromIMeta_metas_0_0_tag == io_itlb_0_resp_bits_paddr_0[47:8]
           & io_metaRead_fromIMeta_entryValid_0_0}
      : {io_metaRead_fromIMeta_metas_0_3_tag == s1_req_paddr_reg_r[47:8]
           & io_metaRead_fromIMeta_entryValid_0_3,
         io_metaRead_fromIMeta_metas_0_2_tag == s1_req_paddr_reg_r[47:8]
           & io_metaRead_fromIMeta_entryValid_0_2,
         io_metaRead_fromIMeta_metas_0_1_tag == s1_req_paddr_reg_r[47:8]
           & io_metaRead_fromIMeta_entryValid_0_1,
         io_metaRead_fromIMeta_metas_0_0_tag == s1_req_paddr_reg_r[47:8]
           & io_metaRead_fromIMeta_entryValid_0_0};
  wire [3:0]  s1_SRAM_waymasks_1 =
    tlb_valid_pulse_1
      ? {io_metaRead_fromIMeta_metas_1_3_tag == io_itlb_1_resp_bits_paddr_0[47:8]
           & io_metaRead_fromIMeta_entryValid_1_3,
         io_metaRead_fromIMeta_metas_1_2_tag == io_itlb_1_resp_bits_paddr_0[47:8]
           & io_metaRead_fromIMeta_entryValid_1_2,
         io_metaRead_fromIMeta_metas_1_1_tag == io_itlb_1_resp_bits_paddr_0[47:8]
           & io_metaRead_fromIMeta_entryValid_1_1,
         io_metaRead_fromIMeta_metas_1_0_tag == io_itlb_1_resp_bits_paddr_0[47:8]
           & io_metaRead_fromIMeta_entryValid_1_0}
      : {io_metaRead_fromIMeta_metas_1_3_tag == s1_req_paddr_reg_r_1[47:8]
           & io_metaRead_fromIMeta_entryValid_1_3,
         io_metaRead_fromIMeta_metas_1_2_tag == s1_req_paddr_reg_r_1[47:8]
           & io_metaRead_fromIMeta_entryValid_1_2,
         io_metaRead_fromIMeta_metas_1_1_tag == s1_req_paddr_reg_r_1[47:8]
           & io_metaRead_fromIMeta_entryValid_1_1,
         io_metaRead_fromIMeta_metas_1_0_tag == s1_req_paddr_reg_r_1[47:8]
           & io_metaRead_fromIMeta_entryValid_1_0};
  ...
  wire        new_info_ptag_same_1 =
    io_MSHRResp_bits_blkPaddr[41:2] == s1_req_paddr_1[47:8];
  wire        new_info_way_same_1 = io_MSHRResp_bits_waymask == old_waymask_1;
  wire        _new_info_T_1 =
    io_MSHRResp_valid & ~io_MSHRResp_bits_corrupt
    & io_MSHRResp_bits_vSetIdx == s1_req_vaddr_1[7:6];
  ...
  wire        s2_MSHR_match_0 =
    s2_req_vaddr_0[7:6] == io_MSHRResp_bits_vSetIdx
    & s2_req_paddr_0[47:8] == io_MSHRResp_bits_blkPaddr[41:2] & s2_valid
    & io_MSHRResp_valid & ~io_MSHRResp_bits_corrupt;
  wire        s2_MSHR_match_1 =
    s2_req_vaddr_1[7:6] == io_MSHRResp_bits_vSetIdx
    & s2_req_paddr_1[47:8] == io_MSHRResp_bits_blkPaddr[41:2] & s2_valid
    & io_MSHRResp_valid & ~io_MSHRResp_bits_corrupt;
    ...
    if (reset) begin
      ...
      if (s1_SRAM_valid | io_MSHRResp_valid & ~io_MSHRResp_bits_corrupt) begin
        ...
        if (_new_info_T_1) begin
          ...
          s1_waymasks_r_1 <= s1_SRAM_waymasks_1;
        if (_GEN)
          s1_meta_codes_r_0 <= ^(s1_req_paddr_0[47:8]);
        else if (s1_SRAM_valid)
          s1_meta_codes_r_0 <= s1_SRAM_meta_codes_0;
        if (_GEN_0)
          s1_meta_codes_r_1 <= ^(s1_req_paddr_1[47:8]);
        else if (s1_SRAM_valid)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_ftqIdx_value = _RANDOM[5'h3][10:8];
        s1_backendException_0 = _RANDOM[5'h3][12:11];
        s1_backendException_1 = _RANDOM[5'h3][14:13];
        state = _RANDOM[5'h3][17:15];
        s0_fire_r = _RANDOM[5'h3][18];
        s1_wait_itlb_0 = _RANDOM[5'h3][19];
        s1_wait_itlb_1 = _RANDOM[5'h3][20];
        REG = _RANDOM[5'h3][21];
        REG_1 = _RANDOM[5'h3][22];
        s1_need_itlb_REG = _RANDOM[5'h3][23];
        s1_need_itlb_REG_1 = _RANDOM[5'h3][24];
        tlb_valid_pulse_REG = _RANDOM[5'h3][25];
        tlb_valid_pulse_REG_1 = _RANDOM[5'h3][26];
        tlb_valid_latch_valid = _RANDOM[5'h3][27];
        tlb_valid_latch_valid_1 = _RANDOM[5'h3][28];
        s1_req_paddr_reg_r = {_RANDOM[5'h3][31:29], _RANDOM[5'h4], _RANDOM[5'h5][12:0]};
        s1_req_paddr_reg_r_1 = {_RANDOM[5'h5][31:13], _RANDOM[5'h6][28:0]};
        s1_req_gpaddr_tmp_r = {_RANDOM[5'h6][31:29], _RANDOM[5'h7], _RANDOM[5'h8][20:0]};
        s1_req_gpaddr_tmp_r_1 =
          {_RANDOM[5'h8][31:21], _RANDOM[5'h9], _RANDOM[5'hA][12:0]};
        s1_req_isForVSnonLeafPTE_tmp_r = _RANDOM[5'hA][13];
        s1_req_isForVSnonLeafPTE_tmp_r_1 = _RANDOM[5'hA][14];
        s1_itlb_exception_tmp_r = _RANDOM[5'hA][16:15];
        s1_itlb_exception_tmp_r_1 = _RANDOM[5'hA][18:17];
        s1_itlb_pbmt_r = _RANDOM[5'hA][20:19];
        s1_itlb_pbmt_r_1 = _RANDOM[5'hA][22:21];
        s1_SRAM_valid_REG = _RANDOM[5'hA][23];
        s1_waymasks_r_0 = _RANDOM[5'hA][27:24];
        s1_waymasks_r_1 = _RANDOM[5'hA][31:28];
        s1_meta_codes_r_0 = _RANDOM[5'hB][0];
        s1_meta_codes_r_1 = _RANDOM[5'hB][1];
        s2_valid = _RANDOM[5'hB][2];
        s2_req_vaddr_0 = {_RANDOM[5'hB][31:3], _RANDOM[5'hC][20:0]};
        s2_req_vaddr_1 = {_RANDOM[5'hC][31:21], _RANDOM[5'hD], _RANDOM[5'hE][6:0]};
        s2_doubleline = _RANDOM[5'hE][8];
        s2_req_paddr_0 = {_RANDOM[5'hE][31:9], _RANDOM[5'hF][24:0]};
        s2_req_paddr_1 = {_RANDOM[5'hF][31:25], _RANDOM[5'h10], _RANDOM[5'h11][8:0]};
        s2_exception_0 = _RANDOM[5'h11][10:9];
        s2_exception_1 = _RANDOM[5'h11][12:11];
        s2_mmio_0 = _RANDOM[5'h11][13];
        s2_mmio_1 = _RANDOM[5'h11][14];
        s2_waymasks_0 = _RANDOM[5'h11][18:15];
        s2_waymasks_1 = _RANDOM[5'h11][22:19];
        s2_MSHR_hits_valid = _RANDOM[5'h11][23];
        s2_MSHR_hits_valid_1 = _RANDOM[5'h11][24];
        has_send_0 = _RANDOM[5'h11][25];
        has_send_1 = _RANDOM[5'h11][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_req_vaddr_0 = 50'h0;
  ...
  assign io_metaRead_toIMeta_bits_vSetIdx_0 =
    s1_need_meta ? s1_req_vaddr_0[7:6] : io_req_bits_startAddr[7:6];
  assign io_metaRead_toIMeta_bits_vSetIdx_1 =
    s1_need_meta ? s1_req_vaddr_1[7:6] : io_req_bits_nextlineStart[7:6];
  ...
  assign io_wayLookupWrite_bits_entry_vSetIdx_0 = s1_req_vaddr_0[7:6];
  assign io_wayLookupWrite_bits_entry_vSetIdx_1 = s1_req_vaddr_1[7:6];
  assign io_wayLookupWrite_bits_entry_waymask_0 = new_info_1;
  assign io_wayLookupWrite_bits_entry_waymask_1 = new_info_1_1;
  assign io_wayLookupWrite_bits_entry_ptag_0 = s1_req_paddr_0[47:8];
  assign io_wayLookupWrite_bits_entry_ptag_1 = s1_req_paddr_1[47:8];
