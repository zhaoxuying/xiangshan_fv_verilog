...
module SnapshotGenerator(
  ...
  output [6:0] io_snapshots_0_value,
  output       io_snapshots_1_flag,
  output [6:0] io_snapshots_1_value,
  output       io_snapshots_2_flag,
  output [6:0] io_snapshots_2_value,
  output       io_snapshots_3_flag,
  output [6:0] io_snapshots_3_value
);

  reg        snapshots_0_flag;
  reg  [6:0] snapshots_0_value;
  reg        snapshots_1_flag;
  reg  [6:0] snapshots_1_value;
  reg        snapshots_2_flag;
  reg  [6:0] snapshots_2_value;
  reg        snapshots_3_flag;
  reg  [6:0] snapshots_3_value;
  reg        snptEnqPtr_flag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        snapshots_0_value = _RANDOM[1'h0][7:1];
        snapshots_1_flag = _RANDOM[1'h0][8];
        snapshots_1_value = _RANDOM[1'h0][15:9];
        snapshots_2_flag = _RANDOM[1'h0][16];
        snapshots_2_value = _RANDOM[1'h0][23:17];
        snapshots_3_flag = _RANDOM[1'h0][24];
        snapshots_3_value = _RANDOM[1'h0][31:25];
