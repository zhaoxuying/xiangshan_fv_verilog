...
module FDivSqrt(
  ...
  wire        _GEN = _fdiv_io_start_ready_o | _io_out_bits_debug_seqNum_T;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_robIdx_value = _RANDOM[3'h0][15:10];
        outCtrl_r_fpu_fmt = _RANDOM[3'h0][31:30];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[3'h7][3];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[3'h7][9:4];
        io_out_bits_ctrl_pdest_r = _RANDOM[3'h7][17:10];
        io_out_bits_ctrl_fpWen_r = _RANDOM[3'h7][18];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[3'h7][21];
      `endif // RANDOMIZE_REG_INIT
    end // initial
