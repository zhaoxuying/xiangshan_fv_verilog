...
module SplittedSRAM_2(
  ...
  SRAMTemplate_122 array_0_1_0 (
    .clock                 (clock),
    .io_r_req_ready        (/* unused */),
    .io_r_req_valid        (io_r_req_valid),
    .io_r_req_bits_setIdx  (io_r_req_bits_setIdx),
    .io_r_resp_data_0      (io_r_resp_data_2),
    .io_r_resp_data_1      (io_r_resp_data_3),
    .io_w_req_valid        (io_w_req_valid),
    .io_w_req_bits_setIdx  (io_w_req_bits_setIdx),
    .io_w_req_bits_data_0  (io_w_req_bits_data_2),
    .io_w_req_bits_data_1  (io_w_req_bits_data_3),
